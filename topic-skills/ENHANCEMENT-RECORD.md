...
| 增强时间 | 2026-04-03 |
| 增强范围 | 内容增强 + 新增 Skill + 基础设施更新 + 自动化脚本 |
...
| 05-service-connectivity.md | 新增 Phase 4/5（Service Mesh/Gateway API）、RC-013/014/015（EndpointSlice/Mesh sidecar/MCS API） |
| 06-certificate-expiry.md | 新增 Phase 4/5（cert-manager轮转/mTLS诊断）、RC-013/014/015（cert-manager/mTLS/OCSP）、REM-012/013 |
