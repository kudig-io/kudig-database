...
每个 demo 场景**严格映射**到 Skill 文档的 10 个 Section（参见 [_skill-schema.md](./_skill-schema.md)），让你看到 Agent 在生产中会如何使用这些 Skill。
...
Demo 的每一步都与 [_skill-schema.md](./_skill-schema.md) 的 10-Section 规范严格对应：
