...
> **适用版本**: v1.25 - v1.32 | **最后更新**: 2026-01 | **参考**: [[23-实体/04-网络/istio.md|istio]].io/latest/docs](https://istio.io/latest/docs/) | [[23-实体/04-网络/linkerd.md|linkerd]].io/docs](https://linkerd.io/docs/)
...
| **熔断** | 异常服务隔离 | 问题保护 | DestinationRule |
