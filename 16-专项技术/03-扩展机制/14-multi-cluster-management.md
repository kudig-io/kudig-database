...
> **适用版本**: v1.25 - v1.32 | **最后更新**: 2026-02 | **参考**: [[23-实体/02-K8s核心组件/kubernetes.md|kubernetes]].io/docs/concepts/architecture/multicluster](https://kubernetes.io/docs/concepts/architecture/multicluster/)
