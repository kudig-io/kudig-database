...
- [Spring Boot on K8s](../../02-工作负载/01-核心工作负载/25-spring-boot-kubernetes-guide.md) — Spring Boot K8s 部署
- [Quarkus/Micronaut 指南](19-quarkus-micronaut-cloud-native-java-guide.md) — 云原生 Java 框架对比
- [JVM GC 容器调优](../../19-故障诊断/05-JVM调优/03-jvm-gc-container-tuning-guide.md) — GC 调优 (JVM 模式)
- [Java 可观测性](../../09-可观测性/01-总览/14-java-observability-kubernetes-guide.md) — Native Image 可观测性
