...
> 💡 **定位**：本文不是「Operator 模式入门」，也不是「controller-runtime 全集」，而是**回答「面对一个新需求，我该用 SDK 的哪一种类型？」**。入门请看 [[22-概念/01-核心架构/operator-pattern.md|Operator 模式]]，深度 reconcile 实现请看 [[16-专项技术/03-扩展机制/02-operator-development-patterns.md|Operator 开发模式]]。
