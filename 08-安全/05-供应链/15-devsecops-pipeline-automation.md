...
本文系统覆盖 DevSecOps 流水线的核心环节与工具选型。供应链安全总览见 [[08-安全/05-供应链/01-supply-chain-security-overview.md|供应链安全总览]]，SBOM 专题见 [[08-安全/05-供应链/03-sbom-generation-management.md|SBOM 生成与管理]]，镜像签名见 [[08-安全/05-供应链/07-sigstore-cosign-signing.md|Sigstore Cosign 签名]]。
