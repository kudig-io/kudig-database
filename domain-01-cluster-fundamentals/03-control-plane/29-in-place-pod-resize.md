---
title: 29 - 原地 Pod 资源调整 (In-Place Pod Resize)
description: 1. [特性概述](#1-特性概述)
...
intent_queries:
- 原地 Pod 资源调整 (In-Place Pod Resize) 是什么
- 如何 原地 Pod 资源调整 (In-Place Pod Resize)
