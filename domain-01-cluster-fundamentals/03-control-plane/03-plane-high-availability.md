...
intent_queries:
- plane-high-availability是什么？
- plane-high-availability的使用方法
- plane-high-availability的最佳实践
trigger_keywords:
- 控制平面高可用部署模式
- Control
- Plane
...
intent_queries:
- 控制平面高可用部署模式 (Control Plane High Availability Deployment Patterns) 是什么
- 如何 控制平面高可用部署模式 (Control Plane High Availability Deployment Patterns)
