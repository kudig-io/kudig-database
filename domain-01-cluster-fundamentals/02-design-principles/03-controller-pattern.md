...
- path: 02-declarative-api-pattern.md
  type: depth
  desc: 声明式 API
- path: ../domain-01-cluster-fundamentals/12-operator-development-guide.md
  type: depth
  desc: Operator 开发指南
cross_refs:
- type: domain
...
- [[domain-01-cluster-fundamentals/02-declarative-api-pattern.md|声明式 API]]
- [[domain-01-cluster-fundamentals/12-operator-development-guide.md|Operator 开发指南]]
