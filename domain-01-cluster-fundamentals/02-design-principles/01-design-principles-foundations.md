...
intent_queries:
- Kubernetes 设计原则与哲学 (Foundations) 是什么
- 如何 Kubernetes 设计原则与哲学 (Foundations)
...
- path: 03-controller-pattern.md
  type: depth
  desc: 控制器模式与调谐循环
- path: ../domain-01-cluster-fundamentals/01-kubernetes-architecture-overview.md
  type: depth
  desc: 架构全景图
cross_refs:
- type: domain
...
<!-- chunk: 控制器模式详解 (Controller Pattern) -->
...
<!-- chunk: 不可变基础设施 (Immutable Infrastructure) -->
...
<!-- chunk: 松耦合架构 (Loosely Coupled Architecture) -->
