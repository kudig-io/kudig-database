...
summary: '**用途**: 全部 Feature Gate 状态速查与配置参考'
...
|:---|:---|:---|
| **PodSecurity** | v1.25 | Pod Securityod Security Admission]] |
