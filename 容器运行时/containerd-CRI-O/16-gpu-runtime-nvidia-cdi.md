...
- 训练任务配合 [[概念/gang-scheduling|Gang Scheduling]] 确保多 GPU Pod 同时调度
- 推理服务配合 [[综合/gpu-scheduling-cost|GPU 调度与成本优化]] 实现 MIG 共享
- GPU 监控集成到 [[可观测性/prometheus|Prometheus]] + Grafana 看板
- 参考 [[AI基础设施/K8s-AI基础设施|K8s AI 基础设施]] 了解完整 AI 平台架构

## Related

- [[综合/gpu-operator-device-plugin-ecosystem|GPU Operator × Device Plugin × CDI 生态]]
- [[综合/gpu-scheduling-cost|GPU 调度与成本优化]]
- [[容器运行时/containerd-CRI-O/12-container-shim-v2|containerd shim v2 架构]]
