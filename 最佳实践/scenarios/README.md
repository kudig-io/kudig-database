...
1. **Q：如何建立场景化知识库？**
   A：识别高频场景→编写标准文档→包含真实案例→定期更新→培训分享。

2. **Q：场景文档的核心要素？**
   A：问题描述、诊断步骤、修复命令、预防措施、相关案例、风险等级。

3. **Q：如何保证场景文档的时效性？**
   A：版本关联、定期审查、故障后更新、自动化检查、社区贡献。
...
- [[技能/培训学习/tools/learn-decision-tree-mermaid.md|故障排查决策树 - Mermaid 可视化版]] — Cross-reference
- [[技能/故障诊断-工作负载/daemonset/skill-22-daemonset-failure.md|DaemonSet 故障诊断与修复 / DaemonSet Failure Diagnosis & Remediation]] — Cross-reference
...
## 场景案例
- [[最佳实践/scenarios/cluster-deployment.md|Cluster Deployment]]
- [[最佳实践/scenarios/upgrade-migration.md|Upgrade Migration]]
