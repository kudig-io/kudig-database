#!/usr/bin/env python3
"""
第四轮修复剩余 broken wikilinks。
主要处理核心概念链接，使用预定义映射 + 模糊匹配。
"""
...
# 预定义概念映射
CONCEPT_MAP = {
    'container runtime': 'concepts/container-runtime.md',
    'dynamic resource allocation': 'concepts/dynamic-resource-allocation.md',
    'sidecar containers': 'concepts/sidecar-containers.md',
    'pod scheduling readiness': 'domain-17-system-foundation/topic-dictionary/scheduling/pod-scheduling-readiness.md',
    'init containers': 'concepts/init-containers.md',
    'kubernetes architecture overview': 'concepts/kubernetes-architecture-overview.md',
    'scheduling framework': 'domain-17-system-foundation/topic-dictionary/scheduling/scheduling-framework.md',
    'cloud native defense in depth': 'concepts/cloud-native-defense-in-depth.md',
    'topology aware routing': 'domain-17-system-foundation/topic-dictionary/networking/topology-aware-routing.md',
    'workload management': 'domain-17-system-foundation/topic-dictionary/workloads/workload-management.md',
    'pod hostname': 'domain-17-system-foundation/topic-dictionary/workloads/pod-hostname.md',
    'infrastructure as code': 'concepts/infrastructure-as-code.md',
    'taints and tolerations': 'domain-17-system-foundation/topic-dictionary/scheduling/taints-and-tolerations.md',
    'pod topology spread constraints': 'domain-17-system-foundation/topic-dictionary/scheduling/pod-topology-spread-constraints.md',
    'workload api': 'concepts/workload-api.md',
    'network policies': 'domain-17-system-foundation/topic-dictionary/networking/network-policies.md',
    'gang scheduling': 'concepts/gang-scheduling.md',
    'kubernetes scheduler': 'domain-17-system-foundation/topic-dictionary/scheduling/kubernetes-scheduler.md',
    'downward api': 'concepts/downward-api.md',
    'pod overhead': 'concepts/pod-overhead.md',
    'cni plugins': 'concepts/cni-plugins.md',
    'csi drivers': 'concepts/csi-drivers.md',
    'monitor kubernetes metrics': 'skills/observability/monitor-kubernetes-metrics.md',
    'configure health probes': 'skills/workloads/configure-health-probes.md',
    'troubleshoot pod issues': 'skills/troubleshooting/troubleshoot-pod-issues.md',
    'troubleshoot node issues': 'skills/troubleshooting/troubleshoot-node-issues.md',
    'service mesh architecture': 'concepts/service-mesh-architecture.md',
    'declarative api': 'concepts/declarative-api.md',
}
...
def find_best_match(target: str, lookup: dict) -> tuple:
    ...
    if target_lower in CONCEPT_MAP:
        return CONCEPT_MAP[target_lower], 'concept-map'
    if target_norm in CONCEPT_MAP:
        return CONCEPT_MAP[target_norm], 'concept-map'
...
def main():
    ...
    report_out = vault / '_reports/broken-links-round4-fix-2026-06-26.md'
    lines = [
        "---",
    ...
    for src, target, matched, confidence in fixed:
    ...
    for src, target, reason in converted:
