...
TERMS = [
    ...
    ("configuration", "limit-range", "限制范围", "LimitRange",
     ...
     "- [[系统基础/topic-dictionary/configuration/resource-quota|ResourceQuota]]\n- [[系统基础/topic-dictionary/scheduling/vpa|VPA]]\n- [[系统基础/topic-dictionary/fundamentals/namespace|Namespace]]"),
    ...
    ("configuration", "taint-toleration", "污点和容忍", "Taints and Tolerations",
     ...
     "- [[系统基础/topic-dictionary/scheduling/node-affinity|Node Affinity]]\n- [[系统基础/topic-dictionary/scheduling/pod-topology-spread|Topology Spread]]\n- [[系统基础/topic-dictionary/fundamentals/cluster|Cluster]]"),
    ...
    ("configuration", "priority-class", "优先级类", "PriorityClass",
     ...
     "- [[系统基础/topic-dictionary/scheduling/pod-disruption-budget|PDB]]\n- [[系统基础/topic-dictionary/scheduling/preemption|Preemption]]\n- [[系统基础/topic-dictionary/configuration/resource-quota|ResourceQuota]]"),
    ...
    ("configuration", "strategic-merge-patch", "策略合并补丁", "Strategic Merge Patch",
     ...
     "- [[系统基础/topic-dictionary/tooling/kubectl|kubectl]]\n- [[系统基础/topic-dictionary/configuration/server-side-apply|Server-Side Apply]]\n- [[系统基础/topic-dictionary/tooling/kustomize|Kustomize]]"),
    ...
    ("configuration", "server-side-apply", "服务端 Apply SSA", "Server-Side Apply",
     ...
     "- [[系统基础/topic-dictionary/configuration/strategic-merge-patch|Strategic Merge Patch]]\n- [[系统基础/topic-dictionary/tooling/kubectl|kubectl]]\n- [[系统基础/topic-dictionary/operations/argo|Argo]]"),
