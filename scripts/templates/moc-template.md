...
- [[scripts/templates/PROJECT-INDEX-TEMPLATE.md|开源项目索引模板]]
- [[scripts/templates/README.md|KUDIG 文档模板体系]]
- [[scripts/templates/best-practice-template.md|最佳实践模板]]
- [[scripts/templates/cheat-sheet-template.md|{{主题名称}} 速查卡]]
- [[scripts/templates/domain-article-template.md|{]]
- [[scripts/templates/febm-template.md|{{主题名称}} FEBM 法医取证分析]]
- [[scripts/templates/fta-template.md|{{组件名称}} 故障树分析 (FTA)]]
- [[templates/presentation-template|Kubernetes [组件/技术名称] 全栈进阶培训 (从入门到专家)]]
- [[scripts/templates/skill-template.md|Skill 运维技能文档模板]]
