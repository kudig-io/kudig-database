...
对于托管集群（EKS、GKE、ACK、AKS 等），控制平面升级通常由云厂商托管，SRE 主要负责工作节点与插件版本同步，具体路径应参考 [[云厂商/99-production-readiness-operations-guide.md|云服务商 生产就绪运维指南]]。若使用 Cluster API、Kubespray 或自研 Operator 管理节点生命周期，可将本手册中的手动命令转化为对应工具的配置与阶段门控。
...
- [[发布变更/99-production-readiness-operations-guide.md|变更与发布管理 生产就绪运维指南]] — 变更窗口、发布门控、回滚审批
- [[可靠性/99-production-readiness-operations-guide.md|可靠性工程 生产就绪运维指南]] — RTO/RPO、DR 演练、PDB 设计
- [[生产运维/99-production-readiness-operations-guide.md|生产运维 生产就绪运维指南]] — 值班、事件响应、变更台账
- [[云厂商/99-production-readiness-operations-guide.md|云服务商 生产就绪运维指南]] — 托管集群（EKS/GKE/ACK）升级路径
- [[安全/99-production-readiness-operations-guide.md|安全合规 生产就绪运维指南]] — 证书生命周期、审计策略
- [[可观测性/99-production-readiness-operations-guide.md|可观测性 生产就绪运维指南]] — 升级期间监控基线与告警配置
