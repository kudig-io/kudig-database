...
description: 整合原 集群基础/2/3 的集群架构基础知识，涵盖架构概述、设计原则、控制平面、API
  版本、kubectl 和性能调优。
summary: 整合原 集群基础/2/3 的集群架构基础知识，涵盖架构概述、设计原则、控制平面、API 版本、kubectl
  和性能调优。
category: domain
tags:
- k8s
...
整合原 集群基础/2/3 的集群架构基础知识，涵盖架构概述、设计原则、控制平面、API 版本、kubectl 和性能调优。
...
- [[工作负载/README.md|工作负载]] — 工作负载部署
- [[网络/README.md|网络]] — 网络流量管理
- [[平台工程/README.md|平台工程]] — 平台运维
