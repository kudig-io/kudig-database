...
- 不允许进行有风险的容量调整
- 不允许破坏性混沌实验
- 自动化执行见 [[12-可靠性/06-SRE实践/07-error-budget-automation.md]]
...
策略需配合自动化才有效（详见 [[12-可靠性/06-SRE实践/07-error-budget-automation.md]]）：
...
- [[12-可靠性/06-SRE实践/07-error-budget-automation.md|05 error budget automation]]
