...
本文覆盖从同城双活到异地多活的完整架构设计，包括数据同步策略、流量调度机制、写冲突解决方案以及 Kubernetes 多集群多活的实现路径。多活架构是 [[12-可靠性/06-SRE实践/12-multi-active-architecture.md|灾难恢复]] 能力的终极保障，也是 [[12-可靠性/06-SRE实践/01-availability-calculation-model.md|高可用性]] 的核心支撑。
...
多活架构需要与以下体系深度集成：
- [[09-可观测性/02-指标/08-multi-cluster-monitoring-governance.md|多集群监控治理]]：统一监控所有活跃集群
...
- [[09-可观测性/02-指标/08-multi-cluster-monitoring-governance.md|多集群监控治理]]
- [[11-发布变更/01-GitOps/01-argo-cd-enterprise-gitops.md|Argo CD 企业级 GitOps]]
- [[12-可靠性/06-SRE实践/11-resilience-patterns-circuit-breaker.md|弹性模式]]
