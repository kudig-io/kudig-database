...
- [ ] 发送事件总结邮件
- [ ] 创建 postmortem 文档（blameless，见 [[12-可靠性/05-事后复盘/01-blameless-postmortem-template.md]]）
- [ ] 排期 48 小时内复盘会
- [ ] 把所有日志/截图归档（保留 90 天）
...
- [[12-可靠性/06-SRE实践/03-incident-command-system.md|03 incident command system]]
