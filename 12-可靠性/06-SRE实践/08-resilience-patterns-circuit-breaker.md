...
与 [[12-可靠性/06-SRE实践/05-error-budget-automation.md|错误预算自动化]] 侧重 SLO 驱动的策略不同，本文聚焦于请求级别的容错机制设计与实现。
...
弹性策略必须通过 [[09-可观测性/01-总览/14-chaos-engineering.md|混沌工程]] 验证：
...
- [[12-可靠性/06-SRE实践/05-error-budget-automation.md|错误预算自动化]]
- [[09-可观测性/01-总览/14-chaos-engineering.md|混沌工程]]
