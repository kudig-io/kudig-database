...
| 9 | 灾备演练记录 | AZ/Region 级、控制面、有状态应用三类场景已演练并有 RTO/RPO 数据 | 见 [[12-可靠性/02-灾难恢复/10-dr-scenarios-catalog.md|灾备场景目录]] |
...
- [[12-可靠性/02-灾难恢复/11-az-failure-playbook.md|AZ 故障 Playbook]]
