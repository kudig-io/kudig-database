...
| 6 | SLO/SLI 已定义 | 关键用户旅程已设定可量化的 SLO，错误预算与 Burn Rate 告警已上线 | 见 [[09-可观测性/06-SLO-SLI/02-slo-implementation-guide.md|SLO 设定与实施指南]] |
...
| 9 | 灾备演练记录 | AZ/Region 级、控制面、有状态应用三类场景已演练并有 RTO/RPO 数据 | 见 [[12-可靠性/02-灾难恢复/01-dr-scenarios-catalog.md|灾备场景目录]] |
...
- [[12-可靠性/02-灾难恢复/02-az-failure-playbook.md|AZ 故障 Playbook]]
