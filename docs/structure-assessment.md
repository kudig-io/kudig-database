...
| `topic-*` | `故障诊断/topic-fta/`、`发布变更/topic-deployment/` | 部分跨域主题应归属到全局 `skills/` 或 `concepts/` |
...
- 实际存在的中文目录（如 `集群基础/`、`故障诊断/topic-fta/`）
...
├── domain-01-cluster-fundamentals/   # 源文档：集群基础
├── domain-02-workloads-applications/ # 源文档：工作负载
├── ...                          # domain-03..20
├── docs/                        # 映射/规范/评估文档
├── _meta/                       # 元数据、语料配置、日志
