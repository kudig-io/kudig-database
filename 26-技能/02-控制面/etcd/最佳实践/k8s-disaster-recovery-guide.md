...
- **生产环境**：Kubernetes 集群 + [[17-系统基础/06-知识字典/storage/persistent-volumes.md|Persistent Volumes]]es（卷）|Volumes]] + etcd
- **备份层**：Velero 备份工具 + 定时备份任务
- **存储层**：S3/OSS 对象存储 + [[17-系统基础/06-知识字典/storage/volume-snapshots.md|Volume Snapshots]] + etcd 备份
