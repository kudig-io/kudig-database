...
**关联文档**:
- [../10-advanced-workloads/10-daemonset-basics.md](../../daemonset/培训/lecturer/01-daemonset-basics.md) — [[daemonset|DaemonSet]]
- [../../故障诊断/topic-skills/17-daemonset-pdb-failure.md](../../故障诊断/技能体系/17-daemonset-pdb-failure.md) — StatefulSet 问题 [[SKILL|Skill]]
- [../../工作负载/](../../工作负载/) — 工作负载文档

## Related

- [[26-技能/05-网络/service/培训/learn-04-service-basics.md|learn-04-service-basics]] — 第四课：Service - 让应用可以被访问
