...
- '[[10-平台工程/03-治理/01-capacity-planning-resource-assessment.md|容量规划与资源评估]]'
fta_ref:
...
> - 配置 [[10-平台工程/03-治理/01-capacity-planning-resource-assessment.md|容量规划]] 流程，评估节点池是否需要升级实例规格。
>
> 如有新异常请随时联系。
