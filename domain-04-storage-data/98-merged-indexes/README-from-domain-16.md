...
|:--------:|:----------:|:----------:|:------:|:------:|:--------:|
| RAID 0   | 2          | 100%       | 高     | 高     | 无       |
| RAID 1   | 2          | 50%        | 高     | 中     | 单盘问题 |
| RAID 5   | 3          | (n-1)/n    | 高     | 中     | 单盘问题 |
| RAID 6   | 4          | (n-2)/n    | 高     | 中     | 双盘问题 |
| RAID 10  | 4          | 50%        | 高     | 高     | 多盘问题 |

---

## 相关领域

- **[Domain-6: Kubernetes存储](../domain-04-storage-data)** - K8s存储实现
- **[Domain-14: Linux基础](../domain-17-system-foundation)** - Linux存储管理
- **[Domain-15: 网络基础](../domain-03-networking-traffic)** - 网络存储协议
