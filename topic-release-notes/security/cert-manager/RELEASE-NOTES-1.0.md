---
title: cert-manager v1.0 Release Notes
description: cert-manager v1.0 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- cert-manager v1.0 Release Notes 是什么
- 如何 cert-manager v1.0 Release Notes
trigger_keywords:
- cert-manager
- v1.0
- Release
...
# cert-manager v1.0 Release Notes

Source: [v1.0.4](https://github.com/cert-manager/cert-manager/releases/tag/v1.0.4)
