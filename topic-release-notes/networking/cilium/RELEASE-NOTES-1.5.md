...
# cilium v1.5 Release Notes

Source: [v1.5.13](https://github.com/cilium/cilium/releases/tag/v1.5.13)

We are pleased to announce this bugfix release for the Cilium v1.5 series. This version includes various bug fixes as well as security fixes for the recently announced Envoy CVEs. For more information, see the [Cilium security advisory](https://github.com/cilium/cilium/security/advisories/GHSA-6hf9-972x-wff3).
