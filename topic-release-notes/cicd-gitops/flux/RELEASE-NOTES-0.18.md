...
# flux v0.18 Release Notes

Source: [v0.18.3](https://github.com/fluxcd/flux2/releases/tag/v0.18.3)

This release  comes with improvements to drift detection of Kubernetes custom resources and fixes for objects validation on older Kubernetes versions.
