...
4. **资源耗尽最适合自动化**：30 分钟 MTTR 且有明确的可观测信号（内存 > 95%、磁盘 > 90%），使其成为 [[skills/FTA-Driven Runbook Automation|FTA 驱动的 Runbook 自动化]] 的最佳候选。
...
- [[synthesis/Production Troubleshooting Playbook|生产排障手册]]
