...
- [[concepts/csi-drivers|CSI 驱动]] — Container Storage Interface 规范、迁移状态、核心能力全景
- [[concepts/cloud-native-storage-systems|云原生存储系统对比]] — Longhorn/Rook-Ceph/OpenEBS/JuiceFS 架构与选型
- [[concepts/storage-performance-optimization|存储性能优化]] — 基准测试、NVMe 调优、存储 QoS
- [[concepts/storage-data-protection|存储数据保护与灾难恢复]] — Velero 最佳实践、不可变备份、DR 策略
- [[concepts/storage-tool-evolution|存储工具演进]] — Rook/Longhorn/Velero 版本演进
...
- [[concepts/csi-drivers|CSI 驱动]] — Kubernetes 官方文档、kubernetes-csi.github.io
- [[concepts/cloud-native-storage-systems|云原生存储系统对比]] — Longhorn/Rook/OpenEBS/JuiceFS 官方文档
- [[concepts/storage-performance-optimization|存储性能优化]] — K8S 官方文档、社区基准测试
- [[concepts/storage-data-protection|存储数据保护与灾难恢复]] — Velero 官方文档、AWS S3 文档
...
- [[concepts/k8s-security-compliance]] — 存储加密（etcd 加密、PV 加密）与零信任安全架构的深度耦合
- [[concepts/k8s-ai-ml-infrastructure]] — AI/ML 工作负载对高性能存储（GPUDirect Storage、NVMe-oF）的需求驱动存储架构变革
- [[concepts/finops-greenops-practices]] — 存储成本优化（分层存储、数据生命周期管理）是 FinOps 实践的关键组成部分
- [[concepts/multi-cluster-dr-automation]] — 跨集群存储复制与灾难恢复策略（Velero、Kasten）保障业务连续性
