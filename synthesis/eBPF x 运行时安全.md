...
relationships:
  - target: "[[domain-17-system-foundation/topic-dictionary/networking/service-mesh]]"
    type: uses
  - target: "[[domain-17-system-foundation/topic-dictionary/security/multi-tenancy]]"
    type: related_to
  - target: "[[entities/networkpolicy]]"
    type: related_to
  - target: "[[domain-17-system-foundation/topic-dictionary/security/runtime-security]]"
    type: related_to
...
---
title: eBPF x [[domain-17-system-foundation/topic-dictionary/security/runtime-security|运行时安全]]
category: synthesis
tags:
- k8s
- ebpf
...
- [[domain-17-system-foundation/topic-dictionary/networking/service|service]]-mesh-architecture.md
...
- **Cilium [[domain-17-system-foundation/topic-dictionary/networking/service-mesh|Service Mesh]]** 用 eBPF L4 mTLS 取代 sidecar 代理模式，消除了每 Pod 代理开销
...
1. **强制** [[entities/networkpolicy|NetworkPolicy]]（L3/L4 丢包）
