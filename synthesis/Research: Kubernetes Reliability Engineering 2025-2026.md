...
- [[concepts/slo-error-budget-framework|SLO/Error Budget 框架]] — 三层模型、五级策略、Burn-Rate 告警
- [[concepts/chaos-engineering-platforms|混沌工程平台对比]] — Chaos Mesh/Litmus/Gremlin 对比与 CI/CD 集成
- [[concepts/incident-management-patterns|事件管理与复盘模式]] — ICS、无责复盘、On-Call 实践
- [[concepts/capacity-planning-cost-optimization|容量规划与成本优化]] — AI 预测、FinOps、Right-sizing
- [[concepts/multi-cluster-dr-automation|多集群灾备与自动化]] — 跨区域 DR、故障切换、备份验证
...
- [[concepts/slo-error-budget-framework|SLO/Error Budget 框架]] — Google SRE Workbook, BackendBytes
- [[concepts/chaos-engineering-platforms|混沌工程平台对比]] — Chaos Mesh/Litmus/Gremlin 官方文档
- [[concepts/incident-management-patterns|事件管理与复盘模式]] — SRE 社区实践
- [[concepts/capacity-planning-cost-optimization|容量规划与成本优化]] — Kubecost/OpenCost/Cast AI 官方文档
- [[concepts/multi-cluster-dr-automation|多集群灾备与自动化]] — ArgoCD/Submariner/CAPI 社区
...
- [[concepts/k8s-observability-stack]] — 可观测性（Prometheus、OpenTelemetry）是可靠性工程的基础，支撑 SLO 监控与故障诊断
- [[concepts/gitops-production-operations]] — GitOps 声明式运维保障集群状态一致性，减少配置漂移导致的可靠性风险
- [[concepts/k8s-security-compliance]] — 安全合规（准入控制、网络策略）直接影响系统可靠性与故障隔离能力
- [[concepts/storage-data-protection]] — 存储持久化与数据保护策略（备份、快照）是可靠性工程的核心保障层
