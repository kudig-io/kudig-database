...
| **无匹配PV** | `no [[系统基础/知识字典/storage/persistent-volumes.md|persistent volumes]]es（卷）|volumes]] available` | `kubectl get pv` | 创建匹配的PV |
...
- [[故障诊断/资源排障/12-rbac-quota-troubleshooting.md|12-rbac-quota-troubleshooting]]
- [[故障诊断/资源排障/13-certificate-troubleshooting.md|13-certificate-troubleshooting]]
- [[故障诊断/资源排障/15-ingress-troubleshooting.md|15-ingress-troubleshooting]]
