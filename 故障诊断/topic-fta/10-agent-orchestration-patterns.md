---
title: 第十章：Agent 编排模式与 FTA 逻辑门映射 (故障诊断)
...
> **上一章**: 第九章：FTA 作为 AI Agent 的知识骨架](./[[故障诊断/topic-fta/09-fta-as-agent-knowledge-skeleton.md|09-fta-as-agent-knowledge-skeleton]].md)  
> **下一章**: [第十一章：FTA 驱动的 Runbook 自动化](./[[故障诊断/topic-fta/11-fta-driven-runbook-automation.md|11-fta-driven-runbook-automation]].md)
...
- [[故障诊断/topic-fta/11-fta-driven-runbook-automation.md|第十一章：FTA 驱动的 Runbook 自动化]]
