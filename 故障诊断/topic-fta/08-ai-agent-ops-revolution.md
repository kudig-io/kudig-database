---
title: 第八章：AI Agent 时代的运维范式革命 [故障诊断]
...
> **下一章**: 第九章：FTA 作为 AI Agent 的知识骨架](./[[故障诊断/topic-fta/09-fta-as-agent-knowledge-skeleton.md|09-fta-as-agent-knowledge-skeleton]].md)
