...
需要深入了解根因机制时，参考以下资源：
- ResourceQuota 控制器工作原理 → `集群基础/resource-quota-controller.md`
- LimitRange 准入控制器机制 → `集群基础/limit-range-admission.md`
- Namespace 生命周期和 Finalizer → `集群基础/namespace-lifecycle.md`
- 多租户资源隔离最佳实践 → `生产运维/topic-best-practices/multi-tenant-resource-isolation.md`
...
- [[故障诊断/01-resource-troubleshooting/24-quota-limitrange-troubleshooting.md|Quota/LimitRange 深度排查]]
- [[故障诊断/topic-fta/list/resource-quota-fta.md|Quota/LimitRange 故障树分析]]
