...
需要深入了解根因机制时，参考以下资源：
- kubeadm 升级原理 → `集群基础/kubeadm-upgrade-mechanism.md`
- etcd 升级和数据迁移 → `集群基础/etcd-upgrade.md`
- Kubernetes 版本偏移策略 → `集群基础/version-skew-policy.md`
- 废弃 API 迁移指南 → `集群基础/deprecated-api-migration.md`
- CNI 插件兼容性矩阵 → `网络/cni-compatibility.md`
...
- [[故障诊断/topic-skills/11-control-plane-failure.md|SKILL-CP-001 etcd 与控制平面故障诊断]]
- [[故障诊断/topic-skills/24-namespace-quota-limitrange.md|SKILL-CONFIG-002 Namespace/Quota/LimitRange 问题]]
- [[故障诊断/topic-skills/19-node-resource-pressure.md|SKILL-NODE-002 节点资源压力诊断]]
- [[故障诊断/topic-skills/20-networkpolicy-connectivity.md|SKILL-NET-004 NetworkPolicy 连通性问题]]
- [[故障诊断/topic-skills/21-statefulset-failure.md|SKILL-WORK-002 StatefulSet 故障诊断]]
- [[故障诊断/topic-skills/22-daemonset-failure.md|SKILL-WORK-003 DaemonSet 故障诊断]]
- [[故障诊断/topic-skills/23-job-cronjob-failure.md|SKILL-WORK-004 Job/CronJob 故障诊断]]
- [[故障诊断/02-infrastructure-troubleshooting/34-upgrade-migration-troubleshooting.md|升级迁移深度排查]]
- [[故障诊断/topic-fta/list/cluster-upgrade-fta.md|升级迁移故障树分析]]

## Related

- [[系统基础/topic-cheat-sheet/k8s.md|k8s]]
- [[故障诊断/topic-skills/19-node-resource-pressure.md|19-node-resource-pressure]]
- [[故障诊断/topic-skills/20-networkpolicy-connectivity.md|20-networkpolicy-connectivity]]
- [[故障诊断/topic-skills/24-namespace-quota-limitrange.md|24-namespace-quota-limitrange]]
- [[故障诊断/topic-skills/22-daemonset-failure.md|22-daemonset-failure]]
