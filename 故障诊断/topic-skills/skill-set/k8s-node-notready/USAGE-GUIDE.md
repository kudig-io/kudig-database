...
> **范围**：`故障诊断/topic-skills/skill-set/k8s-node-notready/` ↔ `故障诊断/topic-fta/list/node-fta.md`  
...
├────────────────────────────────────────────────────────────────────┤
│  第 3 层: 故障诊断/topic-fta/list/            (为什么 — 问题分析模型)         │
│  FTA 问题树: 概率模型、因果链、底事件                                 │
├────────────────────────────────────────────────────────────────────┤
│  第 2 层: 故障诊断/topic-structural-trouble-shooting/  (如何做 — 深度参考)   │
├────────────────────────────────────────────────────────────────────┤
...
```
故障诊断/topic-fta/list/node-fta.md            # FTA 问题树主文档
...
```yaml
fta_mapping:
  file: "故障诊断/topic-fta/list/node-fta.md"   # 必填：相对于仓库根目录的路径
