...
| Admission Webhooks | `专项技术/03-admission-webhook-configuration.md` | Webhook 如何影响 Pod 创建 |
| 容器探针配置 | `工作负载/` | readinessProbe/livenessProbe 最佳实践 |
| 镜像拉取策略 | `工作负载/` | imagePullPolicy 配置和镜像仓库认证 |
