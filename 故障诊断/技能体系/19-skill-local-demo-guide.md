...
summary: 'topic-skills 定义了面向 AI Agent 的 [[Kubernetes|Kubernetes]] 故障诊断技能库（详见 README.md](./[[平台工程/代码分析/deployment-create/README.md|README]].md)）。'
category: demo
tags:
- k8s
- skills
...
topic-skills 定义了面向 AI Agent 的 [[Kubernetes|Kubernetes]] 故障诊断技能库（详见 README.md](./[[平台工程/代码分析/deployment-create/README.md|README]].md)）。本 Demo 允许你在本地 Kind 集群中**实际运行**这些 Skill 的完整执行闭环：
