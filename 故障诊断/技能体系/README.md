...
├─────────────────────────────────────────────────────────────────┤
│  Layer 3: 故障诊断/topic-fta/list/       (为什么 — 故障分析模型层)         │
...
| 资源 | 路径 | 用途 |
|------|------|------|
| FTA 故障树库 | [故障诊断/topic-fta/list/](../故障诊断/topic-fta/list/) | 每个 Skill 对应的故障分析模型 |
| FEBM 循证方法论 | [故障诊断/topic-febm/](../故障诊断/topic-febm/) | Agent 工单处理的理论基础 |
| 结构化故障排查 | [故障诊断/topic-structural-trouble-shooting/](../故障诊断/topic-structural-trouble-shooting/) | 深度排查参考指南 |
| Agent 设计 | [AI基础设施/02-ai-agents/](../AI基础设施/02-ai-agents/) | AI Agent 工程与架构设计 |
| 事件管理 Runbook | [系统基础/topic-dictionary/12-incident-management-runbooks.md](../系统基础/topic-dictionary/12-incident-management-runbooks.md) | 事件管理流程模板 |
| 生产排障 Playbook | [系统基础/topic-dictionary/16-production-troubleshooting-playbook.md](../系统基础/topic-dictionary/16-production-troubleshooting-playbook.md) | 生产环境排障手册 |
