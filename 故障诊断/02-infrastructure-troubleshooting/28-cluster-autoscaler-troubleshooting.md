...
- type: domain
  ...
  label: '相关知识域: 可观测性'
- type: fta
  path: ../故障诊断/topic-fta/list/cluster-autoscaler-fta.md
...
- [[故障诊断/02-infrastructure-troubleshooting/27-image-registry-troubleshooting.md|27-image-registry-troubleshooting]]
