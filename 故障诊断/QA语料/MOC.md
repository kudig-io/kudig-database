...
| 4 | [[概念/ai-agent-README.md|ai agent README]] | 说明文档 | - | 语料结构、使用方式、生成流水线 |
...
- [[故障诊断/技能体系/README.md|Skills 故障诊断手册]]
- [[故障诊断/FTA故障树/fta-index.md|FTA 故障树索引]]
...
- [[release-sre/qa/raw/generated/command-output-diagnosis-p0.md|Release SRE P0 生成语料]]
- [[release-sre/qa/raw/generated/command-output-diagnosis-p1.md|Release SRE P1 生成语料]]
- [[release-sre/qa/raw/generated/command-output-diagnosis-p2.md|Release SRE P2 生成语料]]
- [[release-sre/qa/raw/command-output-diagnosis.with_actions.md|Release SRE 命令输出诊断（含 Actions）]]
- [[release-sre/qa/raw/seed/p0-core-scenarios.with_actions.md|Release SRE P0 核心场景种子数据（含 Actions）]]
- [[release-sre/qa/raw/generated/command-output-diagnosis-p0.with_actions.md|Release SRE P0 生成语料（含 Actions）]]
...
- 发布前评估报告
- [[故障诊断/QA语料/README.md|Agent QA 对语料库 README]]
