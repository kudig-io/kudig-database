...
- [[17-系统基础/06-知识字典/workloads/pod.md|Pod（最小调度单元）]]
- [[17-系统基础/06-知识字典/workloads/pods.md|Pods（Pod 管理）]]
- [[17-系统基础/06-知识字典/workloads/pod-lifecycle.md|Pod 生命周期]]
- [[17-系统基础/06-知识字典/workloads/container-environment.md|容器环境]]
- [[17-系统基础/06-知识字典/workloads/container-lifecycle-hooks.md|容器生命周期钩子]]
- [[17-系统基础/06-知识字典/workloads/init-containers.md|Init Containers]]
- [[17-系统基础/06-知识字典/workloads/sidecar-containers.md|Sidecar Containers]]
- [[17-系统基础/06-知识字典/workloads/ephemeral-containers.md|临时容器]]
- [[17-系统基础/06-知识字典/workloads/images.md|镜像管理]]
- [[17-系统基础/06-知识字典/workloads/runtime-class.md|RuntimeClass]]
- [[17-系统基础/06-知识字典/workloads/user-namespaces.md|User Namespaces]]
- [[17-系统基础/06-知识字典/workloads/pod-hostname.md|Pod 主机名]]
- [[17-系统基础/06-知识字典/workloads/pod-quality-of-service-classes.md|Pod QoS 等级]]
- [[17-系统基础/06-知识字典/workloads/advanced-pod-configuration.md|高级 Pod 配置]]
- [[17-系统基础/06-知识字典/workloads/container-runtime-interface-cri.md|CRI（容器运行时接口）]]

### 工作负载控制器类

- [[17-系统基础/06-知识字典/workloads/deployment.md|Deployment]]
- [[17-系统基础/06-知识字典/workloads/deployments.md|Deployments（综合）]]
...
- [[17-系统基础/06-知识字典/workloads/statefulsets.md|StatefulSets（综合）]]
- [[17-系统基础/06-知识字典/workloads/daemonset.md|DaemonSet]]
- [[17-系统基础/06-知识字典/workloads/job.md|Job]]
- [[17-系统基础/06-知识字典/workloads/jobs.md|Jobs（综合）]]
- [[17-系统基础/06-知识字典/workloads/cronjob.md|CronJob]]
- [[17-系统基础/06-知识字典/workloads/automatic-cleanup-for-finished-jobs.md|Job 自动清理]]

### 高级工作负载类

- [[17-系统基础/06-知识字典/workloads/openkruise.md|OpenKruise（增强控制器）]]
- [[17-系统基础/06-知识字典/workloads/openfunction.md|OpenFunction（Serverless）]]
- [[17-系统基础/06-知识字典/workloads/slimfaas.md|SlimFaas（轻量 FaaS）]]
- [[17-系统基础/06-知识字典/workloads/serverless-workflow.md|Serverless Workflow]]
- [[17-系统基础/06-知识字典/workloads/pod-group-policies.md|Pod Group 策略]]
- [[17-系统基础/06-知识字典/workloads/spot-and-preemptible-workloads.md|竞价实例工作负载]]

### 自动扩缩容类

- [[17-系统基础/06-知识字典/workloads/horizontal-pod-autoscaling.md|HPA]]
- [[17-系统基础/06-知识字典/workloads/vertical-pod-autoscaling.md|VPA]]
- [[17-系统基础/06-知识字典/workloads/autoscaling-workloads.md|自动扩缩综合]]

### 工作负载管理类

- [[17-系统基础/06-知识字典/workloads/managing-workloads.md|工作负载管理]]
- [[17-系统基础/06-知识字典/workloads/workload-management.md|工作负载治理]]
- [[17-系统基础/06-知识字典/workloads/workload-api.md|Workload API]]
- [[17-系统基础/06-知识字典/workloads/workload-reference.md|工作负载参考]]
- [[17-系统基础/06-知识字典/workloads/disruptions.md|中断管理]]
- [[17-系统基础/06-知识字典/workloads/downward-api.md|Downward API]]
...
- [[17-系统基础/06-知识字典/scheduling/hpa.md|HPA 自动扩缩]]
- [[17-系统基础/06-知识字典/configuration/probe.md|探针配置]]
- [[17-系统基础/06-知识字典/storage/persistent-volume-claim.md|PVC 存储申请]]
- [[17-系统基础/06-知识字典/networking/service.md|Service 服务发现]]
