...
- [[17-系统基础/06-知识字典/configuration/configmap.md|ConfigMap（配置数据）]]
- [[17-系统基础/06-知识字典/configuration/configmaps.md|ConfigMaps（配置管理实践）]]
- [[17-系统基础/06-知识字典/configuration/secrets.md|Secrets（敏感信息）]]
- [[17-系统基础/06-知识字典/configuration/downward-api.md|Downward API（元数据暴露）]]
- [[17-系统基础/06-知识字典/configuration/env.md|Env（环境变量）]]
- [[17-系统基础/06-知识字典/configuration/helm-values.md|Helm Values（参数化配置）]]
- [[17-系统基础/06-知识字典/configuration/kustomization.md|Kustomization（声明式定制）]]
- [[17-系统基础/06-知识字典/configuration/kcl.md|KCL（配置语言）]]

### 健康检查类

- [[17-系统基础/06-知识字典/configuration/probe.md|Probe（探针总论）]]
- [[17-系统基础/06-知识字典/configuration/liveness-probe.md|Liveness Probe（存活探针）]]
- [[17-系统基础/06-知识字典/configuration/readiness-probe.md|Readiness Probe（就绪探针）]]
- [[17-系统基础/06-知识字典/configuration/startup-probe.md|Startup Probe（启动探针）]]
- [[17-系统基础/06-知识字典/configuration/liveness-readiness-and-startup-probes.md|三种探针综合实践]]
- [[17-系统基础/06-知识字典/configuration/graceful-shutdown.md|Graceful Shutdown（优雅停机）]]

### 资源管理类

- [[17-系统基础/06-知识字典/configuration/resource-management-for-pods-and-containers.md|Pod/Container 资源管理]]
- [[17-系统基础/06-知识字典/configuration/resource-management-for-windows-nodes.md|Windows 节点资源管理]]
- [[17-系统基础/06-知识字典/configuration/limit-range.md|LimitRange（默认限制）]]
- [[17-系统基础/06-知识字典/configuration/resource-quota.md|ResourceQuota（资源配额）]]
- [[17-系统基础/06-知识字典/configuration/priority-class.md|PriorityClass（优先级）]]
- [[17-系统基础/06-知识字典/configuration/taint-toleration.md|Taint/Toleration（污点容忍）]]

### 变更管理类

- [[17-系统基础/06-知识字典/configuration/server-side-apply.md|Server-Side Apply]]
- [[17-系统基础/06-知识字典/configuration/strategic-merge-patch.md|Strategic Merge Patch]]
- [[17-系统基础/06-知识字典/configuration/validating-webhook.md|Validating Webhook]]
- [[17-系统基础/06-知识字典/configuration/organizing-cluster-access-using-kubeconfig-files.md|Kubeconfig 管理]]
- [[17-系统基础/06-知识字典/configuration/schemahero.md|SchemaHero（数据库 Schema 管理）]]
...
- [[17-系统基础/06-知识字典/scheduling/affinity.md|调度亲和性]]
- [[17-系统基础/06-知识字典/security/rbac.md|RBAC 权限控制]]
- [[17-系统基础/06-知识字典/operations/helm.md|Helm 包管理]]
