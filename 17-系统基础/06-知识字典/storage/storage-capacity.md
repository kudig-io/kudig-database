...
- CSI 临时卷（CSI [[17-系统基础/06-知识字典/storage/ephemeral-volumes.md|ephemeral volumes]]es（卷）|volumes]]）的调度**不**考虑存储容量。
...
- [节点特定卷限制](./[[17-系统基础/06-知识字典/storage/node-specific-volume-limits.md|node-specific-volume-limits]].md) — 节点级卷数量限制
