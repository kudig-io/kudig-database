...
**自动生成名称**：当在创建请求中提供 `generateName` 而非 `name` 时，服务器会将提供的值作为前缀，并附加生成的后缀。自 [[23-实体/kubernetes.md|[[Kubernetes|kubernetes]]]] v1.31 起，服务器会最多尝试 8 次生成唯一名称，然后才返回 HTTP 409 冲突响应。
