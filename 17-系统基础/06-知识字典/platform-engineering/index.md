...
- [[17-系统基础/06-知识字典/platform-engineering/custom-resources.md|Custom Resources（综合）]]
- [[17-系统基础/06-知识字典/platform-engineering/extending-the-kubernetes-api.md|扩展 K8s API]]
...
- [[17-系统基础/06-知识字典/platform-engineering/api-priority-and-fairness.md|API 优先级与公平性]]
- [[17-系统基础/06-知识字典/platform-engineering/kubernetes-api-aggregation-layer.md|API 聚合层]]
- [[17-系统基础/06-知识字典/platform-engineering/admission-webhook-good-practices.md|Admission Webhook 最佳实践]]
- [[17-系统基础/06-知识字典/platform-engineering/server-side-apply.md|Server-Side Apply]]
- [[17-系统基础/06-知识字典/platform-engineering/compatibility-version-for-control-plane.md|控制平面版本兼容]]
- [[17-系统基础/06-知识字典/platform-engineering/coordinated-leader-election.md|协调领导者选举]]

### IDP 与开发者体验类

- [[17-系统基础/06-知识字典/platform-engineering/backstage.md|Backstage（开发者门户）]]
- [[17-系统基础/06-知识字典/platform-engineering/developer-portal-and-platform-metrics.md|开发者门户与平台指标]]
- [[17-系统基础/06-知识字典/platform-engineering/kubevela.md|KubeVela（应用交付）]]
- [[17-系统基础/06-知识字典/platform-engineering/kusionstack.md|KusionStack（配置管理）]]
- [[17-系统基础/06-知识字典/platform-engineering/score.md|Score（工作负载规范）]]
- [[17-系统基础/06-知识字典/platform-engineering/openchoreo.md|OpenChoreo]]
- [[17-系统基础/06-知识字典/platform-engineering/openfeature.md|OpenFeature（特性开关）]]

### GitOps 与 IaC 类

- [[17-系统基础/06-知识字典/platform-engineering/gitops-and-continuous-delivery.md|GitOps 与持续交付]]
- [[17-系统基础/06-知识字典/platform-engineering/opengitops.md|OpenGitOps]]
- [[17-系统基础/06-知识字典/platform-engineering/infrastructure-as-code-for-kubernetes.md|K8s IaC]]
- [[17-系统基础/06-知识字典/platform-engineering/crossplane.md|Crossplane]]
- [[17-系统基础/06-知识字典/platform-engineering/cloudevents.md|CloudEvents]]

### 多集群管理类

- [[17-系统基础/06-知识字典/platform-engineering/karmada.md|Karmada]]
- [[17-系统基础/06-知识字典/platform-engineering/open-cluster-management.md|OCM]]
- [[17-系统基础/06-知识字典/platform-engineering/cluster-api-and-fleet-management.md|Cluster API 与集群编队]]
- [[17-系统基础/06-知识字典/platform-engineering/kubestellar.md|KubeStellar]]
- [[17-系统基础/06-知识字典/platform-engineering/kcp.md|KCP]]
- [[17-系统基础/06-知识字典/platform-engineering/rancher.md|Rancher]]
- [[17-系统基础/06-知识字典/platform-engineering/cozystack.md|Cozystack]]

### 应用运行时类

- [[17-系统基础/06-知识字典/platform-engineering/dapr.md|Dapr（分布式应用运行时）]]
- [[17-系统基础/06-知识字典/platform-engineering/armada.md|Armada（批处理调度）]]
- [[17-系统基础/06-知识字典/platform-engineering/cadence.md|Cadence（工作流）]]
- [[17-系统基础/06-知识字典/platform-engineering/nats.md|NATS（消息系统）]]
- [[17-系统基础/06-知识字典/platform-engineering/grpc.md|gRPC]]

### 边缘与虚拟化类

- [[17-系统基础/06-知识字典/platform-engineering/kubeedge.md|KubeEdge]]
- [[17-系统基础/06-知识字典/platform-engineering/kubevirt-virtual-machines.md|KubeVirt VM]]
- [[17-系统基础/06-知识字典/platform-engineering/webassembly-wasm-workloads.md|Wasm 工作负载]]

### 设备与资源扩展类

- [[17-系统基础/06-知识字典/platform-engineering/device-plugins.md|Device Plugins]]
- [[17-系统基础/06-知识字典/platform-engineering/dynamic-resource-allocation-good-practices.md|DRA 最佳实践]]
- [[17-系统基础/06-知识字典/platform-engineering/network-plugins.md|Network Plugins]]
- [[17-系统基础/06-知识字典/platform-engineering/compute-storage-and-networking-extensions.md|计算存储网络扩展]]
- [[17-系统基础/06-知识字典/platform-engineering/proxies-in-kubernetes.md|K8s 代理]]
- [[17-系统基础/06-知识字典/platform-engineering/manifest.md|Manifest]]
- [[17-系统基础/06-知识字典/platform-engineering/kind.md|Kind（本地集群）]]
...
- [[17-系统基础/06-知识字典/multi-cloud/federation.md|集群联邦]]
- [[17-系统基础/06-知识字典/operations/argo.md|ArgoCD]]
- [[17-系统基础/06-知识字典/configuration/server-side-apply.md|Server-Side Apply]]
- [[17-系统基础/06-知识字典/specialized-workloads/kubevirt.md|KubeVirt]]
