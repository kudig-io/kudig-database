...
- 常用于本地安全访问 [[17-系统基础/06-知识字典/fundamentals/the-kubernetes-api.md|Kubernetes API]]。
...
| Service 无法访问（kube-proxy） | kube-proxy 未运行或 iptables 规则异常 | `kubectl -n kube-system get [[Pods|pods]] -l [[23-实体/kubernetes.md|[[Kubernetes 生产环境速查卡|k8s]]]]-app=kube-proxy`；`iptables-save | grep <svc-name>` |
...
- [[17-系统基础/06-知识字典/platform-engineering/api-group.md|API 组]]
