...
- [[17-系统基础/06-知识字典/scheduling/kubernetes-scheduler.md|Kubernetes Scheduler（调度器）]]
- [[17-系统基础/06-知识字典/scheduling/scheduler.md|Scheduler（调度原理）]]
- [[17-系统基础/06-知识字典/scheduling/scheduling-framework.md|Scheduling Framework（调度框架）]]
- [[17-系统基础/06-知识字典/scheduling/scheduler-performance-tuning.md|调度器性能调优]]

### 调度约束类

- [[17-系统基础/06-知识字典/scheduling/affinity.md|Affinity（亲和性）]]
- [[17-系统基础/06-知识字典/scheduling/anti-affinity.md|Anti-Affinity（反亲和）]]
- [[17-系统基础/06-知识字典/scheduling/node-selector.md|Node Selector（节点选择）]]
- [[17-系统基础/06-知识字典/scheduling/taint.md|Taint（污点）]]
- [[17-系统基础/06-知识字典/scheduling/toleration.md|Toleration（容忍）]]
- [[17-系统基础/06-知识字典/scheduling/taints-and-tolerations.md|Taints & Tolerations（综合）]]
- [[17-系统基础/06-知识字典/scheduling/topology-spread-constraints.md|Topology Spread Constraints]]
- [[17-系统基础/06-知识字典/scheduling/pod-topology-spread-constraints.md|Pod 拓扑分布约束]]
- [[17-系统基础/06-知识字典/scheduling/topology.md|Topology（拓扑）]]
- [[17-系统基础/06-知识字典/scheduling/assigning-pods-to-nodes.md|Pod 节点分配]]
- [[17-系统基础/06-知识字典/scheduling/pod-priority-and-preemption.md|优先级与抢占]]
- [[17-系统基础/06-知识字典/scheduling/pod-scheduling-readiness.md|Pod 调度就绪]]
- [[17-系统基础/06-知识字典/scheduling/node-declared-features.md|节点声明特性]]

### 资源管理类

- [[17-系统基础/06-知识字典/scheduling/resource-request.md|Resource Request]]
- [[17-系统基础/06-知识字典/scheduling/resource-limit.md|Resource Limit]]
- [[17-系统基础/06-知识字典/scheduling/resource-quota.md|Resource Quota]]
- [[17-系统基础/06-知识字典/scheduling/limitrange.md|LimitRange]]
- [[17-系统基础/06-知识字典/scheduling/qos.md|QoS（服务质量）]]
...
- [[17-系统基础/06-知识字典/scheduling/dynamic-resource-allocation.md|DRA（动态资源分配）]]

### 自动扩缩容类

- [[17-系统基础/06-知识字典/scheduling/hpa.md|HPA（水平扩缩）]]
- [[17-系统基础/06-知识字典/scheduling/vpa.md|VPA（垂直扩缩）]]
...
- [[17-系统基础/06-知识字典/scheduling/keda.md|KEDA（事件驱动扩缩）]]

### 批量与高级调度类

- [[17-系统基础/06-知识字典/scheduling/volcano.md|Volcano（批量调度）]]
- [[17-系统基础/06-知识字典/scheduling/gang-scheduling.md|Gang Scheduling]]
- [[17-系统基础/06-知识字典/scheduling/koordinator.md|Koordinator（混部调度）]]
- [[17-系统基础/06-知识字典/scheduling/hami.md|HAMi（GPU 共享）]]
- [[17-系统基础/06-知识字典/scheduling/kaito.md|KAITO（AI 部署）]]
- [[17-系统基础/06-知识字典/scheduling/kubefleet.md|KubeFleet（多集群调度）]]

### 驱逐类

- [[17-系统基础/06-知识字典/scheduling/node-pressure-eviction.md|节点压力驱逐]]
- [[17-系统基础/06-知识字典/scheduling/api-initiated-eviction.md|API 发起驱逐]]
...
- [[17-系统基础/06-知识字典/specialized-workloads/gpu-resource-management-and-partitioning.md|GPU 资源管理]]
- [[17-系统基础/06-知识字典/workloads/deployment.md|Deployment 工作负载]]
- [[17-系统基础/06-知识字典/operations/capacity-planning.md|容量规划]]
