...
intent_queries:
- Resource Bin Packing 是什么
- 如何 Resource Bin Packing
trigger_keywords:
- Resource
- Bin
- Packing
...
- [[23-实体/02-K8s核心组件/kubernetes.md|Kubernetes]] 调度器](./kubernetes-scheduler.md) — 评分阶段如何使用 NodeResourcesFit
...
- [[17-系统基础/06-知识字典/scheduling/affinity.md|亲和性]]
- [[17-系统基础/06-知识字典/scheduling/anti-affinity.md|反亲和性]]
