...
Linux 内核提供了多种安全特性来改善隔离并加固容器化工作负载。[[23-实体/kubernetes.md|[[kubernetes|kubernetes]]]] 允许通过 Pod 的 `securityContext` 配置这些特性，还支持其他安全设置，如特定的 Linux capabilities 或使用 UID/GID 的文件访问权限。
