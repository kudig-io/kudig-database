...
- [[17-系统基础/06-知识字典/multi-cloud/federation.md|Federation（集群联邦）]]
- [[17-系统基础/06-知识字典/multi-cloud/cluster-api.md|Cluster API（声明式集群管理）]]
- [[17-系统基础/06-知识字典/multi-cloud/multi-cluster-service.md|Multi-Cluster Service（多集群服务发现）]]
- [[17-系统基础/06-知识字典/multi-cloud/multi-cloud-operations.md|Multi-Cloud Operations（多云运维）]]

### 基础设施编排类

- [[17-系统基础/06-知识字典/multi-cloud/crossplane-composition.md|Crossplane Composition（云资源组合）]]
- [[17-系统基础/06-知识字典/multi-cloud/cloud-credential-operator.md|Cloud Credential Operator（凭据管理）]]

### 边缘计算类

- [[17-系统基础/06-知识字典/multi-cloud/edge-computing-and-k3s.md|Edge Computing & K3s（边缘计算）]]
- [[17-系统基础/06-知识字典/multi-cloud/spaceborne-computing.md|Spaceborne Computing（天基计算）]]
