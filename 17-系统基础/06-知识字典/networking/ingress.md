...
- [[17-系统基础/06-知识字典/networking/ingress-controllers.md|Ingress Controllers]]](ingress-controllers.md) — 控制器选型和 IngressClass 配置
...
- [[22-概念/11-交叉分析/apiserver-×-Ingress|apiserver × Ingress]]
