...
| 文档 | 内容 | 行数 |
|------|------|------|
| [[17-系统基础/02-硬件/01-cloud-hardware-architecture.md|云硬件架构]] | 数据中心、机架、供电、制冷 | 682 |
| [[17-系统基础/02-硬件/02-server-architecture-principles.md|服务器架构原理]] | 主板、总线、NUMA、PCIe | 748 |
| [[17-系统基础/02-硬件/03-cpu-technology-deep-dive.md|CPU 技术深度]] | 多核、缓存、指令集、GPU | 812 |
| [[17-系统基础/02-硬件/04-motherboard-chipset-technology.md|主板芯片组技术]] | 芯片组、BMC、BIOS/UEFI | 754 |
| [[17-系统基础/02-硬件/05-memory-technology-deep-dive.md|内存技术深度]] | DDR5、ECC、NUMA、大页 | 709 |

### 存储与网络

| 文档 | 内容 | 行数 |
|------|------|------|
| [[17-系统基础/02-硬件/06-storage-hdd-technology.md|HDD 技术]] | 机械硬盘、RAID、SAS | 698 |
| [[17-系统基础/02-硬件/07-storage-ssd-technology.md|SSD 技术]] | NVMe、TLC/QLC、磨损均衡 | 741 |
| [[17-系统基础/02-硬件/08-network-hardware-technology.md|网络硬件技术]] | 网卡、交换机、DPU、RDMA | 394 |

### 生态与厂商

| 文档 | 内容 | 行数 |
|------|------|------|
| [[17-系统基础/02-硬件/09-hardware-vendors-ecosystem.md|硬件厂商生态]] | Dell/HPE/浪潮/华为/超微 | 311 |

### 故障排查

| 文档 | 内容 | 行数 |
|------|------|------|
| [[17-系统基础/02-硬件/10-hardware-troubleshooting-methodology.md|故障排查方法论]] | 系统化排查流程、工具 | 749 |
| [[17-系统基础/02-硬件/11-cpu-memory-troubleshooting.md|CPU/内存故障]] | MCE、ECC 错误、降频 | 626 |
| [[17-系统基础/02-硬件/12-storage-troubleshooting.md|存储故障]] | 磁盘坏道、RAID 降级、IO 延迟 | 632 |
| [[17-系统基础/02-硬件/13-network-hardware-troubleshooting.md|网络硬件故障]] | 网卡、光模块、交换机 | 382 |
| [[17-系统基础/02-硬件/14-power-thermal-troubleshooting.md|电源/散热故障]] | PSU、风扇、温度告警 | 438 |
| [[17-系统基础/02-硬件/15-bios-firmware-troubleshooting.md|BIOS/固件故障]] | 固件升级、POST 失败 | 360 |

### K8s 与案例

| 文档 | 内容 | 行数 |
|------|------|------|
| [[17-系统基础/02-硬件/16-kubernetes-hardware-troubleshooting.md|K8s 硬件故障]] | 节点异常、硬件导致的 Pod 问题 | 909 |
| [[17-系统基础/02-硬件/17-hardware-error-codes-reference.md|错误代码参考]] | 各厂商错误代码详解 | 1275 |
| [[17-系统基础/02-硬件/18-hardware-failure-case-studies.md|故障案例研究]] | 生产真实故障案例 | 859 |
...
- [[17-系统基础/04-K8s事件/06-node-lifecycle-condition-events.md|节点生命周期事件]]
