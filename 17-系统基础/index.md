...
| 子目录 | 内容 | 文件数 | 难度 |
|--------|------|--------|------|
| [[17-系统基础/01-Linux/index.md\|Linux/]] | Linux 系统知识体系 | 17 | 中级-高级 |
| [[17-系统基础/02-硬件/index.md\|硬件/]] | 硬件知识体系 | 19 | 中级 |
| [[17-系统基础/03-网络基础/index.md\|网络基础/]] | TCP/IP、DNS、iptables、HTTP | 7 | 中级-高级 |
| [[17-系统基础/04-K8s事件/index.md\|K8s事件/]] | Kubernetes 事件系统 | 16 | 中级 |
| [[17-系统基础/05-速查卡/index.md\|速查卡/]] | 命令速查卡集合 | 17 | 初级-中级 |
| [[17-系统基础/06-知识字典/index.md\|知识字典/]] | 术语定义与概念解析 | 16子目录 | 全级别 |

## 学习路径

### 新手入门

1. [[17-系统基础/01-Linux/index.md|Linux 基础]] → 掌握操作系统核心概念
2. [[17-系统基础/05-速查卡/index.md|速查卡]] → 熟悉常用命令
3. [[17-系统基础/06-知识字典/index.md|知识字典]] → 建立术语体系

### 中级进阶

4. [[17-系统基础/03-网络基础/index.md|网络基础]] → 深入网络协议
5. [[17-系统基础/04-K8s事件/index.md|K8s 事件]] → 掌握故障排查
6. [[17-系统基础/02-硬件/index.md|硬件知识]] → 理解底层架构
