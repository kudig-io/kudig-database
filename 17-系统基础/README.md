...
| 子目录 | 内容 | 核心话题 |
|--------|------|----------|
| [[17-系统基础/01-Linux/index.md\|Linux/]] | Linux | 进程管理、文件系统、网络配置、内核参数 |
| [[17-系统基础/02-硬件/index.md\|硬件/]] | 硬件 | 服务器、GPU、网络设备、存储硬件 |
| [[17-系统基础/04-K8s事件/index.md\|K8s事件/]] | 事件 | K8s Events 全域事件大全、事件分析 |
