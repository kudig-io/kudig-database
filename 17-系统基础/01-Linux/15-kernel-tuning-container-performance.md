...
5. **与 [[14-容器运行时/03-containerd-CRI-O/01-containerd-production-operations|containerd]] 配合**：snapshotter 和 shim 配置也影响性能
6. **参考 [[17-系统基础/01-Linux/06-linux-performance-tuning|Linux 性能调优]] 了解更多通用调优**
