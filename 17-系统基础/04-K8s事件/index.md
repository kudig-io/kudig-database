...
| 文档 | 内容 | 行数 |
|------|------|------|
| [[17-系统基础/04-K8s事件/01-event-system-architecture.md|事件系统架构]] | Event API、存储、过期、监控 | 626 |

### 资源生命周期事件

| 文档 | 内容 | 行数 |
|------|------|------|
| [[17-系统基础/04-K8s事件/02-pod-container-lifecycle-events.md|Pod/容器生命周期]] | 创建、调度、启动、运行、终止 | 2582 |
| [[17-系统基础/04-K8s事件/03-image-pull-events.md|镜像拉取事件]] | Pulling、Pulled、Failed、认证 | 2544 |
| [[17-系统基础/04-K8s事件/04-probe-health-check-events.md|探针健康检查]] | Liveness、Readiness、Startup | 1545 |
| [[17-系统基础/04-K8s事件/05-scheduling-preemption-events.md|调度与抢占]] | Scheduled、FailedScheduling、Preempting | 1021 |

### 节点与工作负载事件

| 文档 | 内容 | 行数 |
|------|------|------|
| [[17-系统基础/04-K8s事件/06-node-lifecycle-condition-events.md|节点生命周期]] | Ready、NotReady、资源压力 | 2631 |
| [[17-系统基础/04-K8s事件/07-deployment-replicaset-events.md|Deployment/ReplicaSet]] | 滚动更新、扩缩、回滚 | 2446 |
| [[17-系统基础/04-K8s事件/08-statefulset-daemonset-events.md|StatefulSet/DaemonSet]] | 有序部署、节点守护 | 2488 |
| [[17-系统基础/04-K8s事件/09-job-cronjob-batch-events.md|Job/CronJob]] | 批量任务、定时任务、失败 | 2525 |

### 基础设施事件

| 文档 | 内容 | 行数 |
|------|------|------|
| [[17-系统基础/04-K8s事件/10-service-networking-events.md|Service/网络事件]] | Endpoint、Ingress、DNS | 2353 |
| [[17-系统基础/04-K8s事件/11-storage-volume-events.md|存储/卷事件]] | PV/PVC、挂载、快照 | 2391 |
| [[17-系统基础/04-K8s事件/12-autoscaling-events.md|自动扩缩容事件]] | HPA、VPA、KEDA | 2511 |

### 安全与治理事件

| 文档 | 内容 | 行数 |
|------|------|------|
| [[17-系统基础/04-K8s事件/13-security-admission-rbac-events.md|安全/准入/RBAC]] | 准入拒绝、权限失败 | 1871 |
| [[17-系统基础/04-K8s事件/14-namespace-resource-gc-events.md|Namespace/资源/GC]] | 删除、回收、Finalizer | 2897 |
| [[17-系统基础/04-K8s事件/15-ecosystem-addon-events.md|生态/插件事件]] | Helm、Operator、CNI | 1456 |
...
- [[17-系统基础/06-知识字典/index.md|知识字典总索引]]
- [[17-系统基础/05-速查卡/k8s.md|K8s 速查卡]]
- [[17-系统基础/05-速查卡/kubectl-scene-cheatsheet.md|kubectl 场景速查]]
