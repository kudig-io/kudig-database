...
- **[Domain-8: 可观测性 - 事件与审计日志](../../09-可观测性/03-日志/14-events-audit-logs.md)** - 审计日志体系和合规性
- **[Domain-4: 工作负载 - Pod生命周期事件表](02-pod-lifecycle-events.md)** - Pod 事件速查表
- **[Domain-12: 故障排查 - 事件驱动架构](../../19-故障诊断/04-高级排障/07-event-driven-architecture-troubleshooting.md)** - 事件驱动系统故障排查
- **[Domain-1: 架构基础 - kubectl命令参考](../../01-集群基础/05-kubectl/02-kubectl-commands-reference.md)** - kubectl 事件相关命令
