...
| 速查卡 | 内容 | 行数 | 难度 |
|--------|------|------|------|
| [[17-系统基础/05-速查卡/k8s.md|K8s 速查卡]] | K8s 全资源操作、集群管理、故障排查 | 1800+ | 入门→高级 |
| [[17-系统基础/05-速查卡/kubectl-scene-cheatsheet.md|kubectl 场景速查]] | 按场景分类的 kubectl 命令 | 650+ | 入门→中级 |
| [[17-系统基础/05-速查卡/helm.md|Helm 速查卡]] | Chart 管理、模板、仓库操作 | 290+ | 入门→中级 |
| [[17-系统基础/05-速查卡/gateway-api.md|Gateway API 速查]] | Gateway/HTTPRoute/TLS 配置 | 270+ | 中级→高级 |
| [[17-系统基础/05-速查卡/gitops.md|GitOps 速查卡]] | ArgoCD/Flux 操作命令 | 300+ | 中级→高级 |

### 系统与容器

| 速查卡 | 内容 | 行数 | 难度 |
|--------|------|------|------|
| [[17-系统基础/05-速查卡/linux.md|Linux 速查卡]] | 系统管理、性能、网络、存储 | 2200+ | 入门→高级 |
| [[17-系统基础/05-速查卡/docker.md|Docker 速查卡]] | 镜像、容器、网络、构建 | 520+ | 入门→中级 |
| [[17-系统基础/05-速查卡/networking.md|网络速查卡]] | TCP/IP、DNS、抓包、防火墙 | 600+ | 中级→高级 |
| [[17-系统基础/05-速查卡/tls-pki.md|TLS/PKI 速查卡]] | 证书、加密、PKI 操作 | 500+ | 中级→高级 |

### 可观测性

| 速查卡 | 内容 | 行数 | 难度 |
|--------|------|------|------|
| [[17-系统基础/05-速查卡/promql.md|PromQL 速查卡]] | 查询语言、函数、告警规则 | 560+ | 中级→高级 |
| [[17-系统基础/05-速查卡/perf-bpftrace-cheat-sheet.md|性能/bpftrace 速查]] | 性能分析、eBPF 追踪 | 730+ | 高级→专家 |

### 开发与工具

| 速查卡 | 内容 | 行数 | 难度 |
|--------|------|------|------|
| [[17-系统基础/05-速查卡/git.md|Git 速查卡]] | 版本控制、分支、合并、变基 | 650+ | 入门→高级 |
| [[17-系统基础/05-速查卡/go.md|Go 速查卡]] | Go 语言、并发、测试、工具链 | 2600+ | 入门→高级 |
| [[17-系统基础/05-速查卡/sql.md|SQL 速查卡]] | 查询、索引、优化、运维 | 770+ | 入门→高级 |

### 索引与导航

| 文档 | 内容 |
|------|------|
| [[17-系统基础/05-速查卡/MOC.md|内容地图 (MOC)]] | 速查卡导航与关联 |
| [[17-系统基础/05-速查卡/README.md|说明文档]] | 使用指南与贡献规范 |
