...
> **相关领域**: [[entities/k8s-workload-management.md|k8s-workload-management]]
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/scheduling/api-initiated-eviction.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/scheduling/assigning-pods-to-nodes.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/scheduling/dynamic-resource-allocation.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/scheduling/gang-scheduling.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/scheduling/karpenter-autoscaling.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/scheduling/kubernetes-scheduler.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/scheduling/node-declared-features.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/scheduling/node-pressure-eviction.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/scheduling/pod-overhead.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/scheduling/pod-priority-and-preemption.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/scheduling/pod-scheduling-readiness.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/scheduling/pod-topology-spread-constraints.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/scheduling/resource-bin-packing.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/scheduling/scheduler-performance-tuning.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/scheduling/scheduling-framework.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/scheduling/taints-and-tolerations.md`）*
...
- `domain-17-system-foundation/topic-dictionary/scheduling/api-initiated-eviction.md`
- `domain-17-system-foundation/topic-dictionary/scheduling/assigning-pods-to-nodes.md`
- `domain-17-system-foundation/topic-dictionary/scheduling/dynamic-resource-allocation.md`
- `domain-17-system-foundation/topic-dictionary/scheduling/gang-scheduling.md`
- `domain-17-system-foundation/topic-dictionary/scheduling/karpenter-autoscaling.md`
- `domain-17-system-foundation/topic-dictionary/scheduling/kubernetes-scheduler.md`
- `domain-17-system-foundation/topic-dictionary/scheduling/node-declared-features.md`
- `domain-17-system-foundation/topic-dictionary/scheduling/node-pressure-eviction.md`
- `domain-17-system-foundation/topic-dictionary/scheduling/pod-overhead.md`
- `domain-17-system-foundation/topic-dictionary/scheduling/pod-priority-and-preemption.md`
- `domain-17-system-foundation/topic-dictionary/scheduling/pod-scheduling-readiness.md`
- `domain-17-system-foundation/topic-dictionary/scheduling/pod-topology-spread-constraints.md`
- `domain-17-system-foundation/topic-dictionary/scheduling/resource-bin-packing.md`
- `domain-17-system-foundation/topic-dictionary/scheduling/scheduler-performance-tuning.md`
- `domain-17-system-foundation/topic-dictionary/scheduling/scheduling-framework.md`
- `domain-17-system-foundation/topic-dictionary/scheduling/taints-and-tolerations.md`

## Related

- [[entities/observability-terms.md|observability-terms]] — K8s 可观测性术语参考
- [[entities/storage-terms.md|storage-terms]] — K8s 存储术语参考
