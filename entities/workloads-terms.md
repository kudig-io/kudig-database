...
> **相关领域**: [[entities/k8s-workloads-domain-guide.md|k8s-workloads-domain-guide]] | [[entities/k8s-workload-management.md|k8s-workload-management]]
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/advanced-pod-configuration.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/automatic-cleanup-for-finished-jobs.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/autoscaling-workloads.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/container-environment.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/container-lifecycle-hooks.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/container-runtime-interface-cri.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/cronjob.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/daemonset.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/deployments.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/disruptions.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/downward-api.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/ephemeral-containers.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/horizontal-pod-autoscaling.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/images.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/init-containers.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/jobs.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/managing-workloads.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/pod-group-policies.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/pod-hostname.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/pod-lifecycle.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/pod-quality-of-service-classes.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/pods.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/replicaset.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/replicationcontroller.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/runtime-class.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/sidecar-containers.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/spot-and-preemptible-workloads.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/statefulsets.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/user-namespaces.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/vertical-pod-autoscaling.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/workload-api.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/workload-management.md`）*
...
> *（内容已精简，完整版请参阅源文件 `domain-17-system-foundation/topic-dictionary/workloads/workload-reference.md`）*
...
- `domain-17-system-foundation/topic-dictionary/workloads/advanced-pod-configuration.md`
- `domain-17-system-foundation/topic-dictionary/workloads/automatic-cleanup-for-finished-jobs.md`
- `domain-17-system-foundation/topic-dictionary/workloads/autoscaling-workloads.md`
- `domain-17-system-foundation/topic-dictionary/workloads/container-environment.md`
- `domain-17-system-foundation/topic-dictionary/workloads/container-lifecycle-hooks.md`
- `domain-17-system-foundation/topic-dictionary/workloads/container-runtime-interface-cri.md`
- `domain-17-system-foundation/topic-dictionary/workloads/cronjob.md`
- `domain-17-system-foundation/topic-dictionary/workloads/daemonset.md`
- `domain-17-system-foundation/topic-dictionary/workloads/deployments.md`
- `domain-17-system-foundation/topic-dictionary/workloads/disruptions.md`
- `domain-17-system-foundation/topic-dictionary/workloads/downward-api.md`
- `domain-17-system-foundation/topic-dictionary/workloads/ephemeral-containers.md`
- `domain-17-system-foundation/topic-dictionary/workloads/horizontal-pod-autoscaling.md`
- `domain-17-system-foundation/topic-dictionary/workloads/images.md`
- `domain-17-system-foundation/topic-dictionary/workloads/init-containers.md`
- `domain-17-system-foundation/topic-dictionary/workloads/jobs.md`
- `domain-17-system-foundation/topic-dictionary/workloads/managing-workloads.md`
- `domain-17-system-foundation/topic-dictionary/workloads/pod-group-policies.md`
- `domain-17-system-foundation/topic-dictionary/workloads/pod-hostname.md`
- `domain-17-system-foundation/topic-dictionary/workloads/pod-lifecycle.md`
- `domain-17-system-foundation/topic-dictionary/workloads/pod-quality-of-service-classes.md`
- `domain-17-system-foundation/topic-dictionary/workloads/pods.md`
- `domain-17-system-foundation/topic-dictionary/workloads/replicaset.md`
- `domain-17-system-foundation/topic-dictionary/workloads/replicationcontroller.md`
- `domain-17-system-foundation/topic-dictionary/workloads/runtime-class.md`
- `domain-17-system-foundation/topic-dictionary/workloads/sidecar-containers.md`
- `domain-17-system-foundation/topic-dictionary/workloads/spot-and-preemptible-workloads.md`
- `domain-17-system-foundation/topic-dictionary/workloads/statefulsets.md`
- `domain-17-system-foundation/topic-dictionary/workloads/user-namespaces.md`
- `domain-17-system-foundation/topic-dictionary/workloads/vertical-pod-autoscaling.md`
- `domain-17-system-foundation/topic-dictionary/workloads/workload-api.md`
- `domain-17-system-foundation/topic-dictionary/workloads/workload-management.md`
- `domain-17-system-foundation/topic-dictionary/workloads/workload-reference.md`
