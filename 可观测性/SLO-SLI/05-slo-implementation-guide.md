...
为每个关键步骤选择合适的 SLI（参考 [[可靠性/04-slo-sli/01-sli-definition-selection.md|01 sli definition selection]]）：
...
- [[可靠性/04-slo-sli/01-sli-definition-selection.md|01 sli definition selection]] — SLI 定义与选择方法论
