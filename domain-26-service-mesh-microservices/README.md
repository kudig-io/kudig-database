...
| 领域 | 关联内容 | 交集点 |
|:---|:---|:---|
| **[Domain-5: 网络](../domain-5-networking)** | CNI、Ingress、Service、NetworkPolicy | 服务网格依赖K8s网络基础, Ingress是网关的底层 |
| **[Domain-8: 可观测性](../domain-8-observability)** | Prometheus、Grafana、Jaeger、OpenTelemetry | 服务网格提供指标/追踪/日志, OTel统一遥测 |
| **[Domain-25: 云原生安全](../domain-25-cloud-native-security)** | 零信任、mTLS、RBAC、安全策略 | 服务网格mTLS和AuthorizationPolicy是零信任的核心 |
