...
| 子目录 | 内容 | 核心话题 |
|--------|------|----------|
| [[21-生态参考/01-CNCF全景/index.md\|CNCF全景/]] | CNCF 项目 | 毕业/孵化/沙箱项目参考、成熟度评估 |
| [[21-生态参考/02-论文/index.md\|论文/]] | 学术论文 | Raft/Borg/Omega/Kubernetes 设计论文 |
| [[21-生态参考/03-领域索引/index.md\|领域索引/]] | 技术索引 | 各技术领域的全局索引与知识图谱 |

## 生态组件源码级分析

生态上下游组件与 K8s 的集成点、交互机制与依赖关系（行号实测）：

- [[10-平台工程/06-代码分析/kubernetes-ecosystem/README.md|kubernetes-ecosystem 生态集成源码分析系列]]（CRI/CNI/CSI/网格/可观测/CI-CD/仓库-DNS-LB 七篇）
- [[10-平台工程/06-代码分析/kubernetes-core/README.md|kubernetes-core K8s 本体源码解析系列]]（控制平面 + kubelet/kube-proxy 九篇）
- [[33-源码/README.md|33-源码 目录总索引]]（本地源码树↔领域文档双向映射）
