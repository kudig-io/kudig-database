...
│  └──────────────┘     └──────────────┘     └──────────────┘     │
│                                                                  │
│  增强的索引文件: 生态参考/topic-index/*.md (17个)                          │
...
构建了 `生态参考/topic-index/vector-index.json`：
...
构建了 `生态参考/topic-index/hybrid-search-meta.json`：
...
# 加载向量索引
with open('生态参考/topic-index/vector-index.json') as f:
...
# 加载混合搜索元数据
with open('生态参考/topic-index/hybrid-search-meta.json') as f:
...
| network-index.md | TC-INFRA-NET | P1-P2 | CNI、DNS、[[17-系统基础/06-知识字典/networking/service.md|Service]]、[[17-系统基础/06-知识字典/networking/ingress.md|Ingress]] |
...
| etcd-index.md | TC-INFRA-CP | P0 | [[23-实体/02-K8s核心组件/etcd.md|etcd]] 存储、空间、配额 |
