...
- **网络 覆盖**: Service 到 Service 的东西向流量治理（Istio、Linkerd 等服务网格）
- **网络 覆盖**: Kubernetes 网络基础（CNI、Service、DNS、NetworkPolicy）
...
> 详细的 Gateway API 技术解析请参考 [02-Kubernetes Gateway API 标准深度解析](./02-kubernetes-gateway-api-deep-dive.md) 以及 [Domain-5: 网络 - Gateway API 概览](../01-K8s网络核心/37-gateway-api-overview.md)。
...
- [Domain-5: 网络 - Ingress 与 API Gateway 对比表](../01-K8s网络核心/38-api-gateway-patterns.md)
