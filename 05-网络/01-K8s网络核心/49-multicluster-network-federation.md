...
本文深入对比三大主流方案——Submariner、Cilium ClusterMesh、Liqo，覆盖架构原理、生产部署、跨集群 Service 暴露、网络策略同步与故障排查。已有的多集群网络基础概念可以参考 [[05-网络/01-K8s网络核心/32-multi-cluster-networking.md|多集群网络]]。
