...
- `synthesis/gitops-sre-release-gate.md` — now linked from: [[实体/argo.md|argo]]-cd-enterprise-gitops.md]], [[可靠性/SRE实践/02-release-gate-slo-based.md|02 release gate slo based]]
- `[[系统基础/知识字典/networking/service.md|service]]-mesh-zero-trust-security.md` — now linked from: [[实体/istio.md|istio]]-enterprise-service-mesh.md]], [[安全/网络安全/07-zero-trust-security-architecture.md|07 zero trust security architecture]]
