...
5. **与 SLO 联动**：参考 [[概念/slo-error-budget-framework.md|slo error budget framework]]，仅在 Error Budget 充足时执行
...
- [[概念/slo-error-budget-framework.md|slo error budget framework]] — SLO 与 Error Budget 框架
- [[概念/incident-management-patterns.md|incident management patterns]] — 事件管理与响应模式
- [[概念/multi-cluster-dr-automation.md|multi cluster dr automation]] — 多集群灾备与自动化
