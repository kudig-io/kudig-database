...
- [[概念/application-patterns-k8s.md|application patterns k8s]] — K8s 应用架构模式演进与选型

## 跨领域链接

- [[概念/k8s-networking-evolution.md|k8s networking evolution]] — 从 Ingress 到 Gateway API、eBPF 网络的演进
- [[概念/platform-engineering-idp.md|platform engineering idp]] — vCluster 与内部开发者平台的融合
- [[概念/k8s-ai-ml-infrastructure.md|k8s ai ml infrastructure]] — Kueue、GPU 调度与 AI 训练基础设施
