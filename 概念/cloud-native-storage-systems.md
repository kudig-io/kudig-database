...
tier: supporting
relationships:
  - target: '[[概念/csi-drivers.md|csi drivers]]'
    type: related_to
  - target: '[[概念/storageclass.md|storageclass]]'
    type: related_to
  - target: '[[概念/pv.md|pv]]'
    type: related_to
...
云原生存储通过 [[概念/csi-drivers.md|csi drivers]] 标准化接口暴露能力，配合 [[概念/storageclass.md|storageclass]]
实现声明式供给，最终以 [[概念/pv.md|pv]] 绑定到工作负载。
...
- [[概念/csi-drivers.md|csi drivers]] — CSI 驱动规范与实现
- [[概念/storageclass.md|storageclass]] — StorageClass 配置详解
- [[概念/pv.md|pv]] — 持久卷生命周期
