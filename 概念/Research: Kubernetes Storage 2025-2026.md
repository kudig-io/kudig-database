...
- [[概念/csi-drivers.md|CSI 驱动]] — Container Storage Interface 规范、迁移状态、核心能力全景
- [[概念/cloud-native-storage-systems.md|云原生存储系统对比]] — Longhorn/Rook-Ceph/OpenEBS/JuiceFS 架构与选型
- [[概念/storage-performance-optimization.md|存储性能优化]] — 基准测试、NVMe 调优、存储 QoS
- [[概念/storage-data-protection.md|存储数据保护与灾难恢复]] — Velero 最佳实践、不可变备份、DR 策略
- [[概念/storage-tool-evolution.md|存储工具演进]] — Rook/Longhorn/Velero 版本演进
...
- [[概念/csi-drivers.md|CSI 驱动]] — Kubernetes 官方文档、kubernetes-csi.github.io
- [[概念/cloud-native-storage-systems.md|云原生存储系统对比]] — Longhorn/Rook/OpenEBS/JuiceFS 官方文档
- [[概念/storage-performance-optimization.md|存储性能优化]] — K8S 官方文档、社区基准测试
- [[概念/storage-data-protection.md|存储数据保护与灾难恢复]] — Velero 官方文档、AWS S3 文档
...
- [[概念/k8s-security-compliance.md|k8s security compliance]] — 存储加密（etcd 加密、PV 加密）与零信任安全架构的深度耦合
- [[概念/k8s-ai-ml-infrastructure.md|k8s ai ml infrastructure]] — AI/ML 工作负载对高性能存储（GPUDirect Storage、NVMe-oF）的需求驱动存储架构变革
- [[概念/finops-greenops-practices.md|finops greenops practices]] — 存储成本优化（分层存储、数据生命周期管理）是 FinOps 实践的关键组成部分
- [[概念/multi-cluster-dr-automation.md|multi cluster dr automation]] — 跨集群存储复制与灾难恢复策略（Velero、Kasten）保障业务连续性
