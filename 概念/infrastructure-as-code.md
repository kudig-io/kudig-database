...
**State Management**: IaC tools track actual vs desired state. Terraform stores state in backends (S3+DynamoDB for locking, Terraform Cloud for team collaboration). Crossplane stores state in K8s etcd, naturally integrating with [[概念/gitops-principles.md|GitOps]].
...
- [[概念/platform-engineering-idp.md|platform-engineering-idp]] — Platform Engineering and Internal Developer Platforms
