...
- [[概念/gitops-production-operations.md|GitOps 与生产运维]] — ArgoCD/Flux 演进、Cluster API、Fleet 管理、AI 运维
- [[概念/finops-greenops-practices.md|FinOps 与 GreenOps 实践]] — FOCUS 规范、成本分配、GPU 优化、Spot 策略
- [[概念/capacity-planning-cost-optimization.md|容量规划与成本优化]] — AI 预测、Right-sizing、FinOps 成熟度
...
- [[概念/gitops-production-operations.md|GitOps 与生产运维]] — ArgoCD/Flux/CAPI 官方文档
- [[概念/finops-greenops-practices.md|FinOps 与 GreenOps 实践]] — FinOps Foundation/kube-green/NVIDIA 文档
...
- [[概念/k8s-security-compliance.md|k8s security compliance]] — 生产运维中的安全加固（CIS Benchmark、Pod Security Standards）是合规运营的基石
- [[概念/slo-error-budget-framework.md|slo error budget framework]] — SLO/Error Budget 框架指导生产环境的变更节奏与风险决策
- [[概念/k8s-ai-ml-infrastructure.md|k8s ai ml infrastructure]] — AI/ML 工作负载的运维特殊性（GPU 调度、弹性扩缩）对生产运维提出新挑战
- [[概念/progressive-delivery-strategies.md|progressive delivery strategies]] — 渐进式交付（金丝雀、蓝绿部署）是生产变更管理的最佳实践
