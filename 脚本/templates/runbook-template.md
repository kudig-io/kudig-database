...
- [ ] 在 [时间] 内完成 [[脚本/templates/postmortem-template|事后总结]]
- [ ] 更新本 Runbook (补充新发现的诊断步骤)
- [ ] 检查告警阈值是否需要调整
- [ ] 考虑添加自动化修复 (参考 [[脚本/prompts/incident-diagnosis|事件诊断 Prompt]])

### 8. 参考资料

- [[故障诊断/技能体系/MOC|操作技能索引]] — 相关技能卡片
- [[故障诊断/FTA故障树/MOC|FTA 故障树]] — 根因分析参考
- [相关监控 Dashboard 链接]
- [相关架构设计文档]
