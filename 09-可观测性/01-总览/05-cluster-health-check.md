...
intent_queries:
- 集群健康检查指南 (Cluster Health Check Guide) 是什么
- 如何 集群健康检查指南 (Cluster Health Check Guide)
...
> **适用版本**: v1.25 - v1.32 | **最后更新**: 2026-01 | **参考**: [[23-实体/02-K8s核心组件/kubernetes.md|kubernetes]].io/docs/tasks/debug/debug-cluster](https://kubernetes.io/docs/tasks/debug/debug-cluster/)
