...
OTel Collector 应与 [[09-可观测性/04-链路追踪/02-grafana-tempo-tracing.md|Grafana Tempo]] 对接存储 Traces，与 [[09-可观测性/02-指标/01-prometheus-enterprise-monitoring.md|Prometheus/Mimir]] 对接存储 Metrics，与 [[09-可观测性/01-总览/06-elastic-stack-enterprise-observability.md|Loki/ELK]] 对接存储 Logs。通过统一的 Collector 管道，实现三种信号类型的关联查询。
