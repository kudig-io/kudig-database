...
| 文件 | 内容 |
|------|------|
| [[存储/云存储对比/01-cloud-storage-comparison.md\|云存储全面对比]] | AWS/Azure/GCP/阿里云块存储/文件存储/对象存储对比、CSI 集成、选型决策 |
...
- [[存储/AI存储与高级/index.md|AI 存储与高级]] — 云 CSI 驱动详解
- [[云厂商/README.md|云厂商知识域]] — 各云 K8s 服务对比
