...
- Java 应用将 `MaxRAMPercentage` 控制在 65%–75%，并显式限制 `-XX:MaxMetaspaceSize` 与 `-XX:MaxDirectMemorySize`；详见 [[domain-02-workloads-applications/03-jvm-gc-container-tuning.md|JVM GC 容器调优深度指南]]。
...
> 节点维护与 PodDisruptionBudget 的 interplay 详见 [[domain-02-workloads-applications/00-core-workloads/18-node-management-operations.md|节点管理操作]]。
...
排查工作负载故障时，建议遵循“先状态、后日志、再事件、最后深入容器”的顺序。下表列出生产环境最常见症状，并提供对应的确认命令与修复措施。若症状复杂或跨多个域，请结合 [[domain-02-workloads-applications/00-core-workloads/07-workload-troubleshooting-handbook.md|工作负载故障排查手册]] 进行系统分析。
...
更系统的排查流程请参考 [[domain-02-workloads-applications/00-core-workloads/07-workload-troubleshooting-handbook.md|工作负载故障排查手册]]。
...
- [[domain-02-workloads-applications/02-spring-boot-kubernetes-production.md|Spring Boot on Kubernetes 生产实践指南]]
- [[domain-02-workloads-applications/03-jvm-gc-container-tuning.md|JVM GC 容器调优深度指南]]
- [[domain-02-workloads-applications/04-java-operator-sdk-development.md|Java Operator SDK 开发指南]]
- [[domain-02-workloads-applications/05-quarkus-native-kubernetes.md|Quarkus Native on Kubernetes]]
- [[domain-02-workloads-applications/06-java-cicd-tekton-argocd.md|Java CI/CD 与 Tekton/ArgoCD]]
- [[domain-02-workloads-applications/07-java-observability-kubernetes.md|Java 可观测性指南]]
- [[domain-02-workloads-applications/00-core-workloads/21-hpa-vpa-autoscaling.md|HPA/VPA 自动伸缩]]
- [[domain-02-workloads-applications/00-core-workloads/23-resource-management.md|资源管理]]
- [[domain-02-workloads-applications/00-core-workloads/03-statefulset-advanced-operations.md|StatefulSet 高级操作]]
