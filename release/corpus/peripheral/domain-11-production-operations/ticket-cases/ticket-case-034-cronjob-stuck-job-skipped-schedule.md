...
skill_ref:
- '[[domain-02-workloads-applications/00-core-workloads/05-job-cronjob-advanced.md|Job/CronJob
  进阶]]'
...
>
> **后续建议：**
> - 参考 [[domain-02-workloads-applications/00-core-workloads/05-job-cronjob-advanced.md|Job/CronJob 进阶]] review 所有 CronJob 的 `concurrencyPolicy` 与超时设置；
