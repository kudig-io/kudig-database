...
| **Litmus Chaos** | 混沌实验平台 | CloudNative 项目，[[entities/argo.md|Argo Workflows]] 集成 |
| **Gremlin** | SaaS 混沌平台 | 商业方案，丰富的可观测性集成 |
| **Prometheus** | 指标存储 | 实验期间指标采集和 SLO 验证 |
| **Grafana** | 可视化 | 混沌实验 Dashboard，实时观察 |
| **[[entities/jaeger.md|Jaeger]]** | 分布式追踪 | 追踪实验期间的请求链路 |
...
- [[entities/chaos-mesh.md|Chaos Mesh [entities]]]
- [[entities/litmus.md|LitmusChaos]]
