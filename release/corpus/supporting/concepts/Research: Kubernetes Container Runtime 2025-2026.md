...
详细概念模型参见 [[concepts/container-runtime-evolution.md|container runtime evolution]]。
...
- [[concepts/container-runtime-evolution.md|container runtime evolution]] — 容器运行时从 Docker daemon 到多运行时编排的演进路径
...
- [[concepts/k8s-security-compliance.md|k8s security compliance]] — 安全容器运行时（gVisor、Kata、Confidential Containers）是容器安全合规的关键技术层
