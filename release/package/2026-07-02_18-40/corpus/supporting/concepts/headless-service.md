...
更多有状态应用排错方法请参考 [[domain-10-troubleshooting-diagnostics/高级排障/05-workloads/03-statefulset-troubleshooting.md|statefulset-troubleshooting]]，服务发现相关内容参见 [[concepts/service.md|service-discovery]]。
