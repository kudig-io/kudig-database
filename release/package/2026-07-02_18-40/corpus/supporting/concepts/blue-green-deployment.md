...
更多部署排错方法请参考 [[domain-10-troubleshooting-diagnostics/高级排障/05-workloads/02-deployment-troubleshooting.md|deployment-troubleshooting]]，其他部署策略参见 [[concepts/deployments.md|deployment-strategies]]。
