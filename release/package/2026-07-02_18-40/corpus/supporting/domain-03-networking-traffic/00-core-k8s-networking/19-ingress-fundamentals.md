...
| 概念 | 英文术语 | 定义 | 作用 | 版本要求 |
|-----|---------|------|------|---------|
| **Ingress** | Ingress | [[domain-17-system-foundation/知识字典/fundamentals/the-kubernetes-api.md|Kubernetes API]] 对象，管理集群外部访问集群内服务的 HTTP/HTTPS 路由规则 | 定义 L7 路由规则、TLS 终止、虚拟主机 | v1.19+ GA |
