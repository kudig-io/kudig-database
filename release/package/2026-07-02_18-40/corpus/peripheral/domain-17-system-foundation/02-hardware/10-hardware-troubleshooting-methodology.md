...
summary: '硬件故障排查是数据中心运维的核心技能。本文档建立系统化的硬件故障排查方法论，涵盖问题分类、诊断流程、工具使用、排查技巧及最佳实践。'
category: hardware
tags:
- k8s
- hardware
...
硬件故障排查是数据中心运维的核心技能。本文档建立系统化的硬件故障排查方法论，涵盖问题分类、诊断流程、工具使用、排查技巧及最佳实践。
...
│  │                    按问题组件分类                                    │   │
│  │                                                                       │   │
│  │  处理器问题 ──── • CPU过热保护  • 核心问题  • 缓存错误              │   │
│  │                                                                       │   │
│  │  内存问题 ────── • ECC错误  • DIMM失效  • 内存泄漏                  │   │
│  │                                                                       │   │
│  │  存储问题 ────── • 磁盘坏道  • RAID降级  • 控制器问题               │   │
│  │                                                                       │   │
│  │  网络问题 ────── • 网卡失效  • 链路问题  • 光模块问题               │   │
│  │                                                                       │   │
│  │  电源问题 ────── • PSU失效  • 电压异常  • 供电不足                  │   │
│  │                                                                       │   │
│  │  散热问题 ────── • 风扇失效  • 温度过高  • 散热器松动               │   │
│  │                                                                       │   │
│  │  主板问题 ────── • 芯片组问题  • 插槽损坏  • 电容失效               │   │
│  │                                                                       │   │
│  └─────────────────────────────────────────────────────────────────────┘   │
│                                                                             │
│  ┌─────────────────────────────────────────────────────────────────────┐   │
