...
### 📚 扩展学习资料
- **[Kubernetes控制器模式](../domain-01-cluster-fundamentals/03-controller-pattern.md)** - 理解Deployment控制器原理
- **[资源版本控制](../domain-01-cluster-fundamentals/06-resource-version-control.md)** - 资源状态管理机制
