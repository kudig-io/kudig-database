...
- target: '[[domain-17-system-foundation/知识字典/networking/service-mesh.md]]'
  type: uses
- target: '[[domain-17-system-foundation/知识字典/security/multi-tenancy.md]]'
  type: related_to
- target: '[[entities/networkpolicy.md]]'
  type: related_to
- target: '[[domain-17-system-foundation/知识字典/security/runtime-security.md]]'
  type: related_to
...
---
title: eBPF x [[domain-17-system-foundation/知识字典/security/runtime-security.md|运行时安全]]
category: synthesis
tags:
- k8s
- ebpf
...
- [[domain-17-system-foundation/知识字典/networking/service.md|service]]-mesh-architecture.md
...
- **Cilium [[domain-17-system-foundation/知识字典/networking/service-mesh.md|Service Mesh]]** 用 eBPF L4 mTLS 取代 sidecar 代理模式，消除了每 Pod 代理开销
...
1. **强制** [[entities/networkpolicy.md|NetworkPolicy]]（L3/L4 丢包）
...
- **[[domain-17-system-foundation/知识字典/security/multi-tenancy.md|多租户]] eBPF 策略：** 在多租户集群中，如何确保一个租户的 eBPF 程序不会干扰另一个租户的策略？
