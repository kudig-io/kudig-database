...
更多排查细节可参考 [[domain-10-troubleshooting-diagnostics/高级排障/06-security-auth/01-rbac-troubleshooting.md|rbac-troubleshooting]] 与技能页面 [[domain-10-troubleshooting-diagnostics/技能体系/skill-set/k8s-rbac-quota/SKILL.md|k8s-rbac-quota]]。
