...
- **全集群证书灾难**：参考 [[domain-09-reliability-engineering/灾难恢复/09-certificate-expiry-mass-rotation-playbook.md|集群证书批量过期紧急轮转]]。该场景下通常需要 SSH 登录控制平面节点，在时间回退或救援模式下完成证书续期。
...
- [[domain-09-reliability-engineering/灾难恢复/09-certificate-expiry-mass-rotation-playbook.md|集群证书批量过期紧急轮转]]
- [[domain-01-cluster-fundamentals/控制平面/32-kubeadm-cluster-lifecycle.md|kubeadm 集群生命周期管理]]
- [[domain-01-cluster-fundamentals/控制平面/19-etcd-operations.md|etcd 运维操作]]
