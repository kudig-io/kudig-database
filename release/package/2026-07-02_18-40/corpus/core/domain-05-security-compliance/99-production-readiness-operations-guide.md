...
kubectl get nodes
```
更完整的轮换流程与回滚方案参见 [[domain-05-security-compliance/合规审计/10-certificate-management.md|证书管理与 TLS 配置]]。
...
kubectl get clusterroles -o json | jq -r '
  ...
  .metadata.name'
```
推荐采用最小权限角色模板，具体矩阵参考 [[domain-05-security-compliance/身份与访问/07-rbac-matrix-configuration.md|RBAC 权限矩阵表]]。
...
```
签名、SBOM 与 SLSA 实施细节参见 [[domain-05-security-compliance/供应链/01-supply-chain-security-overview.md|供应链安全概览]]。
...
```
规则调优与事件响应流程参考 [[domain-05-security-compliance/运行时安全/99-falco-runtime-security-guide.md|Falco 运行时安全指南]]。
...
```
网络分段与零信任架构设计参考 [[domain-05-security-compliance/网络安全/19-zero-trust-architecture.md|零信任架构]]。
...
- [[domain-05-security-compliance/身份与访问/07-rbac-matrix-configuration.md|RBAC 权限矩阵表]] — 最小权限角色设计参考
- [[domain-05-security-compliance/策略治理/06-pod-security-standards.md|Pod 安全标准详解]] — PSA 分级与迁移
- [[domain-05-security-compliance/合规审计/10-certificate-management.md|证书管理与 TLS 配置]] — 集群证书与 cert-manager 运维
- [[domain-05-security-compliance/网络安全/19-zero-trust-architecture.md|零信任架构]] — 网络分段与身份驱动访问
- [[domain-05-security-compliance/运行时安全/99-falco-runtime-security-guide.md|Falco 运行时安全指南]] — 运行时威胁检测
- [[domain-05-security-compliance/供应链/01-supply-chain-security-overview.md|供应链安全概览]] — 镜像签名与 SBOM
- [[domain-05-security-compliance/事件响应/20-incident-response-process.md|安全事件响应流程]] — 事件响应与取证
