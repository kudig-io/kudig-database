...
- 第23章：FTA 生产环境快速启动与 SRE 集成指南 故障排查
- 第23章：FTA 生产环境快速启动与 SRE 集成指南 排障步骤
...
<!-- chunk: 23.1 FTA 30天快速启动路线图 -->## 23.1 FTA 30天快速启动路线图
...
<!-- chunk: Postmortem 检查清单 -->## Postmortem 检查清单
...
<!-- chunk: 23.2 快速构建你的第一棵 Kubernetes 故障树 -->## 23.2 快速构建你的第一棵 Kubernetes 故障树
...
```markdown
<!-- chunk: On-Call Handoff Report -->## On-Call Handoff Report
...
<!-- chunk: 执行摘要 (Executive Summary) -->## 执行摘要 (Executive Summary)
...
<!-- chunk: 时间线 (Timeline) -->## 时间线 (Timeline)
...
- [[domain-10-troubleshooting-diagnostics/FTA故障树/21-self-evolving-ops-system.md|21-self-evolving-ops-system]]
- [[domain-10-troubleshooting-diagnostics/FTA故障树/22-industry-standardization.md|22-industry-standardization]]
- [[domain-10-troubleshooting-diagnostics/FTA故障树/ack-fta-generator-v2.md|ack-fta-generator-v2]]
- [[domain-10-troubleshooting-diagnostics/FTA故障树/appendix-a-glossary.md|appendix-a-glossary]]
