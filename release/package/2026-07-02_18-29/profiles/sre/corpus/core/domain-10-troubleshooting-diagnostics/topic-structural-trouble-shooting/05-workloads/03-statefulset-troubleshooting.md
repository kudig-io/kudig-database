...
StatefulSet 是 Kubernetes 中用于管理有状态应用的工作负载控制器，为 Pod 提供稳定的网络标识、持久化存储和有序部署/扩缩/删除能力。本文档覆盖 StatefulSet 常见问题的诊断与解决方案。
...
- [PV/PVC 故障排查](../[[domain-10-troubleshooting-diagnostics/高级排障/04-storage/01-pv-pvc-troubleshooting.md|01-pv-pvc-troubleshooting]].md)
- [DNS 故障排查](../[[domain-10-troubleshooting-diagnostics/高级排障/03-networking/02-dns-troubleshooting.md|02-dns-troubleshooting]].md)
- [调度故障排查](../[[domain-10-troubleshooting-diagnostics/高级排障/01-control-plane/03-scheduler-troubleshooting.md|03-scheduler-troubleshooting]].md)
...
- [[domain-10-troubleshooting-diagnostics/高级排障/05-workloads/01-pod-troubleshooting.md|01-pod-troubleshooting]]
- [[domain-10-troubleshooting-diagnostics/高级排障/05-workloads/02-deployment-troubleshooting.md|02-deployment-troubleshooting]]
- [[domain-10-troubleshooting-diagnostics/高级排障/05-workloads/04-daemonset-troubleshooting.md|04-daemonset-troubleshooting]]
