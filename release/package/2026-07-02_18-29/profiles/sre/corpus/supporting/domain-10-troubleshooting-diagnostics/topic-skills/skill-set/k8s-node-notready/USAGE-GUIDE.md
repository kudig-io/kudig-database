...
> **范围**：`domain-10-troubleshooting-diagnostics/topic-skills/skill-set/k8s-node-notready/` ↔ `domain-10-troubleshooting-diagnostics/topic-fta/list/node-fta.md`  
...
1. [系统架构概述](#1-系统架构概述)
2. [文件清单与职责](#2-文件清单与职责)
3. [[domain-14-ai-ml-infra/AI-Agents/openclaw-workspace/SKILL.md|Skill]] 元系统 — 工作原理](#3-skill-元系统--工作原理)
...
```
domain-10-troubleshooting-diagnostics/topic-skills/skill-set/k8s-node-notready/
...
```yaml
fta_mapping:
  file: "domain-10-troubleshooting-diagnostics/topic-fta/list/node-fta.md"   # 必填：相对于仓库根目录的路径
