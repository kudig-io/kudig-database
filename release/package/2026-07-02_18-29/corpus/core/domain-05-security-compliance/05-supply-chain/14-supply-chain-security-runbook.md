...
本手册是 [[domain-05-security-compliance/99-production-readiness-operations-guide.md|安全与合规生产就绪运维指南]] 在供应链安全方向的落地 runbook，参考 [[_reports/domain-content-gap-analysis-2026-07-01.md|域内容缺口分析]] 中“镜像仓库 / 供应链安全”缺口设计，覆盖镜像 SBOM、签名、准入校验、仓库安全与 CI/CD 加固。软件供应链安全的目标是确保从源代码到生产运行的每一步都可追溯、可验证、可审计。
