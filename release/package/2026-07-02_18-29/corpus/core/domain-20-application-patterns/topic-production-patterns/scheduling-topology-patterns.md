...
- **HPA/VPA 弹性伸缩**: 见 `domain-02-workloads-applications/00-core-workloads/21-hpa-vpa-autoscaling.md`
- **Karpenter 节点供应**: 见 `domain-01-cluster-fundamentals/99-production-readiness-operations-guide.md`
