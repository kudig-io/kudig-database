...
- **不可变 Secret**：[[domain-17-system-foundation/topic-cheat-sheet/k8s.md|K8s]] v1.21+ 的 immutable Secret 禁止修改，但容器仍可在运行中读取旧值。Secret 更新后需要 Pod 重建才能加载新值
