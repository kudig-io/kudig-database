...
| **环境变量** | [[domain-17-system-foundation/知识字典/workloads/downward-api.md|Downward API]] | 简单 | 只能传递静态值 | 配置传递 |
...
**参考资料**:
- [KEP-753: [[domain-17-system-foundation/知识字典/workloads/sidecar-containers.md|Sidecar Containers]]](https://github.com/kubernetes/enhancements/tree/master/keps/sig-node/753-sidecar-containers)
