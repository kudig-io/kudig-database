...
### 5. 成本优化：Spot GPU + [[skills/training-public/inner-training/week-3-node-workload/checkpoint.md|Checkpoint]]
...
| **NVIDIA Device Plugin** | GPU 设备发现 | 向 [[entities/kubelet.md|Kubelet]] 报告 GPU/MIG 资源 |
