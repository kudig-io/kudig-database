...
intent_queries:
- domain-29-automated-testing-quality MOC 是什么
- 如何 domain-29-automated-testing-quality MOC
- Kubernetes 08 release change management 最佳实践
trigger_keywords:
- domain-29-automated-testing-quality
- MOC
- release
- change
- management
...
```mermaid
graph TD
    subgraph domain-29-automated-testing-quality
        A["Domain-29 自动化测试与质量 — 开源项目索引"]
    B["Selenium 企业级自动化测试平台"]
    C["JUnit 5 企业级单元测试框架深度实践"]
    D["企业级AI测试与质量保障深度实践"]
    E["Cypress Enterprise Automation Testing 深度实践"]
    F["Playwright Enterprise Automation Testing 深度实践"]
    end
