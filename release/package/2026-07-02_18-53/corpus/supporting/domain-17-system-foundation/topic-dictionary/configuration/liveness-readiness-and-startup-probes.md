...
intent_queries:
- Liveness, Readiness, and Startup Probes 是什么
- 如何 Liveness, Readiness, and Startup Probes
trigger_keywords:
- Liveness
- Readiness
- and
...
- [[domain-17-system-foundation/知识字典/configuration/configmaps.md|ConfigMaps]]](./configmaps.md) — 探针端口/路径可通过 ConfigMap 配置化
