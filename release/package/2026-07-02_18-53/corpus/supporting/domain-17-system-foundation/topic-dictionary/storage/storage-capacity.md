...
- CSI 临时卷（CSI [[domain-17-system-foundation/知识字典/storage/ephemeral-volumes.md|ephemeral volumes]]es（卷）|volumes]]）的调度**不**考虑存储容量。
...
- [节点特定卷限制](./[[domain-17-system-foundation/知识字典/storage/node-specific-volume-limits.md|node-specific-volume-limits]].md) — 节点级卷数量限制
