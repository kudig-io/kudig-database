...
| 12 | **灾难演练与混沌工程** | 已完成 AZ 故障切换、节点故障、控制平面断网演练并记录 RTO | 参考 [[domain-09-reliability-engineering/混沌工程/01-chaos-engineering-overview.md|混沌工程概述]] |
...
- [[domain-12-cloud-providers/多云混合/00-multi-cloud-hybrid-deployment-strategy.md|多云混合部署策略]] — 主备/主主模式、跨云数据同步、故障切换与统一监控。
