...
- **Initialized**: All [[domain-17-system-foundation/知识字典/workloads/init-containers.md|init containers]] completed
...
3. **[[domain-17-system-foundation/知识字典/workloads/sidecar-containers.md|Sidecar Containers]]** (v1.28+) can run alongside init containers in parallel
