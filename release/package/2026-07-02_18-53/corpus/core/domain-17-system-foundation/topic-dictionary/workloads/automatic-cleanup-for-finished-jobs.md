...
## 概述
TTL-after-finished 控制器为已完成的 Job 对象提供基于生存时间（TTL）的自动清理机制。它有助于减少 API Server 中已完成 Job 的累积，降低 [[domain-17-system-foundation/知识字典/fundamentals/etcd.md|etcd]] 压力。
