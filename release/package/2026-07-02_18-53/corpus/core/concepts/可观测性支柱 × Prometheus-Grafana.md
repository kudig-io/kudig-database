...
[[concepts/observability-pillars.md|observability pillars]] 描述 Metrics/Logs/Traces 三大支柱，[[entities/prometheus-grafana.md|prometheus grafana]] 是 Metrics 工具。wiki 将 Prometheus 归类为 Metrics 工具，但 Prometheus 生态实际上已经**超越了 Metrics 范畴**——通过 Loki（日志）和 Tempo（追踪）的标签关联，Prometheus 的标签模型正在成为可观测性三大支柱的统一查询接口。
...
- [[entities/etcd.md|etcd]] × 可观测性.md|etcd × 可观测性]]
- [[concepts/kubeadm-cluster-operations.md|kubeadm-cluster-operations]]
- [[concepts/声明式 API × 控制器模式.md|声明式 API × 控制器模式]]
- [[entities/deployment.md|Deployment]].md|控制器模式 × Deployment]]

## Related

- [[domain-19-landscape-references/_archived-release-notes/observability/grafana/RELEASE-NOTES-11.0.md|grafana v11.0 Release Notes]]
...
- [[domain-19-landscape-references/_archived-release-notes/observability/grafana/RELEASE-NOTES-12.3.md|grafana v12.3 Release Notes]]
- grafana v4.4 Release Notes
- grafana v8.0 Release Notes
- grafana v7.3 Release Notes
- [[domain-19-landscape-references/_archived-release-notes/observability/grafana/RELEASE-NOTES-11.4.md|grafana v11.4 Release Notes]]
- grafana v6.2 Release Notes
- grafana v9.1 Release Notes
- [[domain-19-landscape-references/_archived-release-notes/observability/grafana/RELEASE-NOTES-12.2.md|grafana v12.2 Release Notes]]
- grafana v4.5 Release Notes
- grafana v7.2 Release Notes
- grafana v8.1 Release Notes
- [[domain-19-landscape-references/_archived-release-notes/observability/grafana/RELEASE-NOTES-11.5.md|grafana v11.5 Release Notes]]
- grafana v9.0 Release Notes
- grafana v6.3 Release Notes
- [[domain-19-landscape-references/_archived-release-notes/observability/grafana/RELEASE-NOTES-10.4.md|grafana v10.4 Release Notes]]
- grafana v5.4 Release Notes
- [[domain-19-landscape-references/_archived-release-notes/observability/grafana/RELEASE-NOTES-11.1.md|grafana v11.1 Release Notes]]
...
- [[domain-19-landscape-references/_archived-release-notes/observability/grafana/RELEASE-NOTES-12.1.md|grafana v12.1 Release Notes]]
- [[domain-19-landscape-references/_archived-release-notes/observability/grafana/RELEASE-NOTES-11.6.md|grafana v11.6 Release Notes]]
...
- [[domain-19-landscape-references/_archived-release-notes/observability/grafana/RELEASE-NOTES-11.2.md|grafana v11.2 Release Notes]]
- grafana v4.2 Release Notes
- grafana v5.3 Release Notes
- grafana v6.4 Release Notes
- [[domain-19-landscape-references/_archived-release-notes/observability/grafana/RELEASE-NOTES-10.3.md|grafana v10.3 Release Notes]]
- grafana v7.4 Release Notes
- [[domain-19-landscape-references/_archived-release-notes/observability/grafana/RELEASE-NOTES-11.3.md|grafana v11.3 Release Notes]]
- [[domain-19-landscape-references/_archived-release-notes/observability/grafana/RELEASE-NOTES-12.4.md|grafana v12.4 Release Notes]]
- grafana v4.3 Release Notes
- grafana v5.2 Release Notes
- grafana v6.5 Release Notes
- [[domain-19-landscape-references/_archived-release-notes/observability/grafana/RELEASE-NOTES-10.2.md|grafana v10.2 Release Notes]]
- [[domain-19-landscape-references/_archived-release-notes/observability/grafana/RELEASE-NOTES-12.0.md|grafana v12.0 Release Notes]]
