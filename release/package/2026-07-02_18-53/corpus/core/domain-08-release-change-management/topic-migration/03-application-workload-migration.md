...
NAMESPACES=$(kubectl --context=$SOURCE_CONTEXT get ns --no-headers \
  -o custom-columns=:metadata.name | grep -vE "^(kube-|default$|ingress-|cert-manager)")
...
<!-- chunk: 8. Service 迁移 -->## 8. Service 迁移
...
- topic-migration MOC
- [[domain-08-release-change-management/迁移方案/README.md|自建 Kubernetes 迁移至阿里云 ACK 生产实践指南]]
- [[domain-08-release-change-management/迁移方案/01-migration-assessment-planning.md|01 - 迁移评估与规划]]
- [[domain-08-release-change-management/迁移方案/02-ack-target-cluster-design.md|02 - ACK 目标集群设计与搭建]]
- [[domain-08-release-change-management/迁移方案/04-storage-data-migration.md|04 - 存储与数据迁移]]
- [[domain-08-release-change-management/迁移方案/05-network-migration-traffic-cutover.md|05 - 网络迁移与流量切换]]
- [[domain-08-release-change-management/迁移方案/06-stateful-services-migration.md|06 - 有状态服务迁移]]
- [[domain-08-release-change-management/迁移方案/07-observability-security-migration.md|07 - 可观测性与安全迁移]]
- [[domain-08-release-change-management/迁移方案/08-validation-cutover-decommission.md|08 - 验收、切换与旧集群退役]]
- [[domain-08-release-change-management/迁移方案/09-migration-toolchain.md|09 - 迁移工具链参考]]
- [[domain-08-release-change-management/迁移方案/10-real-world-case-study.md|10 - 生产迁移实战案例]]
