...
> **上一章**: [第一章：FTA 起源与发展史](./[[domain-10-troubleshooting-diagnostics/FTA故障树/01-fta-origin-and-evolution.md|01-fta-origin-and-evolution]].md)  
...
- [[domain-10-troubleshooting-diagnostics/FTA故障树/symptom-vector-matcher.md|symptom-vector-matcher]]
