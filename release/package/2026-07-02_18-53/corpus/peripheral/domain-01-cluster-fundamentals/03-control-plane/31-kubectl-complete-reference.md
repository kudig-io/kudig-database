...
> 完整深度指南请参考 → [[domain-01-cluster-fundamentals/kubectl/03-kubectl-debug-ephemeral-containers|kubectl debug 深度指南]]（ephemeral 容器注入、节点调试、Pod 复制调试、Profile 调试及生产故障排查工作流）
