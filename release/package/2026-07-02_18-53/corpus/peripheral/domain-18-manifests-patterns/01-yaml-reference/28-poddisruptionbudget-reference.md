...
intent_queries:
- 28-poddisruptionbudget-reference的完整参考
- 28-poddisruptionbudget-reference的所有命令/字段
- 28-poddisruptionbudget-reference速查手册
trigger_keywords:
- PodDisruptionBudget
- YAML
- 配置参考
...
- **Involuntary Disruption (非主动中断)**: 不可控的问题
  - 硬件问题
  - 内核崩溃
  - 网络分区
  - OOM Kill
...
<!-- chunk: unhealthyPodEvictionPolicy -->## unhealthyPodEvictionPolicy
