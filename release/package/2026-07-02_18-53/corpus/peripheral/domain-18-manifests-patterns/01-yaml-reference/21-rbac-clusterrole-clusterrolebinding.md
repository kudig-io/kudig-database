...
intent_queries:
- ClusterRole / ClusterRoleBinding YAML 配置参考 是什么
- 如何 ClusterRole / ClusterRoleBinding YAML 配置参考
...
<!-- chunk: 3. 内建 ClusterRole -->## 3. 内建 ClusterRole
...
- 03 - Pod 完整规格说明书
- replicaset.md|04 - Deployment / ReplicaSet YAML 配置参考]]
