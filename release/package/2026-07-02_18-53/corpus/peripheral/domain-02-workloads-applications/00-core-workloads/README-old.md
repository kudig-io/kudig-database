...
| 08 | [[domain-17-system-foundation/知识字典/workloads/replicationcontroller.md|ReplicationController]]](./08-replicationcontroller.md) | 传统副本控制器、迁移指南 | ⭐⭐⭐ |
...
- **[Domain-3: 控制平面](../domain-01-cluster-fundamentals)** - 调度器配置
- **[Domain-5: 网络](../domain-03-networking-traffic)** - 服务网络配置
