...
> 
> **整理原则**：按照 CNCF 云原生技术栈、SRE 运维成熟度模型、平台工程（Platform Engineering）的行业最佳实践进行领域划分，便于检索、学习与持续演进。
...
**涵盖内容**：
- Kubernetes 核心组件（API Server、Scheduler、Controller Manager、Kubelet、etcd 等）
