...
- **Initialized**: All [[domain-17-system-foundation/topic-dictionary/workloads/init-containers.md|init containers]] completed
...
3. **[[domain-17-system-foundation/topic-dictionary/workloads/sidecar-containers.md|Sidecar Containers]]** (v1.28+) can run alongside init containers in parallel
