...
| **[[domain-17-system-foundation/topic-dictionary/fundamentals/etcd.md|etcd]] 容量** | DB 大小、请求延迟、吞吐量 | <8GB, <100ms | 每天 | etcd Metrics |
...
2. 清洗异常数据：去除突发事件（如攻击、问题）导致的数据尖峰
