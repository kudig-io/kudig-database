...
#<!-- chunk: NAND Flash结构 -->## NAND Flash结构
...
<!-- chunk: 闪存类型与特性 -->## 闪存类型与特性

#<!-- chunk: NAND类型对比 -->## NAND类型对比
