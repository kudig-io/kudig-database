...
<!-- chunk: PCIe总线架构 -->## PCIe总线架构

#<!-- chunk: PCIe代际演进 -->## PCIe代际演进
...
<!-- chunk: 服务器管理架构 -->## 服务器管理架构

#<!-- chunk: BMC与IPMI -->## BMC与IPMI
...
#<!-- chunk: Redfish API示例 -->## Redfish API示例
