...
title: [[entities/network-service-mesh.md|Network Service Mesh (NSM)]]
description: '## 项目概述'
...
- **与 [[entities/cni.md|cni]] 无关**: 可与任何 CNI 插件共存，不替换现有网络
...
| **协议支持** | 任意 L2/L3 协议 | HTTP/[[entities/grpc.md|grpc]]/TCP |
