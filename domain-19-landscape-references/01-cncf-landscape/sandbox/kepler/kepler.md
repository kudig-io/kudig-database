---
title: Kepler
description: 'description: ''| **适用场景** | Kubernetes 能耗监控 |'''
category: general
tags:
- cncf
- ecosystem
...
Kepler (Kubernetes-based Efficient Power Level Ex[[domain-19-landscape-references/sandbox/porter/porter.md|porter]]) 使用 eBPF 探测器采集系统计数器，结合机器学习模型估算 Kubernetes Pod 和节点级别的能耗。它将能耗数据导出为 Prometheus 指标，帮助组织了解工作负载的碳足迹，支持可持续计算和绿色IT决策。
