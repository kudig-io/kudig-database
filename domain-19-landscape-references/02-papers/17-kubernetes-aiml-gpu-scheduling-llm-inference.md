...
cross_refs:
- type: fta
  path: ../domain-10-troubleshooting-diagnostics/topic-fta/list/[[skills/gpu-fta.md|gpu-fta]].md
  label: '故障树: gpu'
---
...
#<!-- chunk: 2.3 Dynamic Resource Allocation (DRA) -->## 2.3 Dynamic Resource Allocation (DRA)
