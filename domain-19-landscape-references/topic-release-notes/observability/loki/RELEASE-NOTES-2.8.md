---
title: loki v2.8 Release Notes
description: loki v2.8 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- loki v2.8 Release Notes 是什么
- 如何 loki v2.8 Release Notes
trigger_keywords:
- loki
- v2.8
- Release
...
# loki v2.8 Release Notes

Source: [v2.8.11](https://github.com/grafana/loki/releases/tag/v2.8.11)
