...
* Coming along hand in hand with storing logs for longer durations is the ability to [delete log streams](https://grafana.com/docs/loki/v2.3.0/operations/storage/logs-deletion/). The initial implementation lets you submit delete request jobs which will be processed after 24 hours.
...
* Extending on the work of Alerting Rules, Loki now accepts [recording rules](https://grafana.com/docs/loki/v2.3.0/rules/#recording-rules). This lets you turn your logs into metrics and push them to Prometheus or any Prometheus compatible remote_write endpoint.
