---
title: envoy v1.37 Release Notes
description: envoy v1.37 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- envoy v1.37 Release Notes 是什么
- 如何 envoy v1.37 Release Notes
trigger_keywords:
- envoy
- v1.37
- Release
...
# envoy v1.37 Release Notes

Source: [v1.37.1](https://github.com/envoyproxy/envoy/releases/tag/v1.37.1)
