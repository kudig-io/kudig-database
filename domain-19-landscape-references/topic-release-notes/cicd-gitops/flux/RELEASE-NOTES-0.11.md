...
- PR #1156 - @Legion2 - Fix CRD deletion instruction in Helm Operator migration docs
...
- PR #1122 - @stefanprodan - Add AWS IAM role binding example to SOPS guide
