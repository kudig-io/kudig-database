...
- [release-3.11] fix golang.org/x/net and github.com/containerd/containerd vulns (#2711) [#2711](https://github.com/open-policy-agent/gatekeeper/pull/2711) ([Sertaç Özercan](https://github.com/open-policy-agent/gatekeeper/commit/5ab9a969fba77a308914c79cd958e8ac039d2ec5))
