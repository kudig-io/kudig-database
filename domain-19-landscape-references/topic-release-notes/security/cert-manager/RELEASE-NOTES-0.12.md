---
title: cert-manager v0.12 Release Notes
description: cert-manager v0.12 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- cert-manager v0.12 Release Notes 是什么
- 如何 cert-manager v0.12 Release Notes
trigger_keywords:
- cert-manager
- v0.12
- Release
...
# cert-manager v0.12 Release Notes

Source: [v0.12.0](https://github.com/cert-manager/cert-manager/releases/tag/v0.12.0)
