...
summary: opentelemetry-collector v0.103 Release Notes — Kubernetes 生产运维知识库
...
- `configgrpc`: Revert the zstd compression for [[gRPC|gRPC]] to the third-party library we were using previously. (#10394)
