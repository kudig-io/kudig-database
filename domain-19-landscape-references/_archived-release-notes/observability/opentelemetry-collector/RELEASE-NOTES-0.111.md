---
title: opentelemetry-collector v0.111 Release Notes
description: opentelemetry-collector v0.111 Release Notes — Kubernetes 生产运维知识库
summary: opentelemetry-collector v0.111 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- opentelemetry-collector v0.111 Release Notes 是什么
- 如何 opentelemetry-collector v0.111 Release Notes
trigger_keywords:
...
- `[[Service|service]]/telemetry`: Change default metrics address to "localhost:8888" instead of ":8888" (#11251)
