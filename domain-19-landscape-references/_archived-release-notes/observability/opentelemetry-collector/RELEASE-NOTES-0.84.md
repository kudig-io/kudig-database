...
summary: opentelemetry-collector v0.84 Release Notes — Kubernetes 生产运维知识库
...
- `configgrpc`: Allow any registered [[gRPC|gRPC]] load balancer name to be used. (#8262)
- `[[Service|service]]`: add OTLP export for internal traces (#8106)
