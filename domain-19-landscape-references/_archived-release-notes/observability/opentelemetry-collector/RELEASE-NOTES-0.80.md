...
summary: opentelemetry-collector v0.80 Release Notes — Kubernetes 生产运维知识库
...
- `[[Service|service]]`: Deprecate service.PipelineConfig in favor of pipelines.Config. (#7854)
