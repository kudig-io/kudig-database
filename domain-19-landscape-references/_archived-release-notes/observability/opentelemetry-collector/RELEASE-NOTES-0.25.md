...
summary: opentelemetry-collector v0.25 Release Notes — Kubernetes 生产运维知识库
...
- `kafka` exporter: Key [[Jaeger|jaeger]] messages on traceid (#2855)
...
- `[[Prometheus|prometheus]]` exporter: Allows Summary metrics to be exported to Prometheus (#2900)
