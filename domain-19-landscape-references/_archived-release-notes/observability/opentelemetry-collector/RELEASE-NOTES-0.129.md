...
summary: opentelemetry-collector v0.129 Release Notes — Kubernetes 生产运维知识库
...
- `[[Service|service]]`: Support setting `sampler` and `limits` under `service::telemetry::traces` (#13201)
