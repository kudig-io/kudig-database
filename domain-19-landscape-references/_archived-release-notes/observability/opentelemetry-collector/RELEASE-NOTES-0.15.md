---
title: opentelemetry-collector v0.15 Release Notes
description: opentelemetry-collector v0.15 Release Notes — Kubernetes 生产运维知识库
summary: opentelemetry-collector v0.15 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- opentelemetry-collector v0.15 Release Notes 是什么
- 如何 opentelemetry-collector v0.15 Release Notes
trigger_keywords:
...
- Implement conversion between OpenCensus and [[OpenTelemetry|OpenTelemetry]] Summary Metric (#2048)
- Add ability to generate non nullable messages (#2005)
- Implement Summary Metric in [[Prometheus|Prometheus]] RemoteWrite Exporter (#2083)
...
- Allow for more logging options to be passed to `[[Service|service]]` (#2132)
