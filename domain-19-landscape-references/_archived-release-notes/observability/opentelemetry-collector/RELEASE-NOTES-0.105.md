...
summary: opentelemetry-collector v0.105 Release Notes — Kubernetes 生产运维知识库
...
- `[[Service|service]]`: add `service.disableOpenCensusBridge` feature gate which is enabled by default to remove the dependency on OpenCensus (#10414)
