---
title: opentelemetry-collector v0.39 Release Notes
description: opentelemetry-collector v0.39 Release Notes — Kubernetes 生产运维知识库
summary: opentelemetry-collector v0.39 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- opentelemetry-collector v0.39 Release Notes 是什么
- 如何 opentelemetry-collector v0.39 Release Notes
trigger_keywords:
...
- Move `[[Service|service]]/parserprovider` package to `config/configmapprovider` (#4206)
...
- Moved the [[OpenTelemetry|OpenTelemetry]] Collector Builder to core (#4307)
