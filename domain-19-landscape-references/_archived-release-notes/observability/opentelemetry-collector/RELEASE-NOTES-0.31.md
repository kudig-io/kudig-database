...
summary: opentelemetry-collector v0.31 Release Notes — Kubernetes 生产运维知识库
...
- Update to OTLP 0.8.0:
  ...
  - `[[Prometheus|prometheus]]` receiver: Convert to new Number metrics (#3716)
...
- Handle errors when reloading the collector [[Service|service]] (#3615)
