...
summary: opentelemetry-collector v0.128 Release Notes — Kubernetes 生产运维知识库
...
- `[[Service|service]]/telemetry`: Mark "telemetry.disableAddressFieldForInternalTelemetry" as stable (#13152)
