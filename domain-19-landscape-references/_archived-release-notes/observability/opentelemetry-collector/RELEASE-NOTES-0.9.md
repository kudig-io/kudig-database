---
title: opentelemetry-collector v0.9 Release Notes
description: opentelemetry-collector v0.9 Release Notes — Kubernetes 生产运维知识库
summary: opentelemetry-collector v0.9 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- opentelemetry-collector v0.9 Release Notes 是什么
- 如何 opentelemetry-collector v0.9 Release Notes
trigger_keywords:
...
# 🚀 New components 🚀
- `prometheusremotewrite` exporter (WIP): Send metrics data in [[Prometheus|Prometheus]] TimeSeries format to [[Cortex|Cortex]] or any Prometheus (#1544)
