---
title: opentelemetry-collector v0.107 Release Notes
description: opentelemetry-collector v0.107 Release Notes — Kubernetes 生产运维知识库
summary: opentelemetry-collector v0.107 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- opentelemetry-collector v0.107 Release Notes 是什么
- 如何 opentelemetry-collector v0.107 Release Notes
trigger_keywords:
...
- `[[Service|service]]`: Remove OpenCensus bridge completely, mark feature gate as stable. (#10414)
...
- `service`: Remove `otelcol` from [[Prometheus|Prometheus]] configuration. This means that any metric that isn't explicitly prefixed with `otelcol_` no longer have that prefix. (#9759)
