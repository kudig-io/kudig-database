...
summary: opentelemetry-collector v0.28 Release Notes — Kubernetes 生产运维知识库
...
- Change "[[gRPC|grpc]]" to "GRPC" in configauth function/type names (#3285)
...
- Use dedicated `zapcore.Core` for Windows [[Service|service]] (#3147)
