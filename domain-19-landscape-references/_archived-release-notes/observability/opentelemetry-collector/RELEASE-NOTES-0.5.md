...
summary: opentelemetry-collector v0.5 Release Notes — Kubernetes 生产运维知识库
...
# 🎉 [[OpenTelemetry|OpenTelemetry]] Collector v0.5.0 (Beta) 🎉
...
- Enable Collector to be run as a Windows [[Service|service]] (#1120)
- Add config for HttpServer (#1196)
- Allow cors in HTTPServerSettings (#1211)
- Add a generic [[gRPC|grpc]] server settings config, cleanup client config (#1183)
...
- Handle overlapping metrics from different [[Jobs|jobs]] in [[Prometheus|prometheus]] exporter (#1096)
