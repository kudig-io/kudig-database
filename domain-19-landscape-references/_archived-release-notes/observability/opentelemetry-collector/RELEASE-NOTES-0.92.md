...
summary: opentelemetry-collector v0.92 Release Notes — Kubernetes 生产运维知识库
...
- `[[Service|service]]`: Enable `telemetry.useOtelForInternalMetrics` by updating the flag to beta (#7454)
