---
title: opentelemetry-collector v0.24 Release Notes
description: opentelemetry-collector v0.24 Release Notes — Kubernetes 生产运维知识库
summary: opentelemetry-collector v0.24 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- opentelemetry-collector v0.24 Release Notes 是什么
- 如何 opentelemetry-collector v0.24 Release Notes
trigger_keywords:
...
- `[[Jaeger|jaeger]]` receiver: Escape user input used in output (#2815)
- `[[Prometheus|prometheus]]` exporter: Ensure same time is used for updated time (#2745)
