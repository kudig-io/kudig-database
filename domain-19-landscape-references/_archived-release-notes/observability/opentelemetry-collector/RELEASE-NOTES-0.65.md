...
summary: opentelemetry-collector v0.65 Release Notes — Kubernetes 生产运维知识库
...
- `[[Service|service]]/telemetry`: Remove unit suffixes from metrics exported by the otel-go [[Prometheus|prometheus]] exporter. (#6403)
...
- `batchprocessor`: instrument the `batch` processor with [[OpenTelemetry|OpenTelemetry]] Go SDK (#6423)
