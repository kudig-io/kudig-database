...
summary: prometheus v0.16 Release Notes — Kubernetes 生产运维知识库
...
# [[Prometheus|prometheus]] v0.16 Release Notes
...
- [FEATURE] Create separate [[Kubernetes|Kubernetes]] targets for services and their endpoints
