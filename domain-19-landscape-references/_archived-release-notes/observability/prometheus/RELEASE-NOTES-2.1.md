...
summary: prometheus v2.1 Release Notes — Kubernetes 生产运维知识库
...
# [[Prometheus|prometheus]] v2.1 Release Notes
...
* [FEATURE] New [[Service|Service]] Discovery UI showing labels before and after relabelling.
...
* [ENHANCEMENT] [[Kubernetes|Kubernetes]] SD now includes POD UID in discovery metadata.
