...
summary: prometheus v2.43 Release Notes — Kubernetes 生产运维知识库
...
# [[Prometheus|prometheus]] v2.43 Release Notes
...
faster solution for users managing large-scale [[Deployments|deployments]] or facing performance
