---
title: prometheus v2.5 Release Notes
description: prometheus v2.5 Release Notes — Kubernetes 生产运维知识库
summary: prometheus v2.5 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- prometheus v2.5 Release Notes 是什么
- 如何 prometheus v2.5 Release Notes
trigger_keywords:
- prometheus
- v2.5
- Release
...
# [[Prometheus|prometheus]] v2.5 Release Notes
...
* [ENHANCEMENT] [[Kubernetes|Kubernetes]] SD: Add extended metrics. #4458
