---
title: thanos v0.14 Release Notes
description: thanos v0.14 Release Notes — Kubernetes 生产运维知识库
summary: thanos v0.14 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- thanos v0.14 Release Notes 是什么
- 如何 thanos v0.14 Release Notes
trigger_keywords:
- thanos
- v0.14
- Release
...
# [[Thanos|thanos]] v0.14 Release Notes

Source: [v0.14.0](https://github.com/thanos-io/thanos/releases/tag/v0.14.0)

## Highlights:

* Upgrade to [[Prometheus|Prometheus]] [@3268eac2ddda](https://github.com/prometheus/prometheus/commit/3268eac2ddda) which is after v2.18.1.
