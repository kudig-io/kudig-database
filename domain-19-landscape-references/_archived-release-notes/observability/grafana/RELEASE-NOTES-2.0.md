---
title: grafana v2.0 Release Notes
description: grafana v2.0 Release Notes — Kubernetes 生产运维知识库
summary: grafana v2.0 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- grafana v2.0 Release Notes 是什么
- 如何 grafana v2.0 Release Notes
trigger_keywords:
- grafana
- v2.0
- Release
...
# grafana v2.0 Release Notes

Source: [v2.0.2](https://github.com/grafana/grafana/releases/tag/v2.0.2)
...
- [Whats New In Grafana 2.0](http://docs.grafana.org/guides/whats-new-in-v2/) 
- [Demo site](http://play.grafana.org)
