---
title: coredns v1.13 Release Notes
description: coredns v1.13 Release Notes — Kubernetes 生产运维知识库
summary: coredns v1.13 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- coredns v1.13 Release Notes 是什么
- 如何 coredns v1.13 Release Notes
trigger_keywords:
- coredns
- v1.13
- Release
...
# [[CoreDNS|coredns]] v1.13 Release Notes

Source: [v1.13.2](https://github.com/coredns/coredns/releases/tag/v1.13.2)
...
and fix issues in secondary, nomad, and [[Kubernetes|kubernetes]]. Cache and file plugins also receive
