---
title: coredns v1.9 Release Notes
description: coredns v1.9 Release Notes — Kubernetes 生产运维知识库
summary: coredns v1.9 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- coredns v1.9 Release Notes 是什么
- 如何 coredns v1.9 Release Notes
trigger_keywords:
- coredns
- v1.9
- Release
...
# [[CoreDNS|coredns]] v1.9 Release Notes

Source: [v1.9.4](https://github.com/coredns/coredns/releases/tag/v1.9.4)
...
* plugin/kubernetes: make [[Kubernetes|kubernetes]] client log in CoreDNS format (https://github.com/coredns/coredns/pull/5461)
