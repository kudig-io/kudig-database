...
intent_queries:
- kind v0.20 Release Notes 是什么
- 如何 kind v0.20 Release Notes
trigger_keywords:
- kind
- v0.20
- Release
...
- The default node image is a [[Kubernetes|Kubernetes]] `v1.27.3` image: `kindest/node:v1.27.3@sha256:3966ac761ae0136263ffdb6cfd4db23ef8a83cba8a463690e98317add2c9ba72`

### [[containerd|Containerd]] CRI mirror config deprecation PSA
