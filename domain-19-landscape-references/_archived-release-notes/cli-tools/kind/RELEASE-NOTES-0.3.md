---
title: kind v0.3 Release Notes
description: kind v0.3 Release Notes — Kubernetes 生产运维知识库
summary: kind v0.3 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- kind v0.3 Release Notes 是什么
- 如何 kind v0.3 Release Notes
trigger_keywords:
- kind
- v0.3
- Release
...
- Default clusters will now be [[Kubernetes|Kubernetes]] `v1.14.2`, the default node image is 
