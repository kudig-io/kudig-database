---
title: kind v0.7 Release Notes
description: kind v0.7 Release Notes — Kubernetes 生产运维知识库
summary: kind v0.7 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- kind v0.7 Release Notes 是什么
- 如何 kind v0.7 Release Notes
trigger_keywords:
- kind
- v0.7
- Release
...
`v0.7.0` notably brings greatly improved support for dynamic PersistentVolumes by way of [rancher.io/localhost-path] integration for clusters with [[Kubernetes|Kubernetes]] v1.12.X or greater.
