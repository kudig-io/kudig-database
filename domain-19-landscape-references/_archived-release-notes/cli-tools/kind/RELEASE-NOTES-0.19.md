---
title: kind v0.19 Release Notes
description: kind v0.19 Release Notes — Kubernetes 生产运维知识库
summary: kind v0.19 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- kind v0.19 Release Notes 是什么
- 如何 kind v0.19 Release Notes
trigger_keywords:
- kind
- v0.19
- Release
...
- The default node image is a [[Kubernetes|Kubernetes]] `v1.27.1` image: `kindest/node:v1.27.1@sha256:b7d12ed662b873bd8510879c1846e87c7e676a79fefc93e17b2a52989d3ff42b`
...
- Smaller node image [[containerd|containerd]] binaries with unusable snapshotters compiled out
