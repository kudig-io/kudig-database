...
summary: kops v1.30 Release Notes — Kubernetes 生产运维知识库
...
* Automated cherry pick of #17177: Use the same port for hubble-metrics that is used by [[Cilium|cilium]] by @rifelpet in https://github.com/kubernetes/kops/pull/17199
