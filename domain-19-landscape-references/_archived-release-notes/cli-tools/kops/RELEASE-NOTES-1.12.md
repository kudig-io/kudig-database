...
summary: kops v1.12 Release Notes — Kubernetes 生产运维知识库
...
kops 1.12 supports the [[Kubernetes|kubernetes]] 1.12.x series (and earlier)
...
* Upgrades etcd-manager to 3.0.20190801 - better handles "unexpected" [[etcd|etcd]] versions
