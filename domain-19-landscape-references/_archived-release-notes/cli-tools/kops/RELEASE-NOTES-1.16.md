---
title: kops v1.16 Release Notes
description: kops v1.16 Release Notes — Kubernetes 生产运维知识库
summary: kops v1.16 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- kops v1.16 Release Notes 是什么
- 如何 kops v1.16 Release Notes
trigger_keywords:
- kops
- v1.16
- Release
...
kops 1.16.4 is a patch release in the kops 1.16 series, supporting [[Kubernetes|kubernetes]] version 1.16.x and earlier.
