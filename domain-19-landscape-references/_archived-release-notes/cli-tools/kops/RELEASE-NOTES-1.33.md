---
title: kops v1.33 Release Notes
description: kops v1.33 Release Notes — Kubernetes 生产运维知识库
summary: kops v1.33 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- kops v1.33 Release Notes 是什么
- 如何 kops v1.33 Release Notes
trigger_keywords:
- kops
- v1.33
- Release
...
* Automated cherry pick of #17792: aws: Disable the [[kubelet|kubelet]] systemd unit during warm pool warming by @dezmodue in https://github.com/kubernetes/kops/pull/17802
* Automated cherry pick of #17793: gcp: Update ccm to fix broken arm64 [[Jobs|jobs]] by @upodroid in https://github.com/kubernetes/kops/pull/17814
