...
summary: minikube v1.33 Release Notes — Kubernetes 生产运维知识库
...
* CNI [[Cilium|cilium]]: Fix cilium [[Pods|pods]] failing to start-up [#18846](https://github.com/kubernetes/minikube/pull/18846)
* Addon [[Ingress|ingress]]: Fix enable failing on arm64 machines using VM driver [#18779](https://github.com/kubernetes/minikube/pull/18779)
* Addon [[Kubeflow|kubeflow]]: Fix some components missing arm64 images [#18765](https://github.com/kubernetes/minikube/pull/18765)
