---
title: minikube v1.34 Release Notes
description: minikube v1.34 Release Notes — Kubernetes 生产运维知识库
summary: minikube v1.34 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- minikube v1.34 Release Notes 是什么
- 如何 minikube v1.34 Release Notes
trigger_keywords:
- minikube
- v1.34
- Release
...
Features:
* Bump default [[Kubernetes|Kubernetes]] version to v1.31.0 [#19435](https://github.com/kubernetes/minikube/pull/19435)
...
* Add new [[Volcano|volcano]] addon [#18602](https://github.com/kubernetes/minikube/pull/18602)
