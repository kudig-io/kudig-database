---
title: minikube v1.12 Release Notes
description: minikube v1.12 Release Notes — Kubernetes 生产运维知识库
summary: minikube v1.12 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- minikube v1.12 Release Notes 是什么
- 如何 minikube v1.12 Release Notes
trigger_keywords:
- minikube
- v1.12
- Release
...
* Add warning for [[Ingress|ingress]] addon enabled with driver of none [#8870](https://github.com/kubernetes/minikube/pull/8870)
