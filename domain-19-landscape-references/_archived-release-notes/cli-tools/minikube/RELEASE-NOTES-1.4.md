---
title: minikube v1.4 Release Notes
description: minikube v1.4 Release Notes — Kubernetes 生产运维知识库
summary: minikube v1.4 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- minikube v1.4 Release Notes 是什么
- 如何 minikube v1.4 Release Notes
trigger_keywords:
- minikube
- v1.4
- Release
...
* Update default [[Kubernetes|Kubernetes]] version to v1.16.0 [#5395](https://github.com/kubernetes/minikube/pull/5395)
...
* Include port names in the 'minikube [[Service|service]]' cmd's output [#5290](https://github.com/kubernetes/minikube/pull/5290)
