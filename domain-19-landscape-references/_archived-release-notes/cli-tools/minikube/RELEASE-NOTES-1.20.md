---
title: minikube v1.20 Release Notes
description: minikube v1.20 Release Notes — Kubernetes 生产运维知识库
summary: minikube v1.20 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- minikube v1.20 Release Notes 是什么
- 如何 minikube v1.20 Release Notes
trigger_keywords:
- minikube
- v1.20
- Release
...
* warn about performance for certain versions of [[Kubernetes|kubernetes]] [#11217](https://github.com/kubernetes/minikube/pull/11217)
