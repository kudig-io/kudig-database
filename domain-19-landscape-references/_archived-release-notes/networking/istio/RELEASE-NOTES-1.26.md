---
title: cri-o v1.26 Release Notes
description: cri-o v1.26 Release Notes — Kubernetes 生产运维知识库
summary: cri-o v1.26 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- cri-o v1.26 Release Notes 是什么
- 如何 cri-o v1.26 Release Notes
trigger_keywords:
- cri-o
- v1.26
- Release
...
# cri-o v1.26 Release Notes

Source: [v1.26.4](https://github.com/cri-o/cri-o/releases/tag/v1.26.4)
...
#### Feature
 - Add support for `io.[[Kubernetes|kubernetes]].cri-o.LinkLogs` annotation, which allows a pod's logs to be mounted into a specified empty-dir for inspection by a log aggregator (#7045, @haircommander)
