...
summary: cilium v0.9 Release Notes — Kubernetes 生产运维知识库
...
# [[Cilium|cilium]] v0.9 Release Notes
...
- Core
  ...
  - [[Fluentd|Fluentd]] logging integration (#758)
  - IPv6 proxy redirection support (#818)
  - Transparent [[Ingress|ingress]] proxy redirection (#773)
