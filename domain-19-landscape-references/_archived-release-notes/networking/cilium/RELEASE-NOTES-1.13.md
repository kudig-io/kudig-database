---
title: cilium v1.13 Release Notes
description: cilium v1.13 Release Notes — Kubernetes 生产运维知识库
summary: cilium v1.13 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- cilium v1.13 Release Notes 是什么
- 如何 cilium v1.13 Release Notes
trigger_keywords:
- cilium
- v1.13
- Release
...
# [[Cilium|cilium]] v1.13 Release Notes
...
**Bugfixes:**
* [[Envoy|envoy]]: Avoid short circuit backend filtering (Backport PR #33535, Upstream PR #33403, @sayboras)
* Fix [[Service|service]] connection to terminating backend, when the service has no more backends available. (Backport PR #33276, Upstream PR #31840, @julianwiedmann)
