---
title: cilium v0.10 Release Notes
description: cilium v0.10 Release Notes — Kubernetes 生产运维知识库
summary: cilium v0.10 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- cilium v0.10 Release Notes 是什么
- 如何 cilium v0.10 Release Notes
trigger_keywords:
- cilium
- v0.10
- Release
...
# [[Cilium|cilium]] v0.10 Release Notes

Source: [0.10.1](https://github.com/cilium/cilium/releases/tag/0.10.1)

Bug Fixes
---------
* Fixed an issue where [[Service|service]] IDs were leaked in [[etcd|etcd]]/consul. Services have
...
* Fixed [[Kubernetes|Kubernetes]] CI test to use locally built container image (#1188)
