...
summary: cilium v1.10 Release Notes — Kubernetes 生产运维知识库
...
# [[Cilium|cilium]] v1.10 Release Notes

Source: [v1.10.20](https://github.com/cilium/cilium/releases/tag/v1.10.20)

The Cilium core team is pleased to announce v1.10.20. These releases include a range of bugfixes and updates [[Envoy|Envoy]] to v1.22.7 to pull in an updated BoringSSL library dependency to address CVE-2023-0286.
