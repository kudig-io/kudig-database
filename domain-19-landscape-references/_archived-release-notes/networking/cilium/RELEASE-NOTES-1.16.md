...
intent_queries:
- cilium v1.16 Release Notes 是什么
- 如何 cilium v1.16 Release Notes
trigger_keywords:
- cilium
- v1.16
- Release
...
Source: [v1.16.19](https://github.com/cilium/cilium/releases/tag/v1.16.19)

Summary of Changes
------------------

**Major Changes:**
* Publish [[Helm|Helm]] charts to OCI registries (Backport PR cilium/cilium#43688, Upstream PR cilium/cilium#43624, @aanm)
...
* chore(deps): update quay.io/cilium/cilium-[[Envoy|envoy]] docker tag to v1.34.12-1767177245-7935d4d711cb6f8020385a50c996b90896e16a71 (v1.16) (cilium/cilium#43549, @cilium-renovate[bot])
