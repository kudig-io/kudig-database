---
title: cilium v1.18 Release Notes
description: cilium v1.18 Release Notes — Kubernetes 生产运维知识库
summary: cilium v1.18 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- cilium v1.18 Release Notes 是什么
- 如何 cilium v1.18 Release Notes
trigger_keywords:
- cilium
- v1.18
- Release
...
# [[Cilium|cilium]] v1.18 Release Notes

Source: [v1.18.8](https://github.com/cilium/cilium/releases/tag/v1.18.8)
...
* Fix a bug where removed addresses from [[EndpointSlices|EndpointSlices]] might be missed if multiple EndpointSlices share the same name (Backport PR cilium/cilium#44021, Upstream PR cilium/cilium#43999, @EmilyShepherd)
* Fix [[Envoy|envoy]] admin socket being created as world-accessible (Backport PR cilium/cilium#44592, Upstream PR cilium/cilium#44512, @0xch4z)
