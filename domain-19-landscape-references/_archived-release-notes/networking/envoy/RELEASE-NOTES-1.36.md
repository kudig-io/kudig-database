...
intent_queries:
- minikube v1.36 Release Notes 是什么
- 如何 minikube v1.36 Release Notes
trigger_keywords:
- minikube
- v1.36
- Release
...
Features
* Support [[Kubernetes|Kubernetes]] version v1.33.1 [#20784](https://github.com/kubernetes/minikube/pull/20784)
...
* fix waiting for all [[Pods|pods]] having specified labels to be Ready [#20315](https://github.com/kubernetes/minikube/pull/20315)
...
* Revert "fix --wait's failure to work on [[CoreDNS|coredns]] pods" [#20313](https://github.com/kubernetes/minikube/pull/20313)
...
* Addon [[Headlamp|headlamp]]: Update headlamp-k8s/headlamp image from v0.26.0 to v0.28.0 [#20311](https://github.com/kubernetes/minikube/pull/20311)
