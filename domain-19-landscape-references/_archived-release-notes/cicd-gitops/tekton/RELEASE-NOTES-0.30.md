---
title: tekton v0.30 Release Notes
description: tekton v0.30 Release Notes — Kubernetes 生产运维知识库
summary: tekton v0.30 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- tekton v0.30 Release Notes 是什么
- 如何 tekton v0.30 Release Notes
trigger_keywords:
- tekton
- v0.30
- Release
...
# tekton v0.30 Release Notes

Source: [v0.30.4](https://github.com/tektoncd/pipeline/releases/tag/v0.30.4)

<!-- For major releases, add a tag line
# 🎉 [Tag Line - to be done] 🎉
-->

-[Docs @ v0.30.4](https://github.com/tektoncd/pipeline/tree/v0.30.4/docs)
-[Examples @ v0.30.4](https://github.com/tektoncd/pipeline/tree/v0.30.4/examples)
