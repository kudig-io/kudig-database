---
title: tekton v0.63 Release Notes
description: tekton v0.63 Release Notes — Kubernetes 生产运维知识库
summary: tekton v0.63 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- tekton v0.63 Release Notes 是什么
- 如何 tekton v0.63 Release Notes
trigger_keywords:
- tekton
- v0.63
- Release
...
Added the ability to set the pod-level `securityContext` for the AffinityAssistant [[StatefulSet|StatefulSet]]. 
...
TaskRun [[Pods|pods]] have tekton.dev/taskRunUID and tekton.dev/pipelineRunUID labels
...
* :hammer: Bump go.[[OpenTelemetry|opentelemetry]].io/otel/sdk from 1.27.0 to 1.28.0 (#8154)
