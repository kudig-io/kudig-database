---
title: tekton v1.7 Release Notes
description: tekton v1.7 Release Notes — Kubernetes 生产运维知识库
summary: tekton v1.7 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- tekton v1.7 Release Notes 是什么
- 如何 tekton v1.7 Release Notes
trigger_keywords:
- tekton
- v1.7
- Release
...
StopSidecars now uses Patch instead of Update to avoid conflicts with concurrent [[kubelet|kubelet]] pod status updates.
...
* :hammer: .github: add a dependabot configuration to monitor .[[ko|ko]].yaml (#9173)
