---
title: tekton v1.2 Release Notes
description: tekton v1.2 Release Notes — Kubernetes 生产运维知识库
summary: tekton v1.2 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- tekton v1.2 Release Notes 是什么
- 如何 tekton v1.2 Release Notes
trigger_keywords:
- tekton
- v1.2
- Release
...
* :bug: Do not propagate managed-by annotation to [[Pods|Pods]] (#8846)

od created by the Pipeline controller will now always have app.[[Kubernetes|kubernetes]].io/managed-by set to the default configuration. Prior to this change, it would be overriden by the value of that label set on TaskRun (or PipelineRun).
...
* :hammer: build(deps): bump go.[[OpenTelemetry|opentelemetry]].io/otel/exporters/otlp/otlptrace/otlptracehttp from 1.36.0 to 1.37.0 (#8848)
