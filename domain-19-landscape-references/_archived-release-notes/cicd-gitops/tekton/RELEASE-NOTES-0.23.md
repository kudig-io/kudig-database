...
summary: tekton v0.23 Release Notes — Kubernetes 生产运维知识库
...
Remove cluster-wide write access to [[ConfigMaps|ConfigMaps]], LimitRanges and remove all cluster-wide access to [[Deployments|Deployments]]
