...
summary: tekton v0.48 Release Notes — Kubernetes 生产运维知识库
...
* :sparkles: [TEP-0089] Add CSI volumes to the [[Pods|Pods]] which provide the SPIRE [[domain-17-system-foundation/topic-dictionary/workloads/workload-api.md|workload API]] (#6539)
