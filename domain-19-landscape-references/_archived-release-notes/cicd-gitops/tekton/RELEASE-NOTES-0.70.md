---
title: tekton v0.70 Release Notes
description: tekton v0.70 Release Notes — Kubernetes 生产运维知识库
summary: tekton v0.70 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- tekton v0.70 Release Notes 是什么
- 如何 tekton v0.70 Release Notes
trigger_keywords:
- tekton
- v0.70
- Release
...
* :book: Document `[[ko|ko]]` settings for kind clusters with and without a local registry. (#8662)
