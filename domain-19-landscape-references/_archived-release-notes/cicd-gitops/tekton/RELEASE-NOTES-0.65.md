---
title: tekton v0.65 Release Notes
description: tekton v0.65 Release Notes — Kubernetes 生产运维知识库
summary: tekton v0.65 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- tekton v0.65 Release Notes 是什么
- 如何 tekton v0.65 Release Notes
trigger_keywords:
- tekton
- v0.65
- Release
...
# tekton v0.65 Release Notes

Source: [v0.65.7](https://github.com/tektoncd/pipeline/releases/tag/v0.65.7)

<!-- For major releases, add a tag line
# 🎉 [Tag Line - to be done] 🎉
-->

-[Docs @ v0.65.7](https://github.com/tektoncd/pipeline/tree/v0.65.7/docs)
-[Examples @ v0.65.7](https://github.com/tektoncd/pipeline/tree/v0.65.7/examples)
...
* :bug: [release-v0.65.x] fix: Fix remote task params default-value substitution (#8648)
...
* :hammer: [release-v0.65.x] .github/workflows: add a build and test workflows (#8582)
