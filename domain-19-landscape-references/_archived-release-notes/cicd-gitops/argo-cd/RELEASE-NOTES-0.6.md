...
summary: argo-cd v0.6 Release Notes — Kubernetes 生产运维知识库
...
Bug fixes:
* Health check for [[StatefulSets|StatefulSets]], [[DaemonSet|DaemonSet]], and ReplicaSets were failing due to use of wrong converters