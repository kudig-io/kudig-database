---
title: argo-cd v1.0 Release Notes
description: argo-cd v1.0 Release Notes — Kubernetes 生产运维知识库
summary: argo-cd v1.0 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- argo-cd v1.0 Release Notes 是什么
- 如何 argo-cd v1.0 Release Notes
trigger_keywords:
- argo-cd
- v1.0
- Release
...
## Checking if [[Argo|Argo]] CD is storing unneccesry credentials.
