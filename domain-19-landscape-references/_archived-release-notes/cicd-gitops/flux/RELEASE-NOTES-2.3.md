---
title: flux v2.3 Release Notes
description: flux v2.3 Release Notes — Kubernetes 生产运维知识库
summary: flux v2.3 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- flux v2.3 Release Notes 是什么
- 如何 flux v2.3 Release Notes
trigger_keywords:
- flux
- v2.3
- Release
...
# [[Flux|flux]] v2.3 Release Notes

Source: [v2.3.0](https://github.com/fluxcd/flux2/releases/tag/v2.3.0)
...
This release marks the General Availability (GA) of Flux [[Helm|Helm]] features and APIs, including helm-controller, the `HelmRelease`, `HelmChart`, and `HelmRepository` APIs.
...
### [[Kubernetes|Kubernetes]] compatibility
...
- PR #4777 - @stefanprodan - Add [[k3s|k3s]] to the conformance test suite
