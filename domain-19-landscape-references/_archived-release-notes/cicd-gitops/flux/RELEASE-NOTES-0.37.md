---
title: flux v0.37 Release Notes
description: flux v0.37 Release Notes — Kubernetes 生产运维知识库
summary: flux v0.37 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- flux v0.37 Release Notes 是什么
- 如何 flux v0.37 Release Notes
trigger_keywords:
- flux
- v0.37
- Release
...
- Allow a dry-run of `flux build kustomization` with `--dry-run` and `--kustomization-file ./path/to/local/my-app.yaml`. Using these flags, variable substitutions from [[Secrets|Secrets]] and ConfigMaps are skipped, and no connection to the cluster is made.
