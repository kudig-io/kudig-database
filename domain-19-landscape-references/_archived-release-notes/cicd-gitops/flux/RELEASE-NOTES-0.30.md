...
summary: flux v0.30 Release Notes — Kubernetes 生产运维知识库
...
- PR #2701 - @stefanprodan - Grant [[Service|service]] account read-only access to controllers
