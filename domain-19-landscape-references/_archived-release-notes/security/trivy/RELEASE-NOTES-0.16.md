...
Scan your image in Podman (>=2.0) running locally. The remote Podman is not supported. Before performing Trivy commands, you must enable the podman.sock systemd [[Service|service]] on your machine. For more details, see here
...
### Add redis cache backend configuration options in the [[Helm|Helm]] chart (#784)
Trivy can be deployed to [[Kubernetes|Kubernetes]] with Redis cache.
