...
summary: trivy v0.9 Release Notes — Kubernetes 生产运维知识库
...
# [[Trivy|trivy]] v0.9 Release Notes

Source: [v0.9.2](https://github.com/aquasecurity/trivy/releases/tag/v0.9.2)

## New Features
### Support JUnit XML (#541)
You can see the result on the dashboard if your CI [[Service|service]] supports JUnit XML. This is an example of CircleCI.
...
### Include CVSS [[Score|score]] info in a result (#530)
