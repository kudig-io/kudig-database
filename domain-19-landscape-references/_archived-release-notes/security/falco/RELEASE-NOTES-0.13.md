...
summary: falco v0.13 Release Notes — Kubernetes 生产运维知识库
...
# [[Falco|falco]] v0.13 Release Notes
...
* Improved documentation for running Falco within K8s and getting K8s Audit Logging to work with Minikube and Falco as a [[DaemonSet|Daemonset]] within K8s. [[#496](https://github.com/falcosecurity/falco/pull/496)]

* Fix AWS Permissions for [[Kubernetes|Kubernetes]] Response Engine [[#465](https://github.com/falcosecurity/falco/pull/465)]
