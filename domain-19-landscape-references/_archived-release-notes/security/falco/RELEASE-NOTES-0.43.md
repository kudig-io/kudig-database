...
intent_queries:
- falco v0.43 Release Notes 是什么
- 如何 falco v0.43 Release Notes
trigger_keywords:
- falco
- v0.43
- Release
...
* docs: add deprecation notice for legacy eBPF, gVisor and [[gRPC|gRPC]] usage [[#3763](https://github.com/falcosecurity/falco/pull/3763)] - [@ekoops](https://github.com/ekoops)
