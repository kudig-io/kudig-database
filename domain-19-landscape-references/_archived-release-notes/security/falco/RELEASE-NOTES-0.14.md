...
summary: falco v0.14 Release Notes — Kubernetes 生产运维知识库
...
# [[Falco|falco]] v0.14 Release Notes
...
* Readability/clarity improvements to K8s Audit/K8s [[DaemonSet|Daemonset]] READMEs. [[#503](https://github.com/falcosecurity/falco/pull/503)]

* Add additional RBAC permissions to track [[Deployments|deployments]]/daemonsets/replicasets. [[#514](https://github.com/falcosecurity/falco/pull/514)]
