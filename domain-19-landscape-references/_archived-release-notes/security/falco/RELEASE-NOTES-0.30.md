---
title: falco v0.30 Release Notes
description: falco v0.30 Release Notes — Kubernetes 生产运维知识库
summary: falco v0.30 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- falco v0.30 Release Notes 是什么
- 如何 falco v0.30 Release Notes
trigger_keywords:
- falco
- v0.30
- Release
...
# [[Falco|falco]] v0.30 Release Notes
...
* new: add `--k8s-node` command-line options, which allows filtering by a node when requesting metadata of [[Pods|pods]] to the K8s API server [[#1671](https://github.com/falcosecurity/falco/pull/1671)] - [@leogr](https://github.com/leogr)
