...
summary: velero v1.18 Release Notes — Kubernetes 生产运维知识库
...
In v1.18, Velero allows users to configure cache volumes for data mover [[Pods|pods]] during restore for CSI snapshot data movement and fs-backup. This brings below benefits:
