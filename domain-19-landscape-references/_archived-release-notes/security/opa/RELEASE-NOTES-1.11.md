---
title: opa v1.11 Release Notes
description: opa v1.11 Release Notes — Kubernetes 生产运维知识库
summary: opa v1.11 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- opa v1.11 Release Notes 是什么
- 如何 opa v1.11 Release Notes
trigger_keywords:
- opa
- v1.11
- Release
...
There's a [[Prometheus|Prometheus]] metric for dropped events, `counter_decision_logs_dropped_buffer_size_limit_bytes_exceeded`,
