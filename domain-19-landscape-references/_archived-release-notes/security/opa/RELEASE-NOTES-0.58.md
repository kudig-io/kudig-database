---
title: opentelemetry-collector v0.58 Release Notes
description: opentelemetry-collector v0.58 Release Notes — Kubernetes 生产运维知识库
summary: opentelemetry-collector v0.58 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- opentelemetry-collector v0.58 Release Notes 是什么
- 如何 opentelemetry-collector v0.58 Release Notes
trigger_keywords:
...
- Deprecate duplicate settings in [[Service|service]].ConfigProvider, embed ResolverSettings (#5843)
