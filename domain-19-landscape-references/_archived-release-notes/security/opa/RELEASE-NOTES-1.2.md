...
summary: opa v1.2 Release Notes — Kubernetes 生产运维知识库
...
- server+distributedtracing: Add Additional Resource Attributes for [[OpenTelemetry|OpenTelemetry]] ([#7322](https://github.com/open-policy-agent/opa/issues/7322)) authored by @briankahoot reported by @briankahoot
