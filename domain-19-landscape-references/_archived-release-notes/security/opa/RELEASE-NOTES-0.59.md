...
summary: opentelemetry-collector v0.59 Release Notes — Kubernetes 生产运维知识库
...
- Remove deprecated fields/funcs from `[[Service|service]]` (#5907)
...
- Deprecate builder [[Distribution|distribution]] flags, use configuration. (#5946)
