...
summary: opa v0.11 Release Notes — Kubernetes 生产运维知识库
...
- Add [[Kubernetes|Kubernetes]] admission control debugging tips ([#1039](https://github.com/open-policy-agent/opa/issues/1039))
