...
- [v1.19.0](#v1190)
  ...
  - [What’s New (Major Themes)](#whats-new-major-themes)
    ...
    - [[domain-17-system-foundation/topic-dictionary/networking/endpointslices|EndpointSlices]] are now enabled by default](#endpointslices-are-now-enabled-by-default)
    - [[domain-17-system-foundation/topic-dictionary/networking/ingress|Ingress]] graduates to General Availability](#ingress-graduates-to-general-availability)
