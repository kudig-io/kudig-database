---
title: v1.19.16
description: v1.19.16 — Kubernetes 生产运维知识库
summary: v1.19.16 — Kubernetes 生产运维知识库
...
- [v1.19.0](#v1190)
  ...
  - [What’s New (Major Themes)](#whats-new-major-themes)
    ...
    - [[domain-17-system-foundation/topic-dictionary/networking/endpointslices.md|EndpointSlices]] are now enabled by default](#endpointslices-are-now-enabled-by-default)
    - [[domain-17-system-foundation/topic-dictionary/networking/ingress.md|Ingress]] graduates to General Availability](#ingress-graduates-to-general-availability)
