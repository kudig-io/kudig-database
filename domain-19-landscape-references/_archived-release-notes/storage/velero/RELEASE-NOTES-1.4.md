...
### All Changes
  * log a warning instead of erroring if an additional item returned from a plugin can't be found in [[domain-17-system-foundation/topic-dictionary/fundamentals/the-kubernetes-api|the Kubernetes API]]ubernetes]] API (#2595, @skriss)
