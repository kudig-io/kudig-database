---
title: velero v1.4 Release Notes
description: velero v1.4 Release Notes — Kubernetes 生产运维知识库
summary: velero v1.4 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- velero v1.4 Release Notes 是什么
- 如何 velero v1.4 Release Notes
trigger_keywords:
- velero
- v1.4
- Release
...
# velero v1.4 Release Notes

Source: [v1.4.3](https://github.com/vmware-tanzu/velero/releases/tag/v1.4.3)
...
### All Changes
  ...
  * Ensure that bound PVCs and PVs remain bound on restore. (#3007, @nrb). This fixes [CVE-2020-3996](https://github.com/vmware-tanzu/velero/security/advisories/GHSA-72xg-3mcq-52v4).
...
### All Changes
  * log a warning instead of erroring if an additional item returned from a plugin can't be found in [[domain-17-system-foundation/topic-dictionary/fundamentals/the-kubernetes-api.md|the Kubernetes API]]ubernetes]] API (#2595, @skriss)
