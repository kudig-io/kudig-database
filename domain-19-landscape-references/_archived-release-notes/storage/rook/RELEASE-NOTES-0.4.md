---
title: rook v0.4 Release Notes
description: rook v0.4 Release Notes — Kubernetes 生产运维知识库
summary: rook v0.4 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- rook v0.4 Release Notes 是什么
- 如何 rook v0.4 Release Notes
trigger_keywords:
- rook
- v0.4
- Release
...
* [[Kubernetes|Kubernetes]] 1.6 is now the minimum supported version
...
* Additional Kubernetes support and improvements to the Rook Operator and TPRs, including:
  * [Dynamic volume provisioner](https://github.com/rook/rook/blob/master/Documentation/k8s-block.md#provision-storage) that creates and deletes block storage on demand for use by [[Pods|pods]]
