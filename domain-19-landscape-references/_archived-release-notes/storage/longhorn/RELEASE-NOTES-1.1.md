---
title: longhorn v1.1 Release Notes
description: longhorn v1.1 Release Notes — Kubernetes 生产运维知识库
summary: longhorn v1.1 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- longhorn v1.1 Release Notes 是什么
- 如何 longhorn v1.1 Release Notes
trigger_keywords:
- longhorn
- v1.1
- Release
...
# [[Longhorn|longhorn]] v1.1 Release Notes
...
- [CVE-2021-36779: Host operations allowed in privileged Longhorn managed [[Pods|pods]]](https://github.com/longhorn/longhorn/issues/3419)
...
Longhorn supports 3 installation ways including Rancher catalog, Kubectl, and [[Helm|Helm]]. Follow the installation instructions [here](https://longhorn.io/docs/1.1.3/deploy/install/).
