---
title: longhorn v1.9 Release Notes
description: longhorn v1.9 Release Notes — Kubernetes 生产运维知识库
summary: longhorn v1.9 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- longhorn v1.9 Release Notes 是什么
- 如何 longhorn v1.9 Release Notes
trigger_keywords:
- longhorn
- v1.9
- Release
...
# [[Longhorn|longhorn]] v1.9 Release Notes

Source: [v1.9.2](https://github.com/longhorn/longhorn/releases/tag/v1.9.2)
...
>  [!IMPORTANT]
**Ensure that your cluster is running [[Kubernetes|Kubernetes]] v1.25 or later before installing Longhorn v1.9.2.**

You can install Longhorn using a variety of tools, including Rancher, Kubectl, and [[Helm|Helm]]. For more information about installation methods and requirements, see [Quick Installation](https://longhorn.io/docs/1.9.2/deploy/install/) in the Longhorn documentation.
