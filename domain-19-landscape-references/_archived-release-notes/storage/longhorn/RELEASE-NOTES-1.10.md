...
intent_queries:
- longhorn v1.10 Release Notes 是什么
- 如何 longhorn v1.10 Release Notes
trigger_keywords:
- longhorn
- v1.10
- Release
...
Source: [v1.10.2](https://github.com/longhorn/longhorn/releases/tag/v1.10.2)
...
>      - For [[Helm|Helm]]: Update `values.yaml`
...
Fixed a bug where temporary replicas could accumulate during engine upgrade. High [[etcd|etcd]] latency could cause new replicas to fail verification, leading to accumulation over multiple reconciliation cycles.
