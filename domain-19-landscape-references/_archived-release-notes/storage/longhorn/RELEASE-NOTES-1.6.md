...
intent_queries:
- longhorn v1.6 Release Notes 是什么
- 如何 longhorn v1.6 Release Notes
trigger_keywords:
- longhorn
- v1.6
- Release
...
Source: [v1.6.4](https://github.com/longhorn/longhorn/releases/tag/v1.6.4)
...
>  [!IMPORTANT]
**Ensure that your cluster is running [[Kubernetes|Kubernetes]] v1.21 or later before installing Longhorn v1.6.4.**

You can install Longhorn using a variety of tools, including Rancher, Kubectl, and [[Helm|Helm]]. For more information about installation methods and requirements, see [Quick Installation](https://longhorn.io/docs/1.6.4/deploy/install/) in the Longhorn documentation.
