---
title: longhorn v1.4 Release Notes
description: longhorn v1.4 Release Notes — Kubernetes 生产运维知识库
summary: longhorn v1.4 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- longhorn v1.4 Release Notes 是什么
- 如何 longhorn v1.4 Release Notes
trigger_keywords:
- longhorn
- v1.4
- Release
...
# [[Longhorn|longhorn]] v1.4 Release Notes
...
> **Please ensure your [[Kubernetes|Kubernetes]]es 集群配置最佳实践|Kubernetes cluster]] is at least v1.21 before installing v1.4.4.**

Longhorn supports three installation ways including Rancher App Marketplace, Kubectl, and [[Helm|Helm]]. Follow the installation instructions [here](https://longhorn.io/docs/1.4.4/deploy/install/).
...
### Enhancement
- [FEATURE] Add disk status [[Prometheus|prometheus]] metrics [6858](https://github.com/longhorn/longhorn/issues/6858) - @c3y1huang @chriscchien
