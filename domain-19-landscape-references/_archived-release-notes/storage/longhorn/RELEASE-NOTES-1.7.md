---
title: longhorn v1.7 Release Notes
description: longhorn v1.7 Release Notes — Kubernetes 生产运维知识库
summary: longhorn v1.7 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- longhorn v1.7 Release Notes 是什么
- 如何 longhorn v1.7 Release Notes
trigger_keywords:
- longhorn
- v1.7
- Release
...
# [[Longhorn|longhorn]] v1.7 Release Notes

Source: [v1.7.3](https://github.com/longhorn/longhorn/releases/tag/v1.7.3)
...
>  [!IMPORTANT]
**Ensure that your cluster is running [[Kubernetes|Kubernetes]] v1.21 or later before installing Longhorn v1.7.3.**

You can install Longhorn using a variety of tools, including Rancher, Kubectl, and [[Helm|Helm]]. For more information about installation methods and requirements, see [Quick Installation](https://longhorn.io/docs/1.7.3/deploy/install/) in the Longhorn documentation.
