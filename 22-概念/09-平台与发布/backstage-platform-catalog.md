...
- target: '[[17-系统基础/06-知识字典/networking/service.md]]'
  type: uses
- target: '[[23-实体/10-平台与开发工具/backstage.md]]'
  type: related_to
...
# [[23-实体/10-平台与开发工具/backstage.md|Backstage]] 与平台目录的整合
...
## 与 [[17-系统基础/05-速查卡/k8s.md|K8s]] 集成
...
- 应用模式/01-microservices/01-[[17-系统基础/06-知识字典/networking/service.md|service]]-mesh-patterns

## 相关页面

- [[22-概念/09-平台与发布/platform-engineering-sre.md|平台工程与 SRE 协作]] — Backstage 作为 IDP 核心
- [[22-概念/06-可观测性/observability-finops.md|可观测性与 FinOps]] — Cost Insights 集成
