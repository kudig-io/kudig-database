...
典型叠加：CAPI 供给一个"空"集群 → Karpenter 接管该集群内的节点弹性扩缩。即 **CAPI 决定"集群存在"，Karpenter 决定"集群内节点数"**。详见 [[10-平台工程/02-运维/17-karpenter-node-autoscaling-guide|Karpenter 节点弹性]]。
...
- [[10-平台工程/02-运维/10-multi-cluster-management|多集群管理]] — 多集群架构模式与工具对比，CAPI 与 Karmada/Rancher 的定位
- [[10-平台工程/02-运维/16-virtual-clusters|虚拟集群 vcluster]] — Namespace 内的轻量控制平面，与 CAPI 真实集群的对比与叠加
- [[10-平台工程/02-运维/17-karpenter-node-autoscaling-guide|Karpenter 节点弹性]] — 节点级弹性供给，与 CAPI 集群级供给的边界划分
...
- [[11-发布变更/01-GitOps/10-fleet-gitops-operations-guide|Fleet GitOps 运维]] — Rancher Fleet 的多集群应用分发
