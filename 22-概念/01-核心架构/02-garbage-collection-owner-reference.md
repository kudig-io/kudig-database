...
- [[01-集群基础/02-设计原则/03-declarative-api-pattern.md|声明式 API]] — 声明式 API 与面向终态设计，Finalizer 与 ownerReference 的入门概念
- [[01-集群基础/02-设计原则/13-operator-development-guide.md|Operator 开发指南]] — Operator 中 SetControllerReference 与 finalizer 的工程实践
- [[01-集群基础/02-设计原则/04-controller-pattern.md|控制器模式]] — 控制器模式与调谐循环，GC 是典型的 controller 实现
- [[01-集群基础/02-设计原则/06-informer-workqueue.md|Informer 架构与工作队列]] — GC 的 GraphBuilder 基于 Informer + workqueue 构建，原理同此
- [[01-集群基础/02-设计原则/07-resource-version-control.md|资源版本与并发控制]] — GC 乐观并发（resourceVersion precondition）的底层机制
...
- [[01-集群基础/02-设计原则/03-declarative-api-pattern.md|声明式 API]]
