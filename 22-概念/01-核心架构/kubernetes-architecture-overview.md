...
- **kube-controller-manager**: Runs 40+ built-in controllers maintaining desired state via [[22-概念/01-核心架构/controller-pattern.md|Controller Pattern]]
...
- [[22-概念/01-核心架构/declarative-api.md|declarative-api]] — Declarative API
