...
详细概念模型参见 [[22-概念/12-研究/specialized-k8s-technologies.md|specialized k8s technologies]]。
...
- [[22-概念/12-研究/specialized-k8s-technologies.md|specialized k8s technologies]] — K8s 专项技术栈的整体架构与技术选型框架
...
- [[22-概念/12-研究/container-runtime-evolution.md|container runtime evolution]] — Wasm 运行时演进（SpinKube、runwasi）是 Serverless 与边缘计算场景的关键技术支撑
- [[22-概念/12-研究/k8s-networking-evolution.md|k8s networking evolution]] — 边缘网络架构（低延迟、多集群互联）与服务网格扩展是专项技术的网络基础
- [[22-概念/05-安全/k8s-security-compliance.md|k8s security compliance]] — IoT 与边缘场景的安全挑战（设备认证、远程证明）需要定制化安全策略
- [[22-概念/12-研究/k8s-ai-ml-infrastructure.md|k8s ai ml infrastructure]] — 边缘 AI 推理（KServe 边缘模式）与 Serverless ML 函数是专项技术的重要应用场景
