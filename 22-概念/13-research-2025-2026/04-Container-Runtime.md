...
详细概念模型参见 [[22-概念/12-研究/container-runtime-evolution.md|container runtime evolution]]。
...
- [[22-概念/12-研究/container-runtime-evolution.md|container runtime evolution]] — 容器运行时从 Docker daemon 到多运行时编排的演进路径
...
- [[22-概念/05-安全/k8s-security-compliance.md|k8s security compliance]] — 安全容器运行时（gVisor、Kata、Confidential Containers）是容器安全合规的关键技术层
- [[22-概念/12-研究/specialized-k8s-technologies.md|specialized k8s technologies]] — WebAssembly 运行时（SpinKube、runwasi）拓展了 Kubernetes 在边缘与 IoT 场景的应用边界
- [[22-概念/12-研究/k8s-ai-ml-infrastructure.md|k8s ai ml infrastructure]] — GPU 直通运行时与 MIG 支持是 AI/ML 工作负载高效执行的底层保障
- [[22-概念/12-研究/k8s-networking-evolution.md|k8s networking evolution]] — 运行时与 CNI 的深度集成（eBPF、容器网络命名空间）影响网络性能与安全隔离
