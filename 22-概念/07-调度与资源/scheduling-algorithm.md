...
description: '- [[23-实体/15-参考与索引/scheduling-terms.md|scheduling-terms]] — K8s 调度术语参考'
summary: '- [[23-实体/15-参考与索引/scheduling-terms.md|scheduling-terms]] — K8s 调度术语参考'
category: concepts
tags:
- k8s
- scheduling
...
- [[23-实体/15-参考与索引/scheduling-terms.md|scheduling-terms]] — K8s 调度术语参考
- [[23-实体/15-参考与索引/k8s-workload-management.md|k8s-workload-management]] — 工作负载管理：Pod 生命周期、调度策略与弹性伸缩
