...
更多排查细节可参考 [[19-故障诊断/08-技能体系/skill-set/k8s-ingress-gateway/SKILL.md|ingress-gateway-troubleshooting]] 与技能页面 [[19-故障诊断/08-技能体系/skill-set/k8s-ingress-gateway/SKILL.md|k8s-ingress-gateway]]。
