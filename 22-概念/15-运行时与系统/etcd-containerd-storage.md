...
- [[22-概念/15-运行时与系统/kubernetes-containerd-integration.md|Kubernetes 与 containerd 集成]] — CRI 通信架构
- [[22-概念/15-运行时与系统/containerd-pod-lifecycle.md|containerd Pod 生命周期]] — 存储层与容器生命周期的关系
