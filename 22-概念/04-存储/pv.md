...
- [[22-概念/04-存储/persistent-volume-claim.md|PersistentVolumeClaim]] — PVC 声明与绑定
- [[22-概念/04-存储/storageclass.md|StorageClass]] — 存储类动态供给
- [[22-概念/01-核心架构/kubernetes.md|Kubernetes]] — 核心概念
- [[22-概念/02-工作负载/statefulset.md|StatefulSet]] — 每副本独立 PVC
- [[README]]
