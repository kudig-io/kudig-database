...
详见 [[06-存储/01-K8s存储/16-csi-migration-in-tree-to-csi.md|CSI 迁移：in-tree 到 CSI]]。
...
- [[06-存储/01-K8s存储/05-csi-drivers-integration.md|CSI 驱动集成]] — CSI 生态全景（provisioner/attacher/resizer/snapshotter sidecar 协作）
- [[06-存储/01-K8s存储/02-pv-architecture-fundamentals.md|PV 架构基础]] — PV/PVC 绑定与 finalizer 保护机制
- [[06-存储/01-K8s存储/16-csi-migration-in-tree-to-csi.md|CSI 迁移：in-tree 到 CSI]] — in-tree 卷如何通过 CSIMigration 走 CSI 路径
