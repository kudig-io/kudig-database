---
title: 存储 Concepts
summary: Kubernetes 存储概念索引——PV/PVC/CSI、VolumeAttachment 生命周期、CSIStorageCapacity 容量感知。
category: index
tags:
- index
- concepts
...
> Kubernetes 存储模型、CSI 驱动、卷生命周期与容量调度概念索引。
...
- [[22-概念/04-存储/persistent-volume-claim.md|persistent-volume-claim]]
- [[22-概念/04-存储/pv.md|pv]]
- [[22-概念/04-存储/storage-data-protection.md|storage-data-protection]]
- [[22-概念/04-存储/storage-model.md|storage-model]]
- [[22-概念/04-存储/storage-performance-optimization.md|storage-performance-optimization]]
- [[22-概念/04-存储/storageclass.md|storageclass]]

## Related

- [[22-概念/index.md|Concepts 总索引]]
- [[06-存储/01-K8s存储/index.md|K8s 存储（源文档）]]
