...
> 详见 [[22-概念/04-存储/storage-model.md|storage model]] 了解存储整体架构，[[22-概念/04-存储/pv.md|pv]] 了解 PersistentVolume，[[22-概念/04-存储/storageclass.md|storageclass]] 了解 StorageClass 动态供应。
...
- [[22-概念/04-存储/pv.md|pv]] — PersistentVolume 和 PersistentVolumeClaim
- [[22-概念/04-存储/storageclass.md|storageclass]] — StorageClass 动态供应
- [[22-概念/04-存储/storage-model.md|storage model]] — Kubernetes 存储模型总览
- [[21-生态参考/98-merged-indexes/index.md|index]] — 存储与数据领域索引

## Related

- [[22-概念/04-存储/cloud-native-storage-systems.md|cloud native storage systems]] — 云原生存储系统架构
- [[22-概念/04-存储/storage-performance-optimization.md|storage performance optimization]] — 存储性能优化策略
- [[22-概念/04-存储/storage-data-protection.md|storage data protection]] — 存储数据保护与灾备
