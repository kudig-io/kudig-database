---
title: 可靠性与运维 Concepts
summary: Kubernetes 节点运维概念索引——cordon/drain、graceful shutdown、swap、节点重启回归。
category: index
tags:
- index
- concepts
...
> 节点维护、cordon/drain、优雅关闭与运维 Runbook 概念索引。
...
- [[22-概念/08-可靠性与运维/capacity-planning-cost-optimization.md|capacity-planning-cost-optimization]]
...
- [[22-概念/08-可靠性与运维/chaos-engineering-platforms.md|chaos-engineering-platforms]]
- [[22-概念/08-可靠性与运维/cluster-upgrade-paths.md|cluster-upgrade-paths]]
- [[22-概念/08-可靠性与运维/command-risk-assessment.md|command-risk-assessment]]
...
- [[22-概念/08-可靠性与运维/finops-greenops-practices.md|finops-greenops-practices]]
...
- [[22-概念/08-可靠性与运维/incident-management-patterns.md|incident-management-patterns]]
- [[22-概念/08-可靠性与运维/k8s-mttr-benchmark.md|k8s-mttr-benchmark]]
...
- [[22-概念/08-可靠性与运维/multi-cluster-dr-automation.md|multi-cluster-dr-automation]]
- [[22-概念/08-可靠性与运维/node-lifecycle-management.md|node-lifecycle-management]]
- [[22-概念/08-可靠性与运维/slo-error-budget-framework.md|slo-error-budget-framework]]
- [[22-概念/08-可靠性与运维/velero-disaster-recovery.md|velero-disaster-recovery]]

## Related

- [[22-概念/index.md|Concepts 总索引]]
- [[01-集群基础/03-控制平面/index.md|控制平面（源文档）]]
