...
节点维护（Node Maintenance）是生产集群日常运维中最高频、风险最集中的操作之一。无论是给内核打安全补丁、更换故障内存条、迁移云实例，还是配合 [[01-集群基础/03-控制平面/35-cluster-upgrade-runbook.md|集群升级 Runbook]] 滚动升级 kubelet，核心动作都收敛到一条标准链路：
...
- [[01-集群基础/03-控制平面/33-kubelet-eviction-thresholds.md|kubelet 驱逐阈值]] — 节点压力下的 Pod 驱逐机制（与 drain 的自愿驱逐互补）
- [[01-集群基础/03-控制平面/35-cluster-upgrade-runbook.md|集群升级 Runbook]] — 升级场景下节点 drain 的滚动流程
- [[01-集群基础/03-控制平面/32-kubeadm-upgrade-complete-guide.md|kubeadm 升级完整指南]] — kubelet/kubeadm 升级中的节点维护
...
- [[01-集群基础/03-控制平面/31-kubectl-complete-reference.md|kubectl 完整参考]] — cordon/drain/uncordon 命令速查
