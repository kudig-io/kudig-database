...
- target: '[[23-实体/02-K8s核心组件/kubelet.md]]'
  type: uses
- target: '[[22-概念/05-安全/kubernetes-pki-certificate-system.md]]'
  type: uses
- target: '[[23-实体/02-K8s核心组件/deployment.md]]'
  type: uses
- target: '[[22-概念/11-交叉分析/etcd × 高可用模式.md]]'
  type: uses
status: reviewed
---
...
本文档综合梳理 kubeadm 集群运维的全生命周期知识，涵盖集群创建、高可用部署、证书管理、节点运维、工作负载管理和集群删除六大领域。知识来源为 工作负载/topic-functions/ 下的 82 篇源文档，覆盖 5 个子专题：cluster-cert、cluster-create、cluster-delete、[[23-实体/02-K8s核心组件/deployment.md|deployment]]-create、node-create。
...
- [[23-实体/02-K8s核心组件/kubelet.md|kubelet]] 证书通过 TLS Bootstrap 自动轮换
...
- [[26-技能/01-集群运维/kubeadm/kubeadm-cluster-lifecycle.md|kubeadm 集群创建生命周期]]
- [[26-技能/01-集群运维/kubeadm/kubeadm-cluster-deletion.md|kubeadm 集群删除操作]]
- [[26-技能/01-集群运维/kubeadm/kubeadm-ha-cluster-setup.md|kubeadm 高可用集群搭建]]
- [[22-概念/05-安全/kubernetes-pki-certificate-system.md|Kubernetes PKI 证书体系]]
- [[26-技能/07-安全/certificate/kubelet-certificate-rotation.md|kubelet 证书轮换机制]]
- [[22-概念/08-可靠性与运维/node-lifecycle-management.md|节点生命周期管理]]
- [[26-技能/04-工作负载/deployment/deployment-rolling-update.md|Deployment 滚动更新策略]]
- [[26-技能/04-工作负载/deployment/deployment-canary-and-bluegreen.md|金丝雀与蓝绿发布]]
- [[26-技能/04-工作负载/deployment/deployment-workload-selection.md|工作负载控制器选型]]
...
- [[22-概念/08-可靠性与运维/k8s-mttr-benchmark.md|K8s 问题分布与 MTTR 基准]]
...
- [[22-概念/05-安全/kubernetes-pki-certificate-system.md|kubernetes-pki-certificate-system]] — [[22-概念/05-安全/kubernetes-pki-certificate-system.md|Kubernetes PKI 证书体系]]
