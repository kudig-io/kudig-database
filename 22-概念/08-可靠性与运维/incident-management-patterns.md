...
3. **完成验证**：
   ...
   - 关联的 Chaos 实验验证（参见 [[22-概念/08-可靠性与运维/chaos-engineering-platforms.md|chaos engineering platforms]]）
   - 关联的 SLO 指标改善（参见 [[22-概念/08-可靠性与运维/slo-error-budget-framework.md|slo error budget framework]]）
...
- [[22-概念/08-可靠性与运维/slo-error-budget-framework.md|slo error budget framework]] — SLO 与 Error Budget 框架
- [[22-概念/08-可靠性与运维/chaos-engineering-platforms.md|chaos engineering platforms]] — 混沌工程平台
- [[22-概念/06-可观测性/k8s-observability-stack.md|k8s observability stack]] — K8S 可观测性技术栈
