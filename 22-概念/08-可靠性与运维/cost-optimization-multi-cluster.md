...
- kubectl-basics
relationships:
- target: '[[23-实体/07-可观测性/opencost.md]]'
  type: related_to
status: reviewed
---
...
| 工具 | 功能 | 适用场景 |
|------|------|----------|
| [[23-实体/07-可观测性/opencost.md|OpenCost]] | 开源成本可视化和分摊 | 自建 + 多云 |
...
- [[22-概念/06-可观测性/observability-finops.md|可观测性与 FinOps]] — 利用可观测性数据驱动成本优化
- [[22-概念/07-调度与资源/autoscaling-strategies.md|自动扩缩容策略]] — 弹性扩缩容降低计算成本
