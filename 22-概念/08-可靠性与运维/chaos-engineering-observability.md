...
- target: '[[23-实体/08-交付与制品/argo.md]]'
  type: related_to
- target: '[[23-实体/07-可观测性/jaeger.md]]'
  type: related_to
status: stable
---
...
| **Litmus Chaos** | 混沌实验平台 | CloudNative 项目，[[23-实体/08-交付与制品/argo.md|Argo Workflows]] 集成 |
| **Gremlin** | SaaS 混沌平台 | 商业方案，丰富的可观测性集成 |
| **Prometheus** | 指标存储 | 实验期间指标采集和 SLO 验证 |
| **Grafana** | 可视化 | 混沌实验 Dashboard，实时观察 |
| **[[23-实体/07-可观测性/jaeger.md|Jaeger]]** | 分布式追踪 | 追踪实验期间的请求链路 |
...
- [[23-实体/chaos-mesh.md|Chaos Mesh [entities]]]
- [[23-实体/14-可靠性与混沌/litmus.md|LitmusChaos]]
