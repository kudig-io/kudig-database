...
- [[22-概念/12-研究/ai-agent-ops-patterns.md|AI Agent 运维模式]] — 推理服务部署
- [[22-概念/06-可观测性/observability-finops.md|可观测性与 FinOps]] — GPU 成本监控
- [[22-概念/07-调度与资源/dynamic-resource-allocation.md|动态资源分配]] — GPU 资源声明
