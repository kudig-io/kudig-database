---
title: 可观测性 Concepts
summary: Kubernetes 可观测性概念索引——kube-state-metrics、cAdvisor/kubelet 指标采集、metrics pipeline。
category: index
tags:
- index
- concepts
...
> 指标采集 pipeline、容器级资源指标、对象状态指标概念索引。
...
- [[22-概念/06-可观测性/prometheus-argocd-monitoring.md|prometheus-argocd-monitoring]]
- [[22-概念/06-可观测性/slo-monitoring-integration.md|slo-monitoring-integration]]

## Related

- [[22-概念/index.md|Concepts 总索引]]
- [[09-可观测性/02-指标/index.md|指标与 Prometheus（源文档）]]
