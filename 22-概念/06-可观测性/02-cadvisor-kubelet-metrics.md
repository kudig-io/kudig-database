...
结论：**Metrics Server 服务于 HPA/VPA 的实时决策，Prometheus + cAdvisor 服务于监控与告警**。两者互补，不可互相替代。详见 [[09-可观测性/02-指标/11-kube-state-metrics-deep-dive.md|kube-state-metrics 深度解析]] 了解 KSM 如何补充对象状态维度。
...
- [[09-可观测性/02-指标/11-kube-state-metrics-deep-dive.md|kube-state-metrics 深度解析]] — 对象状态指标，与 cAdvisor 互补
...
- [[09-可观测性/02-指标/05-monitoring-metrics-prometheus.md|监控和指标表]] — 各组件关键指标速查表
