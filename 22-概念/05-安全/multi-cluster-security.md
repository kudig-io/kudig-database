...
| 层面 | 工具 | 功能 |
|------|------|------|
| 服务网格 | Istio, Linkerd, [[23-实体/04-网络/cilium.md|Cilium]] Mesh | 跨集群 mTLS、服务发现、流量管理 |
| 身份 | SPIFFE/SPIRE | 统一 Workload Identity，跨集群身份验证 |
| 策略 | OPA/Gatekeeper (联邦策略) | 安全基线统一执行、合规性验证 |
| Secrets | [[23-实体/06-安全/external-secrets.md|External Secrets]] Operator | 跨集群密钥同步和轮换 |
| 审计 | [[23-实体/06-安全/falco.md|Falco]] + SIEM | 运行时安全事件集中收集 |
...
- [[22-概念/05-安全/service-mesh-security-governance.md|服务网格安全治理]] — 单集群内的安全策略
- [[22-概念/05-安全/security-observability-correlation.md|安全与可观测性关联]] — 安全事件分析
- [[22-概念/05-安全/multi-tenancy-isolation.md|多租户隔离]] — 集群内隔离
