...
- [[06-存储/04-有状态应用存储/01-stateful-app-storage-patterns.md|01 stateful app storage patterns]]
- [[06-存储/04-有状态应用存储/02-mysql-statefulset-production.md|02 mysql statefulset production]]
- [[06-存储/04-有状态应用存储/03-postgresql-statefulset-production.md|03 postgresql statefulset production]]
- [[06-存储/04-有状态应用存储/04-kafka-statefulset-production.md|04 kafka statefulset production]]
- [[06-存储/04-有状态应用存储/05-redis-cluster-statefulset.md|05 redis cluster statefulset]]
- [[06-存储/03-分布式存储/01-velero-backup-recovery.md|01 velero backup recovery]]
