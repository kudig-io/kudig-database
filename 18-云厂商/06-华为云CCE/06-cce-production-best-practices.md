...
1. **鲲鹏 ARM 混合部署**：通过节点池 Taint + Pod nodeAffinity 实现 ARM/x86 工作负载分离，参考 [[17-系统基础/01-Linux/14-arm-architecture-k8s-optimization|ARM 架构优化]]
...
6. **参考 [[10-平台工程/03-治理/10-security-compliance|安全合规]] 完善治理**
