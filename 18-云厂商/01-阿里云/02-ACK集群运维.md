...
- target: '[[23-实体/02-K8s核心组件/kubelet.md]]'
  type: uses
- target: '[[17-系统基础/06-知识字典/security/pod-security-policies.md]]'
  type: uses
---
...
| [[23-实体/02-K8s核心组件/etcd.md|etcd]] | 客户自管 | 阿里云托管 | 专有版自管 |
...
| [[17-系统基础/06-知识字典/security/pod-security-policies.md|Pod 安全策略]] | `kubectl get psp` | 高 |
| 节点镜像预热 | 确认新节点镜像可用 | 中 |
...
| 入站 | TCP | 10250 | 节点间 | [[23-实体/02-K8s核心组件/kubelet.md|Kubelet]] |
...
- [[18-云厂商/01-阿里云/01-专有云架构概述.md|专有云架构概述]]
...
- [[23-实体/02-K8s核心组件/coredns.md|CoreDNS (entities)]]
