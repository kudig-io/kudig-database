...
| 知识轨 | 交付形态 | 子目录 | 核心话题 |
|--------|----------|--------|----------|
| **专有云 Apsara Stack** | 客户数据中心本地化部署 | [[18-云厂商/01-阿里云/专有云-Apsara/index.md\|专有云-Apsara/]] | 天基/ASO 运维、飞天底座组件、升级补丁、合规加固（等保/国密）、盘古存储、ESS/SLS/POP、故障手册 |
...
| # | 文档 | 说明 |
|---|:---|:---|
| 1 | [[18-云厂商/01-阿里云/01-专有云架构概述.md\|01 专有云架构概述]] | 阿里云专有云产品矩阵、部署模式、与公有云差异 |
| 2 | [[18-云厂商/01-阿里云/02-ACK集群运维.md\|02 ACK集群运维]] | ACK 专有版/托管版集群管理、日志监控、安全 |
| 3 | [[18-云厂商/01-阿里云/03-Terway-CNI网络.md\|03 Terway CNI网络]] | Terway 模式详解、常见问题排查、IP 管理 |
| 4 | [[18-云厂商/01-阿里云/04-阿里云存储集成.md\|04 阿里云存储集成]] | 云盘/ESSD、NAS、OSS、CSI 驱动 |
| 5 | [[18-云厂商/01-阿里云/05-阿里云SLB与Ingress.md\|05 阿里云SLB与Ingress]] | SLB/ALB/NLB、Ingress Controller、CDN/WAF |
| 6 | [[18-云厂商/01-阿里云/06-阿里云专有云远程顾问指南.md\|06 专有云远程顾问指南]] | 远程诊断方法论、受限场景替代方案、升级话术 |
