...
- target: '[[18-云厂商/01-阿里云/apsara-stack-components.md]]'
  type: related_to
- target: '[[18-云厂商/01-阿里云/06-阿里云专有云远程顾问指南.md]]'
  type: related_to
- target: '[[18-云厂商/01-阿里云/专有云-Apsara/005-apsara-tianji-aso-operations.md]]'
  type: related_to
- target: '[[18-云厂商/01-阿里云/专有云-Apsara/008-apsara-pangu-storage-troubleshooting.md]]'
  type: related_to
difficulty: advanced
audience:
- SRE
...
本手册面向在客户数据中心运维 [[18-云厂商/01-阿里云/01-专有云架构概述.md|阿里云专有云（Apsara Stack）]] 的 SRE 与远程顾问，将常见 K8s 工单现象与飞天底座组件建立双向映射，提供「**组件异常 → K8s 症状 → 排查命令 → 升级路径**」的可执行 runbook。
...
> 详细排障见 [[18-云厂商/01-阿里云/专有云-Apsara/008-apsara-pangu-storage-troubleshooting.md|256 盘古存储排障]]。
...
> 详细流程见 [[18-云厂商/01-阿里云/专有云-Apsara/005-apsara-tianji-aso-operations.md|253 天基/ASO 运维流程]]。
...
> 详细见 [[18-云厂商/01-阿里云/专有云-Apsara/003-apsara-stack-sls-logging.md|251 SLS 日志服务]]。
...
> **安全**：诊断包不含 AccessKey/SecretKey（绝不收集）；Pod 日志脱敏后再发送。详见 [[18-云厂商/01-阿里云/06-阿里云专有云远程顾问指南.md|06 远程顾问指南]]。
...
- [[18-云厂商/01-阿里云/06-阿里云专有云远程顾问指南.md|06 专有云远程顾问指南]]
...
- [[18-云厂商/01-阿里云/专有云-Apsara/008-apsara-pangu-storage-troubleshooting.md|256 盘古存储排障]]
