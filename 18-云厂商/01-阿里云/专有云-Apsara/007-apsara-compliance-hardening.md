...
本文档面向在客户数据中心运维 [[18-云厂商/01-阿里云/01-专有云架构概述.md|阿里云专有云（Apsara Stack）]] 的安全工程师与 SRE，系统梳理等保四级、商用密码（国密 SM2/SM4）合规要求下的 K8s 安全加固实战：KMS 密钥管理、审计日志对接、金融级 NetworkPolicy、最小权限 RBAC、镜像与准入安全。
...
> 审计日志投递到专有云 SLS（见 [[18-云厂商/01-阿里云/专有云-Apsara/003-apsara-stack-sls-logging.md|251 SLS 日志服务]]），并转发至客户 SIEM 做长期留存（等保要求 ≥180 天）。
...
- [[18-云厂商/01-阿里云/专有云-Apsara/003-apsara-stack-sls-logging.md|251 SLS 日志服务]]
- [[18-云厂商/01-阿里云/专有云-Apsara/004-apsara-stack-pop-operations.md|252 POP 平台运维]]
...
- [[17-系统基础/06-知识字典/security/pod-security-policies.md|Pod 安全策略]]
