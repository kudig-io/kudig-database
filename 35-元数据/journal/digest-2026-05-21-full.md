...
| etcd-fta | etcd 异常 |
| scheduler-fta | 调度器异常 |
| [[19-故障诊断/06-FTA故障树/list/controller-manager-fta.md|controller-manager-fta]] | 控制器管理器异常 |
| kubelet-fta | Kubelet 异常 |
| calico-fta | Calico CNI 问题 |
| cilium-fta | Cilium eBPF 问题 |
| dns-fta | DNS 问题 |
| [[19-故障诊断/06-FTA故障树/list/ingress-fta.md|ingress-fta]] | Ingress 问题 |
| storage-fta | 存储问题 |
| certificate-fta | 证书异常 |
| backup-restore-fta | 备份恢复异常 |
| cluster-upgrade-fta | 集群升级异常 |
| [[19-故障诊断/06-FTA故障树/list/cluster-autoscaler-fta.md|cluster-autoscaler-fta]] | 自动伸缩异常 |
| [[26-技能/01-集群运维/cloud-provider/cloud-provider-fta.md|cloud-provider-fta]] | 云平台集成异常 |
| ... | （共 44 棵） |
...
- [[22-概念/12-研究/ai-agent-README.md|ai-agent-README]] — AI Agent 工程专题
- [[22-概念/09-平台与发布/gitops-principles.md|gitops-principles]] — GitOps Principles and Practice
...
- [[23-实体/05-存储/vineyard.md|Vineyard]]
