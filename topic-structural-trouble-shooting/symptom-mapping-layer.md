...
symptom_mappings:
  ...
  - symptom: "Pod CrashLoopBackOff"
    ...
    related_docs:
      - path: "topic-structural-trouble-shooting/05-workloads/01-pod-troubleshooting.md"
        type: "structural"
        relevance: 0.95
      - path: "topic-fta/kubernetes-fta-full-analysis-v2.md#三te-2-应用服务不可用-p0"
        type: "fta"
        relevance: 0.90
      - path: "domain-12-troubleshooting/07-oom-memory-diagnosis.md"
        type: "domain"
        relevance: 0.90
  ...
  - symptom: "Pod Pending"
    ...
    related_docs:
      - path: "topic-structural-trouble-shooting/05-workloads/01-pod-troubleshooting.md"
        type: "structural"
        relevance: 0.95
      - path: "topic-fta/kubernetes-fta-full-analysis-v2.md#四te-3-pod启动失败-p1"
        type: "fta"
        relevance: 0.90
  ...
  - symptom: "Pod OOMKilled"
    ...
    related_docs:
      - path: "topic-structural-trouble-shooting/07-oom-memory-diagnosis.md"
        type: "structural"
        relevance: 0.98
      - path: "domain-12-troubleshooting/07-oom-memory-diagnosis.md"
        type: "domain"
  ...
  - symptom: "Node NotReady"
    ...
    related_docs:
      - path: "topic-structural-trouble-shooting/06-node-notready-diagnosis.md"
        type: "structural"
        relevance: 0.98
      - path: "domain-12-troubleshooting/06-node-notready-diagnosis.md"
        type: "domain"
        relevance: 0.95
  ...
  - symptom: "Service 不可用"
    ...
    related_docs:
      - path: "topic-structural-trouble-shooting/10-service-comprehensive-troubleshooting.md"
        type: "structural"
        relevance: 0.95
      - path: "topic-fta/kubernetes-fta-full-analysis-v2.md#三te-2-应用服务不可用-p0"
        type: "fta"
  ...
  - symptom: "DNS 解析失败"
    ...
    related_docs:
      - path: "topic-structural-trouble-shooting/03-networking/02-dns-troubleshooting.md"
        type: "structural"
        relevance: 0.98
      - path: "topic-fta/kubernetes-fta-full-analysis-v2.md#五te-4-网络通信异常-p1"
        type: "fta"
        relevance: 0.90
  ...
  - symptom: "PVC 挂载失败"
    ...
    related_docs:
      - path: "topic-structural-trouble-shooting/04-storage/01-pv-pvc-troubleshooting.md"
        type: "structural"
        relevance: 0.95
      - path: "topic-fta/kubernetes-fta-full-analysis-v2.md#六te-5-存储访问失败-p1"
        type: "fta"
        relevance: 0.90
  ...
  - symptom: "证书过期"
    ...
    related_docs:
      - path: "topic-structural-trouble-shooting/06-security-auth/02-certificate-troubleshooting.md"
        type: "structural"
        relevance: 0.98
      - path: "domain-12-troubleshooting/13-certificate-troubleshooting.md"
        type: "domain"
        relevance: 0.95
  ...
  - symptom: "etcd 故障"
    ...
    related_docs:
      - path: "topic-structural-trouble-shooting/01-control-plane/02-etcd-troubleshooting.md"
        type: "structural"
        relevance: 0.98
      - path: "domain-3-control-plane/02-etcd-troubleshooting.md"
        type: "domain"
        relevance: 0.95
      - path: "domain-12-troubleshooting/10-etcd-maintenance.md"
        type: "domain"
        relevance: 0.90
  ...
  - symptom: "Terway 网络故障"
    ...
    related_docs:
      - path: "topic-terway/03-usage.md"
        type: "structural"
        relevance: 0.90
      - path: "topic-fta/kubernetes-fta-full-analysis-v2.md#十te-9-terway-网络故障-p1-新增"
        type: "fta"
        relevance: 0.95
  ...
  - symptom: "ASM 服务网格故障"
    ...
    related_docs:
      - path: "topic-structural-trouble-shooting/03-networking/05-service-mesh-istio-troubleshooting.md"
        type: "structural"
        relevance: 0.95
      - path: "topic-fta/kubernetes-fta-full-analysis-v2.md#十一te-10-asm-服务网格故障-p1-新增"
        type: "fta"
        relevance: 0.95
  ...
  - symptom: "监控告警异常"
    ...
    related_docs:
      - path: "topic-structural-trouble-shooting/12-monitoring-observability/01-monitoring-observability-troubleshooting.md"
        type: "structural"
        relevance: 0.95
      - path: "topic-fta/kubernetes-fta-full-analysis-v2.md#九te-8-监控告警异常-p2"
        type: "fta"
        relevance: 0.90
  ...
  - symptom: "HPA/VPA 扩缩容异常"
    ...
    related_docs:
      - path: "topic-fta/list/hpa-fta.md"
        type: "fta"
        relevance: 0.90
      - path: "topic-fta/list/vpa-fta.md"
        type: "fta"
        relevance: 0.85
```
...
unknown_symptom_handling:
  ...
  step_4:
    ...
    escalation_template: |
      ...
      建议: 请人工排查，可参考 topic-structural-trouble-shooting/README.md
```
