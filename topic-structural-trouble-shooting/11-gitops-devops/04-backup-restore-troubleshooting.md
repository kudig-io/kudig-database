...
| 文档类型 | 路径 | 说明 |
|----------|------|------|
| FTA | `topic-fta/list/backup-restore-fta.md` | 备份恢复异常故障树 |
| Domain | `domain-3-control-plane/11-etcd-deep-dive.md` | etcd 深度解析 |
...
| Skills | `topic-skills/backup-restore-skill.md` | 备份恢复技能卡片 |
