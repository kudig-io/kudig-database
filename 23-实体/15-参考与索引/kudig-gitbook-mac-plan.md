...
description: '- [[23-实体/15-参考与索引/kudig-gitbook-system.md|kudig-gitbook-system]] — Gitbook
  本地文档浏览系统与构建指南'
summary: '- [[23-实体/15-参考与索引/kudig-gitbook-system.md|kudig-gitbook-system]] — Gitbook 本地文档浏览系统与构建指南'
category: reference
tags:
- k8s
- gitbook
