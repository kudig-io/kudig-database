...
| 组件 | 文件数 | 演进参考 |
|---|---|---|
| Argo CD | 40 | [[22-概念/12-研究/gitops-tool-evolution.md|gitops-tool-evolution]] |
...
| 组件 | 文件数 | 演进参考 |
|---|---|---|
| Istio | 38 | [[22-概念/12-研究/service-mesh-evolution.md|service-mesh-evolution]] |
...
| 组件 | 文件数 | 演进参考 |
|---|---|---|
| OPA | 86 | [[22-概念/12-研究/security-tool-evolution.md|security-tool-evolution]] |
...
| 组件 | 文件数 | 演进参考 |
|---|---|---|
| Minikube | 74 | [[22-概念/12-研究/cli-tools-evolution.md|cli-tools-evolution]] |
...
- [[23-实体/02-K8s核心组件/cni-plugins.md|cni-plugins]] — CNI Plugins
- [[cilium]] — Cilium
- [[rook]] — Rook
- [[istio]] — Istio
