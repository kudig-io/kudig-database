...
> **相关领域**: [[23-实体/15-参考与索引/k8s-storage-ecosystem.md|k8s-storage-ecosystem]]
...
> *（内容已精简，完整版请参阅源文件 `系统基础/topic-dictionary/storage/csi-volume-cloning.md`）*
...
> *（内容已精简，完整版请参阅源文件 `系统基础/topic-dictionary/storage/dynamic-volume-provisioning.md`）*
...
> *（内容已精简，完整版请参阅源文件 `系统基础/topic-dictionary/storage/ephemeral-volumes.md`）*
...
> *（内容已精简，完整版请参阅源文件 `系统基础/topic-dictionary/storage/high-performance-storage-networks.md`）*
...
> *（内容已精简，完整版请参阅源文件 `系统基础/topic-dictionary/storage/local-ephemeral-storage.md`）*
...
> *（内容已精简，完整版请参阅源文件 `系统基础/topic-dictionary/storage/node-specific-volume-limits.md`）*
...
> *（内容已精简，完整版请参阅源文件 `系统基础/topic-dictionary/storage/object-storage-and-data-pipelines.md`）*
...
> *（内容已精简，完整版请参阅源文件 `系统基础/topic-dictionary/storage/persistent-volumes.md`）*
...
> *（内容已精简，完整版请参阅源文件 `系统基础/topic-dictionary/storage/projected-volumes.md`）*
...
> *（内容已精简，完整版请参阅源文件 `系统基础/topic-dictionary/storage/storage-capacity.md`）*
...
> *（内容已精简，完整版请参阅源文件 `系统基础/topic-dictionary/storage/storage-classes.md`）*
...
> *（内容已精简，完整版请参阅源文件 `系统基础/topic-dictionary/storage/volume-attributes-classes.md`）*
...
> *（内容已精简，完整版请参阅源文件 `系统基础/topic-dictionary/storage/volume-health-monitoring.md`）*
...
> *（内容已精简，完整版请参阅源文件 `系统基础/topic-dictionary/storage/volume-snapshot-classes.md`）*
...
> *（内容已精简，完整版请参阅源文件 `系统基础/topic-dictionary/storage/volume-snapshots.md`）*
...
> *（内容已精简，完整版请参阅源文件 `系统基础/topic-dictionary/storage/volumes.md`）*
...
> *（内容已精简，完整版请参阅源文件 `系统基础/topic-dictionary/storage/windows-storage.md`）*
...
- `系统基础/topic-dictionary/storage/csi-volume-cloning.md`
- `系统基础/topic-dictionary/storage/dynamic-volume-provisioning.md`
- `系统基础/topic-dictionary/storage/ephemeral-volumes.md`
- `系统基础/topic-dictionary/storage/high-performance-storage-networks.md`
- `系统基础/topic-dictionary/storage/local-ephemeral-storage.md`
- `系统基础/topic-dictionary/storage/node-specific-volume-limits.md`
- `系统基础/topic-dictionary/storage/object-storage-and-data-pipelines.md`
- `系统基础/topic-dictionary/storage/persistent-volumes.md`
- `系统基础/topic-dictionary/storage/projected-volumes.md`
- `系统基础/topic-dictionary/storage/storage-capacity.md`
- `系统基础/topic-dictionary/storage/storage-classes.md`
- `系统基础/topic-dictionary/storage/volume-attributes-classes.md`
- `系统基础/topic-dictionary/storage/volume-health-monitoring.md`
- `系统基础/topic-dictionary/storage/volume-snapshot-classes.md`
- `系统基础/topic-dictionary/storage/volume-snapshots.md`
- `系统基础/topic-dictionary/storage/volumes.md`
- `系统基础/topic-dictionary/storage/windows-storage.md`

## Related

- [[23-实体/15-参考与索引/configuration-terms.md|configuration-terms]] — K8s 配置管理术语参考
- [[23-实体/15-参考与索引/observability-terms.md|observability-terms]] — K8s 可观测性术语参考
