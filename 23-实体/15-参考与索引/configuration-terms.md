...
> **相关领域**: [[23-实体/15-参考与索引/k8s-architecture-fundamentals.md|k8s-architecture-fundamentals]] | [[23-实体/15-参考与索引/k8s-control-plane-deep-dive.md|k8s-control-plane-deep-dive]]
...
> *（内容已精简，完整版请参阅源文件 `系统基础/topic-dictionary/configuration/configmaps.md`）*
...
> *（内容已精简，完整版请参阅源文件 `系统基础/topic-dictionary/configuration/liveness-readiness-and-startup-probes.md`）*
...
> *（内容已精简，完整版请参阅源文件 `系统基础/topic-dictionary/configuration/organizing-cluster-access-using-kubeconfig-files.md`）*
...
> *（内容已精简，完整版请参阅源文件 `系统基础/topic-dictionary/configuration/resource-management-for-pods-and-containers.md`）*
...
> *（内容已精简，完整版请参阅源文件 `系统基础/topic-dictionary/configuration/resource-management-for-windows-nodes.md`）*
...
> *（内容已精简，完整版请参阅源文件 `系统基础/topic-dictionary/configuration/secrets.md`）*
...
- `系统基础/topic-dictionary/configuration/configmaps.md`
- `系统基础/topic-dictionary/configuration/liveness-readiness-and-startup-probes.md`
- `系统基础/topic-dictionary/configuration/organizing-cluster-access-using-kubeconfig-files.md`
- `系统基础/topic-dictionary/configuration/resource-management-for-pods-and-containers.md`
- `系统基础/topic-dictionary/configuration/resource-management-for-windows-nodes.md`
- `系统基础/topic-dictionary/configuration/secrets.md`

## Related

- [[23-实体/15-参考与索引/platform-engineering-terms.md|platform-engineering-terms]] — K8s 平台工程术语参考
- [[23-实体/15-参考与索引/tooling-terms.md|tooling-terms]] — K8s 工具链术语参考
