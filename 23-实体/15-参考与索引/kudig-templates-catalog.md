...
| FEBM 取证模板 | 法医取证分析 | 故障诊断/FEBM方法论/ 目录 |
...
- [[23-实体/15-参考与索引/KUDIG Templates and Agent Prompts.md|原版模板集合]]
...
- [[23-实体/15-参考与索引/kudig-documentation-specs.md|KUDIG 文档规范体系：标签字典、Frontmatter、场景分类、同义词典]] — Cross-reference
