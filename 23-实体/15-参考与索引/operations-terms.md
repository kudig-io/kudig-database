...
summary: '本页汇总了 **运维运营** 领域的 20 个 Kubernetes 术语定义与概念说明。'
category: references
tags:
- k8s
- dictionary
...
> **相关领域**: [[23-实体/15-参考与索引/k8s-production-operations.md|k8s-production-operations]] | [[23-实体/15-参考与索引/k8s-structured-troubleshooting.md|k8s-structured-troubleshooting]]
