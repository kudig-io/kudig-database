...
| `tags` | array | Document tags from [[23-实体/15-参考与索引/KUDIG Tag Dictionary.md|KUDIG Tag Dictionary]] | `[k8s, troubleshooting, etcd]` |
...
- [[29-文档/specs/SYNONYM-DICTIONARY.md|SYNONYM-DICTIONARY]]
