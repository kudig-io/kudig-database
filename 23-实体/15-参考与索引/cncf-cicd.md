...
Helm 是 K8s 应用包管理器（详见 [[23-实体/15-参考与索引/cncf-orchestration.md|cncf-orchestration]]）。
...
- [[22-概念/09-平台与发布/ci-cd-pipeline-patterns.md|ci-cd-pipeline-patterns]] — CI/CD 流水线模式
