...
2. **ACK 审计**: 记录 [[17-系统基础/06-知识字典/fundamentals/the-kubernetes-api.md|Kubernetes API]] Server 的所有请求。
...
- [241-ack-slb-nlb-alb.md](../[[18-云厂商/01-阿里云/公有云-ACK/003-ack-slb-nlb-alb.md|241-ack-slb-nlb-alb]].md) - 专有云负载均衡集成
