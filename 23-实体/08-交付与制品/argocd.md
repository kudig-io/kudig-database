---
title: ArgoCD
description: '- [[22-概念/11-交叉分析/CI-CD 流水线 × Secret 管理.md|CI-CD 流水线 × Secret 管理]] — 综合'
summary: '- [[22-概念/11-交叉分析/CI-CD 流水线 × Secret 管理.md|CI-CD 流水线 × Secret 管理]] — 综合'
category: entities
tags:
- argocd
- gitops
...
- Connects to [[23-实体/06-安全/vault.md|Vault]] for secret injection via Vault Agent templates
- Works with [[kyverno|Kyverno]] for policy enforcement post-sync
- Part of broader [[22-概念/09-平台与发布/ci-cd-pipeline-patterns.md|CI/CD Pipeline Patterns]] ecosystem

## Related
- [[22-概念/11-交叉分析/CI-CD 流水线 × Secret 管理.md|CI-CD 流水线 × Secret 管理]] — 综合
