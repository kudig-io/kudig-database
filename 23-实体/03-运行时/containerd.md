...
containerd is an industry-standard [[22-概念/15-运行时与系统/container-runtime.md|container runtime]] that manages the complete container lifecycle on a host system. It was donated to CNCF by Docker in 2017 and became the default K8s runtime after dockershim removal in v1.24.
...
- [[22-概念/15-运行时与系统/overlayfs-storage.md|OverlayFS Storage]] — Cross-reference
