...
#<!-- chunk: FinOps 成熟度模型 -->## FinOps 成熟度模型
...
#<!-- chunk: Terraform 多云工作空间 -->## Terraform 多云工作空间
...
#<!-- chunk: FinOps 成本优化自动化 -->## FinOps 成本优化自动化
...
- [[domain-12-cloud-providers/README|[[Domain 27: 多云与混合云架构管理|Domain 27: 多云与混合云架构管理]]]]
