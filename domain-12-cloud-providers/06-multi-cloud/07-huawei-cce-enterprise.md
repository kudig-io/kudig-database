...
#<!-- chunk: Terraform 部署 CCE Turbo 集群 -->## Terraform 部署 CCE Turbo 集群
...
#<!-- chunk: Volcano 调度器配置 -->## Volcano 调度器配置
...
#<!-- chunk: 裸金属容器实例 (BCI) 完整配置 -->## 裸金属容器实例 (BCI) 完整配置
...
#<!-- chunk: 混合集群与 UCS 管理 -->## 混合集群与 UCS 管理
...
kubectl get podsecuritypolicy 2>/dev/null || echo "PSP 未配置"
