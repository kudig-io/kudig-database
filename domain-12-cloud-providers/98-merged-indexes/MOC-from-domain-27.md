...
intent_queries:
- domain-27-multi-cloud-hybrid MOC 是什么
- 如何 domain-27-multi-cloud-hybrid MOC
- Kubernetes 12 cloud providers 最佳实践
trigger_keywords:
- domain-27-multi-cloud-hybrid
- MOC
- cloud
- providers
prerequisites:
...
```mermaid
graph TD
    subgraph domain-27-multi-cloud-hybrid
        A["Domain-27 多云与混合云 — 开源项目索引"]
    B["AWS EKS 企业级多云管理平台"]
    C["Azure AKS 企业级多云管理平台"]
    D["企业级多云治理与成本优化深度实践"]
    E["Google GKE 企业级多云管理深度实践"]
    F["IBM Cloud Kubernetes Service (IKS) 企业级深度实践"]
    end
