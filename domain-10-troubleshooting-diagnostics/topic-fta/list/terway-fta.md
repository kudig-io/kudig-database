...
cross_refs:
- type: structural
  path: ../domain-10-troubleshooting-diagnostics/topic-structural-trouble-shooting/03-networking/07-terway-troubleshooting.md
  ...
  "flow_steps": [
    ...
    },
    {
      ...
      "metadata": { "severity": "high", "probability": "low", "mttr_minutes": 15,
        ...
        "remediation": { "manual_steps": ["检查 /etc/cni/net.d/ 配置文件", "验证 Terway ConfigMap 配置", "确认 CNI 版本与 [[domain-17-system-foundation/topic-cheat-sheet/k8s.md|k8s]] 版本兼容"], "auto_actions": [] } },
      "next_step": "gate_root_or"
    },
    {
...
| 1.24 | 移除 dockershim, CNI spec 1.0.0 过渡 | Terway 需适配 [[entities/containerd.md|containerd]] CRI |
