...
cross_refs:
- type: structural
  path: ../domain-10-troubleshooting-diagnostics/topic-structural-trouble-shooting/05-workloads/05-job-cronjob-troubleshooting.md
...
graph TD
    A["故障: Job/CronJob 异常]"]
    B{"检查组件状态"}
    C["修复: job-cronjob 配置/重启"]
    D{"检查日志和事件"}
    E["修复: job-cronjob 深度诊断"]
    F{"检查资源配置"}
    G["修复: job-cronjob 专项处理"]
    I["验证修复"]
    J["记录根因，关闭"]
    H["升级到专家"]
...
- [[domain-17-system-foundation/topic-dictionary/workloads/jobs.md|jobs]]
