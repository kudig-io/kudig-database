...
cross_refs:
- type: structural
  path: ../domain-10-troubleshooting-diagnostics/topic-structural-trouble-shooting/03-networking/06-gateway-api-troubleshooting.md
...
- **共性**：遵循 `[[domain-10-troubleshooting-diagnostics/topic-fta/fta-methodology-and-agentic-practices.md|fta-methodology-and-agentic-practices]].md` 中的"版本适配基线"。default": "continue_to:gate_health_or"
      }
    },
...
```mermaid
graph TD
    A["故障: Gateway API 访问异常]"]
    B{"诊断命令快速参考"}
    C["修复: gateway-api 配置/重启"]
    I["验证修复"]
    J["记录根因，关闭"]
    H["升级到专家"]
