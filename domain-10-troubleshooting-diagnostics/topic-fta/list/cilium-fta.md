...
- cilium FTA 树：eBPF/Cilium CNI 故障诊断 故障排查
- cilium FTA 树：eBPF/Cilium CNI 故障诊断 排障步骤
...
title: [[skills/cilium-fta.md|Cilium Fta]] 树：eBPF/Cilium CNI 故障诊断
...
related_skills: []
knowledge_refs:
  - domain-03-networking-traffic/05-terway-advanced-guide.md
...
```mermaid
graph TD
    A["故障: Cilium/EBPF 网络异常<br/>Pod 无法通信 / 访问延迟高"]'"]
    B{"检查组件状态"}
    C["修复: cilium 配置/重启"]
    D{"检查日志和事件"}
    E["修复: cilium 深度诊断"]
