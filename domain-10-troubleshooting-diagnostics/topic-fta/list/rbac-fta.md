---
title: RBAC 异常 FTA 树
description: 'description: ROLE_OR --> ROLE3[Role 配置错误]'
category: fta
tags:
- k8s
- fault-tree
...
cross_refs:
- type: domain
  path: ../domain-05-security-compliance/07-rbac-matrix-configuration.md
...
- type: structural
  path: ../domain-10-troubleshooting-diagnostics/topic-structural-trouble-shooting/06-security-auth/01-rbac-troubleshooting.md
...
agent_notes:
  decision_tree_entry: kubectl auth can-i <verb> <resource> --as=system:serviceaccount:<ns>:<sa>
    检查权限
  critical_commands:
