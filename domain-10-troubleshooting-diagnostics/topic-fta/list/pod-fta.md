...
| `evt_kubeproxy_fail` | kube-proxy 异常 | `kubectl get pods -n kube-system -l [[domain-17-system-foundation/topic-cheat-sheet/k8s.md|k8s]]-app=kube-proxy -o wide` | Pod 非 Running | **确认根因** |
...
| `evt_controller_issue` | [[domain-01-cluster-fundamentals/13-kube-controller-manager-deep-dive.md|13-kube-controller-manager-deep-dive]]异常 | `kubectl get pods -n kube-system -l component=kube-controller-manager -o wide` | Pod 非 Running | **确认根因** |
