...
> **上一章**: [第十三章：智能工单处理的 AI Agent 架构](./[[domain-10-troubleshooting-diagnostics/topic-fta/13-intelligent-ticket-processing|13-intelligent-ticket-processing]].md)  
