...
> **下一章**: 第九章：FTA 作为 AI Agent 的知识骨架](./[[domain-10-troubleshooting-diagnostics/topic-fta/09-fta-as-agent-knowledge-skeleton|09-fta-as-agent-knowledge-skeleton]].md)
