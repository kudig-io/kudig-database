...
| 主题 | 引用路径 | 适用场景 |
|------|---------|---------|
| Ingress 故障排查深度指南 | `domain-10-troubleshooting-diagnostics/15-ingress-troubleshooting.md` | 超出本 Skill 覆盖范围的深度排查 |
| Kubernetes 网络模型 | `domain-03-networking-traffic/` | 理解 Service、Endpoints、网络策略 |
| Gateway API 详解 | `domain-03-networking-traffic/` | Gateway API 概念和最佳实践 |
