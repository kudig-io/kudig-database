...
| 主题 | 引用路径 | 适用场景 |
|------|---------|---------|
| Kubernetes 安全架构 | `domain-05-security-compliance/` | 理解 K8s 安全模型和防御深度 |
| 云原生安全最佳实践 | `domain-05-security-compliance/` | 安全加固方案设计 |
| 供应链安全 | `domain-05-security-compliance/` | 供应链攻击防御和 SBOM 管理 |
| 安全故障排查 | `domain-10-troubleshooting-diagnostics/32-security-troubleshooting.md` | 详细的安全问题诊断流程 |
