...
本文系统对比四大主流方案——Vault、External Secrets Operator、Sealed Secrets、SOPS，覆盖架构原理、生产部署、etcd 静态加密、密钥生命周期管理，帮助平台与安全团队根据自身规模和需求做出合理选型。Vault 的企业级实践见 [[安全/身份与访问/05-vault-enterprise-secrets-management.md|Vault 企业级 Secrets 管理]]，密钥轮换见 [[安全/身份与访问/13-key-rotation-automation.md|密钥轮换自动化]]。
...
- [[安全/身份与访问/05-vault-enterprise-secrets-management.md|Vault 企业级 Secrets 管理]]
- [[安全/身份与访问/11-secret-management-tools.md|Secret 管理工具]]
- [[安全/身份与访问/13-key-rotation-automation.md|密钥轮换自动化]]
- [[安全/身份与访问/03-service-account-token-management.md|ServiceAccount Token 管理]]
- [[安全/供应链/07-sigstore-cosign-signing.md|Sigstore Cosign 签名]]
- [[安全/身份与访问/99-vault-k8s-secrets-guide.md|Vault K8s Secrets 指南]]
