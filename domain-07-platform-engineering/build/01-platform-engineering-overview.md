...
#<!-- chunk: 1.2 平台工程的起源与演进 -->## 1.2 平台工程的起源与演进
...
#<!-- chunk: 2.1 Gartner 平台工程预测 -->## 2.1 Gartner 平台工程预测
...
#<!-- chunk: 2.2 Gartner 技术成熟度曲线位置 -->## 2.2 Gartner 技术成熟度曲线位置
...
#<!-- chunk: 2.3 市场数据与投资趋势 -->## 2.3 市场数据与投资趋势
...
#<!-- chunk: 3.2 DORA 四关键指标 -->## 3.2 DORA 四关键指标
...
#<!-- chunk: 3.3 平台工程与 DevOps 的互补关系 -->## 3.3 平台工程与 DevOps 的互补关系
...
#<!-- chunk: 4.2 IDP 五大核心组件 -->## 4.2 IDP 五大核心组件
...
#<!-- chunk: 4.3 IDP 核心能力矩阵 -->## 4.3 IDP 核心能力矩阵
...
#<!-- chunk: 4.4 黄金路径 (Golden Path) 概念 -->## 4.4 黄金路径 (Golden Path) 概念
...
#<!-- chunk: 5.2 Level 1：临时阶段 (Ad-hoc) -->## 5.2 Level 1：临时阶段 (Ad-hoc)
...
#<!-- chunk: 5.3 Level 2：标准化阶段 (Standardized) -->## 5.3 Level 2：标准化阶段 (Standardized)
...
#<!-- chunk: 5.4 Level 3：产品化阶段 (Productized) -->## 5.4 Level 3：产品化阶段 (Productized)
...
#<!-- chunk: 5.5 Level 4：优化阶段 (Optimized) -->## 5.5 Level 4：优化阶段 (Optimized)
...
#<!-- chunk: 6.2 平台团队内部结构 -->## 6.2 平台团队内部结构
...
#<!-- chunk: 6.3 平台团队规模参考 -->## 6.3 平台团队规模参考
...
#<!-- chunk: 6.4 平台团队与开发团队协作模式 -->## 6.4 平台团队与开发团队协作模式
...
#<!-- chunk: 7.1 为什么要将平台视为产品？ -->## 7.1 为什么要将平台视为产品？
...
#<!-- chunk: 7.2 平台产品管理框架 -->## 7.2 平台产品管理框架
...
#<!-- chunk: 7.4 平台产品路线图示例 -->## 7.4 平台产品路线图示例
...
#<!-- chunk: 8.1 SPACE 指标框架 -->## 8.1 SPACE 指标框架
...
#<!-- chunk: 8.2 平台 KPI 仪表板 -->## 8.2 平台 KPI 仪表板
...
#<!-- chunk: 8.3 ROI 计算模型 -->## 8.3 ROI 计算模型
...
#<!-- chunk: 9.1 CNCF 平台工程工具全景 -->## 9.1 CNCF 平台工程工具全景
...
#<!-- chunk: 9.2 工具选型决策矩阵 -->## 9.2 工具选型决策矩阵
...
#<!-- chunk: 10.1 90 天快速启动计划 -->## 10.1 90 天快速启动计划
...
#<!-- chunk: 10.2 平台工程十大最佳实践 -->## 10.2 平台工程十大最佳实践
...
#<!-- chunk: 11.1 平台工程反模式汇总 -->## 11.1 平台工程反模式汇总
...
#<!-- chunk: 11.2 关键反模式详解 -->## 11.2 关键反模式详解
...
#<!-- chunk: 12.1 Netflix：Paved Road 先驱 -->## 12.1 Netflix：Paved Road 先驱
...
#<!-- chunk: 12.2 Spotify：Backstage 的诞生 -->## 12.2 Spotify：Backstage 的诞生
...
#<!-- chunk: 12.3 Airbnb：基础设施产品化 -->## 12.3 Airbnb：基础设施产品化
...
#<!-- chunk: 13.1 AI 辅助平台工程 -->## 13.1 AI 辅助平台工程
...
#<!-- chunk: 13.2 平台工程 2030 展望 -->## 13.2 平台工程 2030 展望
...
#<!-- chunk: 13.3 平台工程师职业发展路径 -->## 13.3 平台工程师职业发展路径
