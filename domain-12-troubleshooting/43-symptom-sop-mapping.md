...
修复步骤:
  ...
  3. 强制删除（不推荐用于有状态应用）: kubectl delete pod <pod-name> --grace-period=0 --force
```
...
修复步骤:
  ...
  2. 强制删除（无状态应用）: kubectl delete pod <pod> --grace-period=0 --force
...
修复步骤:
  ...
  3. 如有状态应用，谨慎处理；如是无状态应用: kubectl delete pod <pod> --grace-period=0 --force
...
related:
  - topic-structural-trouble-shooting/09-command-output/00-command-output-root-cause-parser.md
