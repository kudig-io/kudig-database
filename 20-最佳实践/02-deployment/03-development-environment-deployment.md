...
<!-- chunk: 八、多环境配置管理 (Kustomize) -->## 八、多环境配置管理 (Kustomize)
...
**来源文档**: `集群基础/12-cluster-deployment-patterns.md`, `平台工程/02-cluster-lifecycle-management.md`, `工作负载/02-deployment-production-patterns.md`
...
- [[11-发布变更/06-部署方案/04-production-environment-deployment.md|04 - 生产环境部署 (Production Environment Deployment)]]
