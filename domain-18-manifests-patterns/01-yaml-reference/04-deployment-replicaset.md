...
intent_queries:
- 如何部署04-deployment-replicaset？
- 04-deployment-replicaset的部署模式和最佳实践
- 04-deployment-replicaset生产环境部署
trigger_keywords:
- Deployment
- ReplicaSet
- YAML
...
intent_queries:
- Deployment / ReplicaSet YAML 配置参考 是什么
- 如何 Deployment / ReplicaSet YAML 配置参考
...
<!-- chunk: 2. Deployment API 信息 -->## 2. Deployment API 信息
...
<!-- chunk: 6. 生产级完整配置(专家) -->## 6. 生产级完整配置(专家)
...
- [Kubernetes 故障排查 - Workloads](../domain-10-troubleshooting-diagnostics/topic-structural-trouble-shooting/05-workloads/01-pod-troubleshooting.md)
...
- [[domain-18-manifests-patterns/02-namespace-resourcequota-limitrange.md|02-namespace-resourcequota-limitrange]]
