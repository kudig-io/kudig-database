...
<!-- chunk: 1. Init Container 模式 -->## 1. Init Container 模式
...
<!-- chunk: 2. Sidecar Container 模式 -->## 2. Sidecar Container 模式
...
<!-- chunk: 4. Pod Affinity/Anti-Affinity -->## 4. Pod Affinity/Anti-Affinity
...
<!-- chunk: 5. Topology Spread Constraints -->## 5. Topology Spread Constraints
...
<!-- chunk: 6. Taints and Tolerations -->## 6. Taints and Tolerations
...
<!-- chunk: 8. 优雅终止与生命周期钩子 -->## 8. 优雅终止与生命周期钩子
...
<!-- chunk: 9. Projected Volumes 组合投射 -->## 9. Projected Volumes 组合投射
...
<!-- chunk: 10. Downward API 完整字段参考 -->## 10. Downward API 完整字段参考
...
<!-- chunk: 11. Resource QoS 详解 -->## 11. Resource QoS 详解
...
- [[domain-18-manifests-patterns/34-component-configuration.md|34-component-configuration]]
- [[domain-18-manifests-patterns/36-ecosystem-kustomize-helm-argocd.md|36-ecosystem-kustomize-helm-argocd]]
- [[domain-18-manifests-patterns/01-yaml-syntax-resource-conventions.md|01-yaml-syntax-resource-conventions]]
