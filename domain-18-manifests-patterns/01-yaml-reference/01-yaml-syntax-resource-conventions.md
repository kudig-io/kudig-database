...
intent_queries:
- yaml-syntax-resource-conventions是什么？
- yaml-syntax-resource-conventions的使用方法
- yaml-syntax-resource-conventions的最佳实践
trigger_keywords:
- YAML
- 语法基础与
- Kubernetes
...
<!-- chunk: 3. Kubernetes 资源四大顶层字段 -->## 3. Kubernetes 资源四大顶层字段
