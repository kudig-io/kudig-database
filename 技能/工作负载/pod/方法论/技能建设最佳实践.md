...
- 技能/pod/README.md
- 技能/fta-方法论/methodology/FTA Methodology and Core Principles.md
created: '2026-07-23'
updated: '2026-07-23'
lifecycle: active
tier: core
...
- [[技能/pod/02-pod-pending-scheduling.md|Pod 调度失败诊断]] — 上游依赖
- [[技能/node/01-node-notready.md|Node NotReady 诊断]] — 关联排查
```
...
|---------|---------|-----------|---------|
| S1 | Pod 长时间处于 Pending | "Pending"、"无法调度"、"扩容失败" | `kubectl get pod -o wide` |
| S2 | Events 显示 FailedScheduling | "Insufficient cpu/memory" | `kubectl describe pod` |
...
| 文档 | 说明 |
|------|------|
| [元数据/projects/kudig-templates-catalog.md](../../元数据/projects/kudig-templates-catalog.md) | KUDIG 文档模板目录 |
| [技能/pod/README.md](../pod/README.md) | Pod 异常诊断技能集（标杆示例） |
| [技能/fta-方法论/methodology/FTA Methodology and Core Principles.md](../FTA%20Methodology%20and%20Core%20Principles.md) | FTA 方法论与核心原则 |
| [技能/fta-方法论/execution-engine/FTA Diagnostic Execution Engine.md](../FTA%20Diagnostic%20Execution%20Engine.md) | FTA 诊断执行引擎 |
| [技能/fta-方法论/diagnostic-overview/Kubernetes Diagnostic Skills Overview.md](../Kubernetes%20Diagnostic%20Skills%20Overview.md) | 诊断技能总览 |
| [AI基础设施/AI-Agents/13-trusted-agent-system-fiscal-plan.md](../../AI基础设施/AI-Agents/13-trusted-agent-system-fiscal-plan.md) | 可信智能体体系财年规划 |
| [AI基础设施/AI-Agents/29-agentscope-studio-skill-demo.md](../../AI基础设施/AI-Agents/29-agentscope-studio-skill-demo.md) | AgentScope Skill 实战指南 |

## Related

- [[技能/pod/README.md|Pod 异常诊断技能集]] — 技能集标杆示例
- [[技能/node/README.md|Node 异常诊断技能集]] — 节点域技能集
- [[技能/fta-方法论/methodology/FTA Methodology and Core Principles.md|FTA 方法论]] — 故障树分析方法论
- [[技能/fta-方法论/diagnostic-overview/Kubernetes Diagnostic Skills Overview.md|诊断技能总览]] — 全部诊断技能索引
- [[元数据/projects/kudig-templates-catalog.md|KUDIG Templates Catalog]] — 文档模板目录
