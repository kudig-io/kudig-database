...
- [[技能/工作负载/pod/02-pod-pending-scheduling.md|Pod 调度失败诊断]] — 上游依赖
- [[技能/节点/node/01-node-notready-diagnosis.md|Node NotReady 诊断]] — 关联排查
```
...
- [[技能/工作负载/pod/README.md|Pod 异常诊断技能集]] — 技能集标杆示例
- [[技能/节点/node/README.md|Node 异常诊断技能集]] — 节点域技能集
- [[技能/工作负载/pod/方法论/FTA Methodology and Core Principles.md|FTA 方法论]] — 故障树分析方法论
- [[技能/工作负载/pod/方法论/Kubernetes Diagnostic Skills Overview.md|诊断技能总览]] — 全部诊断技能索引
