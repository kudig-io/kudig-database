...
description: '## 概述'
summary: '值班交接是保障系统持续稳定运行的关键环节。良好的交接可以确保问题不遗漏、上下文不丢失、响应不延迟。本文档定义了标准化的值班交接流程、交班人和接班人的职责清单、紧急交接的处理方式，以及值班期间的行为规范。'
category: skills
tags:
- k8s
- learn
...
- [[技能/工作负载/pod/培训/learn-inner-training.md|learn-inner-training]] — [[Kubernetes|Kubernetes]]es 培训：Inner Training|Kubernetes 培训：Inner Training]]
