...
The Reconcile() function follows the [[概念/controller-pattern.md|[[Controller Pattern (Reconciliation Loop)|Controller Pattern]]]]:
...
- Tests reconciler against real [[系统基础/知识字典/fundamentals/the-kubernetes-api.md|Kubernetes API]]
