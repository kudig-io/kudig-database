...
<!-- chunk: 一、GraalVM Native Image 技术全景 -->
...
<!-- chunk: 六、Reachability Metadata 配置 -->
...
- [Java 容器化最佳实践](32-发布/package/2026-07-02_18-29/corpus/peripheral/domain-13-container-runtime/01-docker/10-java-containerization-guide.md) — Dockerfile 模式与镜像优化
- [Spring Boot on K8s](32-发布/package/2026-07-02_18-29/corpus/supporting/domain-02-workloads-applications/00-core-workloads/08-spring-boot-kubernetes-guide.md) — Spring Boot K8s 部署
- [Quarkus/Micronaut 指南](17-quarkus-micronaut-cloud-native-java-guide.md) — 云原生 Java 框架对比
- [JVM GC 容器调优](32-发布/package/2026-07-02_18-29/corpus/supporting/domain-10-troubleshooting-diagnostics/04-jvm-tuning/03-jvm-gc-container-tuning-guide.md) — GC 调优 (JVM 模式)
- [Java 可观测性](32-发布/package/2026-07-02_18-29/corpus/supporting/domain-06-observability/01-overview/12-java-observability-kubernetes-guide.md) — Native Image 可观测性
