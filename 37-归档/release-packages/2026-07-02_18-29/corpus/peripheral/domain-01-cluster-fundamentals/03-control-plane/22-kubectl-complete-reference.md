...
> 完整深度指南请参考 → [[32-发布/package/2026-07-02_18-29/corpus/supporting/domain-01-cluster-fundamentals/05-kubectl/01-kubectl-debug-ephemeral-containers|kubectl debug 深度指南]]（ephemeral 容器注入、节点调试、Pod 复制调试、Profile 调试及生产故障排查工作流）
...
- [[domain-07-platform-engineering/代码分析/deployment-create/01-overview.md|01-overview]]
- [[domain-07-platform-engineering/代码分析/cluster-delete/01-overview.md|01-overview]]
