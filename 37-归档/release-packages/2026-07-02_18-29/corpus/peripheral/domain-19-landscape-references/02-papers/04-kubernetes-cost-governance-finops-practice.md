...
- 适用场景分析（波动型工作负载最受益）
- 详见 "[25-GKE Autopilot与Google AI基础设施](32-发布/package/2026-07-02_18-29/corpus/supporting/domain-19-landscape-references/02-papers/08-gke-autopilot-google-cloud-ai-infrastructure.md)"
