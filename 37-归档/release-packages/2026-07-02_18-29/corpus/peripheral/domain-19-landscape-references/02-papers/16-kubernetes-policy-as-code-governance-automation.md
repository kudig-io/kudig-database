...
本文系统梳理 Kubernetes 生态中最主流的策略引擎——**Kyverno**、**OPA/Gatekeeper** 以及 K8s 1.30+ 正式 GA 的 **ValidatingAdmissionPolicy（CEL 原生）**，涵盖架构设计、规则编写、生命周期管理、命名空间治理、合规报告及企业级体系建设，并展望 AI 辅助策略生成等前沿趋势。文档面向平台工程师、安全架构师及 DevOps 团队，建议结合 [doc-03 零信任安全](./03-kubernetes-zero-trust-security.md)、[doc-08 网络策略](32-发布/package/2026-07-02_18-29/corpus/supporting/domain-19-landscape-references/02-papers/03-kubernetes-network-policies-security-micro-segmentation.md) 及 [doc-20 供应链安全](13-kubernetes-supply-chain-security-sbom-slsa-sigstore.md) 协同阅读。
