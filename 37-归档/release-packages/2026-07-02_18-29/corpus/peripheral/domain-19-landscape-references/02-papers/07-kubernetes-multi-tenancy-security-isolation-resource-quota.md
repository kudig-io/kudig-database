...
intent_queries:
- 13-kubernetes-multi-tenancy-security-isolation-res的安全加固怎么做？
- 13-kubernetes-multi-tenancy-security-isolation-res的安全最佳实践
- 13-kubernetes-multi-tenancy-security-isolation-res有哪些安全风险？
trigger_keywords:
- Kubernetes
- 多租户安全隔离与资源配额管理
- Multi-Tenancy
...
- Kubernetes 多租户安全隔离与资源配额管理 (Multi-Tenancy Security Isolation and Resource Quota Management)
  是什么
- 如何 Kubernetes 多租户安全隔离与资源配额管理 (Multi-Tenancy Security Isolation and Resource Quota
  Management)
...
多租户策略分层:
  ...
  详见: "[24-策略即代码与治理自动化](16-kubernetes-policy-as-code-governance-automation.md)"
```
...
*2026-03 更新: 新增vCluster虚拟集群多租户方案、ValidatingAdmissionPolicy原生租户策略；关联文档 [24-策略即代码](16-kubernetes-policy-as-code-governance-automation.md)、[26-vCluster多租户](17-kubernetes-vcluster-virtual-cluster-multi-tenancy.md)；版本升级至v1.5。*
