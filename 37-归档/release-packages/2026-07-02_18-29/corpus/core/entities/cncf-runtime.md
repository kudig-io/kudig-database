...
## 容器运行时（[[concepts/container-runtime.md|Container Runtime]]）
...
- **多租户**: 资源隔离与配额
- **可观测性**: [[32-发布/package/2026-07-02_18-29/corpus/core/entities/08-containerd-observability|observability]]|指标与日志]]
- **Windows 支持**: Windows 容器支持
- **灾备**: [[32-发布/package/2026-07-02_18-29/corpus/supporting/entities/02-containerd-disaster-recovery|状态备份与恢复]]
