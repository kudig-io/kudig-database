...
> 基础概念和访问模式选择指南详见 [06-存储基础概念](32-发布/package/2026-07-02_18-29/corpus/peripheral/domain-04-storage-data/01-k8s-storage/01-storage-fundamental-concepts.md)。本节侧重 PV 层面的访问模式约束和生产注意事项。
...
> 基础概念和运维操作详见 [06-存储基础概念 - 回收策略机制](32-发布/package/2026-07-02_18-29/corpus/peripheral/domain-04-storage-data/01-k8s-storage/01-storage-fundamental-concepts.md)。本节侧重 PV 层面的回收策略选择和生产实践。
