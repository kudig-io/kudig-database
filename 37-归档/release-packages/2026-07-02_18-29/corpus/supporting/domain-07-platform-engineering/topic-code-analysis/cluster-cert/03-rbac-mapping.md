...
| [`GetAPIServerAltNames`](05-cert-config.md) | `cmd/kubeadm/app/phases/certs/certs.go` | API Server 证书 SAN 生成 |
...
| [`X509 Authenticator`](04-apiserver-cert-flags.md) | `staging/src/k8s.io/apiserver/pkg/authentication/request/x509/x509.go` | X509 认证插件 |
