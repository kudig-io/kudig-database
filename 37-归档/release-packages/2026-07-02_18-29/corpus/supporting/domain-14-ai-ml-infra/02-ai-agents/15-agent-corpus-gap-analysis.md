...
| [domain-10-troubleshooting-diagnostics/topic-fta/09-fta-as-agent-knowledge-skeleton.md](../domain-10-troubleshooting-diagnostics/FTA故障树/09-fta-as-agent-knowledge-skeleton.md) | FTA 作为 Agent 知识骨架 |
| [domain-10-troubleshooting-diagnostics/topic-fta/10-agent-orchestration-patterns.md](../domain-10-troubleshooting-diagnostics/FTA故障树/10-agent-orchestration-patterns.md) | Agent 编排模式 |
| [domain-10-troubleshooting-diagnostics/topic-febm/04-febm-agent-ticket-processing.md](../domain-10-troubleshooting-diagnostics/FEBM方法论/04-febm-agent-ticket-processing.md) | FEBM Agent 工单处理 |
