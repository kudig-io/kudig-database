...
- 所有 Pod 间通信均失败（不仅是特定 Pod）→ 可能是 CNI 级问题 → [[domain-10-troubleshooting-diagnostics/核心排障/03-networking-cni-troubleshooting.md|03-networking-cni-troubleshooting]].md
