...
<!-- chunk: 4. 跨集群网络和服务发现问题排查 (Cross-[[domain-17-system-foundation/知识字典/networking/cluster-networking.md|Cluster Networking]]Networking]] and [[Service|Service]] Discovery Issues) -->
...
rm -rf $BACKUP_DIR/$TIMESTAMP  # ⚠️ 删除系统/数据文件
...
- [[32-发布/package/2026-07-02_18-29/profiles/sre/corpus/core/domain-10-troubleshooting-diagnostics/03-advanced-troubleshooting/01-helm-chart-troubleshooting|36-helm-chart-troubleshooting]]
