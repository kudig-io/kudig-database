...
| 速查卡 | 深度知识来源 | 故障排查 |
|:---|:---|:---|
| k8s.md | domain-01-cluster-fundamentals ~ domain-10-troubleshooting-diagnostics | domain-12, topic-fta |
| linux.md | domain-17-system-foundation | domain-10-troubleshooting-diagnostics/35 |
| docker.md | domain-13-container-runtime | domain-10-troubleshooting-diagnostics/08 |
| promql.md | domain-8, domain-06-observability | domain-10-troubleshooting-diagnostics/30 |
| networking.md | domain-5, domain-03-networking-traffic | domain-10-troubleshooting-diagnostics/25-26 |
| tls-pki.md | domain-05-security-compliance | domain-10-troubleshooting-diagnostics/13 |
| git.md | domain-08-release-change-management | - |
| sql.md | domain-16-database-middleware | - |
| go.md | domain-01-cluster-fundamentals (源码阅读) | - |
