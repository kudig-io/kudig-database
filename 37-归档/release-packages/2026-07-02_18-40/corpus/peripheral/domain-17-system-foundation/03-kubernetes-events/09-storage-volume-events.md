...
| 文档 | 相关事件 |
|:---|:---|
| [02 - Pod 与容器生命周期事件](32-发布/package/2026-07-02_18-40/corpus/core/domain-17-system-foundation/02-kubernetes-events/01-pod-container-lifecycle-events.md) | `FailedMount` → Pod 无法启动 |
| [05 - 调度与抢占事件](04-scheduling-preemption-events.md) | `WaitForFirstConsumer` → 延迟绑定等待调度 |
| [06 - 节点生命周期事件](05-node-lifecycle-condition-events.md) | `FailedAttachVolume` → 节点异常导致 Attach 失败 |
