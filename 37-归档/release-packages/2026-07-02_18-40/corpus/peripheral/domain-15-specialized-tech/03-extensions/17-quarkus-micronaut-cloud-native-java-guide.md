...
- [Spring Boot on K8s](32-发布/package/2026-07-02_18-40/corpus/supporting/domain-02-workloads-applications/00-core-workloads/08-spring-boot-kubernetes-guide.md) — Spring Boot 对比参考
- [Java 容器化](32-发布/package/2026-07-02_18-40/corpus/peripheral/domain-13-container-runtime/01-docker/10-java-containerization-guide.md) — 容器构建优化
- [Java 性能 Sizing](32-发布/package/2026-07-02_18-40/corpus/supporting/domain-10-troubleshooting-diagnostics/04-jvm-tuning/02-java-performance-resource-sizing-guide.md) — 资源配置
