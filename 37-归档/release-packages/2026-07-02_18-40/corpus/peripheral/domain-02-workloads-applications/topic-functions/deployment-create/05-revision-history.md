...
- [`syncDeployment`](01-deployment-controller.md) — 主协调函数驱动回滚
- [`rolloutRolling`](03-rolling-update.md) — 滚动更新策略实现
- [`getNewReplicaSet`](01-deployment-controller.md) — 查找当前版本 RS
- [`GetPodTemplateSpecHash`](01-deployment-controller.md) — 计算 PodTemplate hash
- [`cleanupOldReplicaSets`](01-deployment-controller.md) — 清理过期 RS
