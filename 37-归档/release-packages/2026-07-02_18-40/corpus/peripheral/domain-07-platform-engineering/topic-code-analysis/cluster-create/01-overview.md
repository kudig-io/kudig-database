...
- [控制面组件](04-control-plane.md) — static Pod 创建
- [etcd 管理](06-etcd.md) — etcd 静态 Pod
- [节点加入](05-join.md) — worker 节点 join 流程
- [初始化阶段](15-init-phases.md) — phase 详细说明
- [CRI 运行时](16-cri-runtime.md) — CRI 预检和容器运行时
