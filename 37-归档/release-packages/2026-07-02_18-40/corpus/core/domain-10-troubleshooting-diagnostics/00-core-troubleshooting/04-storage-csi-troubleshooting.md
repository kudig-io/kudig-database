...
| 错误信息 | 可能原因 | 解决方案 |
|---------|---------|---------|
| `no [[domain-17-system-foundation/知识字典/storage/persistent-volumes.md|persistent volumes]]es（卷）|volumes]] available` | 无匹配的PV/StorageClass配置错误 | 检查StorageClass参数配置 |
