...
| 12 | **灾难演练与混沌工程** | 已完成 AZ 故障切换、节点故障、控制平面断网演练并记录 RTO | 参考 [[32-发布/package/2026-07-02_18-40/corpus/core/domain-09-reliability-engineering/03-chaos-engineering/01-chaos-engineering-overview|混沌工程概述]] |
...
- [[32-发布/package/2026-07-02_18-40/corpus/peripheral/domain-12-cloud-providers/01-multi-cloud/00-multi-cloud-hybrid-deployment-strategy|多云混合部署策略]] — 主备/主主模式、跨云数据同步、故障切换与统一监控。
...
- [[32-发布/package/2026-07-02_18-40/corpus/core/domain-01-cluster-fundamentals/06-kubernetes-production-architecture-blueprint|Kubernetes 生产架构蓝图]] — 生产集群整体架构设计原则。
