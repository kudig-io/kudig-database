...
| 19 | **云原生 DevOps** | [19-cloudnative-devops-architecture.md](32-发布/package/2026-07-02_18-40/corpus/supporting/domain-20-application-patterns/topic-application-architecture/08-cloudnative-devops-architecture.md) | 7+ | Tekton、[[entities/argocd.md|argocd]]、Ingress-Nginx、Cluster Autoscaler |
| 20 | **微服务治理** | [20-microservice-governance-architecture.md](32-发布/package/2026-07-02_18-40/corpus/supporting/domain-20-application-patterns/topic-application-architecture/09-microservice-governance-architecture.md) | 9+ | OpenTelemetry、[[entities/jaeger.md|Jaeger]]、[[entities/istio.md|Istio]]、mTLS、Sidecar |
