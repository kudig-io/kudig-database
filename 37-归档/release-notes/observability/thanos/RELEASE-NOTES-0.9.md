---
title: thanos v0.9 Release Notes
description: thanos v0.9 Release Notes — Kubernetes 生产运维知识库
summary: thanos v0.9 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- thanos v0.9 Release Notes 是什么
- 如何 thanos v0.9 Release Notes
trigger_keywords:
- thanos
- v0.9
- Release
...
# [[Thanos|thanos]] v0.9 Release Notes
...
- [#1687](https://github.com/thanos-io/thanos/pull/1687) Add a new `--grpc-grace-period` CLI option to components which serve [[gRPC|gRPC]] to set how long to wait until gRPC Server shuts down.
- [#1660](https://github.com/thanos-io/thanos/pull/1660) Sidecar: Add a new `--[[Prometheus|prometheus]].ready_timeout` CLI option to the sidecar to set how long to wait until Prometheus starts up.
- [#1573](https://github.com/thanos-io/thanos/pull/1573) `AliYun OSS` object storage, see [documents](文档/storage.md#aliyun-oss) for further information.
