...
summary: thanos v0.11 Release Notes — Kubernetes 生产运维知识库
...
- [#1939](https://github.com/thanos-io/thanos/pull/1939) Ruler: Add TLS and authentication support for query endpoints with the `--query.config` and `--query.config-file` CLI flags. See [documentation](文档/components/rule.md/#configuration) for further information.
