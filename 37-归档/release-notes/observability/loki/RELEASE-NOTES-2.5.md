---
title: loki v2.5 Release Notes
description: loki v2.5 Release Notes — Kubernetes 生产运维知识库
summary: loki v2.5 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- loki v2.5 Release Notes 是什么
- 如何 loki v2.5 Release Notes
trigger_keywords:
- loki
- v2.5
- Release
...
Source: [v2.5.0](https://github.com/grafana/loki/releases/tag/v2.5.0)
...
- Promtail has several new ways to ingest logs:
    - The **[ability to do [[Service|service]] discovery and tailing directly from the Docker daemon](https://github.com/grafana/loki/pull/4911)**.
...
As always, please read the [upgrade guide](https://github.com/grafana/loki/blob/v2.5.0/docs/sources/upgrading/_index.md#250) before upgrading Loki.
