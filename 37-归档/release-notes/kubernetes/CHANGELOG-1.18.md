...
summary: v1.18.20 — Kubernetes 生产运维知识库
...
- [v1.18.0](#v1180)
  ...
  - [What’s New (Major Themes)](#whats-new-major-themes)
    - [[23-实体/02-K8s核心组件/kubernetes.md|Kubernetes]] Topology Manager Moves to Beta - Align Up!](#kubernetes-topology-manager-moves-to-beta---align-up)
    - [Serverside Apply - Beta 2](#serverside-apply---beta-2)
    - [Extending [[Ingress|Ingress]] with and replacing a deprecated annotation with IngressClass](#extending-ingress-with-and-replacing-a-deprecated-annotation-with-ingressclass)
