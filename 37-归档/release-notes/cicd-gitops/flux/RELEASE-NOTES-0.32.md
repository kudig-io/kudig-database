---
title: flux v0.32 Release Notes
description: flux v0.32 Release Notes — Kubernetes 生产运维知识库
summary: flux v0.32 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- flux v0.32 Release Notes 是什么
- 如何 flux v0.32 Release Notes
trigger_keywords:
- flux
- v0.32
- Release
...
# [[Flux|flux]] v0.32 Release Notes

Source: [v0.32.0](https://github.com/fluxcd/flux2/releases/tag/v0.32.0)

## Highlights

Flux v0.32.0 comes with support for distributing [[Kubernetes|Kubernetes]] manifests, Kustomize overlays and Terraform code as OCI artifacts.
...
- Resolve [[Helm|Helm]] dependencies from OCI for charts defined in Git.
