...
intent_queries:
- kops v1.17 Release Notes 是什么
- 如何 kops v1.17 Release Notes
trigger_keywords:
- kops
- v1.17
- Release
...
kops 1.17.2 is the next patch release in the kops 1.17 series, supporting [[Kubernetes|kubernetes]] version 1.17.x and earlier.
