---
title: helm v3.6 Release Notes
description: helm v3.6 Release Notes — Kubernetes 生产运维知识库
summary: helm v3.6 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- helm v3.6 Release Notes 是什么
- 如何 helm v3.6 Release Notes
trigger_keywords:
- helm
- v3.6
- Release
