---
title: kind v0.12 Release Notes
description: kind v0.12 Release Notes — Kubernetes 生产运维知识库
summary: kind v0.12 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- kind v0.12 Release Notes 是什么
- 如何 kind v0.12 Release Notes
trigger_keywords:
- kind
- v0.12
- Release
...
- The default node image is a [[Kubernetes|Kubernetes]] `v1.23.4` image: `kindest/node:v1.23.4@sha256:0e34f0d0fd448aa2f2819cfd74e99fe5793a6e4938b328f657c8e3f81ee0dfb9`
- The haproxy image used for multiple control-plane cluster is distroless now

<h1 id="new-features">New Features</h1>

- [[Pods|Pods]] running at different nodes have different product_uuid
...
- Base image updates
  ...
  - Crictl 1.23.0
  - [[23-实体/02-K8s核心组件/cni-plugins.md|CNI plugins]] 1.1.0
