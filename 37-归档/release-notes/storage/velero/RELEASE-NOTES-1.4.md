...
### All Changes
  * log a warning instead of erroring if an additional item returned from a plugin can't be found in [[17-系统基础/06-知识字典/fundamentals/the-kubernetes-api.md|the Kubernetes API]]ubernetes]] API (#2595, @skriss)
