---
title: velero v1.0 Release Notes
description: velero v1.0 Release Notes — Kubernetes 生产运维知识库
summary: velero v1.0 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- velero v1.0 Release Notes 是什么
- 如何 velero v1.0 Release Notes
trigger_keywords:
- velero
- v1.0
- Release
...
# velero v1.0 Release Notes

Source: [v1.0.0](https://github.com/vmware-tanzu/velero/releases/tag/v1.0.0)
...
- We removed all legacy Ark references, including API types, [[Prometheus|prometheus]] metrics, restic & hook annotations, etc.
...
* Plugin APIs have moved to reduce the import surface:
    * Plugin [[gRPC|gRPC]] servers live in `github.com/heptio/velero/pkg/plugin/framework`
