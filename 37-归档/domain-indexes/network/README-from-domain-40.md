...
本领域专注于云原生 API 网关技术栈的深度实践，涵盖 Higress、Apache APISIX、Kong、Envoy Gateway、Traefik 等主流开源 API 网关产品。领域范围聚焦于南北向（Ingress）流量治理，包括 Kubernetes Gateway API 标准、Wasm 插件生态、API 安全体系、可观测性集成以及生产环境最佳实践。东西向（服务网格）流量治理请参考 [Domain-26: 服务网格](../网络)。
...
- **[Domain-5: 网络](../网络)** - Kubernetes 网络架构、Ingress 基础、Gateway API 概览
- **[Domain-26: 服务网格](../网络)** - Istio/Linkerd 等东西向流量治理
- **[Domain-8: 可观测性](../可观测性)** - 监控告警体系基础
- **[Domain-25: 云原生安全](../安全)** - 安全架构基础
- **[Domain-34: CNCF Landscape](../生态参考)** - CNCF 开源项目全景
