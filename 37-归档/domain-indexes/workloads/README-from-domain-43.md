---
title: Java on Kubernetes 综合实践指南 (工作负载)
...
```mermaid
graph TB
    ROOT[Java on [[17-系统基础/05-速查卡/k8s.md|k8s]]<br/>综合实践指南] --> A[容器化]
    ROOT --> B[运行时]
    ROOT --> C[框架]
    ROOT --> D[CI/CD]
    ROOT --> E[可观测性]
...
| 2 | [GraalVM Native Image 指南](../../../16-专项技术/03-扩展机制/18-graalvm-native-image-guide.md) | Spring Boot 3 原生编译、Quarkus/Micronaut 原生、Metadata 配置、K8s 部署 | 高级 |

### 2.2 运行时 (2 篇)

| # | 指南 | 说明 | 难度 |
|---|------|------|------|
| 3 | [JVM GC 容器调优深度指南](../../../19-故障诊断/05-JVM调优/03-jvm-gc-container-tuning-guide.md) | G1GC/ZGC/Shenandoah 对比、容器感知参数、GC 监控告警 | 高级 |
| 4 | [Java 性能调优与资源 Sizing](../../../19-故障诊断/05-JVM调优/02-java-performance-resource-sizing-guide.md) | 资源 Sizing 公式、启动优化、线程池调优、CDS/AppCDS | 高级 |

### 2.3 框架 (3 篇)

| # | 指南 | 说明 | 难度 |
|---|------|------|------|
| 5 | [Spring Boot on Kubernetes](../../../02-工作负载/01-核心工作负载/25-spring-boot-kubernetes-guide.md) | 探针、配置管理、优雅停机、数据库连接池、生产 Deployment | 中级 |
| 6 | [Spring Cloud K8s + 服务网格](../../../05-网络/03-服务网格/13-spring-cloud-kubernetes-service-mesh-guide.md) | Spring Cloud → K8s 原生映射、[[23-实体/04-网络/istio.md|Istio]] 集成、Resilience4j、迁移路径 | 高级 |
| 7 | [Quarkus/Micronaut 云原生 Java](../../../16-专项技术/03-扩展机制/19-quarkus-micronaut-cloud-native-java-guide.md) | Quarkus vs Micronaut vs Spring Boot、Dev Services、反应式编程 | 中级 |

### 2.4 CI/CD (1 篇)

| # | 指南 | 说明 | 难度 |
|---|------|------|------|
| 8 | [Tekton Java CI/CD 流水线](../../../11-发布变更/01-GitOps/21-tekton-java-cicd-guide.md) | Maven/Gradle Task、Jib 构建、安全扫描、GitOps 集成 | 中级 |

### 2.5 可观测性 (1 篇)

| # | 指南 | 说明 | 难度 |
|---|------|------|------|
| 9 | [Java 可观测性整合指南](../../../09-可观测性/01-总览/14-java-observability-kubernetes-guide.md) | Micrometer + JMX Exporter + OTel Agent + 日志 JSON + Grafana Dashboard | 高级 |

### 2.6 安全 (1 篇)

| # | 指南 | 说明 | 难度 |
|---|------|------|------|
| 10 | [Java 安全加固指南](../../../08-安全/06-合规审计/14-java-security-kubernetes-guide.md) | SecurityContext、KeyStore/TrustStore、OAuth2、SBOM、NetworkPolicy | 高级 |

### 2.7 平台开发 (1 篇)

| # | 指南 | 说明 | 难度 |
|---|------|------|------|
| 11 | [Java K8s Client / Operator SDK](../../../10-平台工程/01-构建/16-java-k8s-client-operator-guide.md) | fabric8/client-java、Java Operator SDK、Informer 模式 | 高级 |

### 2.8 运维 (1 篇)

| # | 指南 | 说明 | 难度 |
|---|------|------|------|
| 12 | [Java 性能与资源 Sizing](../../../19-故障诊断/05-JVM调优/02-java-performance-resource-sizing-guide.md) | 容器资源公式、启动优化、线程池、连接池 Sizing | 高级 |
