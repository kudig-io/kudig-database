...
| 编号 | 文档 | 关键内容 | 事件数 | 重要程度 |
|:---:|:---|:---|:---:|:---:|
| 01 | [事件系统架构与 API 参考](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/01-event-system-architecture.md) | Event 数据模型、API 版本演进、事件生命周期、持久化方案 | - | 必读 |
...
| 06 | [节点生命周期与状态事件](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/06-node-lifecycle-condition-events.md) | NodeReady、DiskPressure、MemoryPressure、Rebooted、Eviction 等 | ~23 | 必读 |

### 控制器事件 (07-09)

| 编号 | 文档 | 关键内容 | 事件数 | 重要程度 |
|:---:|:---|:---|:---:|:---:|
| 07 | [Deployment 与 ReplicaSet 事件](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/07-deployment-replicaset-events.md) | ScalingReplicaSet、ProgressDeadlineExceeded、FailedCreate 等 | ~16 | 必读 |
| 08 | [StatefulSet 与 DaemonSet 事件](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/08-statefulset-daemonset-events.md) | 有序创建/删除、FailedPlacement、UnhealthyPodEviction 等 | ~13 | 重要 |
| 09 | [Job 与 CronJob 批处理事件](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/09-job-cronjob-batch-events.md) | Completed、BackoffLimitExceeded、TooManyMissedTimes 等 | ~20 | 重要 |

### 网络与存储事件 (10-11)

| 编号 | 文档 | 关键内容 | 事件数 | 重要程度 |
|:---:|:---|:---|:---:|:---:|
| 10 | [Service 与网络事件](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/10-service-networking-events.md) | LoadBalancer 生命周期、EndpointSlice、HostPortConflict 等 | ~21 | 必读 |
| 11 | [存储与卷事件](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/11-storage-volume-events.md) | FailedMount、ProvisioningFailed、VolumeResize 等 | ~22 | 必读 |

### 扩展与运维事件 (12-15)

| 编号 | 文档 | 关键内容 | 事件数 | 重要程度 |
|:---:|:---|:---|:---:|:---:|
| 12 | [自动扩缩容事件](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/12-autoscaling-events.md) | HPA SuccessfulRescale、VPA、Cluster Autoscaler 等 | ~28 | 重要 |
| 13 | [安全、准入与 RBAC 事件](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/13-security-admission-rbac-events.md) | 证书审批、Admission Webhook、Pod Security 等 | ~14 | 重要 |
| 14 | [Namespace、资源管理与 GC 事件](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/14-namespace-resource-gc-events.md) | Namespace 删除、ResourceQuota、PDB 等 | ~15 | 参考 |
| 15 | [生态系统与插件事件](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/15-ecosystem-addon-events.md) | NPD、Ingress、cert-manager、Istio、ArgoCD、Velero 等 | ~56 | 参考 |
...
| `DeletedTokenSecret` | Normal | token-controller | [13](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/13-security-admission-rbac-events.md) |
| `DeletingAllPods` | Normal | node-controller | [06](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/06-node-lifecycle-condition-events.md) |
| `DeletingDependents` | Normal | gc-controller | [14](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/14-namespace-resource-gc-events.md) |
| `DeletingNode` | Normal | node-controller | [06](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/06-node-lifecycle-condition-events.md) |
| `DeploymentPaused` | Normal | deployment-controller | [07](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/07-deployment-replicaset-events.md) |
| `DeploymentResumed` | Normal | deployment-controller | [07](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/07-deployment-replicaset-events.md) |
| `DeploymentRollback` | Normal | deployment-controller | [07](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/07-deployment-replicaset-events.md) |
| `DesiredReplicasComputed` | Normal | HPA | [12](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/12-autoscaling-events.md) |
| `DisruptionAllowed` | Normal | disruption-controller | [14](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/14-namespace-resource-gc-events.md) |
...
| `FailedCreate` (RS) | Warning | replicaset-controller | [07](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/07-deployment-replicaset-events.md) |
| `FailedCreate` (STS) | Warning | statefulset-controller | [08](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/08-statefulset-daemonset-events.md) |
...
| `FreeDiskSpaceFailed` | Warning | kubelet | [06](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/06-node-lifecycle-condition-events.md) |
| `HostPortConflict` | Warning | kubelet | [10](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/10-service-networking-events.md) |
| `ImageGCFailed` | Warning | kubelet | [06](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/06-node-lifecycle-condition-events.md) |
...
| `NodeHasInsufficientMemory` | Warning | kubelet | [06](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/06-node-lifecycle-condition-events.md) |
| `NodeHasInsufficientPID` | Warning | kubelet | [06](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/06-node-lifecycle-condition-events.md) |
| `NodeHasNoDiskPressure` | Normal | kubelet | [06](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/06-node-lifecycle-condition-events.md) |
| `NodeHasSufficientMemory` | Normal | kubelet | [06](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/06-node-lifecycle-condition-events.md) |
| `NodeHasSufficientPID` | Normal | kubelet | [06](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/06-node-lifecycle-condition-events.md) |
| `NodeNotReady` | Warning | kubelet/node-controller | [06](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/06-node-lifecycle-condition-events.md) |
| `NodeNotSchedulable` | Normal | kubelet | [06](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/06-node-lifecycle-condition-events.md) |
| `NodeReady` | Normal | kubelet | [06](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/06-node-lifecycle-condition-events.md) |
...
| `ProvisioningSucceeded` | Normal | pv-controller | [11](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/11-storage-volume-events.md) |
| `Pulled` | Normal | kubelet | [03](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/03-image-pull-events.md) |
| `Pulling` | Normal | kubelet | [03](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/03-image-pull-events.md) |
| `Rebooted` | Warning | kubelet | [06](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/06-node-lifecycle-condition-events.md) |
...
| `SuccessfulCreate` (STS) | Normal | statefulset-controller | [08](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/08-statefulset-daemonset-events.md) |
| `SuccessfulDelete` (RS) | Normal | replicaset-controller | [07](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/07-deployment-replicaset-events.md) |
| `SuccessfulMountVolume` | Normal | kubelet | [11](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/11-storage-volume-events.md) |
| `SuccessfulRescale` | Normal | HPA | [12](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/12-autoscaling-events.md) |
| `Suspended` | Normal | job-controller | [09](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/09-job-cronjob-batch-events.md) |
...
| `UpdateLoadBalancerFailed` | Warning | service-controller | [10](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/10-service-networking-events.md) |
| `VolumeDeleted` | Normal | pv-controller | [11](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/11-storage-volume-events.md) |
| `VolumeFailedDelete` | Warning | pv-controller | [11](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/11-storage-volume-events.md) |
| `VolumeResizeFailed` | Warning | kubelet | [11](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/11-storage-volume-events.md) |
| `VolumeResizeSuccessful` | Normal | kubelet | [11](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/11-storage-volume-events.md) |
| `WaitForFirstConsumer` | Normal | pv-controller | [11](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/11-storage-volume-events.md) |
| `WaitingForGates` | Normal | default-scheduler | [05](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/05-scheduling-preemption-events.md) |

> 生态系统插件事件 (NPD、Ingress Controller、cert-manager、Istio、ArgoCD、Knative、Prometheus Operator、Velero、External DNS、MetalLB) 的 56+ 个事件详见 [15-ecosystem-addon-events.md](../../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/04-K8s%E4%BA%8B%E4%BB%B6/15-ecosystem-addon-events.md)
...
| 领域 | 关联说明 |
|:---|:---|
| [Domain-4: 工作负载与调度](../工作负载/) | Pod 生命周期、容器状态 |
| [Domain-5: 网络](../网络/) | Service、Ingress、DNS |
| [Domain-6: 存储](../存储/) | PV/PVC、StorageClass、CSI |
| [Domain-8: 可观测性](../可观测性/) | 事件监控、审计日志 |
| [Domain-12: 故障排查](../故障诊断/) | 各组件故障排查指南 |
| [Domain-18: 生产运维](../生产运维/) | 生产环境运维实践 |
| [Domain-20: 企业监控告警](../可观测性/) | Prometheus、告警规则 |
