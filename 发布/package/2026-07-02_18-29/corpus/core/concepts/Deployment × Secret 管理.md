...
- **TLS 证书挂载**：[[domain-17-system-foundation/知识字典/networking/ingress.md|Ingress]] Controller 或 API 服务的 Deployment 通过 Secret 卷挂载 TLS 证书。证书到期后需要滚动更新 Deployment 才能重新加载
