...
- [[domain-16-database-middleware/Operator管理/01-database-operator-patterns.md|数据库 Operator 设计模式]]
- [[domain-16-database-middleware/Operator管理/02-operator-comparison-mysql-postgres-redis.md|MySQL/PostgreSQL/Redis Operator 对比]]
