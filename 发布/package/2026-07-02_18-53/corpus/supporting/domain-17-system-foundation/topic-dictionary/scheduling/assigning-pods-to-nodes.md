...
4. **[[domain-17-system-foundation/知识字典/scheduling/pod-topology-spread-constraints.md|Pod topology spread constraints]]（Pod 拓扑分布约束）**：控制 Pod 在集群中的分布方式，如跨区域、跨节点等。
