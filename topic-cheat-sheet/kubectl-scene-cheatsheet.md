...
kubectl patch pod <pod-name> -p '{"spec":{"tolerations":[{"key":"node.kubernetes.io/not-ready","operator":"Exists","effect":"NoExecute","tolerationSeconds":300}]}}'  # 临时添加容忍
...
related:
  ...
  - domain-12-troubleshooting/00-troubleshooting-overview.md
