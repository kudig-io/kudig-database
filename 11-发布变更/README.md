...
description: 发布与变更管理知识域 — GitOps、IaC、变更管理、测试质量、部署方案、迁移方案、渐进式交付
summary: 发布与变更管理知识域入口，涵盖 ArgoCD/Flux GitOps、Terraform/Pulumi IaC、变更审批流程、金丝雀/蓝绿部署、集群迁移
category: domain
tags:
- gitops
- cicd
...
> GitOps、IaC、变更管理、测试质量、部署方案与迁移方案。

## 二级子目录

| 子目录 | 内容 | 核心话题 |
|--------|------|----------|
| [[11-发布变更/01-GitOps/index.md\|GitOps/]] | GitOps 工作流 | ArgoCD/Flux/App-of-Apps/多集群 GitOps |
| [[11-发布变更/02-IaC/index.md\|IaC/]] | 基础设施即代码 | Terraform/Pulumi/Crossplane/状态管理 |
| [[11-发布变更/03-Progressive-Delivery/index.md\|Progressive-Delivery/]] | 渐进式交付 | Argo Rollouts/Flagger/金丝雀分析/蓝绿部署 |
| [[11-发布变更/04-变更管理/index.md\|变更管理/]] | 变更控制 | 变更审批/回滚策略/变更日历/风险评估 |
| [[11-发布变更/05-测试质量/index.md\|测试质量/]] | 测试与质量 | CI 流水线/集成测试/质量门禁 |
| [[11-发布变更/06-部署方案/index.md\|部署方案/]] | 部署策略 | 金丝雀/蓝绿/滚动更新 |
| [[11-发布变更/07-迁移方案/index.md\|迁移方案/]] | 集群迁移 | 跨云迁移/版本升级/零停机迁移 |
