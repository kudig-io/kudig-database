...
本文提供经过大规模生产验证的 Helm 实践模式，覆盖 Chart 开发规范、Values 管理策略、敏感信息加密、自动化测试、模板复用和 OCI 分发。与 [[11-发布变更/01-GitOps/19-helm-production-guide.md|Helm 生产指南]] 侧重基础操作不同，本文聚焦于企业级 Chart 工程化实践。
...
Chart 变更应集成到 [[11-发布变更/01-GitOps/09-cicd-pipeline-patterns.md|CI/CD 流水线]]：
...
- [[11-发布变更/01-GitOps/07-flux-gitops-continuous-delivery.md|Flux GitOps 持续交付]]
