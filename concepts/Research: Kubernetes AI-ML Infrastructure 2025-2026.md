...
相关核心概念详见 [[concepts/k8s-ai-ml-infrastructure.md|k8s ai ml infrastructure]]，涵盖：
...
- [[concepts/container-runtime-evolution.md|container runtime evolution]] — 容器运行时演进（Wasm、gVisor）为 AI/ML 推理工作负载提供更高效的隔离与执行环境
