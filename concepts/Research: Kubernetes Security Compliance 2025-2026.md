...
相关核心概念详见 [[concepts/k8s-security-compliance.md|k8s security compliance]]，涵盖：

- [[concepts/supply-chain-security.md|supply chain security]] — Sigstore、SLSA与镜像签名验证
- eBPF 运行时安全 — eBPF运行时监控与Tetragon
- CEL 原生策略 — CEL策略引擎与Admission Policy GA
- 零信任 mTLS — mTLS、SPIFFE与零信任微分段
- [[concepts/secrets-management.md|secrets management]] — External Secrets Operator与CSI Driver
...
- [[concepts/k8s-networking-evolution.md|k8s networking evolution]] — 网络安全（Cilium NetworkPolicy、eBPF 可观测）是零信任架构的网络层核心
