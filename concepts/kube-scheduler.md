...
更多排查细节可参考 [[domain-10-troubleshooting-diagnostics/topic-structural-trouble-shooting/01-control-plane/03-scheduler-troubleshooting.md|scheduler-troubleshooting]] 与 [[node-notready]]。
