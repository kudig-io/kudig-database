...
- **NetworkPolicy 与 [[系统基础/知识字典/networking/service-mesh.md|Service Mesh]] 策略的层级关系**：NetworkPolicy（CNI 层，L3/L4）与 [[entities/istio.md|Istio]] AuthorizationPolicy（Service Mesh 层，L7）同时存在时，哪个优先？两者的冲突如何检测？当前没有标准工具可以回答"这个请求是否会被允许"的问题
