...
更多排查细节可参考 [[故障诊断/高级排障/03-networking/04-networkpolicy-troubleshooting.md|network-policy-troubleshooting]] 与 [[entities/cilium.md|cilium-network-policy]]。远程顾问应指导用户先确认 CNI 类型，再逐条核对策略规则，避免在错误的假设上消耗排查时间。
