...
更多排查细节可参考 [[domain-10-troubleshooting-diagnostics/topic-skills/skill-set/k8s-ingress-gateway/README|ingress-gateway-troubleshooting]] 与技能页面 [[domain-10-troubleshooting-diagnostics/topic-skills/skill-set/k8s-ingress-gateway/README|k8s-ingress-gateway]]。
