...
- 网络
related_topics:
- 应用模式/topic-application-architecture/12-smart-logistics-architecture
- 应用模式/topic-application-architecture/17-saas-multitenant-architecture
- 工作负载/topic-functions/04-high-concurrency-system
- 工作负载/topic-functions/07-distributed-transaction
authors:
- name: KUDIG Team
  role: contributor
k8s_versions:
