...
> **适用版本**: v1.25 - v1.32 | **最后更新**: 2026-01 | **参考**: [[23-实体/02-K8s核心组件/kubernetes.md|Kubernetes]] Workloads](https://kubernetes.io/docs/concepts/workloads/)
...
- [[10-平台工程/06-代码分析/deployment-create/10-workload-comparison.md|Deployment vs StatefulSet vs DaemonSet 选型指南]]
## See Also
...
- [[10-平台工程/06-代码分析/kubernetes-core/03-kube-controller-manager-deep-dive.md|KCM 源码深度剖析（Deployment/RS/StatefulSet 调谐链行号级实现）]]
