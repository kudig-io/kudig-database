...
| **环境变量** | [[17-系统基础/06-知识字典/workloads/downward-api.md|Downward API]] | 简单 | 只能传递静态值 | 配置传递 |
...
**参考资料**:
- [KEP-753: [[17-系统基础/06-知识字典/workloads/sidecar-containers.md|Sidecar Containers]]](https://github.com/kubernetes/enhancements/tree/master/keps/sig-node/753-sidecar-containers)
- [Kubernetes Sidecar 模式](https://kubernetes.io/blog/2023/08/25/native-sidecar-containers/)
- [[23-实体/04-网络/istio.md|Istio]] Sidecar 注入](https://istio.io/latest/docs/setup/additional-setup/sidecar-injection/)
