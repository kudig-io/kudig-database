...
- Java 应用将 `MaxRAMPercentage` 控制在 65%–75%，并显式限制 `-XX:MaxMetaspaceSize` 与 `-XX:MaxDirectMemorySize`；详见 [[02-工作负载/02-Java-on-K8s/03-jvm-gc-container-tuning.md|JVM GC 容器调优深度指南]]。
...
- [[02-工作负载/02-Java-on-K8s/03-jvm-gc-container-tuning.md|JVM GC 容器调优深度指南]]
- [[02-工作负载/02-Java-on-K8s/04-java-operator-sdk-development.md|Java Operator SDK 开发指南]]
- [[02-工作负载/02-Java-on-K8s/05-quarkus-native-kubernetes.md|Quarkus Native on Kubernetes]]
- [[02-工作负载/02-Java-on-K8s/06-java-cicd-tekton-argocd.md|Java CI/CD 与 Tekton/ArgoCD]]
- [[02-工作负载/02-Java-on-K8s/07-java-observability-kubernetes.md|Java 可观测性指南]]
