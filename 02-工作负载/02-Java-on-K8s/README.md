...
| # | 指南 | 说明 | 难度 |
|---|------|------|------|
| 5 | [Spring Boot on Kubernetes](../01-核心工作负载/25-spring-boot-kubernetes-guide.md) | 探针、配置管理、优雅停机、数据库连接池、生产 Deployment | 中级 |
| 6 | [Spring Cloud K8s + 服务网格](../../05-网络/03-服务网格/13-spring-cloud-kubernetes-service-mesh-guide.md) | Spring Cloud → K8s 原生映射、Istio 集成、Resilience4j、迁移路径 | 高级 |
