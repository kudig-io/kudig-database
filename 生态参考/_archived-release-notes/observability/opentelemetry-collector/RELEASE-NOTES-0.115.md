---
title: opentelemetry-collector v0.115 Release Notes
description: opentelemetry-collector v0.115 Release Notes — Kubernetes 生产运维知识库
summary: opentelemetry-collector v0.115 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- opentelemetry-collector v0.115 Release Notes 是什么
- 如何 opentelemetry-collector v0.115 Release Notes
trigger_keywords:
...
- `[[Service|service]]`: label metrics as alpha to communicate their stability (#11729)
