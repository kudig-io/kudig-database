---
title: opentelemetry-collector v0.132 Release Notes
description: opentelemetry-collector v0.132 Release Notes — Kubernetes 生产运维知识库
summary: opentelemetry-collector v0.132 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- opentelemetry-collector v0.132 Release Notes 是什么
- 如何 opentelemetry-collector v0.132 Release Notes
trigger_keywords:
...
# opentelemetry-collector v0.132 Release Notes

Source: [v0.132.0](https://github.com/open-telemetry/opentelemetry-collector/releases/tag/v0.132.0)
...
- `[[Service|service]]`: move service.noopTraceProvider feature gate to deprecated stage (#13492)
