...
- [v1.20.0](#v1200)
  ...
  - [What's New (Major Themes)](#whats-new-major-themes)
    ...
    - [[系统基础/topic-dictionary/workloads/cronjob.md|CronJob]] controller v2 is available through feature gate](#cronjob-controller-v2-is-available-through-feature-gate)
    ...
    - [Security Improvements for [[entities/csi-drivers.md|CSI Drivers]] (Alpha)](#security-improvements-for-csi-drivers-alpha)
