---
title: falco v0.23 Release Notes
description: falco v0.23 Release Notes — Kubernetes 生产运维知识库
summary: falco v0.23 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- falco v0.23 Release Notes 是什么
- 如何 falco v0.23 Release Notes
trigger_keywords:
- falco
- v0.23
- Release
...
# [[Falco|falco]] v0.23 Release Notes
...
* BREAKING CHANGE: the falco-driver-loader script now references `falco-probe.o` and `falco-probe.[[ko|ko]]` as `falco.o` and `falco.ko` [[#1158](https://github.com/falcosecurity/falco/pull/1158)]
...
* docs(examples): set audit level to metadata for object [[Secrets|secrets]] [[#1153](https://github.com/falcosecurity/falco/pull/1153)]
