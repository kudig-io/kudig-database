---
title: opentelemetry-collector v0.68 Release Notes
description: opentelemetry-collector v0.68 Release Notes — Kubernetes 生产运维知识库
summary: opentelemetry-collector v0.68 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- opentelemetry-collector v0.68 Release Notes 是什么
- 如何 opentelemetry-collector v0.68 Release Notes
trigger_keywords:
...
- `[[Service|service]]`: Remove deprecated `service.[Collector|New|CollectorSettings|ConfigProvider]` (#5564)
...
- `configgrpc`: Fix todo to add MeterProvider to [[gRPC|grpc]] instrumentation (#4030)
