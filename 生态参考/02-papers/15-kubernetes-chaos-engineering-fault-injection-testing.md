...
# [[Kubernetes|Kubernetes]] 混沌工程与故障注入测试 ([[系统基础/topic-dictionary/operations/chaos-engineering.md|Chaos Engineering]] and Fault Injection Testing)
...
故障注入类型体系:
  ...
  平台层问题:
    - API Server问题: 响应延迟、部分失效
    - etcd问题: 数据库延迟、leader选举
    - 调度器问题: 调度延迟、调度失败
