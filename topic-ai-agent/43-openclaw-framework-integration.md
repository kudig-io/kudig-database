...
## 3. OpenClaw × Harness Engineering 映射矩阵
...
```
topic-ai-agent/openclaw-workspace/
...
|--------------|---------------------------|-------------|
| SOUL.md | [domain-7-security](../domain-7-security/) | 安全红线规则来源 |
| USER.md | [domain-9-platform-ops](../domain-9-platform-ops/) | 运维工程师角色定义 |
| AGENTS.md | [domain-12-troubleshooting](../domain-12-troubleshooting/) | 诊断工作流模板 |
| TOOLS.md | [domain-5-networking](../domain-5-networking/), [domain-8-observability](../domain-8-observability/) | 工具使用规范 |
| SKILL.md | [topic-fta](../topic-fta/), [topic-structural-trouble-shooting](../topic-structural-trouble-shooting/) | 故障树 + SOP 知识 |
| MEMORY.md | [domain-33-kubernetes-events](../domain-33-kubernetes-events/) | 事件模式知识库 |
...
*本文档为 kudig-database 项目 topic-ai-agent 专题原创内容，基于 OpenClaw 框架设计理念与 Harness Engineering 最佳实践编写。*
