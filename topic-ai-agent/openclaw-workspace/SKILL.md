...
|--------|------------------------|
| Pod 故障 | `domain-12-troubleshooting/05-pod-pending-diagnosis.md` ~ `08-pod-comprehensive-troubleshooting.md` |
| Node 故障 | `domain-12-troubleshooting/06-node-notready-diagnosis.md`, `09-node-comprehensive-troubleshooting.md` |
| Network 故障 | `domain-12-troubleshooting/25-network-connectivity-troubleshooting.md`, `26-dns-troubleshooting.md` |
| Storage 故障 | `domain-12-troubleshooting/14-pvc-storage-troubleshooting.md`, `04-storage-csi-troubleshooting.md` |
| 性能问题 | `domain-12-troubleshooting/33-performance-bottleneck-troubleshooting.md` |
