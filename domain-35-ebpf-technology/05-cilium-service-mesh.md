...
> **关键词**: Cilium, eBPF, Service Mesh, Sidecar-less, mTLS, SPIFFE, Gateway API, L7 流量管理
...
## 1. Service Mesh 演进：Sidecar → Sidecar-less
...
## 附录 A：Cilium Service Mesh 完整配置参考
