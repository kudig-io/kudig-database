...
| 02-ai-agents/ | AI Agent 框架、RAG、工具调用 |
| 03-mlops/ | 实验管理、模型注册、AutoML |

## 与其他 Domain 的关系

- [[domain-02-workloads-applications/README|domain-02-workloads-applications]] — 工作负载调度
- [[domain-07-platform-engineering/README|domain-07-platform-engineering]] — 平台资源管理
