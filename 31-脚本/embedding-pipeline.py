...
功能：
  1. 读取 35-元数据/corpus-config/profiles/*.yaml 配置
...
用法：
  python3 31-脚本/embedding-pipeline.py --profile 35-元数据/corpus-config/profiles/rag-sre-profile.yaml
  python3 31-脚本/embedding-pipeline.py --profile 35-元数据/corpus-config/profiles/rag-full-profile.yaml --incremental
  python3 scripts/embedding-pipeline.py --search "node notready" --top-k 5

输出：
  35-元数据/corpus-config/profiles/.vector-cache/<profile-name>/
