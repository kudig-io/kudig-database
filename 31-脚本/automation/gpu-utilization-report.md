...
echo "    - Review [[31-脚本/prompts/cost-analysis|cost analysis]] for GPU cost optimization"
...
- 配合 [[31-脚本/prompts/cost-analysis|成本优化 Prompt]] 分析 GPU 空闲时段的成本浪费
- 结合 [[31-脚本/prompts/capacity-review|容量规划 Prompt]] 评估 GPU 右 Sizing
