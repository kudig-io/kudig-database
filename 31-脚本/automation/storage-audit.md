...
echo "   5. Use [[31-脚本/prompts/cost-analysis|cost analysis prompt]] for full ROI"
```
...
- 配合 [[31-脚本/automation/resource-cleanup|资源清理脚本]] 清理孤立 PVC
- 配合 [[31-脚本/prompts/cost-analysis|成本优化 Prompt]] 评估存储降级的成本节省
