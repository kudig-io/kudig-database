...
cross_refs:
  - type: "skill"
    path: "../19-故障诊断/topic-skills/{{NN}}-{{scenario}}.md"
    label: "{{技能名称}}"
  - type: "domain"
    path: "../domain-{{N}}-{{name}}/{{doc}}.md"
    label: "{{文档名称}}"
  - type: "structural"
    path: "../19-故障诊断/04-高级排障/structural-{{component}}-*.md"
    label: "结构化故障排查"
...
| FEBM | [../故障诊断/FEBM方法论/{{NN}}-{{scenario}}.md](../故障诊断/FEBM方法论/{{NN}}-{{scenario}}.md) | 取证分析方法 |
| 速查卡 | [../系统基础/topic-cheat-sheet/k8s.md](../../17-%E7%B3%BB%E7%BB%9F%E5%9F%BA%E7%A1%80/05-%E9%80%9F%E6%9F%A5%E5%8D%A1/k8s.md) | 命令速查 |
...
> **关联文档**: [故障诊断/FTA故障树/fta-methodology-and-agentic-practices.md](../../19-%E6%95%85%E9%9A%9C%E8%AF%8A%E6%96%AD/06-FTA%E6%95%85%E9%9A%9C%E6%A0%91/fta-methodology-and-agentic-practices.md)（FTA 方法论与 AI Agent 智能运维实践）
