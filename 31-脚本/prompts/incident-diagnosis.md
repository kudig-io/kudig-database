...
5. 升级建议: 建议通知 DBA 团队排查连接池; 参考 Runbook: [[19-故障诊断/08-技能体系/skill-08-oom-troubleshooting]]
```
...
- [[19-故障诊断/06-FTA故障树/MOC|FTA 故障树索引]] — 根因映射参考
- [[19-故障诊断/07-FEBM方法论/MOC|FEBM 证据收集方法论]] — 证据分级标准
- [[31-脚本/templates/runbook-template|Runbook 模板]] — 配套 Runbook 编写
