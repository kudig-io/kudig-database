...
4. 右 Sizing 建议参考 [[31-脚本/prompts/capacity-review|容量规划审查]] 的详细分析
5. 定期执行: 建议每月一次成本回顾，每季度一次深度优化

## 参考文档

- [[22-概念/bp-cost-optimization|成本优化最佳实践]] — FinOps 规范
- [[31-脚本/prompts/capacity-review|容量规划审查]] — 右 Sizing 详细分析
- [[31-脚本/automation/resource-cleanup|资源清理脚本]] — 闲置资源清理
