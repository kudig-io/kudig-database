...
整合原 专项技术/37/38 的专项技术知识，涵盖边缘计算、WebAssembly 和 K8s 扩展。
...
| 04-serverless/ | Knative、Serverless 工作负载 |
| 05-ebpf-programming/ | eBPF 编程与高级网络可观测 |

## 与其他 Domain 的关系

- [[集群基础/README.md|集群基础]] — 扩展机制基础
- [[平台工程/README.md|平台工程]] — 平台扩展
