...
7. **与 [[专项技术/边缘计算/03-kubeedge-architecture-deployment|KubeEdge 架构]] 和 [[专项技术/边缘计算/05-openyurt-architecture|OpenYurt 架构]] 配合**：了解底层原理
8. **监控集成**：边缘节点指标通过 [[可观测性/prometheus|Prometheus]] 联邦或 Pushgateway 上报
...
- [[专项技术/边缘计算/03-kubeedge-architecture-deployment|KubeEdge 架构部署]]
- [[专项技术/边缘计算/05-openyurt-architecture|OpenYurt 架构]]
- [[专项技术/边缘计算/14-edge-production-runbook|边缘生产运维手册]]
- [[专项技术/边缘计算/15-virtual-kubelet-serverless-node|Virtual Kubelet]]
- [[集群基础/节点管理|节点管理]]
- [[生产运维/升级策略|升级策略]]
