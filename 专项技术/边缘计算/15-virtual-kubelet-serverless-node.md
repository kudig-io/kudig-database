...
6. **与 [[专项技术/边缘计算/01-edge-computing-architecture|边缘计算]] 结合**：边缘节点通过 Virtual Kubelet 连接到中心集群
7. **参考 [[平台工程/99-karpenter-node-autoscaling-guide|Karpenter]] 对比**：稳态扩容用 Karpenter，突发 Burst 用 Virtual Kubelet

## Related

- [[专项技术/边缘计算/01-edge-computing-architecture|边缘计算架构]]
- [[专项技术/边缘计算/16-edge-fleet-lifecycle-management|边缘舰队管理]]
- [[平台工程/99-karpenter-node-autoscaling-guide|Karpenter 节点自动伸缩]]
- [[平台工程/99-keda-event-driven-autoscaling-guide|KEDA 事件驱动伸缩]]
- [[集群基础/节点管理|节点管理]]
- [[工作负载/pod-scheduling|Pod 调度]]
