...
- **高可用与灾难恢复**：服务在多个集群中同时运行，单个集群故障时流量自动切换
...
| **Failover** | 本地集群健康时优先本地，故障时切换到远端 | 高可用保障 |
...
1. **全球化电商服务**：用户在北京访问时，订单服务调用本地的库存服务；当北京集群故障时，自动切换到上海的库存服务
...
- **证书管理复杂化**：多集群 mTLS 需要统一的 CA 或互信的 CA 链，建议使用 cert-manager + Vault 集中管理
