...
对于大规模多集群场景，ApplicationSet 更灵活（见 [[清单模式/04-gitops-patterns/02-argocd-applicationset-multi-cluster|ApplicationSet 文档]]）。
...
- [[清单模式/04-gitops-patterns/02-argocd-applicationset-multi-cluster|ApplicationSet 多集群]]
