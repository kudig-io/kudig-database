...
4. **与 [[清单模式/08-platform-patterns/02-cue-language-configuration|CUE]] 对比选择**：需要强类型选 CUE，需要复杂逻辑选 Jsonnet
5. **与 [[综合/helm-gitops|Helm GitOps]] 配合**：Tanka 管理基础设施，Helm 管理应用
6. **参考 [[清单模式/08-platform-patterns/index|平台模式索引]] 了解全局**
...
- [[综合/argocd-gitops|ArgoCD GitOps 综合]]
