...
- [[清单模式/07-resilience-patterns/03-vpa-patterns|VPA 集成模式]]
- [[清单模式/07-resilience-patterns/04-karpenter-nodepool-patterns|Karpenter NodePool]]
- [[清单模式/YAML参考/27-hpa-autoscaling-v2|HPA 参考文档]]
