...
- **官方文档**:
  - [Extend [[系统基础/知识字典/fundamentals/the-kubernetes-api.md|the Kubernetes API]] with the aggregation layer](https://kubernetes.io/docs/concepts/extend-kubernetes/api-extension/apiserver-aggregation/)
