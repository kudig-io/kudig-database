...
groups:
  ...
  - name: slo_fast_burn
    ...
    rules:
      ...
      # 双窗口验证: 1h 短窗口 + 1h 长窗口（相同，用于快速检测持续故障）
...
预算消耗:
  故障期间请求: 2,000,000 × (30/1440) = 41,667 次
...
场景 3: 第三方支付网关间歇性故障，错误率波动
─────────────────────────────────────────────────

10:00 网关故障，错误率 2%，持续 10 分钟
10:10 网关恢复，错误率正常
...
| **依赖故障未覆盖** | 下游故障未触发告警 | 添加依赖服务 Burn Rate 监控 |
