...
> 构建、运维、治理、开发体验与平台代码分析。

## 二级子目录

| 子目录 | 内容 | 核心话题 |
|--------|------|----------|
| [[10-平台工程/01-构建/index.md\|构建/]] | CI/CD | Tekton/Argo Workflows、构建优化、制品管理 |
| [[10-平台工程/02-运维/index.md\|运维/]] | 平台运维 | 自动化运维、Day-2 操作、平台 SRE |
| [[10-平台工程/03-治理/index.md\|治理/]] | 治理 | 策略引擎、合规、多租户、配额管理 |
| [[10-平台工程/04-开发体验/index.md\|开发体验/]] | DX | IDP/Backstage、自助服务、Golden Path |
| [[10-平台工程/06-代码分析/README.md\|代码分析/]] | 分析 | 代码质量、技术债务、依赖审计 |
