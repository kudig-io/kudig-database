...
- 成本数据接入 [[10-平台工程/03-治理/03-cost-optimization-finops|FinOps 平台]]
- 准入策略通过 [[10-平台工程/03-治理/06-multi-tenant-management|多租户管理]] 统一管理
...
- [[24-综合/01-AI与机器学习/gpu-operator-device-plugin-ecosystem|GPU Operator 生态]]
- [[10-平台工程/03-治理/06-multi-tenant-management|多租户管理]]
- [[10-平台工程/03-治理/03-cost-optimization-finops|成本优化与 FinOps]]
- [[14-容器运行时/03-containerd-CRI-O/19-gpu-runtime-nvidia-cdi|GPU 运行时]]
