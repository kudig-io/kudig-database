...
4. **成本透明**：每个实验/训练/推理的 GPU 费用实时可见，接入 [[10-平台工程/03-治理/03-cost-optimization-finops|FinOps]] 体系
...
- 集成到 [[10-平台工程/01-构建/03-backstage-deployment|Backstage]] 开发者门户
...
- 多租户隔离参考 [[10-平台工程/03-治理/06-multi-tenant-management|多租户管理]]
