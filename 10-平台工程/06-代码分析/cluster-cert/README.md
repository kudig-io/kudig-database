...
Kubernetes 集群的认证与授权体系高度依赖 PKI（Public Key Infrastructure，公钥基础设施）。一个标准的 kubeadm 部署的集群包含超过 10 组证书/密钥对，涵盖 API Server、etcd、kubelet、Controller Manager、Scheduler、Front Proxy 等所有组件的身份认证。理解这些证书的生成逻辑、信任链关系和轮换机制，对于集群安全管理和故障排查至关重要。
...
- [[31-脚本/templates/cheat-sheet-template.md|cheat sheet template]]
- [[17-系统基础/06-知识字典/operations/certificates.md|certificates]]
- [[10-平台工程/06-代码分析/cluster-cert/11-apiserver-cert-flags.md|11-apiserver-cert-flags]]

- [[10-平台工程/06-代码分析/node-create/README.md|Node Create 模块函数索引]]
- [[10-平台工程/06-代码分析/cluster-create/README.md|Cluster Create — Kubernetes 集群新建源码分析]]
