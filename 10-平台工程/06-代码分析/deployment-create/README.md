...
- [`rolloutRecreate`](07-recreate-strategy.md) — Recreate 策略：先全停再全启
- [`calculateStatus`](05-deployment-status.md) — 计算 Deployment Status 的各个字段
- [`rollbackToRevision`](06-revision-history.md) — 版本回滚的实现逻辑
- [`HPA 集成`](08-hpa-integration.md) — Deployment 与 HorizontalPodAutoscaler 集成分析
- [`金丝雀与蓝绿发布`](09-canary-bluegreen.md) — 进阶发布模式工程实践
- [`工作负载选型`](10-workload-comparison.md) — Deployment vs StatefulSet vs DaemonSet 对比
...
- [[26-技能/04-工作负载/deployment/deployment-canary-and-bluegreen.md|deployment-canary-and-bluegreen]]
- [[23-实体/02-K8s核心组件/kubernetes.md|kubernetes]]
- [[23-实体/08-交付与制品/ko.md|ko]]
