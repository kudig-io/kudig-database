---
title: Agent Harness 可观测性体系 (AI基础设施)
...
本文系统阐述 Agent Harness 的可观测性架构，包括 OpenTelemetry 集成、[[AI基础设施/03-agent-runtime/13-agent-observability-langfuse.md|Langfuse]] 追踪、Prometheus 指标体系、告警规则设计、调试工具链，以及生产级 Dashboard 方案。
