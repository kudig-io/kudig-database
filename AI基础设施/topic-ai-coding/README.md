...
| 专题/领域 | 与本专题的关系 |
|---------|--------------|
| [02-ai-agents](../AI基础设施/02-ai-agents/) | Agent CLI 系列，OpenRouter 是主流 Agent 工具的统一 LLM 后端 |
| [domain-11-ai-infra](../AI基础设施/) | AI 基础设施，OpenRouter 作为 LLM 推理服务的统一接入层 |
| [domain-40-cloud-native-api-gateway](../网络/) | 云原生 API 网关，OpenRouter 是 LLM 领域的 API Gateway 实践 |
...
- [[AI基础设施/topic-ai-coding/06-openrouter-structured-outputs-tools.md|06-openrouter-structured-outputs-tools]]
- [[AI基础设施/topic-ai-coding/01-openrouter-overview-architecture.md|01-openrouter-overview-architecture]]
- [[AI基础设施/topic-ai-coding/09-openrouter-frameworks-integrations.md|09-openrouter-frameworks-integrations]]
- [[AI基础设施/topic-ai-coding/10-openrouter-streaming-multimedia.md|10-openrouter-streaming-multimedia]]
- [[AI基础设施/topic-ai-coding/29-opencode-tui-customization.md|29-opencode-tui-customization]]
- [[AI基础设施/topic-ai-coding/03-openrouter-models-providers.md|03-openrouter-models-providers]]
- [[AI基础设施/topic-ai-coding/07-openrouter-plugins-web-search.md|07-openrouter-plugins-web-search]]
- [[AI基础设施/topic-ai-coding/02-openrouter-quickstart-setup.md|02-openrouter-quickstart-setup]]
- [[AI基础设施/topic-ai-coding/23-opencode-providers-models.md|23-opencode-providers-models]]
