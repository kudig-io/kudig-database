...
- uses: anomalyco/opencode/github@latest
  with:
    ...
    prompt: |
      ...
      1. [[安全/README.md|security]] vulnerabilities (OWASP Top 10)
...
| [AI基础设施/02-ai-agents/28](../AI基础设施/02-ai-agents/28-agent-cli-enterprise-automation.md) | Agent CLI 企业自动化通用指南 |
