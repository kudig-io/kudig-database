...
| 结构化排障 | `故障诊断/topic-structural-trouble-shooting/` | 48+ | ~600K 字 | ★★★★★ 已有决策树结构 |
...
structural_ref: 故障诊断/topic-structural-trouble-shooting/05-workloads/01-pod-troubleshooting.md
---
```
...
| `故障诊断/topic-structural-trouble-shooting/` 48+ 篇 | ★★★★☆ 决策树 | ~150+ | ✗ 需提取为映射表 |
...
| `故障诊断/topic-structural-trouble-shooting/` | 48+ | 决策树、症状映射 | 低 - 已半结构化 |
