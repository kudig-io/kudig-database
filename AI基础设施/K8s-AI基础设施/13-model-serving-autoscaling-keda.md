...
- 利用 [[AI基础设施/K8s-AI基础设施/16-cdi-device-plugin-framework.md|CDI 与 Device Plugin 框架]] 优化设备分配
...
5. **GPU 资源池化**：结合 [[AI基础设施/基础设施/03-gpu-scheduling-management.md|GPU 调度与管理]] 实现跨模型 GPU 共享
