...
| 场景 | 文件 | 说明 |
|:---|:---|:---|
| 确认收到 | [[13-生产运维/06-回复话术/01-acknowledgment.md|确认收到话术]] | 标准、紧急、非工作时间、重复问题、节假日、VIP 等确认模板 |
| 请求信息 | [[13-生产运维/06-回复话术/02-information-request.md|请求信息话术]] | 通用信息、诊断命令、权限、变更记录、日志截图、业务影响、时间线 |
| 给出方案 | [[13-生产运维/06-回复话术/03-solution-proposal.md|给出方案话术]] | 临时缓解、完整修复、自助修复、需审批方案、多选方案、配置变更、补丁升级 |
| 升级通知 | [[13-生产运维/06-回复话术/04-escalation-notice.md|升级通知话术]] | 标准升级、P0 紧急、厂商/底座团队、内部协调、非工作时间、跨团队 |
| 闭环确认 | [[13-生产运维/06-回复话术/05-closure-confirmation.md|闭环确认话术]] | 已解决、待用户确认、暂时缓解观察、未复现/咨询、邀请评价、自动关闭 |
...
- [[13-生产运维/03-事件响应/escalation-playbook.md|升级与交接协议]]
- [[19-故障诊断/08-技能体系/skill-set/k8s-node-notready/SKILL.md|K8s Node NotReady 诊断与修复 Skill]]

## See Also

- 工单闭环样本库 `生产运维/ticket-cases/`
- [[13-生产运维/README.md|Production Operations Domain]]
