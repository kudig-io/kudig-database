...
> 成本治理、集群治理、事件响应、绿色计算、工单案例与回复话术。
> 场景入口：[[13-生产运维/08-运维场景剧本/index.md|运维场景剧本总索引]] —— 按生产场景编排 FTA 故障树、技能卡与工单案例的可执行工作流。

## 二级子目录

| 子目录 | 内容 | 核心话题 |
|--------|------|----------|
| [[13-生产运维/01-成本治理/index.md\|成本治理/]] | FinOps | 资源右调优、Spot/RI、成本分摊、Kubecost |
| [[13-生产运维/02-集群治理/index.md\|集群治理/]] | 治理 | OPA/Gatekeeper、准入控制、合规审计 |
| [[13-生产运维/03-事件响应/index.md\|事件响应/]] | 事件 | On-Call 流程、严重级定义、升级路径、复盘 |
| [[13-生产运维/04-绿色计算/index.md\|绿色计算/]] | 绿色 | 碳排放监控、能效优化、调度策略 |
| [[13-生产运维/05-工单案例/index.md\|工单案例/]] | 工单 | 典型故障工单、处理流程、知识沉淀 |
| [[13-生产运维/06-回复话术/README.md\|回复话术/]] | 话术 | 客户沟通模板、状态通报、SLA 说明 |
| [[13-生产运维/07-运维手册/index.md\|运维手册/]] | 手册 | SRE 日常运营、变更管理、容量规划、安全运营 |
| [[13-生产运维/08-运维场景剧本/index.md\|运维场景剧本/]] | 剧本 | 工单剧本编排层：20 个生产场景 × 触发条件 → 工作流分支 → 验证清单 |
