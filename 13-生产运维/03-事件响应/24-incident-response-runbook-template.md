...
- **节点大面积 NotReady**：隔离异常节点并扩容健康节点池。
  ...
  ```
- **证书过期**：参考 [[01-集群基础/03-控制平面/34-certificate-pki-lifecycle-runbook.md|Kubernetes 证书与 PKI 生命周期运维 Runbook]]。
...
- [[19-故障诊断/00-总览/99-production-readiness-operations-guide.md|故障诊断 生产就绪运维指南]]
