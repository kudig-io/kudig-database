...
- name: KUDIG Team
  role: contributor
relationships:
- target: '[[17-系统基础/06-知识字典/networking/dns-resolution.md]]'
  type: related_to
- target: '[[23-实体/02-K8s核心组件/coredns.md]]'
  type: related_to
- target: '[[17-系统基础/06-知识字典/networking/dns.md]]'
  type: related_to
- target: '[[13-生产运维/05-工单案例/ticket-case-013-configmap-secret-update-not-effective.md]]'
  type: related_to
- target: '[[17-系统基础/06-知识字典/configuration/configmap.md]]'
  type: related_to
- target: '[[22-概念/03-网络/service-networking.md]]'
  type: related_to
---
...
- CoreDNS (entities)
- 域名服务
- [[13-生产运维/05-工单案例/ticket-case-013-configmap-secret-update-not-effective.md|ConfigMap/Secret 更新后应用未生效]]
- 配置映射
