...
- '[[10-平台工程/03-治理/03-capacity-planning-resource-assessment.md|容量规划与资源评估]]'
fta_ref:
- '[[19-故障诊断/06-FTA故障树/list/scheduler-fta.md|FTA: Scheduler
  异常]]'
...
- target: '[[13-生产运维/05-工单案例/ticket-case-041-ingress-controller-502.md]]'
  type: related_to
- target: '[[13-生产运维/05-工单案例/ticket-case-017-pod-pending-resource-exhaustion.md]]'
  type: related_to
---
...
> - 配置 [[10-平台工程/03-治理/03-capacity-planning-resource-assessment.md|容量规划]] 流程，评估节点池是否需要升级实例规格。
>
> 如有新异常请随时联系。
...
- [[13-生产运维/05-工单案例/ticket-case-017-pod-pending-resource-exhaustion.md|Pod 大量 Pending：节点 CPU/内存资源不足]]
