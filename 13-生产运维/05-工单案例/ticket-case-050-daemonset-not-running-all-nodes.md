...
skill_ref:
- '[[02-工作负载/01-核心工作负载/04-daemonset-management.md|DaemonSet
  管理]]'
- Logtail 排障
- '[[19-故障诊断/08-技能体系/skill-set/k8s-node-notready/SKILL.md|节点诊断
  Skill]]'
fta_ref:
...
- name: KUDIG Team
  role: contributor
relationships:
- target: '[[22-概念/02-工作负载/daemonset.md]]'
  type: related_to
...
> - 对带 Taint 的节点建立标准化 Toleration 清单，参考 [[02-工作负载/01-核心工作负载/04-daemonset-management.md|DaemonSet 管理]]；
