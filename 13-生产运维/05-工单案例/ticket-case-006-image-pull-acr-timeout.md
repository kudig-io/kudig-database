...
- target: '[[23-实体/02-K8s核心组件/deployment.md]]'
  type: related_to
- target: '[[17-系统基础/06-知识字典/operations/rolling-update.md]]'
  type: related_to
- target: '[[26-技能/04-工作负载/deployment/deployment-rolling-update.md]]'
  type: related_to
- target: '[[13-生产运维/05-工单案例/ticket-case-009-etcd-disk-full-apiserver-slow.md]]'
  type: related_to
---
