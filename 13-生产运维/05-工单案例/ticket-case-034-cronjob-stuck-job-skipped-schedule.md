...
- '[[19-故障诊断/06-FTA故障树/list/job-cronjob-fta.md|FTA:
  CronJob 执行失败]]'
- '[[19-故障诊断/06-FTA故障树/list/deployment-fta.md|FTA: 工作负载发布失败]]'
...
- name: KUDIG Team
  role: contributor
relationships:
- target: '[[22-概念/02-工作负载/cronjob.md]]'
  type: related_to
- target: '[[13-生产运维/05-工单案例/ticket-case-049-job-cronjob-execution-failure.md]]'
  type: related_to
...
>
> **后续建议：**
> - 参考 [[02-工作负载/01-核心工作负载/05-job-cronjob-advanced.md|Job/CronJob 进阶]] review 所有 CronJob 的 `concurrencyPolicy` 与超时设置；
