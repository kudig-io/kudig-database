...
当监控触发 P0/P1 告警时，立即按 [[13-生产运维/03-事件响应/03-on-call-playbook.md|值班手册]] 启动升级，并按 [[13-生产运维/03-事件响应/04-incident-response-template.md|事故响应模板]] 记录时间线。
...
- 集群升级运维手册（待补充）
- [[13-生产运维/07-运维手册/10-observability-operations.md|可观测性运维]]（待补充）
- GitOps 运维（待补充）
- 自动化修复运维（待补充）
- 节点与容器运行时运维（待补充）
