...
**修复方案**：确保 DCGM Exporter 和 NVIDIA Device Plugin 正确部署（参考 [[15-AI基础设施/01-基础设施/04-gpu-monitoring-dcgm.md|GPU 监控 DCGM]]）；验证 OpenCost 的 pricing ConfigMap 中 GPU 型号名称与节点标签匹配。
...
2. **时间切片共享**：开发环境使用 GPU Time-Slicing（参考 [[15-AI基础设施/01-基础设施/03-gpu-scheduling-management.md|GPU 调度与管理]]），多个轻量任务共享一张卡
...
- [[15-AI基础设施/01-基础设施/12-ai-cost-analysis-finops.md|AI 成本分析 FinOps]]
