...
本文聚焦 vLLM 在 Kubernetes 上的生产级部署，覆盖从基础 Deployment 到多 GPU Tensor Parallel、量化推理、性能调优、监控告警和故障排查的完整链路。关于模型部署的整体架构，参见 [[15-AI基础设施/05-K8s-AI基础设施/05-kserve-model-serving-platform|10-model-deployment-serving]]；GPU 调度基础参见 [[22-概念/07-调度与资源/gpu-scheduling-ai-workloads]]。
...
7. ** Gang Scheduling**：多 GPU Pod 需要所有 GPU 同时就绪，建议配合 [[22-概念/07-调度与资源/gang-scheduling]] 避免资源碎片化导致的调度死锁。

## Related

- [[15-AI基础设施/05-K8s-AI基础设施/05-kserve-model-serving-platform|10-model-deployment-serving]]
