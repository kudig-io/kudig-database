...
关于 GPU 资源管理和调度，参见 [[15-AI基础设施/01-基础设施/03-gpu-scheduling-management]]；模型部署生命周期管理参见 [[15-AI基础设施/05-K8s-AI基础设施/05-kserve-model-serving-platform|10-model-deployment-serving]]。
