...
1. **度量层**：OpenCost/Kubecost 归因到团队/项目/模型（参考 [[15-AI基础设施/05-K8s-AI基础设施/14-gpu-cost-attribution-multitenant.md|GPU 成本分摊与多租户 AI 平台]]）
...
- [[15-AI基础设施/05-K8s-AI基础设施/16-cdi-device-plugin-framework.md|CDI 与 Device Plugin 框架]]
