...
本文将系统性地覆盖 GPU Operator 的生产部署、各共享模式的配置方法、方案选型对比以及常见故障的排查路径。关于 GPU 调度的基础概念，参见 [[22-概念/07-调度与资源/gpu-scheduling-ai-workloads]]；GPU 监控相关内容参见 [[15-AI基础设施/01-基础设施/04-gpu-monitoring-dcgm]]。
...
4. **监控先行**：部署 DCGM Exporter 并配置 Prometheus 告警规则，监控 GPU 利用率、显存使用、温度、XID 错误。参见 [[15-AI基础设施/01-基础设施/04-gpu-monitoring-dcgm]]。
