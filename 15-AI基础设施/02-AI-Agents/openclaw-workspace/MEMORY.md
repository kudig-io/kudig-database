...
known_issues:
  - id: KI-001
    ...
    reference: "故障诊断/03-networking-cni-troubleshooting.md"
  ...
  - id: KI-002
    ...
    reference: "故障诊断/14-pvc-storage-troubleshooting.md"
  ...
  - id: KI-003
    ...
    reference: "故障诊断/26-dns-troubleshooting.md"
...
| 检查项 | 频率 | 说明 |
|--------|------|------|
| 过期记忆清理 | 每周 | 删除已被新规则替代的旧条目 |
| 冲突检测 | 每次写入 | 新记忆与已有记忆矛盾时合并 |
| 精度校验 | 每月 | 抽样验证记忆与实际代码一致性 |
| 容量控制 | 持续 | 单文件不超过 500 行，超出则拆分 |
