...
没有评测的 Agent 是黑盒。评测体系解决"Agent 质量是否达标"的问题，可观测性解决"Agent 为什么这么做"的问题。本文覆盖从单轮问答到多步轨迹的全面评测框架、RAGAS/LLM-as-Judge 实施方法、LangSmith/[[15-AI基础设施/03-Agent运行时/13-agent-observability-langfuse.md|Langfuse]]/Phoenix 的配置与使用，以及生产 Agent 的关键监控指标体系。
...
| [domain-20-enterprise-monitoring-alerting](../可观测性/) | 企业级监控告警系统 |
| [可观测性](../可观测性/) | 可观测性基础设施 |
