...
| 文档 | 关系 |
|------|------|
| [05 - 工具与权限](17-opencode-tools-permissions.md) | MCP 工具的权限配置 |
| [04 - Agent 系统](16-opencode-agents-system.md) | Per-Agent MCP 配置 |
| [10 - Server API](22-opencode-server-api.md) | MCP 动态管理 API |
| [AI基础设施/02-ai-agents/25](../02-AI-Agents/25-agent-cli-mcp-integration.md) | MCP 协议通用指南 |
