...
| 文档 | 关系 |
|------|------|
| [01 - 概述与架构](13-opencode-overview-architecture.md) | 理解 OpenCode 全貌 |
| [03 - Provider 与模型管理](15-opencode-providers-models.md) | 深入 Provider 配置 |
| [04 - Agent 系统](16-opencode-agents-system.md) | 深入 Build/Plan 模式 |
| [09 - TUI 定制](21-opencode-tui-customization.md) | 自定义快捷键和主题 |
