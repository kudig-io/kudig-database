...
└── .opencode/
    ├── agents/                # 自定义 Agent
    │   ├── review.md
    │   └── [[23-实体/02-K8s核心组件/kubernetes.md|k8s]]-ops.md
    ├── commands/              # 自定义命令
    │   ├── test.md
    │   └── deploy.md
    ├── skills/                # Agent Skill
...
| 文档 | 关系 |
|------|------|
| [01 - 概述与架构](13-opencode-overview-architecture.md) | 架构基础 |
| [05 - 工具与权限](17-opencode-tools-permissions.md) | 安全权限详解 |
| [06 - MCP 集成](18-opencode-mcp-integration.md) | MCP 故障排查 |
| [10 - Server API](22-opencode-server-api.md) | Server 安全配置 |
| [11 - GitHub CI/CD](23-opencode-github-automation.md) | CI/CD 自动化 |
