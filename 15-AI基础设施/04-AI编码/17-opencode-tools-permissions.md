...
> **文档类型**: 核心能力专题 | **最后更新**: 2026-03 | **关键词**: OpenCode, Tools, Permissions, Custom Tools, bash, edit, read, grep, [[08-安全/README.md|security]], TypeScript
...
| 文档 | 关系 |
|------|------|
| [04 - Agent 系统](16-opencode-agents-system.md) | Per-Agent 权限配置 |
| [06 - MCP 集成](18-opencode-mcp-integration.md) | MCP 工具的权限管理 |
| [12 - 进阶话题](24-opencode-advanced-topics.md) | 安全加固策略 |
