...
└──────────────┘               └───────┬─────────┘
                                       │
┌──────────────┐               ┌───────▼─────────┐
│  自定义客户端  │◄──────────►│  SQLite [[06-存储/README.md|storage]]  │
│  (SDK/脚本)   │               └─────────────────┘
└──────────────┘
```
...
| 文档 | 关系 |
|------|------|
| [01 - 概述与架构](13-opencode-overview-architecture.md) | Client/Server 架构详解 |
| [11 - GitHub CI/CD](23-opencode-github-automation.md) | 基于 Server 的自动化 |
