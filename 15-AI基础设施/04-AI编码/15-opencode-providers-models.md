...
| 文档 | 关系 |
|------|------|
| [02 - 安装部署](14-opencode-installation-quickstart.md) | Provider 快速配置 |
| [04 - Agent 系统](16-opencode-agents-system.md) | Per-Agent 模型配置 |
| [12 - 进阶话题](24-opencode-advanced-topics.md) | 成本控制策略 |
