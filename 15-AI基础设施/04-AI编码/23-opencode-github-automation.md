...
- uses: anomalyco/opencode/github@latest
  with:
    ...
    prompt: |
      ...
      1. [[08-安全/README.md|security]] vulnerabilities (OWASP Top 10)
...
| 文档 | 关系 |
|------|------|
| [10 - Server 模式](22-opencode-server-api.md) | 理解底层 Server 架构 |
| [04 - Agent 系统](16-opencode-agents-system.md) | 配置执行 Agent |
| [12 - 进阶话题](24-opencode-advanced-topics.md) | 非交互模式与安全 |
| [AI基础设施/02-ai-agents/28](../02-AI-Agents/28-agent-cli-enterprise-automation.md) | Agent CLI 企业自动化通用指南 |
