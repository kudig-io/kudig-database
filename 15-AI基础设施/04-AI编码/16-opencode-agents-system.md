...
| 文档 | 关系 |
|------|------|
| [05 - 工具与权限](17-opencode-tools-permissions.md) | Agent 的工具和权限配置 |
| [08 - [[SKILL|Skill]] 与命令](20-opencode-skills-commands.md) | Agent 可加载的 Skill 定义 |
| [03 - Provider 与模型](15-opencode-providers-models.md) | Per-Agent 模型选择 |
| [12 - 进阶话题](24-opencode-advanced-topics.md) | 团队级 Agent 协作模式 |
