...
<available_skills>
  ...
  <skill>
    <name>k8s-debug</name>
    <description>Debug [[23-实体/02-K8s核心组件/kubernetes.md|kubernetes]] pod issues</description>
  </skill>
</available_skills>
```
...
| 文档 | 关系 |
|------|------|
| [04 - Agent 系统](16-opencode-agents-system.md) | Skill 与 Agent 的交互 |
| [05 - 工具与权限](17-opencode-tools-permissions.md) | skill 工具权限配置 |
| [12 - 进阶话题](24-opencode-advanced-topics.md) | 团队级 Skill 共享 |
