...
| 文档 | 关系 |
|------|------|
| [02 - 安装部署与快速入门](14-opencode-installation-quickstart.md) | 下一步：安装并开始使用 |
| [04 - Agent 系统深度指南](16-opencode-agents-system.md) | 深入 Agent 架构 |
| [10 - Server 模式与 HTTP API](22-opencode-server-api.md) | 深入 Client/Server 架构 |
| [AI基础设施/02-ai-agents/23](../02-AI-Agents/23-agent-cli-fundamentals.md) | Agent CLI 通用理论框架 |
