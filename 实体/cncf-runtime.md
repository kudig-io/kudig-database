...
## 容器运行时（[[概念/container-runtime.md|Container Runtime]]）
...
- **多租户**: 资源隔离与配额
- **可观测性**: [[实体/06-containerd-observability.md|observability]]|指标与日志]]
...
- [[实体/cncf-networking.md|cncf-networking]] — 网络与服务网格
- [[实体/cncf-storage.md|cncf-storage]] — 存储与数据库
- [[实体/cncf-orchestration.md|cncf-orchestration]] — 编排与应用管理
- [[实体/container-runtime.md|container-runtime]] — 容器运行时概念
