...
- 参见 [[概念/core-dependency-version-matrix.md|[[核心依赖版本矩阵|核心依赖版本矩阵]]]] 了解完整版本矩阵
...
- 参见 [[实体/container-runtime.md|[[Container Runtime|Container Runtime]]]] 了解容器运行时架构
...
- **版本矩阵**：升级前查询 [[概念/core-dependency-version-matrix.md|核心依赖版本矩阵]] 确认兼容性
