...
| 组件 | 文件数 | 演进参考 |
|---|---|---|
| Argo CD | 40 | [[概念/gitops-tool-evolution.md|gitops-tool-evolution]] |
...
| 组件 | 文件数 | 演进参考 |
|---|---|---|
| Istio | 38 | [[概念/service-mesh-evolution.md|service-mesh-evolution]] |
...
| 组件 | 文件数 | 演进参考 |
|---|---|---|
| OPA | 86 | [[概念/security-tool-evolution.md|security-tool-evolution]] |
...
| 组件 | 文件数 | 演进参考 |
|---|---|---|
| Minikube | 74 | [[概念/cli-tools-evolution.md|cli-tools-evolution]] |
