...
| `_reports/broken-links-full-fix-2026-06-26.md` | `service` | `系统基础/topic-dictionary/networking/service.md` | fuzzy |
| `_reports/broken-links-full-fix-2026-06-26.md` | `kubelet` | `系统基础/topic-dictionary/fundamentals/kubelet.md` | fuzzy |
| `_reports/broken-links-full-fix-2026-06-26.md` | `gitops cicd index` | `生态参考/topic-index/gitops-cicd-index.md` | fuzzy |
| `_reports/broken-links-full-fix-2026-06-26.md` | `helm` | `系统基础/topic-dictionary/tooling/helm.md` | fuzzy |
| `_reports/broken-links-full-fix-2026-06-26.md` | `ingress` | `系统基础/topic-dictionary/networking/ingress.md` | fuzzy |
| `_reports/broken-links-full-fix-2026-06-26.md` | `argocd` | `entities/argocd.md` | fuzzy |
| `_reports/broken-links-full-fix-2026-06-26.md` | `README` | `生态参考/topic-release-notes/README.md` | fuzzy |
| `_reports/broken-links-full-fix-2026-06-26.md` | `cilium` | `系统基础/topic-dictionary/networking/cilium.md` | fuzzy |
| `_reports/broken-links-full-fix-2026-06-26.md` | `istio` | `系统基础/topic-dictionary/networking/istio.md` | fuzzy |
| `_reports/broken-links-full-fix-2026-06-26.md` | `pods` | `系统基础/topic-dictionary/workloads/pods.md` | fuzzy |
...
| `_reports/broken-links-full-fix-2026-06-26.md` | `aeraki mesh` | `系统基础/topic-dictionary/networking/aeraki-mesh.md` | exact |
| `_reports/broken-links-full-fix-2026-06-26.md` | `serverless workflow` | `系统基础/topic-dictionary/workloads/serverless-workflow.md` | exact |
...
| `_reports/broken-links-full-fix-2026-06-26.md` | `系统基础/topic-dictionary/workloads/[[sidecar-containers` | no match |
| `_reports/broken-links-full-fix-2026-06-26.md` | `系统基础/topic-dictionary/scheduling/[[gang-scheduling` | no match |
| `_reports/broken-links-full-fix-2026-06-26.md` | `系统基础/topic-dictionary/scheduling/[[dynamic-resource-allocation` | no match |
| `_reports/broken-links-full-fix-2026-06-26.md` | `系统基础/topic-dictionary/scheduling/[[pod-overhead` | no match |
| `_reports/broken-links-full-fix-2026-06-26.md` | `[ephemeral-containers` | no match |
| `_reports/broken-links-full-fix-2026-06-26.md` | `平台工程/topic-code-analysis/MOC`` | no match |
