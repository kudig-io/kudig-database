...
**影响**: 远程顾问模式的核心机制是「概念 → 诊断 → 修复」的知识链路。当加载 `concepts/ingress-controller.md` 并尝试跳转到 `[[19-故障诊断/08-技能体系/skill-set/k8s-ingress-gateway/SKILL.md|ingress-gateway-troubleshooting]]` 时，文件不存在，链路断裂。
