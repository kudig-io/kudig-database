---
title: v1.3.10
description: v1.3.10 — Kubernetes 生产运维知识库
summary: v1.3.10 — Kubernetes 生产运维知识库
...
* gci: decouple from the built-in [[kubelet|kubelet]] version ([#31367](https://github.com/kubernetes/kubernetes/pull/31367), [@Amey-D](https://github.com/Amey-D))
...
* Introducing ScheduledJobs as described in [the proposal](文档/proposals/scheduledjob.md) as part of `batch/v2alpha1` version (experimental feature). ([#24970](https://github.com/kubernetes/kubernetes/pull/24970), [@soltysh](https://github.com/soltysh))
