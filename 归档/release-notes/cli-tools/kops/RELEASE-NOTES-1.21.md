---
title: kops v1.21 Release Notes
description: kops v1.21 Release Notes — Kubernetes 生产运维知识库
summary: kops v1.21 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- kops v1.21 Release Notes 是什么
- 如何 kops v1.21 Release Notes
trigger_keywords:
- kops
- v1.21
- Release
...
## [[Service|Service]] Account Issuer Discovery and AWS IAM Roles for Service Accounts (IRSA)
