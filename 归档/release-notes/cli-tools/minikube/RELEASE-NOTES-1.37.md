---
title: minikube v1.37 Release Notes
description: minikube v1.37 Release Notes — Kubernetes 生产运维知识库
summary: minikube v1.37 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- minikube v1.37 Release Notes 是什么
- 如何 minikube v1.37 Release Notes
trigger_keywords:
- minikube
- v1.37
- Release
...
# minikube v1.37 Release Notes

Source: [v1.37.0](https://github.com/kubernetes/minikube/releases/tag/v1.37.0)
...
## Highlight
Run AI workloads on Macbook's GPU in [[Kubernetes|Kubernetes]] using the new `krunkit driver`. Get started with our [AI Playground tutorial](https://minikube.sigs.k8s.io/docs/tutorials/ai-playground/)
...
### Footnote
The `docker-machine-driver-kvm2` aux drivers binaries were rebuilt after the release to include  https://github.com/kubernetes/minikube/pull/21550 that was affecting KVM driver on Fedora with SELinux enabled.
