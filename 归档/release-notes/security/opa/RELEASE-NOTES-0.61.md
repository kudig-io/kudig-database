---
title: opentelemetry-collector v0.61 Release Notes
description: opentelemetry-collector v0.61 Release Notes — Kubernetes 生产运维知识库
summary: opentelemetry-collector v0.61 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- opentelemetry-collector v0.61 Release Notes 是什么
- 如何 opentelemetry-collector v0.61 Release Notes
trigger_keywords:
...
- Deprecate `go.[[OpenTelemetry|opentelemetry]].io/collector/service/featuregate` in favor of `go.opentelemetry.io/collector/featuregate`. (#6094)
...
- Deprecate `p[metric|log|trace]otlp.[Client|Server]` in favor of `p[metric|log|trace]otlp.[[gRPC|GRPC]][Client|Server]` (#6165)
