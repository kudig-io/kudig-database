---
title: thanos v0.38 Release Notes
description: thanos v0.38 Release Notes — Kubernetes 生产运维知识库
summary: thanos v0.38 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- thanos v0.38 Release Notes 是什么
- 如何 thanos v0.38 Release Notes
trigger_keywords:
- thanos
- v0.38
- Release
...
# [[Thanos|thanos]] v0.38 Release Notes

Source: [v0.38.0](https://github.com/thanos-io/thanos/releases/tag/v0.38.0)
...
- [#7907](https://github.com/thanos-io/thanos/pull/7907) Receive: Add `--receive.grpc-service-config` flag to configure [[gRPC|gRPC]] [[Service|service]] config for the receivers.
