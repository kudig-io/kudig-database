---
title: thanos v0.16 Release Notes
description: thanos v0.16 Release Notes — Kubernetes 生产运维知识库
summary: thanos v0.16 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- thanos v0.16 Release Notes 是什么
- 如何 thanos v0.16 Release Notes
trigger_keywords:
- thanos
- v0.16
- Release
...
- [#3136](https://github.com/thanos-io/thanos/pull/3136) Sidecar: Improved detection of directory changes for [[Prometheus|Prometheus]] config.
