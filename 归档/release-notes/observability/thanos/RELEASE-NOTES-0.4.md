...
See [this](文档/proposals/approved/201809_gossip-removal.md) for more details.
...
* Control of concurrency and sample limits on Store Gateway [[gRPC|gRPC]] API
...
- [#905](https://github.com/improbable-eng/thanos/pull/905) Thanos support for Query API: /api/v1/labels. Notice that the API was added in [[Prometheus|Prometheus]] v2.6.
