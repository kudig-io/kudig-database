---
title: thanos v0.7 Release Notes
description: thanos v0.7 Release Notes — Kubernetes 生产运维知识库
summary: thanos v0.7 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- thanos v0.7 Release Notes 是什么
- 如何 thanos v0.7 Release Notes
trigger_keywords:
- thanos
- v0.7
- Release
...
- [#1268](https://github.com/thanos-io/thanos/pull/1268) Thanos Sidecar added support for newest [[Prometheus|Prometheus]] streaming remote read added [here](https://github.com/prometheus/prometheus/pull/5703). This massively improves memory required by single 
