...
summary: opentelemetry-collector v0.98 Release Notes — Kubernetes 生产运维知识库
...
- `[[Service|service]]`: emit internal collector metrics with _ instead of / with OTLP export (#9774)
  ...
  is currently still in experimental support. The [[Prometheus|prometheus]] metrics already replaced `/` with `_`
