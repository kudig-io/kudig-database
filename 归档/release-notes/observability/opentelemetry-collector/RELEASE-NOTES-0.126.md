...
summary: opentelemetry-collector v0.126 Release Notes — Kubernetes 生产运维知识库
...
- `[[Service|service]]`: Replace `go.opentelemetry.io/collector/semconv` usage with `go.opentelemetry.io/otel/semconv` (#12991)
