---
title: opentelemetry-collector v0.4 Release Notes
description: opentelemetry-collector v0.4 Release Notes — Kubernetes 生产运维知识库
summary: opentelemetry-collector v0.4 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- opentelemetry-collector v0.4 Release Notes 是什么
- 如何 opentelemetry-collector v0.4 Release Notes
trigger_keywords:
...
# 🎉 [[OpenTelemetry|OpenTelemetry]] Collector v0.4.0 (Beta) 🎉
...
- `thrift_tchannel` protocol moved from `[[Jaeger|jaeger]]` receiver to `jaeger_legacy` in contrib (#636) 
