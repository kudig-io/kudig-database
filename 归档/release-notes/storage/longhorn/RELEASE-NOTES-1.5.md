---
title: longhorn v1.5 Release Notes
description: longhorn v1.5 Release Notes — Kubernetes 生产运维知识库
summary: longhorn v1.5 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- longhorn v1.5 Release Notes 是什么
- 如何 longhorn v1.5 Release Notes
trigger_keywords:
- longhorn
- v1.5
- Release
...
# [[Longhorn|longhorn]] v1.5 Release Notes

Source: [v1.5.5](https://github.com/longhorn/longhorn/releases/tag/v1.5.5)
...
>  [!IMPORTANT]  
> **Ensure that your cluster is running [[Kubernetes|Kubernetes]] v1.21 or later before installing Longhorn v1.5.5.**

You can install Longhorn using a variety of tools, including Rancher, Kubectl, and [[Helm|Helm]]. For more information about installation methods and requirements, see [Quick Installation](https://longhorn.io/docs/1.5.5/deploy/install/) in the Longhorn documentation.
