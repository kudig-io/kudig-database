...
### All Changes
  * log a warning instead of erroring if an additional item returned from a plugin can't be found in [[系统基础/topic-dictionary/fundamentals/the-kubernetes-api.md|the Kubernetes API]]ubernetes]] API (#2595, @skriss)
