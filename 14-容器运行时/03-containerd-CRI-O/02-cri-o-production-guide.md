...
- 容器运行时/01-containerd-deep-guide.md
- 工作负载/00-core-workloads/15-container-runtime-interfaces.md
k8s_versions:
- '1.28'
- '1.29'
- '1.30'
...
sudo systemctl restart crio
```
在 Pod 中通过 `runtimeClassName: kata` 即可使用 Kata。详见 [[14-容器运行时/03-containerd-CRI-O/03-oci-runtimes-comparison.md|OCI 运行时对比]]。
...
- [[14-容器运行时/03-containerd-CRI-O/03-oci-runtimes-comparison.md|OCI 运行时对比]]
- [[14-容器运行时/03-containerd-CRI-O/01-containerd-deep-guide.md|containerd 深度指南]]
- [[02-工作负载/01-核心工作负载/15-container-runtime-interfaces.md|容器运行时接口]]
