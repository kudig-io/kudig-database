...
6. **与 [[云厂商/多云混合/11-multicloud-comparison-decision-matrix|多云对比]] 配合**：评估是否需要多云部署
7. **参考 [[平台工程/治理/10-security-compliance|安全合规]] 完善安全体系**

## Related

- [[云厂商/多云混合/11-multicloud-comparison-decision-matrix|多云对比决策矩阵]]
- [[云厂商/华为云CCE/06-cce-production-best-practices|华为 CCE 生产实践]]
- [[网络/cni-plugins|CNI 插件]]
- [[存储/csi-drivers|CSI 驱动]]
- [[平台工程/治理/10-security-compliance|安全合规]]
- [[可观测性/prometheus|Prometheus 监控]]
