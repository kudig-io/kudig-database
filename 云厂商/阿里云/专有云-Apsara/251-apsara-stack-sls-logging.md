...
本文档面向在客户数据中心运维 [[云厂商/阿里云/01-专有云架构概述.md|阿里云专有云（Apsara Stack）]] 的 SRE，系统梳理专有云 SLS（日志服务）的三层架构、Logtail 采集方案、机房级日志审计与安全、高性能查询与仪表盘及运维最佳实践。
...
> **关键认知**：SLS 的存储底座是盘古。当 SLS 查询/写入全局异常时，需联动 [[云厂商/阿里云/专有云-Apsara/256-apsara-pangu-storage-troubleshooting.md|盘古存储排障]]。
