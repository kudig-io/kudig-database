...
本文档面向在客户数据中心运维 [[云厂商/阿里云/01-专有云架构概述.md|阿里云专有云（Apsara Stack）]] 的 SRE 与远程顾问，聚焦飞天分布式存储底座——**盘古（Pangu）**及其上层云盘（ESSD）、NAS、OSS、CPFS 的 K8s 存储故障排障：PVC 卡 Pending、IO 延迟飙升、快照/扩容失败、盘古集群健康检查与升级路径。
...
- [[实体/csi.md|CSI]]
- [[系统基础/知识字典/storage/storageclasses.md|StorageClass]]
