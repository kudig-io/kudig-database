...
1. **鲲鹏 ARM 混合部署**：通过节点池 Taint + Pod nodeAffinity 实现 ARM/x86 工作负载分离，参考 [[系统基础/Linux/14-arm-architecture-k8s-optimization|ARM 架构优化]]
...
5. **与 [[云厂商/多云混合/11-multicloud-comparison-decision-matrix|多云对比]] 配合**：评估混合云需求
6. **参考 [[平台工程/治理/10-security-compliance|安全合规]] 完善治理**

## Related

- [[云厂商/多云混合/11-multicloud-comparison-decision-matrix|多云对比决策矩阵]]
- [[云厂商/腾讯云TKE/06-tke-production-best-practices|腾讯 TKE 生产实践]]
- [[系统基础/Linux/14-arm-architecture-k8s-optimization|ARM 架构 K8s 优化]]
- [[网络/cni-plugins|CNI 插件]]
- [[存储/csi-drivers|CSI 驱动]]
- [[平台工程/治理/10-security-compliance|安全合规]]
