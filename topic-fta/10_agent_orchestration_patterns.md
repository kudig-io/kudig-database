...
> **上一章**: [第九章：FTA 作为 AI Agent 的知识骨架](./9_fta_as_agent_knowledge_skeleton.md)  
> **下一章**: [第十一章：FTA 驱动的 Runbook 自动化](./11_fta_driven_runbook_automation.md)
...
> **导航**: [<< 上一章 - FTA 作为 AI Agent 的知识骨架](./9_fta_as_agent_knowledge_skeleton.md) | [下一章 - FTA 驱动的 Runbook 自动化 >>](./11_fta_driven_runbook_automation.md)
