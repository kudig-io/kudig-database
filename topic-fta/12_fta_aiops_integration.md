...
> **上一章**: [第十一章：FTA 驱动的 Runbook 自动化](./11_fta_driven_runbook_automation.md)  
> **下一章**: [第十三章：智能工单处理的 AI Agent 架构](./13_intelligent_ticket_processing.md)
...
> **导航**: [<< 上一章 - FTA 驱动的 Runbook 自动化](./11_fta_driven_runbook_automation.md) | [下一章 - 智能工单处理的 AI Agent 架构 >>](./13_intelligent_ticket_processing.md)
