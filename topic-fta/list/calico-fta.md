...
agent_notes:
  decision_tree_entry: "kubectl get pods -n kube-system -l k8s-app=calico-node 检查 Calico Pod 状态"
  critical_commands:
...
related_skills: []
knowledge_refs:
  - domain-5-networking/03-cni-plugins-comparison.md
  - domain-5-networking/27-cni-troubleshooting-optimization.md
  - topic-fta/list/networkpolicy-fta.md
  - topic-fta/list/terway-fta.md
---
```