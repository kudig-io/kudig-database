...
cross_refs:
- type: domain
  path: ../domain-5-networking/21-nginx-ingress-complete-guide.md
  label: '核心文档: 21-nginx-ingress-complete-guide'
- type: index
  path: ../../topic-index/nginx-ingress-index.md
...
- [nginx-ingress 全局索引](./topic-index/nginx-ingress-index.md)