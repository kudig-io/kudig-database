...
agent_notes:
  decision_tree_entry: "kubeadm init --dry-run 检查配置错误; journalctl -u kubelet 检查 kubelet 日志"
  critical_commands:
...
related_skills: []
knowledge_refs:
  - domain-32-yaml-manifests/33-kubeadm-cluster-bootstrap.md
  - domain-3-control-plane/31-kubectl-complete-reference.md
