...
cross_refs:
- type: structural
  path: ../topic-structural-trouble-shooting/03-networking/08-flannel-troubleshooting.md
  label: '结构化排障: 08-flannel-troubleshooting'
- type: index
  path: ../../topic-index/flannel-index.md
...
- [Flannel 完全指南](./domain-5-networking/04-flannel-complete-guide.md)
- [Flannel 故障排查](./topic-structural-trouble-shooting/03-networking/08-flannel-troubleshooting.md)
- [CNI 网络故障排查](./topic-structural-trouble-shooting/03-networking/01-cni-troubleshooting.md)
- [Flannel 全局索引](./topic-index/flannel-index.md)