...
> **上一章**: [第一章：FTA 起源与发展史](./1_fta_origin_and_evolution.md)  
> **下一章**: [第三章：FTA 符号体系与标准规范](./3_fta_symbol_system_and_standards.md)
...
> **导航**: [<< 上一章 - FTA 起源与发展史](./1_fta_origin_and_evolution.md) | [下一章 - FTA 符号体系与标准规范 >>](./3_fta_symbol_system_and_standards.md)
