...
> **上一章**: [第二章：FTA 数学基础与理论模型](./2_fta_mathematical_foundations.md)  
> **下一章**: [第四章：FTA 方法论核心原则](./4_fta_core_principles.md)
...
> **导航**: [<< 上一章 - FTA 数学基础与理论模型](./2_fta_mathematical_foundations.md) | [下一章 - FTA 方法论核心原则 >>](./4_fta_core_principles.md)
