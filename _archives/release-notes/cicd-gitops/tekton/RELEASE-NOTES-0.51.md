...
summary: tekton v0.51 Release Notes — Kubernetes 生产运维知识库
...
**With this release, the minimun [[Kubernetes|Kubernetes]] version supported is now 1.25.**
...
Users can now opt in this new feature to schedule all the [[Pods|pods]] in the same node and to optionally enforce one running pipelinerun in a node at the same time.
* :sparkles: Add [[Service|service]] for Resolvers - metrics, probes and tracing (#6973)
