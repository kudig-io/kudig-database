...
summary: rook v0.9 Release Notes — Kubernetes 生产运维知识库
...
- Add missing "host path requires privileged" setting to the [[Helm|helm]] chart (#2735, @galexrt)
