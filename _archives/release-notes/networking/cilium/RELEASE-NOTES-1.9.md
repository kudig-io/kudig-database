...
summary: cilium v1.9 Release Notes — Kubernetes 生产运维知识库
...
**Minor Changes:**
* ui: v0.9.0 images and drop [[Envoy|envoy]] proxy container (Backport PR #20365, Upstream PR #19565, @geakstr)

**Bugfixes:**
* Fix agent panic in some cases when [[Service|service]] matcher local redirect policy was deployed prior to the selected service. (Backport PR #20180, Upstream PR #19522, @aditighag)
