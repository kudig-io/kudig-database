---
title: cilium v1.8 Release Notes
description: cilium v1.8 Release Notes — Kubernetes 生产运维知识库
summary: cilium v1.8 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- cilium v1.8 Release Notes 是什么
- 如何 cilium v1.8 Release Notes
trigger_keywords:
- cilium
- v1.8
- Release
...
# [[Cilium|cilium]] v1.8 Release Notes

Source: [v1.8.13](https://github.com/cilium/cilium/releases/tag/v1.8.13)

We are pleased to release Cilium v1.8.13. This release bumps [[Istio|Istio]] integration to v1.10.4, fixes some reported bugs and updates the underlying base images for the latest library dependencies. For more details, see the full release notes below.
