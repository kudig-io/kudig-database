...
summary: minikube v1.24 Release Notes — Kubernetes 生产运维知识库
...
Features:
* Add --no-[[Kubernetes|kubernetes]] flag  to start minikube without kubernetes [#12848](https://github.com/kubernetes/minikube/pull/12848)
