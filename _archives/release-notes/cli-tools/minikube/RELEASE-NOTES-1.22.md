---
title: minikube v1.22 Release Notes
description: minikube v1.22 Release Notes — Kubernetes 生产运维知识库
summary: minikube v1.22 Release Notes — Kubernetes 生产运维知识库
...
intent_queries:
- minikube v1.22 Release Notes 是什么
- 如何 minikube v1.22 Release Notes
trigger_keywords:
- minikube
- v1.22
- Release
...
Bugs:
* Fix "[[kubelet|kubelet]] Default-Start contains no runlevels" error [#11815](https://github.com/kubernetes/minikube/pull/11815)

Version Upgrades:
* bump default [[Kubernetes|kubernetes]] version to v1.21.2 & newest kubernetes version to v1.22.0-beta.0 [#11901](https://github.com/kubernetes/minikube/pull/11901)
