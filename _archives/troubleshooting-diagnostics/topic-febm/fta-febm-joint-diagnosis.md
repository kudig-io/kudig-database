...
### 3.1 案例 1：HPA 扩容后新型故障（FTA+FEBM 联合）
...
FTA 路径遍历:
  TE-10 → IE-10.1 数据面故障 → BE-10.1 [[domain-19-landscape-references/01-cncf-landscape/graduated/envoy/envoy|Envoy]] 资源耗尽
...
### 3.3 案例 3：Terway ENI 复杂故障（FTA 主导 + FEBM 验证）
