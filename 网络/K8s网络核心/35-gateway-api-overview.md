...
- type: domain
  ...
  label: '相关知识域: 可观测性'
- type: fta
  path: ../故障诊断/topic-fta/list/gateway-api-fta.md
...
<!-- chunk: 3. GAMMA: 服务网格治理标准化 (East-West) -->
...
<!-- chunk: 12. 迁移指南 (Ingress -> Gateway API) -->
