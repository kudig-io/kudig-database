...
│  └───────────────────────┘  │  完全隔离，独立生命周期          │
│                             │                             │
│  优点: 资源利用率高，运维统一  │  优点: 完全隔离，问题不互相影响   │
│  缺点: 问题影响范围大         │  缺点: 资源浪费，运维复杂度高    │
...
| 证书过期 / HTTPS 问题 | HTTPS 流量中断 | P1 | §10.4 |
...
| 性能基准测试与调优 | `网络/13-api-gateway-performance-benchmarks.md` |
| Higress 详细配置 | `网络/04-higress-enterprise-gateway.md` |
| APISIX 生产配置 | `网络/05-apisix-enterprise-gateway.md` |
| Kong 生产配置 | `网络/06-kong-enterprise-gateway.md` |
| 网关产品选型 | `网络/03-api-gateway-selection-guide.md` |
