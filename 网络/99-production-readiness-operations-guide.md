...
排查网络故障时，建议遵循先控制面后数据面、先节点后 Pod、先同节点后跨节点的分层思路。对于复杂场景，可结合 [[../故障诊断/topic-fta/fta-index.md|故障树]] 进行结构化分析。在排查过程中应做好抓包和日志留存，便于事后复盘。
...
| NetworkPolicy / mTLS / 证书生命周期 | [[../安全/02-network-security/02-network-security-policies.md|安全]] | 本域实施 L3/L4 网络隔离，安全域负责零信任架构、密钥与合规审计 |
| 网络指标、流量拓扑、告警 | [[../可观测性/02-metrics/99-prometheus-enterprise-guide.md|可观测性]] | 本域定义网络黄金信号，可观测域负责采集、存储与可视化 |
| 网络 SLO/SLI、容灾演练 | [[../可靠性/02-disaster-recovery/99-velero-backup-recovery-guide.md|可靠性]] | 本域提供网络组件 RTO/RPO 要求，可靠性域负责整体灾备设计 |
| 网络故障树与现场诊断 | [[../故障诊断/topic-fta/fta-index.md|故障诊断]] | 本域提供网络专业知识，排障域负责结构化诊断流程 |
...
- [[../安全/02-network-security/02-network-security-policies.md|网络安全策略]]
- [[../可观测性/02-metrics/99-prometheus-enterprise-guide.md|Prometheus 企业级监控指南]]
- [[../可靠性/02-disaster-recovery/99-velero-backup-recovery-guide.md|Velero 备份恢复指南]]
- [[../故障诊断/topic-fta/list/networkpolicy-fta.md|NetworkPolicy 故障树]]
- [[../故障诊断/topic-fta/list/dns-fta.md|DNS 故障树]]
- [[../故障诊断/topic-fta/list/ingress-fta.md|Ingress 故障树]]
