...
| 安全边界 | 谁能改 Git 即谁能改集群 | ArgoCD ServiceAccount 权限即集群能力上限 | 需配合 [[概念/rbac-authorization.md\|RBAC]] 与 PR 审批 |
...
- [[概念/gitops-production-operations.md|GitOps 生产运维]]
- [[概念/gitops-tool-evolution.md|GitOps 工具演进]]
- [[概念/gitops-release-gate.md|GitOps 发布门禁]]
- [[概念/helm-argocd-gitops.md|Helm-ArgoCD-GitOps]]
- [[综合/helm-gitops.md|Helm × GitOps]]
- [[综合/platform-engineering-devex.md|Platform Engineering × Developer Experience]]
