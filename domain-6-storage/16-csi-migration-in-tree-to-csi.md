...
| 已有 PVC 无法挂载 | CSI Node 插件缺失 | 确保 DaemonSet 部署到所有节点 |
...
- [../../domain-3-control-plane/22-container-storage-deep-dive.md](../domain-3-control-plane/22-container-storage-deep-dive.md) - CSI 架构原理
