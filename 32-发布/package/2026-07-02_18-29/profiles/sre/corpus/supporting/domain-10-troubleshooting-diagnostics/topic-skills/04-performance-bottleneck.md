...
- **应用级性能分析**: pprof/[[32-发布/package/2026-07-02_18-29/profiles/sre/corpus/supporting/domain-10-troubleshooting-diagnostics/04-jvm-tuning/01-jdk-flight-recorder-k8s|JFR]]/perf 实战工具使用
...
| 主题 | 引用路径 | 适用场景 |
|------|---------|---------|
| 性能瓶颈深度排查 | `domain-10-troubleshooting-diagnostics/33-performance-bottleneck-troubleshooting.md` | 超出本 Skill 覆盖的复杂性能问题 |
| 性能调优指南 | `domain-01-cluster-fundamentals/13-performance-tuning-guide.md` | 系统性的性能优化方法论 |
| cgroup 详解 | `domain-17-system-foundation/08-linux-container-fundamentals.md` | cgroup v1/v2 深入理解 |
| 网络性能分析 | `domain-03-networking-traffic/` | 网络层面性能问题深入分析 |
| 存储性能 | `domain-04-storage-data/` | 磁盘 I/O 性能深入分析 |
| 可观测性 | `domain-06-observability/` | 监控指标和告警配置 |
| API Server 架构 | `domain-01-cluster-fundamentals/` | API Server 性能调优 |
| etcd 运维 | `domain-01-cluster-fundamentals/` | etcd 性能问题排查 |
