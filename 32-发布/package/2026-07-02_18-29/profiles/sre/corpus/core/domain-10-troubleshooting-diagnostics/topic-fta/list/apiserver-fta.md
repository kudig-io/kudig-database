...
## 适用范围与说明
- **目标**：覆盖 [[domain-17-system-foundation/知识字典/fundamentals/the-kubernetes-api.md|Kubernetes API]] Server 不可用/性能劣化的关键成因与路径，支撑生产环境快速定位与自动化处置。
...
> [[_archives/troubleshooting-diagnostics/FTA故障树/list/apiserver-fta.md|Apiserver FTA 完整版]]
