...
<!-- chunk: 2. 备份系统状态检查 (Backup System Status Check) -->
...
# 6. 清理验证环境
kubectl delete namespace $VALIDATION_NAMESPACE  # ⚠️ 不可逆：永久删除命名空间及全部资源
...
echo
if $REPLY =~ ^[Yy]$; then
    kubectl delete namespace $TARGET_NAMESPACE  # ⚠️ 不可逆：永久删除命名空间及全部资源
...
# 6. 清理测试环境
kubectl delete namespace $TEST_NAMESPACE restored-$TEST_NAMESPACE  # ⚠️ 不可逆：永久删除命名空间及全部资源
...
- [[32-发布/package/2026-07-02_18-29/profiles/sre/corpus/core/domain-10-troubleshooting-diagnostics/02-infrastructure-troubleshooting/03-cloud-provider-troubleshooting|29-cloud-provider-troubleshooting]]
- [[32-发布/package/2026-07-02_18-29/profiles/sre/corpus/core/domain-10-troubleshooting-diagnostics/02-infrastructure-troubleshooting/04-monitoring-alerting-troubleshooting|30-monitoring-alerting-troubleshooting]]
- [[32-发布/package/2026-07-02_18-29/profiles/sre/corpus/supporting/domain-10-troubleshooting-diagnostics/02-infrastructure-troubleshooting/03-security-troubleshooting|32-security-troubleshooting]]
- [[32-发布/package/2026-07-02_18-29/profiles/sre/corpus/core/domain-10-troubleshooting-diagnostics/02-infrastructure-troubleshooting/06-performance-bottleneck-troubleshooting|33-performance-bottleneck-troubleshooting]]
