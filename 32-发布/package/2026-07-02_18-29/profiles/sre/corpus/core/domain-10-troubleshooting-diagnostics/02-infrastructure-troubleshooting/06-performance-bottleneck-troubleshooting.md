...
<!-- chunk: 1. 性能瓶颈故障诊断总览 (Performance Bottleneck Diagnosis Overview) -->
...
<!-- chunk: 2. CPU性能瓶颈排查 (CPU Performance Bottleneck Troubleshooting) -->
...
<!-- chunk: 6. API Server性能瓶颈排查 (API Server Performance Bottleneck Troubleshooting) -->
