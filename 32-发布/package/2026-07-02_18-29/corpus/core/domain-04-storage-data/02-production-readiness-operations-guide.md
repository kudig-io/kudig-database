...
本指南聚焦将 `domain-04-storage-data` 的存储能力从“可用”推进到“可长期稳定运行”，重点补齐当前知识库在**存储多租户治理、临时存储管理、CSI 供应链安全、容量规划、存储混沌演练**五个方向的缺口。阅读前建议先熟悉 [[K8s存储/01-storage-architecture-overview.md|存储架构概览]] 与 [[32-发布/package/2026-07-02_18-29/corpus/peripheral/domain-04-storage-data/01-k8s-storage/02-storage-daily-operations|存储日常运维操作手册]]。
...
| 8 | 备份策略落地 | 使用 Velero 或云厂商方案对关键 PVC/命名空间执行定期备份，并验证还原 | 见 [[32-发布/package/2026-07-02_18-29/corpus/supporting/domain-04-storage-data/04-distributed-storage/01-velero-backup-recovery|Velero 备份恢复]] |
...
通用诊断脚本可直接使用 [[32-发布/package/2026-07-02_18-29/corpus/supporting/domain-04-storage-data/01-k8s-storage/05-pv-pvc-troubleshooting|PV/PVC 故障排查与解决方案]] 中的 `pv-pvc-diagnostics.sh`。
...
- [[32-发布/package/2026-07-02_18-29/corpus/peripheral/domain-04-storage-data/01-k8s-storage/02-storage-daily-operations|存储日常运维操作手册]]
- [[32-发布/package/2026-07-02_18-29/corpus/supporting/domain-04-storage-data/01-k8s-storage/05-pv-pvc-troubleshooting|PV/PVC 故障排查与解决方案]]
- [[32-发布/package/2026-07-02_18-29/corpus/peripheral/domain-04-storage-data/01-k8s-storage/05-storage-security-compliance|存储安全与合规管理]]
...
- [[32-发布/package/2026-07-02_18-29/corpus/supporting/domain-04-storage-data/04-distributed-storage/01-velero-backup-recovery|Velero 备份恢复]]
