...
本指南为 **domain-11-production-operations** 提供生产就绪（Production Readiness）门控框架与持续运维动作集，适用于集群上线前评审、重大变更前的状态确认，以及日常 SRE 值班。生产就绪不是一次性验收，而是贯穿容量、成本、安全、可观测性与事件响应的持续状态管理。它不会替代 [[32-发布/package/2026-07-02_18-29/corpus/core/domain-11-production-operations/02-production-sre-daily-ops|日常巡检与值班手册]] 或 [[32-发布/package/2026-07-02_18-29/corpus/core/domain-11-production-operations/03-change-management-guide|变更管理指南]]，而是将这些实践汇总为可执行的生产就绪标准，并在 gap 分析推荐的专题缺失时给出最小可行方案。
...
当监控触发 P0/P1 告警时，立即按 [[32-发布/package/2026-07-02_18-29/corpus/supporting/domain-11-production-operations/04-on-call-playbook|值班手册]] 启动升级，并按 [[32-发布/package/2026-07-02_18-29/corpus/supporting/domain-11-production-operations/06-incident-response-template|事故响应模板]] 记录时间线。
...
- [[32-发布/package/2026-07-02_18-29/corpus/core/domain-11-production-operations/02-production-sre-daily-ops|生产环境日常巡检与值班手册]]
- [[32-发布/package/2026-07-02_18-29/corpus/core/domain-11-production-operations/03-change-management-guide|变更管理指南]]
- [[32-发布/package/2026-07-02_18-29/corpus/supporting/domain-11-production-operations/04-on-call-playbook|值班手册与告警响应规范]]
- [[32-发布/package/2026-07-02_18-29/corpus/supporting/domain-11-production-operations/06-incident-response-template|事故响应模板与流程规范]]
- [[32-发布/package/2026-07-02_18-29/corpus/supporting/domain-11-production-operations/02-governance/05-resource-quota-management|资源配额管理]]
- [[32-发布/package/2026-07-02_18-29/corpus/peripheral/domain-11-production-operations/01-finops/01-kubernetes-cost-governance|Kubernetes 成本治理]]
...
- 多集群与舰队运维（待补充）
- 灾备与备份恢复运维（待补充）
- [[32-发布/package/2026-07-02_18-29/corpus/core/domain-11-production-operations/07-security-operations-runbook|生产安全运维手册]]（待补充）
- 集群升级运维手册（待补充）
- [[32-发布/package/2026-07-02_18-29/corpus/core/domain-11-production-operations/08-observability-operations|可观测性运维]]（待补充）
- GitOps 运维（待补充）
- 自动化修复运维（待补充）
- 节点与容器运行时运维（待补充）
