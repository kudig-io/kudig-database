...
``` bash
# 🟡 中风险：会修改集群/资源状态，执行前请确认目标、影响范围与授权
# 参见 [[32-发布/package/2026-07-02_18-29/corpus/core/domain-05-security-compliance/01-supply-chain/02-supply-chain-security-runbook|供应链安全运维 Runbook]]
# 最小示例：禁止未签名镜像
cat <<EOF | kubectl apply -f -
...
- [[32-发布/package/2026-07-02_18-29/corpus/core/domain-13-container-runtime/04-production-readiness-operations-guide|容器运行时 生产就绪运维指南]]
...
- [[32-发布/package/2026-07-02_18-29/corpus/core/domain-05-security-compliance/01-supply-chain/02-supply-chain-security-runbook|供应链安全运维 Runbook]]
- [[32-发布/package/2026-07-02_18-29/corpus/core/domain-13-container-runtime/04-production-readiness-operations-guide|安全与合规 生产就绪运维指南]]
