...
**关联文档**:
- [../05-configuration/05-configmap-secret.md](32-发布/package/2026-07-02_18-29/corpus/peripheral/skills/training-lecturer/03-configuration/01-configmap-secret.md) — 配置管理
- [../../domain-10-troubleshooting-diagnostics/topic-skills/13-ingress-gateway-failure.md](32-发布/package/2026-07-02_18-29/corpus/core/domain-10-troubleshooting-diagnostics/topic-skills/12-ingress-gateway-failure.md) — Ingress 问题 [[SKILL|Skill]]
