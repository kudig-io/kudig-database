...
intent_queries:
- 03-logging-architecture的架构设计
- 03-logging-architecture的组件和交互
- 03-logging-architecture的系统设计
trigger_keywords:
- 日志收集架构详解
- Logging
- Architecture
...
intent_queries:
- 日志收集架构详解 (Logging Architecture) 是什么
- 如何 日志收集架构详解 (Logging Architecture)
