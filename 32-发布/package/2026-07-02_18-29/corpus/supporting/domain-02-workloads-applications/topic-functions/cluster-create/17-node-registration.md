...
- [`CSR 自动审批`](11-join-advanced.md) — CertificateSigningRequest 自动审批机制
- [`证书轮换`](32-发布/package/2026-07-02_18-29/corpus/peripheral/domain-07-platform-engineering/topic-code-analysis/node-create/04-certificate.md) — kubelet 证书自动轮换
- [`Node Lifecycle Controller`](../node-create/01-overview.md) — 节点健康监控与驱逐
- [`kubeadm init phase bootstrap-token`](14-init-phases.md) — init 时创建 Bootstrap Token
