...
| 文档 | 相关事件 |
|:---|:---|
| [02 - Pod 与容器生命周期事件](32-发布/package/2026-07-02_18-29/corpus/core/domain-17-system-foundation/02-kubernetes-events/01-pod-container-lifecycle-events.md) | `FailedMount` → Pod 无法启动 |
