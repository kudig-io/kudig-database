...
intent_queries:
  - ACK week 3 node [[domain-17-system-foundation/知识字典/workloads/workload-management.md|workload management]] curriculum
...
- [K8s 架构与组件深入](32-发布/package/2026-07-02_18-29/corpus/core/domain-01-cluster-fundamentals/01-architecture-overview/01-core-components-deep-dive.md)
- [ACK 服务总览](../../domain-12-cloud-providers/04-alicloud-ack/alicloud-ack-overview.md)
- [ECS 计算资源](32-发布/package/2026-07-02_18-29/corpus/supporting/entities/003-ack-ecs-compute.md)
- [Pod 生命周期事件](32-发布/package/2026-07-02_18-29/corpus/core/domain-02-workloads-applications/00-core-workloads/03-pod-lifecycle-events.md)
- [HPA/VPA 自动伸缩](32-发布/package/2026-07-02_18-29/corpus/peripheral/domain-02-workloads-applications/00-core-workloads/11-hpa-vpa-autoscaling.md)
...
- [集群自动伸缩排障](32-发布/package/2026-07-02_18-29/corpus/core/domain-10-troubleshooting-diagnostics/02-infrastructure-troubleshooting/02-cluster-autoscaler-troubleshooting.md)
