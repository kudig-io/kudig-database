...
- [`rolloutRolling`](03-rolling-update.md) — RollingUpdate 策略的详细实现
- [`rolloutRecreate`](README.md) — Recreate 策略的详细实现
- [`calculateStatus`](04-deployment-status.md) — Deployment Status 计算
- [`rollbackToRevision`](05-revision-history.md) — 版本回滚实现
