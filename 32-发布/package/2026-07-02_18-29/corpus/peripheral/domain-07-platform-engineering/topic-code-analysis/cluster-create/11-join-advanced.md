...
- [节点加入基础](05-join.md) — join 基本流程
- [证书管理](03-certs.md) — TLS 证书体系
- [安全机制](14-security.md) — Bootstrap Token 安全模型
- [高可用进阶](13-ha-advanced.md) — control-plane join 和证书分发
- [CRI 运行时](16-cri-runtime.md) — join 时 CRI 检查
