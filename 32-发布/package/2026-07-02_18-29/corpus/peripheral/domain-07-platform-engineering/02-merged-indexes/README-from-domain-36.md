...
- **[09-开发者体验度量](32-发布/package/2026-07-02_18-29/corpus/peripheral/domain-07-platform-engineering/developer-experience/01-developer-experience-metrics.md)** - DORA 指标、SPACE 框架、平台 KPI
- **[10-平台团队拓扑与运营](32-发布/package/2026-07-02_18-29/corpus/peripheral/domain-07-platform-engineering/developer-experience/02-platform-team-topology.md)** - Team Topologies、平台运营、支持模式

### 🌐 前端部署平台 (11)
- **[11-Vercel前端部署平台](./[[32-发布/package/2026-07-02_18-29/corpus/supporting/domain-07-platform-engineering/build/01-vercel-frontend-deployment-platform|11-vercel-frontend-deployment-platform]].md)** - Vercel 平台深度指南，涵盖零配置部署、Serverless/Edge Functions、企业级安全与性能优化
...
- **[Domain-23: GitOps CI/CD](../domain-08-release-change-management)** - 持续交付实践
