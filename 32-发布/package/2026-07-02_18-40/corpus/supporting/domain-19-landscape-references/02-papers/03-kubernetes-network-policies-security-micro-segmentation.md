...
Cilium与AdminNetworkPolicy集成:
  ...
  迁移到Cilium CNI:
    ...
    - 额外获得L7策略和eBPF加速
    - 详细迁移指南见 "[18-eBPF与Cilium深度实践](32-发布/package/2026-07-02_18-40/corpus/peripheral/domain-19-landscape-references/02-papers/11-kubernetes-ebpf-cilium-deep-practice.md)"
```
...
智能化网络策略趋势(2026-2027):
  ...
  3. eBPF全面替代iptables
     ...
     - eBPF LSM增强运行时安全
     - 详见 "[18-eBPF与Cilium深度实践](32-发布/package/2026-07-02_18-40/corpus/peripheral/domain-19-landscape-references/02-papers/11-kubernetes-ebpf-cilium-deep-practice.md)"
  
  4. Gateway API与网络策略统一
     - 流量管理与安全策略统一管理
     - 详见 "[19-Gateway API与现代流量管理](32-发布/package/2026-07-02_18-40/corpus/peripheral/domain-19-landscape-references/02-papers/12-kubernetes-gateway-api-modern-traffic-management.md)"
```
