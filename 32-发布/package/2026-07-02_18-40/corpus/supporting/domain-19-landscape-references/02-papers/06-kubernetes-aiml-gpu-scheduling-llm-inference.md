...
交叉引用:
  ...
  - "[23-OpenTelemetry原生可观测性](32-发布/package/2026-07-02_18-40/corpus/peripheral/domain-19-landscape-references/02-papers/15-kubernetes-opentelemetry-native-observability.md)" - GPU指标集成OTel
  - "[06-成本治理与FinOps](32-发布/package/2026-07-02_18-40/corpus/peripheral/domain-19-landscape-references/02-papers/04-kubernetes-cost-governance-finops-practice.md)" - GPU成本优化策略
```
