...
kubectl get nodes
```
更完整的轮换流程与回滚方案参见 [[32-发布/package/2026-07-02_18-40/corpus/supporting/domain-05-security-compliance/06-compliance/07-certificate-management|证书管理与 TLS 配置]]。
...
kubectl get clusterroles -o json | jq -r '
  ...
  .metadata.name'
```
推荐采用最小权限角色模板，具体矩阵参考 [[32-发布/package/2026-07-02_18-40/corpus/supporting/domain-05-security-compliance/01-identity-access/06-rbac-matrix-configuration|RBAC 权限矩阵表]]。
...
```
签名、SBOM 与 SLSA 实施细节参见 [[32-发布/package/2026-07-02_18-40/corpus/core/domain-05-security-compliance/01-supply-chain/01-supply-chain-security-overview|供应链安全概览]]。
...
```
规则调优与事件响应流程参考 [[32-发布/package/2026-07-02_18-40/corpus/supporting/domain-05-security-compliance/03-runtime-security/07-falco-runtime-security-guide|Falco 运行时安全指南]]。
...
```
网络分段与零信任架构设计参考 [[32-发布/package/2026-07-02_18-40/corpus/supporting/domain-05-security-compliance/02-network-security/04-zero-trust-architecture|零信任架构]]。
...
- [[32-发布/package/2026-07-02_18-40/corpus/supporting/domain-05-security-compliance/01-identity-access/06-rbac-matrix-configuration|RBAC 权限矩阵表]] — 最小权限角色设计参考
- [[32-发布/package/2026-07-02_18-40/corpus/supporting/domain-05-security-compliance/04-policy-governance/03-pod-security-standards|Pod 安全标准详解]] — PSA 分级与迁移
- [[32-发布/package/2026-07-02_18-40/corpus/supporting/domain-05-security-compliance/06-compliance/07-certificate-management|证书管理与 TLS 配置]] — 集群证书与 cert-manager 运维
- [[32-发布/package/2026-07-02_18-40/corpus/supporting/domain-05-security-compliance/02-network-security/04-zero-trust-architecture|零信任架构]] — 网络分段与身份驱动访问
- [[32-发布/package/2026-07-02_18-40/corpus/supporting/domain-05-security-compliance/03-runtime-security/07-falco-runtime-security-guide|Falco 运行时安全指南]] — 运行时威胁检测
- [[32-发布/package/2026-07-02_18-40/corpus/core/domain-05-security-compliance/01-supply-chain/01-supply-chain-security-overview|供应链安全概览]] — 镜像签名与 SBOM
- [[32-发布/package/2026-07-02_18-40/corpus/core/domain-05-security-compliance/02-incident-response/01-incident-response-process|安全事件响应流程]] — 事件响应与取证
