...
<!-- chunk: 1. Node 状态诊断总览 (Node Status Overview) -->
...
<!-- chunk: 2. NotReady 状态排查 (NotReady Troubleshooting) -->
...
<!-- chunk: 3. 资源压力排查 (Resource Pressure Troubleshooting) -->
...
docker system prune -af      # Docker清理  # ⚠️ 强制清理，可能杀运行中容器
...
<!-- chunk: 4. 网络问题排查 (Network Troubleshooting) -->
...
<!-- chunk: 5. 容器运行时排查 (Container Runtime Troubleshooting) -->
...
<!-- chunk: 8. 监控与告警 (Monitoring & Alerting) -->
