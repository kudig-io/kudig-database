...
---
title: [[domain-17-system-foundation/速查卡/gitops.md|GitOps]] x 平台工程
category: synthesis
tags:
- k8s
- gitops
...
| **Secret 管理复杂度** | GitOps 要求 Git 中的 Secret（通过 Sealed [[domain-17-system-foundation/知识字典/configuration/secrets.md|Secrets]] 或 SOPS 加密），而平台工程希望开发者通过门户请求 Secret。这两种工作流必须融合——开发者通过 Backstage 请求 Secret 应该产生一个加密的 Git 提交，Flux 可以协调它。 |
...
- [[32-发布/package/2026-07-02_18-40/corpus/supporting/domain-15-specialized-tech/04-extensions/01-helm-charts-management|47 - Helm Chart开发与管理]]
