...
**关联文档**:
- [../06-configuration/06-namespace-resource-quota.md](32-发布/package/2026-07-02_18-40/corpus/peripheral/skills/training-lecturer/05-configuration/01-namespace-resource-quota.md) — 命名空间与资源配额
- [../../domain-10-troubleshooting-diagnostics/topic-skills/14-configmap-secret-failure.md](32-发布/package/2026-07-02_18-40/corpus/supporting/domain-10-troubleshooting-diagnostics/topic-skills/03-configmap-secret-failure.md) — 配置管理问题 [[SKILL|Skill]]
