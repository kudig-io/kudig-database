...
知识体系关联:
  零信任安全架构:
    文档: "[03-零信任安全架构](02-kubernetes-zero-trust-security-architecture.md)"
    关联点:
      - 供应链签名验证 = 镜像身份认证(零信任)
  ...
  GitOps实践:
    文档: "[05-GitOps完整实践指南](32-发布/package/2026-07-02_18-40/corpus/core/domain-19-landscape-references/01-papers/01-kubernetes-gitops-complete-practice-guide.md)"
    关联点:
  ...
  eBPF与Cilium:
    文档: "[18-eBPF与Cilium深度实践](11-kubernetes-ebpf-cilium-deep-practice.md)"
    关联点:
      - Tetragon运行时供应链检测
