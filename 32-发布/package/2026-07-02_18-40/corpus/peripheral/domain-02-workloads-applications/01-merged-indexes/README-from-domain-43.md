...
| 6 | [Spring Cloud K8s + 服务网格](32-发布/package/2026-07-02_18-40/corpus/peripheral/domain-03-networking-traffic/02-service-mesh/12-spring-cloud-kubernetes-service-mesh-guide.md) | Spring Cloud → K8s 原生映射、[[entities/istio.md|Istio]] 集成、Resilience4j、迁移路径 | 高级 |
