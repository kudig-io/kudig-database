...
skill_ref:
- '[[32-发布/package/2026-07-02_18-40/corpus/supporting/domain-02-workloads-applications/00-core-workloads/02-job-cronjob-advanced|Job/CronJob
  进阶]]'
- '[[32-发布/package/2026-07-02_18-40/corpus/supporting/domain-08-release-change-management/01-gitops/05-argo-cd-gitops-guide|GitOps
  变更管理]]'
fta_ref:
- '[[domain-10-troubleshooting-diagnostics/FTA故障树/list/job-cronjob-fta.md|FTA:
  CronJob 执行失败]]'
- '[[domain-10-troubleshooting-diagnostics/FTA故障树/list/deployment-fta.md|FTA: 工作负载发布失败]]'
...
>
> **后续建议：**
> - 参考 [[32-发布/package/2026-07-02_18-40/corpus/supporting/domain-02-workloads-applications/00-core-workloads/02-job-cronjob-advanced|Job/CronJob 进阶]] review 所有 CronJob 的 `concurrencyPolicy` 与超时设置；
