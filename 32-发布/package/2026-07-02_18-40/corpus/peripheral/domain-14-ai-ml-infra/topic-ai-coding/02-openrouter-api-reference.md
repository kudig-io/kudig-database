...
| 文档 | 关系 |
|------|------|
| [04 - 智能路由](01-openrouter-provider-routing.md) | provider 请求参数详解 |
| [06 - Structured Outputs 与 Tool Calling](32-发布/package/2026-07-02_18-40/corpus/supporting/domain-14-ai-ml-infra/topic-ai-coding/04-openrouter-structured-outputs-tools.md) | JSON Schema 约束与工具调用 |
| [10 - 流式传输与多模态](32-发布/package/2026-07-02_18-40/corpus/supporting/domain-14-ai-ml-infra/topic-ai-coding/07-openrouter-streaming-multimedia.md) | SSE Streaming 详解 |
| [12 - 企业级实践](05-openrouter-enterprise-advanced.md) | Rate Limits 与故障排查 |
