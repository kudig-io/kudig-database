...
| [04 - 智能路由](01-openrouter-provider-routing.md) | 生产路由策略 |
| [08 - Prompt Caching](03-openrouter-prompt-caching-optimization.md) | 成本优化深入 |
| [11 - 安全与隐私](04-openrouter-security-privacy.md) | 安全加固与合规 |
| [topic-coding/03](../topic-coding/03-opencode-providers-models.md) | OpenCode 配置 OpenRouter Provider |
| [02-ai-agents](../domain-14-ai-ml-infra/AI-Agents/) | Agent CLI 统一 LLM 后端 |
| [domain-14-ai-ml-infra/17](32-发布/package/2026-07-02_18-40/corpus/peripheral/domain-14-ai-ml-infra/01-ai-infra/15-llm-inference-serving.md) | LLM 推理服务层 |
