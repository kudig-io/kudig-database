...
> **交叉引用**：控制平面 HA 的详细配置请参考 [Domain-3: 控制平面高可用](32-发布/package/2026-07-02_18-40/corpus/peripheral/domain-01-cluster-fundamentals/03-control-plane/02-plane-high-availability.md)。
