...
intent_queries:
- 如何监控05-plane-monitoring-observability？
- 05-plane-monitoring-observability的关键指标有哪些？
- 05-plane-monitoring-observability的告警规则
trigger_keywords:
- 控制平面监控与可观测性
- Control
- Plane
...
intent_queries:
- 控制平面监控与可观测性 (Control Plane Monitoring & Observability) 是什么
- 如何 控制平面监控与可观测性 (Control Plane Monitoring & Observability)
