...
| 文档 | 描述 |
|------|------|
| **domain-17-system-foundation/01-pod-lifecycle-events.md** | Pod 生命周期事件，包括 Pending 状态 |
| **domain-17-system-foundation/02-scheduling-events.md** | 调度事件，CA 扩容后的调度过程 |
| **domain-17-system-foundation/05-resource-events.md** | 资源配额事件，HPA/CA 受限场景 |
| **domain-17-system-foundation/11-metrics-monitoring-events.md** | Metrics Server 事件，HPA 指标源 |
