...
- [控制面组件](04-control-plane.md) — kube-apiserver 等 static Pod 通过 CRI 启动
- [节点加入](05-join.md) — join 时检查 CRI 运行时
- [证书管理](03-certs.md) — CRI 与证书挂载关系
- [集群升级](08-upgrade.md) — 升级时 CRI 兼容性检查
- [存储与卷](22-storage-volumes.md) — CRI volume 挂载实现
- [kube-proxy](18-kube-proxy.md) — kube-proxy 依赖 CRI 运行
- [安全机制](14-security.md) — CRI 运行时安全配置
