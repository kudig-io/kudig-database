...
- [[32-发布/package/2026-07-02_18-40/corpus/core/domain-07-platform-engineering/topic-code-analysis/cluster-create/01-upgrade-advanced|15-upgrade-advanced]]
authors:
- name: KUDIG Team
  role: contributor
k8s_versions:
...
- [升级进阶](15-upgrade-advanced.md) — 滚动升级和回滚
- [证书管理](03-certs.md) — 升级时证书续签
- [etcd 管理](06-etcd.md) — etcd 备份和升级
- [控制面组件](04-control-plane.md) — static Pod 升级
- [高可用进阶](13-ha-advanced.md) — HA 滚动升级
