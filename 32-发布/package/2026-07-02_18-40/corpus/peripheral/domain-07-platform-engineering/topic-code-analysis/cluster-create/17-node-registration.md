...
- [`kubeadm join`](05-join.md) — 节点加入完整流程
- [`CSR 自动审批`](11-join-advanced.md) — CertificateSigningRequest 自动审批机制
- [`证书轮换`](../node-create/04-certificate.md) — kubelet 证书自动轮换
- [`Node Lifecycle Controller`](../node-create/01-overview.md) — 节点健康监控与驱逐
- [`kubeadm init phase bootstrap-token`](15-init-phases.md) — init 时创建 Bootstrap Token
