...
- **[[domain-17-system-foundation/知识字典/scheduling/pod-overhead.md|Pod Overhead]]**：记录 Pod 基础设施本身消耗的资源（超出容器请求/限制的部分），由 RuntimeClass 定义。
...
- [[domain-17-system-foundation/知识字典/workloads/pods.md|Pods]]](pods.md) — Pod 基础概念和配置
