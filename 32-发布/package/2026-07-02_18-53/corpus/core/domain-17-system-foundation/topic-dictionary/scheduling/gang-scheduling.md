...
Gang Scheduling 依赖于 [[domain-17-system-foundation/知识字典/workloads/workload-api.md|Workload API]]。需要启用 `GenericWorkload` 特性门控和 `scheduling.k8s.io/v1alpha1` API 组。
