...
- **多租户**: 资源隔离与配额
- **可观测性**: [[32-发布/package/2026-07-02_18-53/corpus/core/entities/08-containerd-observability|observability]]|指标与日志]]
- **Windows 支持**: Windows 容器支持
- **灾备**: [[32-发布/package/2026-07-02_18-53/corpus/supporting/entities/02-containerd-disaster-recovery|状态备份与恢复]]
