...
| **FTA vs FEBM 对比** | [topic-febm](../domain-10-troubleshooting-diagnostics/[[entities/kudig-metadata-index.md|README]]]].md) |
...
| 专题 | 说明 |
|:---|:---|
| [topic-febm](../domain-10-troubleshooting-diagnostics/[[domain-10-troubleshooting-diagnostics/FEBM方法论/README.md|README]].md) | FEBM 法医鉴定循证方法论（归纳法视角，与FTA互补） |
| [topic-structural-trouble-shooting](../domain-10-troubleshooting-diagnostics/[[domain-10-troubleshooting-diagnostics/高级排障/README.md|README]].md) | 结构化故障排查知识库 |
