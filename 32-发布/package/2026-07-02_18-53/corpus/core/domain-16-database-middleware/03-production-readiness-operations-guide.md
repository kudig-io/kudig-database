...
在将任一数据库或中间件实例标记为 `Production Ready` 之前，建议逐项核对以下检查点。本清单基于 [[32-发布/package/2026-07-02_18-53/corpus/peripheral/domain-16-database-middleware/01-databases/03-database-middleware-kubernetes|数据库中间件 Kubernetes 企业级实践]] 与 [[32-发布/package/2026-07-02_18-53/corpus/supporting/domain-16-database-middleware/06-operator-management/01-database-operator-patterns|数据库 Operator 设计模式]] 中的生产要求提炼而成。
...
- **[[domain-04-storage-data/README.md|domain-04-storage-data]]（存储与数据）**: 负责 StorageClass、CSI 驱动、PVC 扩容、快照与备份存储。数据库层应复用其存储治理与容量规划结论，不自行维护底层存储 SOP。
- **[[domain-05-security-compliance/README.md|domain-05-security-compliance]]（安全合规）**: 负责 NetworkPolicy 默认拒绝、Secret/凭据生命周期、Pod Security Standards、TLS/mTLS 策略。数据库安全加固的具体实践见 数据库安全加固（待补充）。
- **[[domain-06-observability/README.md|domain-06-observability]]（可观测性）**: 负责 Prometheus、Grafana、Loki、Jaeger 的统一采集与告警路由。数据库层需提供Exporter/ServiceMonitor，并定义自身的 SLO/SLI，详情参考 数据库 SLO 与容量规划（待补充）。
- **[[domain-07-platform-engineering/README.md|domain-07-platform-engineering]]（平台工程）**: 负责 Operator 注册、多租户命名空间模板、GitOps 交付、资源配额。数据库实例通过平台目录发布，避免业务团队自行部署。
- **[[domain-09-reliability-engineering/README.md|domain-09-reliability-engineering]]（可靠性工程）**: 负责跨域灾难恢复、PDB、混沌演练、RTO/RPO 定义。数据库的跨集群 DR 方案见 数据库多集群灾备手册（待补充）。
- **[[domain-11-production-operations/README.md|domain-11-production-operations]]（生产运维）**: 负责事件响应、值班手册、变更管理。数据库 P0/P1 故障应接入统一事件流程。
- **[[domain-14-ai-ml-infra/README.md|domain-14-ai-ml-infra]]（AI/ML 基础设施）**: 负责 AI 数据管道、特征存储、向量数据库集成。当数据库层为 AI 工作负载提供数据服务时，需协同评估高并发读取与向量索引性能。
...
- [[32-发布/package/2026-07-02_18-53/corpus/peripheral/domain-16-database-middleware/01-databases/03-database-middleware-kubernetes|数据库中间件 Kubernetes 企业级实践]]
- [[32-发布/package/2026-07-02_18-53/corpus/peripheral/domain-16-database-middleware/01-databases/05-redis-enterprise-cache|Redis 企业级缓存]]
- [[32-发布/package/2026-07-02_18-53/corpus/supporting/domain-16-database-middleware/02-databases/02-kafka-kubernetes-strimzi|Kafka Kubernetes Strimzi 实践]]
- [[32-发布/package/2026-07-02_18-53/corpus/peripheral/domain-16-database-middleware/01-databases/07-cloudnativepg-enterprise-guide|CloudNativePG 企业指南]]
- [[32-发布/package/2026-07-02_18-53/corpus/supporting/domain-16-database-middleware/04-message-queues/03-message-queue-comparison|消息队列选型]]
- [[32-发布/package/2026-07-02_18-53/corpus/supporting/domain-16-database-middleware/05-time-series-db/01-prometheus-tsdb-deep-dive|Prometheus TSDB 深度解析]]
- [[32-发布/package/2026-07-02_18-53/corpus/supporting/domain-16-database-middleware/06-operator-management/01-database-operator-patterns|数据库 Operator 设计模式]]
- [[32-发布/package/2026-07-02_18-53/corpus/supporting/domain-16-database-middleware/06-operator-management/03-operator-lifecycle-management|Operator 生命周期管理]]
- [[32-发布/package/2026-07-02_18-53/corpus/supporting/domain-16-database-middleware/07-data-streaming/01-cdc-change-data-capture|CDC 变更数据捕获]]
...
- [[domain-04-storage-data/README.md|domain-04-storage-data]] — 存储基础与 PVC 治理
- [[domain-05-security-compliance/README.md|domain-05-security-compliance]] — 安全基线与合规
- [[domain-06-observability/README.md|domain-06-observability]] — 监控告警与 SLO
- [[domain-09-reliability-engineering/README.md|domain-09-reliability-engineering]] — 灾难恢复与韧性设计
- [[domain-11-production-operations/README.md|domain-11-production-operations]] — 事件响应与值班手册
