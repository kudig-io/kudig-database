...
- target: '[[entities/argo.md]]'
  type: related_to
- target: '[[domain-17-system-foundation/知识字典/workloads/daemonset.md]]'
  type: related_to
---
...
这个分层设计成为所有复杂控制器的模板：StatefulSet（有序 Pod 管理）、[[domain-17-system-foundation/知识字典/workloads/daemonset.md|DaemonSet]]（节点级调度）、Job（完成度追踪）。
...
- [[domain-07-platform-engineering/代码分析/deployment-create/README.md|Deployment Create — [[entities/kubernetes.md|Kubernetes]] Deployment 控制器源码分析]]
