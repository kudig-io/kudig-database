...
echo "预期: 无输出 (已清理)"
```
> GC 机制详解参考: [04-operations.md](03-operations.md) 第 2 节 | [domain-03-networking-traffic/38-terway-gc-mechanism.md](32-发布/package/2026-07-02_18-53/corpus/peripheral/domain-03-networking-traffic/00-core-k8s-networking/30-terway-gc-mechanism.md)
...
```
> 安全组配置参考: [03-usage.md](./[[32-发布/package/2026-07-02_18-53/corpus/core/domain-03-networking-traffic/topic-terway/01-usage|03-usage]].md) 第 2 节

---

## 8. 性能基准测试

> 详细性能分析参考: [06-performance.md](32-发布/package/2026-07-02_18-53/corpus/supporting/domain-03-networking-traffic/topic-terway/01-performance.md)
...
| [03-usage.md](32-发布/package/2026-07-02_18-53/corpus/core/domain-03-networking-traffic/topic-terway/01-usage.md) | 安装配置、NetworkPolicy 使用、固定 IP 配置 |
| [04-operations.md](03-operations.md) | 健康检查、GC 机制详解、监控告警、故障排查 |
| [06-performance.md](32-发布/package/2026-07-02_18-53/corpus/supporting/domain-03-networking-traffic/topic-terway/01-performance.md) | 性能基准数据、内核调优、大规格实例优化 |

### Domain 知识库

| 文档 | 说明 |
|:---|:---|
| [domain-03-networking-traffic/05-terway-advanced-guide.md](32-发布/package/2026-07-02_18-53/corpus/supporting/domain-03-networking-traffic/00-core-k8s-networking/01-terway-advanced-guide.md) | Terway 高级指南（模式对比、容量规划） |
| [domain-03-networking-traffic/37-terway-resources-crud-operations.md](32-发布/package/2026-07-02_18-53/corpus/peripheral/domain-03-networking-traffic/00-core-k8s-networking/29-terway-resources-crud-operations.md) | Terway CRD 资源 CRUD 操作 |
| [domain-03-networking-traffic/38-terway-gc-mechanism.md](32-发布/package/2026-07-02_18-53/corpus/peripheral/domain-03-networking-traffic/00-core-k8s-networking/30-terway-gc-mechanism.md) | GC 垃圾回收机制详解 |
