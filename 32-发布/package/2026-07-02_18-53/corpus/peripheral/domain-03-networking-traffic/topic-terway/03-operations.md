...
> 本节内容综合整理自 [domain-03-networking-traffic/38-terway-gc-mechanism.md](32-发布/package/2026-07-02_18-53/corpus/peripheral/domain-03-networking-traffic/00-core-k8s-networking/30-terway-gc-mechanism.md)
...
> 本节内容提取自 [domain-03-networking-traffic/38-terway-gc-mechanism.md](32-发布/package/2026-07-02_18-53/corpus/peripheral/domain-03-networking-traffic/00-core-k8s-networking/30-terway-gc-mechanism.md) 第 4 节。
...
> 详细性能调优参考: [06-performance.md](32-发布/package/2026-07-02_18-53/corpus/supporting/domain-03-networking-traffic/topic-terway/01-performance.md)
...
| [03-usage.md](./[[32-发布/package/2026-07-02_18-53/corpus/core/domain-03-networking-traffic/topic-terway/01-usage|03-usage]].md) | 使用指南: 安装配置、NetworkPolicy、固定 IP |
| [05-testing.md](04-testing.md) | 测试验证: 连通性测试、NetworkPolicy 测试、GC 验证 |
...
| 文档 | 说明 |
|:---|:---|
| [domain-03-networking-traffic/38-terway-gc-mechanism.md](32-发布/package/2026-07-02_18-53/corpus/peripheral/domain-03-networking-traffic/00-core-k8s-networking/30-terway-gc-mechanism.md) | GC 机制详解: 架构、源码分析、执行流程 |
| [domain-03-networking-traffic/37-terway-resources-crud-operations.md](32-发布/package/2026-07-02_18-53/corpus/peripheral/domain-03-networking-traffic/00-core-k8s-networking/29-terway-resources-crud-operations.md) | CRD 资源 CRUD 操作 |
| [domain-03-networking-traffic/05-terway-advanced-guide.md](32-发布/package/2026-07-02_18-53/corpus/supporting/domain-03-networking-traffic/00-core-k8s-networking/01-terway-advanced-guide.md) | Terway 高级指南: 容量规划、模式对比 |
