...
- **高可用不足**: 单个 Prometheus 实例问题会导致监控数据丢失
...
SLO/SLI 体系是 Google SRE 方法的核心。它将服务的可靠性从模糊的"尽量不出问题"转变为可量化的、可管理的数据驱动流程。
...
- [Grafana 企业级可观测性](32-发布/package/2026-07-02_18-53/corpus/supporting/domain-06-observability/07-tools/01-grafana-enterprise-observability.md)
