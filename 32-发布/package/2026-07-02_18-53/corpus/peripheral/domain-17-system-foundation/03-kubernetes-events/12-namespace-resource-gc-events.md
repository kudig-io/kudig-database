...
intent_queries:
- Namespace、资源管理与垃圾回收事件 是什么
- 如何 Namespace、资源管理与垃圾回收事件
...
- [02 - Pod 与容器生命周期事件](32-发布/package/2026-07-02_18-53/corpus/core/domain-17-system-foundation/02-kubernetes-events/01-pod-container-lifecycle-events.md) - Pod 终止和驱逐事件
- [05 - 调度与抢占事件](04-scheduling-preemption-events.md) - Pod 调度和资源分配
- [06 - 节点生命周期与状态事件](05-node-lifecycle-condition-events.md) - 节点压力和驱逐
- [07 - Deployment 与 ReplicaSet 事件](06-deployment-replicaset-events.md) - FailedCreate 事件
