...
skill_ref:
- '[[32-发布/package/2026-07-02_18-53/corpus/supporting/domain-03-networking-traffic/00-core-k8s-networking/07-nginx-ingress-complete-guide|Nginx
  Ingress 完全指南]]'
...
> - 参考 [[32-发布/package/2026-07-02_18-53/corpus/core/domain-03-networking-traffic/00-core-k8s-networking/02-ingress-monitoring-troubleshooting|Ingress 监控与排障]] 配置入口延迟、5xx 比例、Controller CPU/内存使用率告警；
