...
skill_ref:
- '[[32-发布/package/2026-07-02_18-53/corpus/supporting/domain-01-cluster-fundamentals/03-control-plane/10-kubelet-eviction-thresholds|kubelet
  驱逐阈值]]'
- '[[32-发布/package/2026-07-02_18-53/corpus/supporting/domain-02-workloads-applications/00-core-workloads/06-node-management-operations|节点管理运维]]'
fta_ref:
...
>
> **后续建议：**
> - 参考 [[32-发布/package/2026-07-02_18-53/corpus/supporting/domain-01-cluster-fundamentals/03-control-plane/10-kubelet-eviction-thresholds|kubelet 驱逐阈值]] 为节点池配置合理的磁盘告警；
