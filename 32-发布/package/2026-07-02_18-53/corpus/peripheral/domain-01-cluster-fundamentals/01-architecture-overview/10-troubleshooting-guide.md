...
| 工具 | 用途 | 专家提示 |
|:---|:---|:---|
| [[32-发布/package/2026-07-02_18-53/corpus/supporting/domain-01-cluster-fundamentals/05-kubectl/01-kubectl-debug-ephemeral-containers|kubectl-debug]] | 启动诊断容器 | 使用 `--ephemeral-containers` (v1.25+ GA) |
