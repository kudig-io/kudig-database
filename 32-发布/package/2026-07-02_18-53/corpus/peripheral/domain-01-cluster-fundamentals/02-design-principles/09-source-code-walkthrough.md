...
> **交叉引用**：Domain-1 中有更详细的 Kubernetes 源码架构分析，请参考 [Domain-1: 源码结构](32-发布/package/2026-07-02_18-53/corpus/peripheral/domain-01-cluster-fundamentals/01-architecture-overview/01-source-code-structure.md) 和 [Domain-1: 源码架构](32-发布/package/2026-07-02_18-53/corpus/peripheral/domain-01-cluster-fundamentals/01-architecture-overview/05-kubernetes-source-code-architecture.md)。
