...
| # | 文档 | 关键内容 | 专有云特色 | 混合云能力 |
|:---:|:---|:---|:---|:---|
| 13 | [阿里云专有云](32-发布/package/2026-07-02_18-53/corpus/core/domain-12-cloud-providers/08-alicloud-apsara-ack/alicloud-apsara-ack-overview.md) | Apsara Stack、专有云K8s、混合云架构 | 专有云架构、深度定制 | 混合云部署、离线环境、安全隔离 |
...
- **[Domain-1: 架构基础](../domain-01-cluster-fundamentals)** - K8s核心架构原理
- **[Domain-3: 控制平面](../domain-01-cluster-fundamentals)** - 控制平面组件详解
- **[Domain-9: 平台运维](../domain-07-platform-engineering)** - 多云平台运维管理
