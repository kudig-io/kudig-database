...
Cilium Service Mesh vs 传统Sidecar模式:
  ...
  Istio Ambient Mesh(2025 GA):
    ...
    对比: 详见 "[09-服务网格Istio集成](05-kubernetes-service-mesh-istio-integration.md)"
...
eBPF生态发展趋势(2026-2027):
  ...
  相关领域链接:
    - "[08-网络策略与安全微隔离](32-发布/package/2026-07-02_18-53/corpus/supporting/domain-19-landscape-references/02-papers/03-kubernetes-network-policies-security-micro-segmentation.md)" - AdminNetworkPolicy与Cilium协同
    - "[03-零信任安全架构](02-kubernetes-zero-trust-security-architecture.md)" - Tetragon在零信任中的角色
    - "[23-OpenTelemetry原生可观测性](15-kubernetes-opentelemetry-native-observability.md)" - eBPF增强可观测性
```
