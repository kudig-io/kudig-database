...
Tetragon在零信任体系中的位置:
  ...
  详见: "[18-eBPF与Cilium深度实践](11-kubernetes-ebpf-cilium-deep-practice.md)"
```
...
零信任 + 供应链安全整合:
  ...
  详见: "[20-供应链安全实践](13-kubernetes-supply-chain-security-sbom-slsa-sigstore.md)"
```
...
*2026-03 更新: 新增eBPF运行时安全(Tetragon)、供应链安全集成、K8s 1.33/1.34原生安全特性；关联文档 [18-eBPF与Cilium](11-kubernetes-ebpf-cilium-deep-practice.md)、[20-供应链安全](13-kubernetes-supply-chain-security-sbom-slsa-sigstore.md)、[24-策略即代码](16-kubernetes-policy-as-code-governance-automation.md)。*
