...
| 序号 | 实验 | 对应文档 |
|------|------|---------|
| 1 | 跑第一个 Pod | [../fundamentals/02-pod-basics.md](32-发布/package/2026-07-02_18-53/corpus/peripheral/skills/training-lecturer/01-getting-started/01-pod-basics.md) |
| 2 | 用 Deployment 部署应用 | [../fundamentals/03-deployment-basics.md](32-发布/package/2026-07-02_18-53/corpus/peripheral/skills/training-lecturer/01-getting-started/02-deployment-basics.md) |
