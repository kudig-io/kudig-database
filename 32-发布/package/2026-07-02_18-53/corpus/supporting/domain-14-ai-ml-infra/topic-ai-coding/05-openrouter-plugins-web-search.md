...
| 文档 | 关系 |
|------|------|
| [06 - Structured Outputs](04-openrouter-structured-outputs-tools.md) | Response Healing 与工具调用 |
| [05 - API 参考](32-发布/package/2026-07-02_18-53/corpus/peripheral/domain-14-ai-ml-infra/topic-ai-coding/02-openrouter-api-reference.md) | plugins 请求参数详解 |
| [08 - Prompt Caching](32-发布/package/2026-07-02_18-53/corpus/peripheral/domain-14-ai-ml-infra/topic-ai-coding/03-openrouter-prompt-caching-optimization.md) | 成本优化策略 |
| [10 - 流式传输](07-openrouter-streaming-multimedia.md) | 插件与流式的配合 |
