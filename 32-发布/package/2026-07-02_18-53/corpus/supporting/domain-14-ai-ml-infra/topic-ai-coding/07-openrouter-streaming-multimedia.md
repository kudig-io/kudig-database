...
| 文档 | 关系 |
|------|------|
| [05 - API 参考](32-发布/package/2026-07-02_18-53/corpus/peripheral/domain-14-ai-ml-infra/topic-ai-coding/02-openrouter-api-reference.md) | 流式响应 Schema 详解 |
| [07 - 插件与 Web Search](05-openrouter-plugins-web-search.md) | File Parser 插件与 PDF 解析 |
| [09 - 框架集成](06-openrouter-frameworks-integrations.md) | Vercel AI SDK 流式 UI 集成 |
| [12 - 企业级实践](32-发布/package/2026-07-02_18-53/corpus/peripheral/domain-14-ai-ml-infra/topic-ai-coding/05-openrouter-enterprise-advanced.md) | 故障排查与最佳实践 |
