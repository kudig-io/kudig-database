...
| 文档 | 关系 |
|------|------|
| [05 - API 参考](32-发布/package/2026-07-02_18-53/corpus/peripheral/domain-14-ai-ml-infra/topic-ai-coding/02-openrouter-api-reference.md) | Tool Calling 请求/响应 Schema |
| [07 - 插件与 Web Search](05-openrouter-plugins-web-search.md) | Response Healing 插件详解 |
| [09 - 框架集成](06-openrouter-frameworks-integrations.md) | LangChain/LlamaIndex Tool 集成 |
