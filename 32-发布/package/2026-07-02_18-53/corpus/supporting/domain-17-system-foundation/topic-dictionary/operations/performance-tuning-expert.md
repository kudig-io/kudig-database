...
**前置知识要求**:
- **基础**: Kubernetes架构(API Server、[[domain-17-system-foundation/知识字典/fundamentals/etcd.md|etcd]]、调度器)、Pod生命周期、资源请求与限制
- **中级**: 存储类(StorageClass)、网络插件(CNI)、监控体系([[Prometheus|Prometheus]]/Grafana)
- **专家**: Linux内核调优、容器运行时原理、网络栈优化、应用性能分析

**关联文件**:
- [./operations-best-practices.md](././operations-best-practices.md) - 运维最佳实践,包含日常性能管理流程
- [./failure-patterns-analysis.md](././failure-patterns-analysis.md) - 故障模式分析,性能问题的故障诊断方法
...
| 主题 | 文件 | 说明 |
|------|------|------|
| **运维最佳实践** | [./operations-best-practices.md](././operations-best-practices.md) | 日常运维中的性能管理流程和最佳实践,包括资源规划、变更管理等 |
| **故障模式分析** | [./failure-patterns-analysis.md](././failure-patterns-analysis.md) | 性能相关的故障模式识别和诊断方法,如CPU throttling、OOM、网络延迟等 |
| **SRE成熟度模型** | [./sre-maturity-model.md](././sre-maturity-model.md) | SRE体系中的性能工程能力评估和成熟度提升路径 |
...
| **控制平面故障排查** | [../domain-10-troubleshooting-diagnostics/topic-structural-trouble-shooting/01-control-plane/](../domain-10-troubleshooting-diagnostics/高级排障/01-control-plane/) | API Server、etcd、调度器的性能故障排查详细指南 |
| **网络故障排查** | [../domain-10-troubleshooting-diagnostics/topic-structural-trouble-shooting/03-networking/](../domain-10-troubleshooting-diagnostics/高级排障/03-networking/) | CNI插件、Service、网络策略的性能问题诊断 |
| **存储故障排查** | [../domain-10-troubleshooting-diagnostics/topic-structural-trouble-shooting/04-storage/](../domain-10-troubleshooting-diagnostics/高级排障/04-storage/) | PV/PVC、CSI驱动的性能问题分析和优化 |
| **网络深入指南** | [../domain-03-networking-traffic/](../domain-03-networking-traffic/) | Kubernetes网络架构、Service Mesh、网关API等网络性能优化专题 |

---

**优化建议流程**:
1. **新手入门**: 先阅读[./operations-best-practices.md](././operations-best-practices.md)了解基础运维规范
2. **性能诊断**: 使用本文第1节工具识别瓶颈,结合[./failure-patterns-analysis.md](././failure-patterns-analysis.md)分析故障模式
