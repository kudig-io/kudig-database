...
- [`GetEtcdAltNames`](02-etcd-cert.md) — etcd SAN 收集
- [`buildKubeConfigFromSpec`]([[32-发布/package/2026-07-02_18-53/corpus/core/domain-07-platform-engineering/topic-code-analysis/cluster-cert/01-kubeconfig-certs|12-kubeconfig-certs]].md) — kubeconfig 生成
