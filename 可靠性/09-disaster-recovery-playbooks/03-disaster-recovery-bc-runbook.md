...
```
> 详细步骤与数据校验参见 [[可靠性/09-disaster-recovery-playbooks/03-etcd-corruption-recovery-playbook.md|etcd 数据损坏检测与恢复全流程]]。
...
- **无法恢复且备份不可用**：启动“控制面全损重建”流程，按 [[可靠性/09-disaster-recovery-playbooks/06-control-plane-loss-recovery-playbook.md|控制面全部丢失的灾难恢复]] 从 snapshot 重建集群。
...
- [[可靠性/09-disaster-recovery-playbooks/02-az-failure-playbook.md|可用区故障恢复手册]]
- [[可靠性/09-disaster-recovery-playbooks/03-etcd-corruption-recovery-playbook.md|etcd 数据损坏检测与恢复全流程]]
- [[可靠性/09-disaster-recovery-playbooks/06-control-plane-loss-recovery-playbook.md|控制面全部丢失的灾难恢复]]
- [[可靠性/01-backup-recovery/01-etcd-backup-restore.md|etcd 备份与恢复]]
- [[可靠性/02-disaster-recovery/99-velero-backup-recovery-guide.md|Velero 企业级备份恢复实践指南]]
- [[可靠性/02-disaster-recovery/18-cross-region-disaster-recovery.md|跨区域灾难恢复]]
- [[可靠性/02-disaster-recovery/17-disaster-recovery-drills.md|灾难恢复演练]]
- [[生产运维/99-production-readiness-operations-guide.md|生产运维生产就绪指南]]
- [[发布变更/99-production-readiness-operations-guide.md|发布变更管理生产就绪指南]]
- [[云厂商/99-production-readiness-operations-guide.md|云厂商生产就绪指南]]
- [[集群基础/99-production-readiness-operations-guide.md|集群基础生产就绪指南]]
- [[存储/99-production-readiness-operations-guide.md|存储数据生产就绪指南]]
