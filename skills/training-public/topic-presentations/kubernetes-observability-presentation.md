...
| 隔离性 | 共享采集器，一个故障影响全节点 | 独立采集器，故障隔离 |
...
| **EFK** | Elasticsearch + Fluentd + Kibana | Fluentd 比 Logstash 更轻量 | 学习曲线陡 | Kubernetes 原生日志 |
...
| 红线 | 说明 | 违反后果 |
|------|------|---------|
| **红线 1** | 监控系统必须独立于业务集群部署 | 业务集群故障导致监控也瘫痪 |
| **红线 2** | 核心业务必须有对应的可视化看板 | 故障时无法快速评估影响范围 |
...
| **红线 7** | etcd 和控制平面组件必须有独立监控面板 | 控制平面故障无法及时发现 |
