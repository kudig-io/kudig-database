...
<!-- chunk: 演示文稿模板结构（Standard Presentation Structure） -->## 演示文稿模板结构（Standard Presentation Structure）
...
<!-- chunk: Mermaid 图表模板库（Mermaid Diagram Template Library） -->## Mermaid 图表模板库（Mermaid Diagram Template Library）
...
<!-- chunk: 实验设计模板（Lab Design Template） -->## 实验设计模板（Lab Design Template）
...
<!-- chunk: SRE 运维红线（SRE Guardrails） -->## SRE 运维红线（SRE Guardrails）
