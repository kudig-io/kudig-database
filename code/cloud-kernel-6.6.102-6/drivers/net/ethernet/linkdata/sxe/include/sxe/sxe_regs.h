...
#define SXE_SFP_STATE_PRESENT 0x00000004
...
#define SXE_EXTENDED_VLAN BIT(26)
...
#define SXE_SRRCTL_BASE 0x01014
#define SXE_SRRCTL(i) \
	({ \
		typeof(i) _i = (i);   \
...
#define SXE_RXDCTL_BASE 0x01028
#define SXE_RXDCTL(i) \
	({ \
		typeof(i) _i = (i);   \
...
#define SXE_LROCTL_BASE 0x0102C
#define SXE_LROCTL(i) \
	({ \
		typeof(i) _i = (i);   \
...
#define SXE_TPH_RXCTRL_BASE 0x0100C
#define SXE_TPH_RXCTRL(i) \
	({ \
		typeof(i) _i = (i);   \
