...
extern typeof(rhashtable_init_noprof) rhashtable_init __attribute__((alias("rhashtable_init_noprof")));
...
/* kapi: preserve original exported symbol */
#undef rhltable_init
extern typeof(rhltable_init_noprof) rhltable_init __attribute__((alias("rhltable_init_noprof")));
