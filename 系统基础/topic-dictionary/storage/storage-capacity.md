...
- CSI 临时卷（CSI [[系统基础/topic-dictionary/storage/ephemeral-volumes.md|ephemeral volumes]]es（卷）|volumes]]）的调度**不**考虑存储容量。
...
- [节点特定卷限制](./[[系统基础/topic-dictionary/storage/node-specific-volume-limits.md|node-specific-volume-limits]].md) — 节点级卷数量限制
