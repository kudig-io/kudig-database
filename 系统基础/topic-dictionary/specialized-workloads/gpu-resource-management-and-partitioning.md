...
Kubernetes 1.26+ 引入的 **[[系统基础/topic-dictionary/scheduling/dynamic-resource-allocation.md|Dynamic Resource Allocation]] (DRA)** 提供了比 Device Plugin 更灵活的资源模型。DRA 支持：
- 定义自定义资源分配语义
