...
- [[系统基础/知识字典/networking/service-internal-traffic-policy.md|Service Internal Traffic Policy]]](service-internal-traffic-policy.md) — 节点本地路由（互斥特性）
- [[系统基础/知识字典/networking/endpointslices.md|EndpointSlices]]](endpointslices.md) — hints 字段和 zone 信息
