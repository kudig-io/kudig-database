...
- [[系统基础/知识字典/scheduling/gang-scheduling.md|Gang Scheduling]]](./gang-scheduling.md) — 分布式 GPU 训练需要 DRA + gang 调度
- [[系统基础/知识字典/scheduling/pod-overhead.md|Pod Overhead]]](./pod-overhead.md) — DRA 设备的额外资源开销
