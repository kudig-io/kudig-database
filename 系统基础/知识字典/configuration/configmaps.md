...
4. **[[系统基础/topic-dictionary/fundamentals/the-kubernetes-api.md|Kubernetes API]] 读取**：在 Pod 内通过代码直接调用 Kubernetes API 读取 ConfigMap，可订阅变更事件，也能访问其他命名空间的 ConfigMap。
