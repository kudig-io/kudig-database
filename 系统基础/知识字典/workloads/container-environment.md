...
[[实体/kubernetes.md|[[Kubernetes|kubernetes]]]] 容器环境为容器提供了若干重要资源，包括文件系统、容器自身信息，以及集群中其他对象的信息。了解这些资源有助于开发人员在容器内正确获取运行时的上下文信息。
...
- **Pod 名称和命名空间**：通过 [[系统基础/知识字典/workloads/downward-api.md|Downward API]] 以环境变量的形式注入到容器中
