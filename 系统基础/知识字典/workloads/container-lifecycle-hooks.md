...
- [[系统基础/知识字典/workloads/disruptions.md|Disruptions]]](disruptions.md) — PDB 与优雅终止的配合
- [[系统基础/知识字典/workloads/deployments.md|Deployments]]](deployments.md) — 滚动更新中的 PreStop 行为
