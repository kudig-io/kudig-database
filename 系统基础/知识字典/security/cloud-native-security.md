...
- **运行时（Runtime）**：分为以下关键领域：
  - **访问（Access）**：保护 [[系统基础/知识字典/fundamentals/the-kubernetes-api.md|Kubernetes API]]，实施有效的认证与授权，使用 ServiceAccount 管理工作负载身份，启用 TLS 保护 API 流量。
...
- https://kubernetes.io/docs/concepts/[[系统基础/知识字典/security/cloud-native-security.md|cloud-native-security]]/
