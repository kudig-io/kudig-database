...
- [[系统基础/知识字典/fundamentals/kube-controller-manager.md|kube-controller-manager]]
- [[系统基础/知识字典/fundamentals/controller-manager.md|Controller Manager]]
...
- [[系统基础/知识字典/fundamentals/control-plane-node.md|Control Plane Node]]
...
- [[系统基础/知识字典/fundamentals/container-runtime.md|Container Runtime]]
...
- [[系统基础/知识字典/fundamentals/container2wasm.md|container2wasm]]
- [[系统基础/知识字典/fundamentals/hyperlight.md|Hyperlight]]
...
- [[系统基础/知识字典/fundamentals/labels-and-selectors.md|Labels and Selectors]]
- [[系统基础/知识字典/fundamentals/annotations.md|Annotations]]
- [[系统基础/知识字典/fundamentals/finalizers.md|Finalizers]]
- [[系统基础/知识字典/fundamentals/owners-and-dependents.md|Owners and Dependents]]
- [[系统基础/知识字典/fundamentals/object-names-and-ids.md|Object Names and IDs]]
- [[系统基础/知识字典/fundamentals/objects-in-kubernetes.md|Objects in Kubernetes]]
- [[系统基础/知识字典/fundamentals/field-selectors.md|Field Selectors]]
- [[系统基础/知识字典/fundamentals/recommended-labels.md|Recommended Labels]]
- [[系统基础/知识字典/fundamentals/leases.md|Leases]]

### 集群架构与机制

- [[系统基础/知识字典/fundamentals/kubernetes.md|Kubernetes]]
- [[系统基础/知识字典/fundamentals/cluster.md|Cluster]]
- [[系统基础/知识字典/fundamentals/kubernetes-components.md|Kubernetes Components]]
- [[系统基础/知识字典/fundamentals/controllers.md|Controllers]]
- [[系统基础/知识字典/fundamentals/kubernetes-self-healing.md|Self Healing]]
- [[系统基础/知识字典/fundamentals/garbage-collection.md|Garbage Collection]]
- [[系统基础/知识字典/fundamentals/kubernetes-object-management.md|Object Management]]
- [[系统基础/知识字典/fundamentals/the-kubernetes-api.md|The Kubernetes API]]
- [[系统基础/知识字典/fundamentals/the-kubectl-command-line-tool.md|kubectl]]
- [[系统基础/知识字典/fundamentals/kubernetes-concepts-reference.md|Concepts Reference]]
- [[系统基础/知识字典/fundamentals/communication-between-nodes-and-the-control-plane.md|Node-Control Plane 通信]]
- [[系统基础/知识字典/fundamentals/storage-versions.md|Storage Versions]]
- [[系统基础/知识字典/fundamentals/mixed-version-proxy.md|Mixed Version Proxy]]
- [[系统基础/知识字典/fundamentals/about-cgroup-v2.md|Cgroup v2]]

### 操作系统与底层

- [[系统基础/知识字典/fundamentals/flatcar.md|Flatcar]]
- [[系统基础/知识字典/fundamentals/kairos.md|Kairos]]
- [[系统基础/知识字典/fundamentals/bpfman.md|bpfman]]
...
- [[系统基础/知识字典/scheduling/kube-scheduler.md|kube-scheduler 调度]]
- [[系统基础/知识字典/networking/kube-proxy.md|kube-proxy 网络]]
- [[系统基础/知识字典/security/rbac.md|RBAC 权限]]
