...
- [[系统基础/知识字典/specialized-workloads/ai-infra-specialist.md|AI Infra Specialist（AI 基础设施专家）]]
- [[系统基础/知识字典/specialized-workloads/gpu-resource-management-and-partitioning.md|GPU Resource Management（GPU 资源管理与分区）]]
- [[系统基础/知识字典/specialized-workloads/kserve.md|KServe（模型推理服务）]]
- [[系统基础/知识字典/specialized-workloads/kserve-model-serving.md|KServe Model Serving（模型服务部署）]]
- [[系统基础/知识字典/specialized-workloads/kubeflow.md|Kubeflow（ML 平台）]]
- [[系统基础/知识字典/specialized-workloads/ray.md|Ray（分布式计算）]]
- [[系统基础/知识字典/specialized-workloads/kueue-job-queue-management.md|Kueue（作业队列管理）]]
- [[系统基础/知识字典/specialized-workloads/llm-inference-optimization.md|LLM Inference Optimization（LLM 推理优化）]]
- [[系统基础/知识字典/specialized-workloads/mlops-pipelines-and-model-registry.md|MLOps Pipelines（ML 流水线）]]
- [[系统基础/知识字典/specialized-workloads/modelpack.md|ModelPack（模型打包）]]
- [[系统基础/知识字典/specialized-workloads/kitops.md|KitOps（AI 资产打包）]]
- [[系统基础/知识字典/specialized-workloads/vector-databases-and-rag-infrastructure.md|Vector DB & RAG（向量数据库与 RAG）]]
- [[系统基础/知识字典/specialized-workloads/seldon.md|Seldon（模型部署）]]

### Serverless 与 FaaS 类

- [[系统基础/知识字典/specialized-workloads/knative.md|Knative（Serverless 框架）]]
- [[系统基础/知识字典/specialized-workloads/openfaas.md|OpenFaaS（函数计算）]]

### 边缘计算与 Wasm 类

- [[系统基础/知识字典/specialized-workloads/openyurt.md|OpenYurt（云边一体）]]
- [[系统基础/知识字典/specialized-workloads/spin.md|Spin（Wasm 运行时）]]
- [[系统基础/知识字典/specialized-workloads/spinkube.md|SpinKube（Wasm on K8s）]]
- [[系统基础/知识字典/specialized-workloads/wasmcloud.md|wasmCloud（分布式 Wasm）]]

### 虚拟化与混合 OS 类

- [[系统基础/知识字典/specialized-workloads/kubevirt.md|KubeVirt（VM on K8s）]]
- [[系统基础/知识字典/specialized-workloads/windows-containers-in-kubernetes.md|Windows Containers]]
- [[系统基础/知识字典/specialized-workloads/guide-for-running-windows-containers-in-kubernetes.md|Windows 容器实践指南]]

### HPC 与科学计算类

- [[系统基础/知识字典/specialized-workloads/hpc-and-bioinformatics.md|HPC & Bioinformatics]]
...
- [[系统基础/知识字典/multi-cloud/edge-computing-and-k3s.md|边缘计算与 K3s]]
- [[系统基础/知识字典/workloads/job-cronjob.md|Job/CronJob 工作负载]]
