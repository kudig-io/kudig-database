...
- [[系统基础/知识字典/operations/gitops.md|GitOps（原则与实践）]]
- [[系统基础/知识字典/operations/argo.md|ArgoCD]]
- [[系统基础/知识字典/operations/flux.md|Flux]]
- [[系统基础/知识字典/operations/tekton.md|Tekton（CI/CD）]]
- [[系统基础/知识字典/operations/pipecd.md|PipeCD]]
- [[系统基础/知识字典/operations/flagger.md|Flagger（渐进式交付）]]
- [[系统基础/知识字典/operations/rolling-update.md|滚动更新]]
- [[系统基础/知识字典/operations/rollback.md|回滚]]
- [[系统基础/知识字典/operations/change-management-release.md|变更管理]]

### SRE 与可靠性类

- [[系统基础/知识字典/operations/sli-slo-sla-engineering.md|SLI/SLO/SLA 工程]]
- [[系统基础/知识字典/operations/sre-maturity-model.md|SRE 成熟度模型]]
- [[系统基础/知识字典/operations/incident-management-runbooks.md|事件管理与 Runbook]]
- [[系统基础/知识字典/operations/production-troubleshooting-playbook.md|生产排障手册]]
- [[系统基础/知识字典/operations/failure-patterns-analysis.md|故障模式分析]]
- [[系统基础/知识字典/operations/pdb.md|Pod Disruption Budget]]
- [[系统基础/知识字典/operations/operations-best-practices.md|运维最佳实践]]
- [[系统基础/知识字典/operations/enterprise-ops-practices.md|企业运维实践]]

### 混沌工程类

- [[系统基础/知识字典/operations/chaos-engineering.md|混沌工程（原则）]]
- [[系统基础/知识字典/operations/chaos-mesh.md|Chaos Mesh]]
- [[系统基础/知识字典/operations/litmus.md|Litmus]]
- [[系统基础/知识字典/operations/chaosblade.md|ChaosBlade]]
- [[系统基础/知识字典/operations/krkn.md|Krkn]]
- [[系统基础/知识字典/operations/kube-burner.md|KubeBurner（压力测试）]]

### 备份与恢复类

- [[系统基础/知识字典/operations/backup-disaster-recovery.md|备份与灾难恢复]]
- [[系统基础/知识字典/operations/velero.md|Velero]]
- [[系统基础/知识字典/operations/k8up.md|K8Up]]
...
- [[系统基础/知识字典/operations/node-autoscaling.md|节点自动扩缩]]
- [[系统基础/知识字典/operations/node-shutdowns.md|节点关机]]
- [[系统基础/知识字典/operations/kured.md|Kured（重启守护）]]
- [[系统基础/知识字典/operations/upgrade.md|集群升级]]
- [[系统基础/知识字典/operations/scale.md|扩缩容]]
- [[系统基础/知识字典/operations/swap-memory-management.md|Swap 内存管理]]

### 成本与治理类

- [[系统基础/知识字典/operations/finops-and-cost-optimization.md|FinOps 与成本优化]]
- [[系统基础/知识字典/operations/greenops-and-carbon-aware-computing.md|GreenOps 与绿色计算]]
- [[系统基础/知识字典/operations/cloud-custodian.md|Cloud Custodian]]
- [[系统基础/知识字典/operations/capacity-planning-forecasting.md|容量规划]]

### 工具与平台类

- [[系统基础/知识字典/operations/k8sgpt.md|K8sGPT（AI 诊断）]]
- [[系统基础/知识字典/operations/holmesgpt.md|HolmesGPT]]
- [[系统基础/知识字典/operations/kuberhealthy.md|KuberHealthy]]
- [[系统基础/知识字典/operations/meshery.md|Meshery]]
- [[系统基础/知识字典/operations/kubean.md|Kubean]]
- [[系统基础/知识字典/operations/tinkerbell.md|Tinkerbell]]
- [[系统基础/知识字典/operations/konveyor.md|Konveyor]]
- [[系统基础/知识字典/operations/cert-manager.md|cert-manager]]
- [[系统基础/知识字典/operations/certificates.md|证书管理]]
- [[系统基础/知识字典/operations/installing-addons.md|Addon 安装]]
- [[系统基础/知识字典/operations/performance-tuning-expert.md|性能调优]]
...
- [[系统基础/知识字典/observability/alerting-and-slo-monitoring.md|告警与 SLO]]
- [[系统基础/知识字典/scheduling/cluster-autoscaler.md|Cluster Autoscaler]]
- [[系统基础/知识字典/reliability/chaos-engineering.md|混沌工程]]
