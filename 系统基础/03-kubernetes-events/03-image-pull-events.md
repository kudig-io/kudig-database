...
- **[Domain-12: Troubleshooting / 27-image-registry-troubleshooting.md](../../故障诊断/topic-structural-trouble-shooting/02-node-components/05-image-registry-troubleshooting.md)** - 镜像仓库故障排查
- **[Domain-12: Troubleshooting / 03-container-runtime-troubleshooting.md](../../故障诊断/topic-structural-trouble-shooting/02-node-components/03-container-runtime-troubleshooting.md)** - 容器运行时(containerd/docker)故障排查
- **[Domain-12: Troubleshooting / 01-pod-troubleshooting.md](../../故障诊断/topic-structural-trouble-shooting/05-workloads/01-pod-troubleshooting.md)** - Pod 故障排查综合指南
...
- **[Domain-5: Networking / DNS Configuration](../网络/03-dns-configuration.md)** - DNS 配置和故障排查(影响镜像仓库域名解析)
- **[Domain-5: Networking / Proxy Configuration](../网络/05-proxy-configuration.md)** - 代理配置(影响镜像拉取)

## 10.6 Domain-7: 安全

- **[Domain-7: Security / Secret Management](../安全/03-secret-management.md)** - Secret 管理(包括 ImagePullSecret)
- **[Domain-7: Security / RBAC](../安全/01-rbac.md)** - RBAC 权限管理(ServiceAccount imagePullSecrets)
