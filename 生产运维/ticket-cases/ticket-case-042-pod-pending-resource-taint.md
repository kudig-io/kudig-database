...
ticket_type: 调度失败
skill_ref:
- '[[故障诊断/topic-fta/list/pod-fta.md|Pod 异常故障树分析]]'
- '[[平台工程/governance/03-capacity-planning-resource-assessment.md|容量规划与资源评估]]'
fta_ref:
- '[[故障诊断/topic-fta/list/scheduler-fta.md|FTA: Scheduler
  异常]]'
...
> - 配置 [[平台工程/governance/03-capacity-planning-resource-assessment.md|容量规划]] 流程，评估节点池是否需要升级实例规格。
>
> 如有新异常请随时联系。
