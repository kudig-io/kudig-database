...
- '[[平台工程/治理/03-capacity-planning-resource-assessment.md|容量规划与资源评估]]'
fta_ref:
- '[[故障诊断/FTA故障树/list/scheduler-fta.md|FTA: Scheduler
  异常]]'
...
> - 配置 [[平台工程/治理/03-capacity-planning-resource-assessment.md|容量规划]] 流程，评估节点池是否需要升级实例规格。
>
> 如有新异常请随时联系。
