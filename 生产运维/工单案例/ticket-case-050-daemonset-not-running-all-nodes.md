...
skill_ref:
- '[[工作负载/核心工作负载/04-daemonset-management.md|DaemonSet
  管理]]'
- Logtail 排障
- '[[故障诊断/技能体系/skill-set/k8s-node-notready/SKILL.md|节点诊断
  Skill]]'
fta_ref:
...
> - 对带 Taint 的节点建立标准化 Toleration 清单，参考 [[工作负载/核心工作负载/04-daemonset-management.md|DaemonSet 管理]]；
