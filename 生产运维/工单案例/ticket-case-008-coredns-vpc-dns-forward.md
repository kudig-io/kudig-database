...
- name: KUDIG Team
  role: contributor
relationships:
- target: '[[系统基础/topic-dictionary/networking/dns-resolution.md]]'
  type: related_to
- target: '[[entities/coredns.md]]'
  type: related_to
- target: '[[系统基础/topic-dictionary/networking/dns.md]]'
  type: related_to
- target: '[[生产运维/ticket-cases/ticket-case-013-configmap-secret-update-not-effective.md]]'
  type: related_to
...
- CoreDNS (entities)
- 域名服务
- [[生产运维/ticket-cases/ticket-case-013-configmap-secret-update-not-effective.md|ConfigMap/Secret 更新后应用未生效]]
- 配置映射
