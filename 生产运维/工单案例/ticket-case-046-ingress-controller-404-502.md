...
skill_ref:
- '[[故障诊断/技能体系/skill-set/k8s-ingress-gateway/SKILL.md|Ingress
  网关诊断 Skill]]'
...
> - 在 CI/CD 中增加 Ingress 注解语法校验，参考 [[网络/K8s网络核心/25-ingress-monitoring-troubleshooting.md|Ingress 监控与排障]]；
