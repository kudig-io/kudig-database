...
skill_ref:
- '[[故障诊断/topic-skills/skill-set/k8s-ingress-gateway/SKILL.md|Ingress
  网关诊断 Skill]]'
...
> - 在 CI/CD 中增加 Ingress 注解语法校验，参考 [[网络/00-core-k8s-networking/25-ingress-monitoring-troubleshooting.md|Ingress 监控与排障]]；
