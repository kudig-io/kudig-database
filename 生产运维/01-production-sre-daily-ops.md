...
5. **事后复盘**：记录根因，更新 [[可靠性/事后复盘/02-postmortem-culture-guide.md|postmortem]] 和 [[元数据/KUDIG Knowledge Base Architecture.md|knowledge-base]]
...
- 阿里云组件升级公告订阅
- 升级前在测试集群验证兼容性
- 升级后检查 [[概念/cluster-upgrade-paths.md|cluster-upgrade-paths]] 确认版本匹配
...
- [[生产运维/02-change-management-guide.md|change-management-guide]] — 变更管理的详细流程
- [[生产运维/04-incident-response-template.md|incident-response-playbook]] — 事件响应操作手册
- [[生产运维/03-on-call-playbook.md|值班手册]] — 告警响应与值班规范
- [[可观测性/指标/index.md|指标监控]] — 监控体系设计
