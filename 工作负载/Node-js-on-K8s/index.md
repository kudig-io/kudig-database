...
| 文件 | 内容 |
|------|------|
| [[工作负载/Node-js-on-K8s/01-nodejs-production-kubernetes.md\|Node.js 生产部署]] | 生产级配置、内存管理、优雅关闭、健康检查 |
| [[工作负载/Node-js-on-K8s/02-nodejs-observability-performance.md\|Node.js 可观测性与性能]] | 性能调优、APM 集成、事件循环监控 |
...
- [[工作负载/核心工作负载/index.md|核心工作负载]] — K8s 原生工作负载控制器
- [[工作负载/多语言运行 时/index.md|多语言运行时]] — Go/Python/Rust 实践
