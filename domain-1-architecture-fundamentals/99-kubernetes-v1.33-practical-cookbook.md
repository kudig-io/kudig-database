...
Dynamic Resource Allocation (v1.33 GA) 允许 Pod 请求 GPU/FPGA 等外部资源，替代 Device Plugin 方案。
...
CoordinatedLeaderElection (v1.32 Alpha) 允许多个组件共享领导者选举配置，减少 etcd 压力。
