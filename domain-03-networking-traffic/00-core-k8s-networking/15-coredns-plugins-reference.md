...
intent_queries:
- CoreDNS 插件完整参考 (Plugins Reference) 是什么
- 如何 CoreDNS 插件完整参考 (Plugins Reference)
...
<!-- chunk: 一、插件分类总览 (Plugin Categories Overview) -->
...
<!-- chunk: 二、数据源插件 (Data Source Plugins) -->
...
<!-- chunk: 四、转发插件 (Forwarding Plugins) -->
...
<!-- chunk: 五、修改插件 (Modification Plugins) -->
...
<!-- chunk: 六、监控插件 (Monitoring Plugins) -->
