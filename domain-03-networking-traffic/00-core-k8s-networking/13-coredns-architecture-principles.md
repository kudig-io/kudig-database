...
intent_queries:
- CoreDNS 架构与核心原理 (Architecture & Principles) 是什么
- 如何 CoreDNS 架构与核心原理 (Architecture & Principles)
...
<!-- chunk: 一、CoreDNS 架构概览 (Architecture Overview) -->
...
<!-- chunk: 二、Kubernetes 集成架构 (Kubernetes Integration) -->
...
<!-- chunk: 三、插件链机制深度解析 (Plugin Chain In-Depth) -->
...
<!-- chunk: 四、高可用架构设计 (High Availability) -->
...
<!-- chunk: 五、集群规模与容量规划 (Capacity Planning) -->
...
<!-- chunk: 六、监控指标体系 (Monitoring Metrics) -->
...
<!-- chunk: 七、与kube-dns对比 (Comparison with kube-dns) -->
