...
<!-- chunk: 3. 10 分钟快速诊断流程 -->## 3. 10 分钟快速诊断流程
...
<!-- chunk: 4. ENI 分配异常诊断 -->## 4. ENI 分配异常诊断

#<!-- chunk: 4.1 决策树 -->## 4.1 决策树
...
<!-- chunk: 5. IP 地址池异常诊断 -->## 5. IP 地址池异常诊断

#<!-- chunk: 5.1 决策树 -->## 5.1 决策树
...
#<!-- chunk: 5.3 IP 泄漏检测脚本 -->## 5.3 IP 泄漏检测脚本
...
<!-- chunk: 6. CNI 插件异常诊断 -->## 6. CNI 插件异常诊断

#<!-- chunk: 6.1 决策树 -->## 6.1 决策树
...
<!-- chunk: 7. 节点网络异常诊断 -->## 7. 节点网络异常诊断

#<!-- chunk: 7.1 决策树 -->## 7.1 决策树
...
<!-- chunk: 8. 安全组/ACL 异常诊断 -->## 8. 安全组/ACL 异常诊断

#<!-- chunk: 8.1 安全组 + NetworkPolicy 优先级矩阵 -->## 8.1 安全组 + NetworkPolicy 优先级矩阵
...
<!-- chunk: 9. 控制面/云平台异常诊断 -->## 9. 控制面/云平台异常诊断

#<!-- chunk: 9.1 决策树 -->## 9.1 决策树
...
<!-- chunk: 10. AND 门组合故障 -->## 10. AND 门组合故障

#<!-- chunk: 10.1 IP 完全耗尽 (vSwitch 空 + IP 泄漏) -->## 10.1 IP 完全耗尽 (vSwitch 空 + IP 泄漏)
...
#<!-- chunk: 10.2 扩容网络阻塞 (ENI 配额满 + API 限流) -->## 10.2 扩容网络阻塞 (ENI 配额满 + API 限流)
...
<!-- chunk: 12. 生产级观测与证据清单 -->## 12. 生产级观测与证据清单

#<!-- chunk: 12.1 关键事件 -->## 12.1 关键事件
...
<!-- chunk: 13. IPVLAN 模式故障诊断（Terway v1.4+） -->## 13. IPVLAN 模式故障诊断（Terway v1.4+）

> **适用场景**: Terway IPVLAN 模式（ENIIP 模式）下的故障排查

#<!-- chunk: 13.1 决策树 -->## 13.1 决策树
...
<!-- chunk: 14. BGP 模式故障诊断（Terway v1.5+） -->## 14. BGP 模式故障诊断（Terway v1.5+）

> **适用场景**: Terway BGP 模式的动态路由故障

#<!-- chunk: 14.1 决策树 -->## 14.1 决策树
...
<!-- chunk: 15. Service/Ingress 流量异常诊断 -->## 15. Service/Ingress 流量异常诊断

#<!-- chunk: 15.1 决策树 -->## 15.1 决策树
...
<!-- chunk: 16. Terway 故障树完整速查（TE-9 全部底事件） -->## 16. Terway 故障树完整速查（TE-9 全部底事件）
...
<!-- chunk: 17. 与症状快速映射层集成 -->## 17. 与症状快速映射层集成
...
<!-- chunk: 18. 错误信息速查目录（扩展版） -->## 18. 错误信息速查目录（扩展版）
