...
- [Spring Boot on K8s](../domain-4-workloads/99-spring-boot-kubernetes-guide.md) — Spring Boot 对比参考
- [Java 容器化](../domain-13-docker/12-java-containerization-guide.md) — 容器构建优化
- [Java 性能 Sizing](../domain-12-troubleshooting/99-java-performance-resource-sizing-guide.md) — 资源配置
