...
| 编号 | 文章 | 主题 | 适用场景 |
|------|------|------|---------|
| 01 | [[03-清单模式/09-平台模式/01-crossplane-compositions-patterns\|Crossplane 组合模式]] | XRD/Composition 设计、Provider 配置、平台抽象 | 云资源自助服务、平台 API |
| 02 | [[03-清单模式/09-平台模式/02-cue-language-configuration\|CUE 语言配置]] | 类型安全配置、约束验证、模块化 | 配置标准化、合规检查 |
| 03 | [[03-清单模式/09-平台模式/03-jsonnet-tanka-patterns\|Jsonnet/Tanka 模式]] | 函数式配置、多环境管理、大型项目 | 复杂配置逻辑、多环境 |
...
- [[10-平台工程/01-构建/08-golden-paths-design|Golden Path 设计]]
...
- [[03-清单模式/09-平台模式/03-jsonnet-tanka-patterns|Jsonnet/Tanka 模式]]
- [[10-平台工程/01-构建/01-platform-engineering-overview|平台工程概述]]
