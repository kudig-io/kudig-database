...
5. **与 [[10-平台工程/01-构建/07-crossplane-platform-composition|Crossplane 平台组合]] 配合**：了解更完整的平台设计
6. **与 [[03-清单模式/09-平台模式/02-cue-language-configuration|CUE]] 结合**：使用 CUE 验证 XRD schema
7. **参考 [[10-平台工程/01-构建/01-platform-engineering-overview|平台工程概述]] 了解全局**
...
- [[24-综合/02-交付与GitOps/crossplane-iac|Crossplane IaC 综合]]
- [[10-平台工程/01-构建/06-kratix-platform-as-code|Kratix 平台即代码]]
