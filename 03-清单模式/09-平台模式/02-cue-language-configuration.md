...
6. **与 [[03-清单模式/09-平台模式/01-crossplane-compositions-patterns|Crossplane]] 配合**：CUE 验证 XRD Claim 配置
7. **与 [[03-清单模式/09-平台模式/03-jsonnet-tanka-patterns|Jsonnet/Tanka]] 对比**：根据团队技能选择
8. **参考 [[10-平台工程/01-构建/08-golden-paths-design|Golden Path 设计]] 了解平台配置策略**
