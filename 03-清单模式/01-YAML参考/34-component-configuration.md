...
- **版本化**：配置 API 遵循 [[17-系统基础/06-知识字典/fundamentals/the-kubernetes-api.md|Kubernetes API]] 版本控制原则，支持平滑升级
...
- [[10-平台工程/06-代码分析/node-create/10-kubelet-config.md|10-kubelet-config]]
- [[10-平台工程/06-代码分析/cluster-create/04-kubeconfig.md|04-kubeconfig]]
- [[10-平台工程/06-代码分析/cluster-create/24-what-kubeadm-does-not-install.md|24-what-kubeadm-does-not-install]]
- [[10-平台工程/06-代码分析/cluster-cert/13-cert-config.md|13-cert-config]]
```
