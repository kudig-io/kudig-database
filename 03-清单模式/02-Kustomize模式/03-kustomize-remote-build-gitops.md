...
- [[03-清单模式/02-Kustomize模式/01-kustomize-base-overlay-structure|Kustomize Base/Overlay 分层架构]]
- [[03-清单模式/02-Kustomize模式/02-kustomize-transformers-reference|Kustomize Transformers 参考]]
