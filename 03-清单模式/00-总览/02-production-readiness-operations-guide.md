...
- 使用 Pod Security Admission 将命名空间标记为 `enforce: restricted`：
  ...
  ```
- 参考 [[08-安全/04-策略治理/03-pod-security-standards.md|Pod Security Standards]] 配置基线策略，并在 CI 中集成策略校验。
...
- [[11-发布变更/01-GitOps/17-argo-cd-gitops-guide.md|ArgoCD GitOps 指南]]
- [[11-发布变更/01-GitOps/19-helm-production-guide.md|Helm 生产化指南]]
- [[08-安全/04-策略治理/08-kyverno-policy-guide.md|Kyverno 策略指南]]
- [[08-安全/04-策略治理/09-opa-gatekeeper-policy-guide.md|OPA Gatekeeper 策略指南]]
- [[09-可观测性/02-指标/05-monitoring-metrics-prometheus.md|Prometheus 监控指标实践]]
- [[12-可靠性/06-SRE实践/04-slo-sli-guide.md|SLO/SLI 指南]]
