...
related_topics:
  ...
  - topic-skills/assessment/k8s-fundamentals-quiz
  - topic-dictionary/k8s-glossary
...
| Day | 主题 | 文件 |
|:---:|------|------|
| Day 22 | Service 基础实操 | [day-22-service-basics/01-service-basics-hands-on.md](./day-22-service-basics/01-service-basics-hands-on.md) |
| Day 23 | Ingress 实操 | [day-23-ingress/01-ingress-hands-on.md](./day-23-ingress/01-ingress-hands-on.md) |
...
| kubectl 场景速查卡 | `topic-cheat-sheet/kubectl-scene-cheatsheet.md` | 命令场景对照 |
| 新人上手路径 | `topic-learn/quick-start/` | 快速入门指南 |
| 考核评估体系 | `topic-skills/assessment/` | 技能评估工具 |
| K8s 术语表 | `topic-dictionary/k8s-glossary.md` | 术语查询 |
| 故障排查手册 | `domain-12-troubleshooting/` | 故障排查参考 |
| 内部培训教案 | `topic-learn/inner-training/` | 详细教案 (阿里云版本) |
| 公开培训教案 | `topic-learn/public-training/` | 通用版本教案 |
...
related:
  - topic-learn/quick-start/README.md
  - topic-skills/assessment/k8s-fundamentals-quiz.md
  - topic-dictionary/k8s-glossary.md
---
```
