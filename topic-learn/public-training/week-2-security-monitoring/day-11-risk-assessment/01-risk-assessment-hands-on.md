...
related_topics:
  ...
  - vulnerability
related:
  - topic-learn/public-training/week-2-security-monitoring/day-08-rbac/01-rbac-hands-on.md
  - domain-7-security/05-pod-security-standards.md
  - domain-25-cloud-native-security/01-falco-cloud-native-security.md
---
```