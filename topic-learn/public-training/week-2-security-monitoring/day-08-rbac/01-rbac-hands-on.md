...
related_topics:
  ...
  - serviceaccount
related:
  - topic-learn/public-training/week-2-security-monitoring/day-09-ram-account-management.md
  - domain-12-troubleshooting/07-rbac-permission-troubleshooting.md
---
```