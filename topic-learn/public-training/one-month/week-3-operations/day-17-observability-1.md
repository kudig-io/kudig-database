...
related_topics:
  - topic-learn/public-training/one-month/week-3-operations/day-18-observability-2
...
- [监控指标系统](../../domain-8-observability/02-monitoring-metrics-system.md)
- [Prometheus 生产级配置](../../domain-8-observability/10-monitoring-metrics-prometheus.md)
- [告警管理](../../domain-8-observability/05-alerting-management.md)
