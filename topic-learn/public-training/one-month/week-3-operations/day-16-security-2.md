...
related_topics:
  ...
  - topic-fta/04-fta-core-principles
---
...
- [文件: `../../domain-7-security/06-pod-security-standards.md`](../../domain-7-security/06-pod-security-standards.md)
- [文件: `../../domain-7-security/11-secret-management-tools.md`](../../domain-7-security/11-secret-management-tools.md)
- [文件: `../../domain-7-security/14-policy-engines-opa-kyverno.md`](../../domain-7-security/14-policy-engines-opa-kyverno.md)
