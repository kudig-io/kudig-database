...
related_topics:
  ...
  - container
related:
  - topic-learn/public-training/one-month/week-2-core-tech/README.md
  - topic-learn/public-training/one-month/projects/p1-k8s-cluster-setup.md
---
```
...
| UTS | 主机名和域名 | 容器有自己的 hostname | Pod hostname |
...
- [Linux 系统架构](../../domain-14-linux/01-linux-system-architecture.md)
- [Linux 进程管理](../../domain-14-linux/02-linux-process-management.md)
- [Linux 网络配置](../../domain-14-linux/04-linux-networking-configuration.md)
- [K8s 架构总览](../../domain-1-architecture-fundamentals/01-kubernetes-architecture-overview.md)
- [K8s 核心组件深入](../../domain-1-architecture-fundamentals/02-core-components-deep-dive.md)
