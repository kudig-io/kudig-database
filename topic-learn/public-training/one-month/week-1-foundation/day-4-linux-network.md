...
1. **Linux 网络配置**
   - 文件: `../../domain-14-linux/04-linux-networking-configuration.md`
   - 重点: ip 命令、iptables 基础、路由表、网络命名空间

2. **性能调优**
   - 文件: `../../domain-14-linux/06-linux-performance-tuning.md`
   - 重点: 内核参数调优 (K8s 生产必做)

### 补充阅读

3. **运维基础操作**
   - 文件: `../../domain-14-linux/09-linux-operations-basics.md`
...
Day 5 将正式进入 Kubernetes 架构学习，理解 Master/Node 组件及其交互。
