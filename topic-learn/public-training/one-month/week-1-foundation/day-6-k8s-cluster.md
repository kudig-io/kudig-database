...
related_topics:
  ...
  - rollout
related:
  - topic-learn/public-training/one-month/week-1-foundation/day-5-k8s-architecture.md
...
- [集群配置参数](../../domain-1-architecture-fundamentals/06-cluster-configuration-parameters.md)
- [API 版本与特性](../../domain-1-architecture-fundamentals/03-api-versions-features.md)
