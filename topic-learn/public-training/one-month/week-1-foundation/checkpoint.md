...
related:
  ...
  - topic-learn/public-training/one-month/week-1-foundation/day-1-docker-basics.md
---
```
...
- [Docker 基础概念](../../domain-13-docker/01-docker-fundamentals-concepts.md)
- [K8s 架构总览](../../domain-1-architecture-fundamentals/01-kubernetes-architecture-overview.md)
- [K8s 核心组件](../../domain-1-architecture-fundamentals/02-core-components-deep-dive.md)
- [kubectl 命令参考](../../domain-1-architecture-fundamentals/05-kubectl-commands-reference.md)
- [Pod 排障指南](../../domain-12-troubleshooting/08-pod-comprehensive-troubleshooting.md)
