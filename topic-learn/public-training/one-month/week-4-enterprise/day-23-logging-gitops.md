...
related_topics:
  - topic-learn/public-training/one-month/week-4-enterprise/day-22-enterprise-monitoring
...
- [文件: `../../domain-21-logging-management-analytics/01-elk-stack-enterprise-logging.md`](../../domain-21-logging-management-analytics/01-elk-stack-enterprise-logging.md)
- [文件: `../../domain-23-gitops-ci-cd/01-argo-cd-enterprise-gitops.md`](../../domain-23-gitops-ci-cd/01-argo-cd-enterprise-gitops.md)
