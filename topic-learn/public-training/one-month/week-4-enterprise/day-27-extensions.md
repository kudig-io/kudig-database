...
- **证书管理**: 自动签发和轮转 TLS 证书（如 cert-manager）
...
- [CRD/Operator 开发](../../domain-9-platform-ops/20-crd-operator-development.md)
- [控制器模式](../../domain-2-design-principles/03-controller-pattern.md)
