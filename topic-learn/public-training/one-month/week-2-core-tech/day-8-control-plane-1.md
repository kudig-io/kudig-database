...
related_topics:
  ...
  - authentication
related:
  - topic-learn/public-training/one-month/week-2-core-tech/day-9-control-plane-2.md
...
深入理解 etcd 和 API Server 的工作原理，对于排查控制平面故障、优化集群性能和保障集群安全至关重要。本课程将从架构原理到实际操作，全面深入这两个核心组件。
...
etcd 是一个高可用的分布式键值存储系统，使用 Raft 共识算法保证数据一致性。在 Kubernetes 中，etcd 是唯一的数据存储后端，所有集群状态（Pod、Service、ConfigMap、Secret 等）都存储在 etcd 中。
...
- [文件: `../../domain-3-control-plane/11-etcd-deep-dive.md`](../../domain-3-control-plane/11-etcd-deep-dive.md)
- [文件: `../../domain-3-control-plane/12-apiserver-deep-dive.md`](../../domain-3-control-plane/12-apiserver-deep-dive.md)
- [文件: `../../domain-2-design-principles/07-distributed-consensus-etcd.md`](../../domain-2-design-principles/07-distributed-consensus-etcd.md)
