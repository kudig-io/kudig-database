...
related_topics:
  ...
  - storage
related:
  - topic-learn/public-training/one-month/week-1-foundation/README.md
  - topic-learn/public-training/one-month/week-3-devops-toolchain/README.md
---
```
...
推荐 3 个或 5 个节点（奇数个）。Raft 协议需要多数派同意才能提交数据，所以 3 节点允许 1 个故障，5 节点允许 2 个故障。超过 5 个节点会增加写入延迟但不提高容错能力，不建议。在 ACK 托管版中，etcd 由阿里云管理，无需关心。
...
- [etcd 深入](../../domain-3-control-plane/11-etcd-deep-dive.md)
- [API Server 深入](../../domain-3-control-plane/12-apiserver-deep-dive.md)
- [Scheduler 深入](../../domain-3-control-plane/20-kube-scheduler-deep-dive.md)
- [Deployment 生产模式](../../domain-4-workloads/02-deployment-production-patterns.md)
- [StatefulSet 高级操作](../../domain-4-workloads/03-statefulset-advanced-operations.md)
