...
1. **网络架构总览**
   - 文件: `../../domain-5-networking/01-network-architecture-overview.md`
   - 重点: K8s 网络模型、三层扁平网络

2. **CNI 架构基础**
   - 文件: `../../domain-5-networking/02-cni-architecture-fundamentals.md`
   - 重点: CNI 插件机制、常见 CNI 实现

3. **Service 概念和类型**
   - 文件: `../../domain-5-networking/06-service-concepts-types.md`
   - 重点: ClusterIP/NodePort/LoadBalancer/ExternalName

4. **DNS 和服务发现**
   - 文件: `../../domain-5-networking/11-dns-service-discovery-coredns.md`
