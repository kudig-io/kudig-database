...
metadata:
  name: standard
provisioner: kubernetes.io/gce-pd  # 或 aws-ebs / kubernetes.io/azure-disk
parameters:
...
related_topics:
  ...
  - csi
related:
  - topic-learn/public-training/week-4-network-storage/day-27-pvc-mount/01-pvc-mount-hands-on.md
  - domain-12-troubleshooting/10-pv-pvc-troubleshooting.md
---
```
