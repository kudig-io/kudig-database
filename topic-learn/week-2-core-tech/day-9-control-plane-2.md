...
1. **Scheduler 深入**
   - 文件: `../../domain-3-control-plane/20-kube-scheduler-deep-dive.md`
   - 重点: 调度算法、Filter/Score、调度框架

2. **Controller Manager 深入**
   - 文件: `../../domain-3-control-plane/13-kube-controller-manager-deep-dive.md`
   - 重点: 各种 Controller 的工作原理

3. **控制器模式**
   - 文件: `../../domain-2-design-principles/03-controller-pattern.md`
