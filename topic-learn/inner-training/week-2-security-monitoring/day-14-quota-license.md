...
related_topics:
  - topic-learn/inner-training/week-2-security-monitoring/checkpoint
  - domain-4-workloads/23-resource-management
  - domain-12-troubleshooting/24-quota-limitrange-troubleshooting
id: WEEK2-DAY14
topic: training
type: hands-on
...
- [资源管理](../../domain-4-workloads/23-resource-management.md)
- [配额排障](../../domain-12-troubleshooting/24-quota-limitrange-troubleshooting.md)
- [K8s Resource Quota 文档](https://kubernetes.io/docs/concepts/policy/resource-quotas/)
