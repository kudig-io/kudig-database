...
related_topics:
  ...
  - domain-8-observability/03-logging-architecture
id: WEEK2-DAY12
topic: training
type: hands-on
...
Kubernetes 审计（Audit）是集群安全体系中的重要组成部分，它记录了集群中发生的所有 API 操作，包括谁在什么时候对什么资源执行了什么操作。审计日志是安全合规、故障追溯和操作审计的基础，在安全事件响应中发挥着关键作用。
...
- **审计日志**记录所有 API 操作，是安全合规和故障追溯的基础
...
- [文件: `../../../domain-8-observability/01-observability-architecture-overview.md`](../../../domain-8-observability/01-observability-architecture-overview.md)
- [文件: `../../../domain-8-observability/03-logging-architecture.md`](../../../domain-8-observability/03-logging-architecture.md)
