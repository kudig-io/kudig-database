...
related_topics:
  ...
  - domain-7-security/01-authentication-authorization-system
  - domain-7-security/07-rbac-matrix-configuration
id: WEEK2-DAY8
topic: training
type: hands-on
...
- **资源（Resource）**: 操作的对象。如 pods、services、deployments、secrets 等
...
- [认证授权体系](../../domain-7-security/01-authentication-authorization-system.md)
- [RBAC 矩阵配置](../../domain-7-security/07-rbac-matrix-configuration.md)
- [安全架构总览](../../domain-1-architecture-fundamentals/14-security-architecture.md)
- [ACK 安全管理](../../domain-17-cloud-provider/04-alicloud-ack/270-ack-security.md)
