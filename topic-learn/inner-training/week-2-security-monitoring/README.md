...
related_topics:
  ...
  - topic-learn/inner-training/week-2-security-monitoring/day-8-rbac
  - topic-learn/inner-training/week-2-security-monitoring/day-12-cluster-audit
  - topic-learn/inner-training/week-2-security-monitoring/day-14-quota-license
id: WEEK2-INDEX
topic: training
type: week-index
...
- [证书管理](../../domain-7-security/10-certificate-management.md)
- [Secret 管理工具](../../domain-7-security/11-secret-management-tools.md)
