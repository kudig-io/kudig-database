...
| 资源 | 说明 |
|------|------|
| `topic-cheat-sheet/kubectl-scene-cheatsheet.md` | kubectl 场景速查卡 |
| `P1-5-oncall-quick-reference-card.md` | oncall 速查卡 |
| `domain-12-troubleshooting/` | 故障排查手册 |
| `topic-skills/assessment/daily-check-quiz.md` | 每日一题 |
