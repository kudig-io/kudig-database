...
| 场景 | 参考文档 |
|------|---------|
| Pod 故障 | `topic-cheat-sheet/kubectl-scene-cheatsheet.md` |
| Service 问题 | `P1-5-oncall-quick-reference-card.md` |
| 节点问题 | `domain-12-troubleshooting/02-node-notready-troubleshooting.md` |
| 网络问题 | `domain-12-troubleshooting/03-service-endpoints-troubleshooting.md` |
...
related_topics:
  - topic-learn/quick-start/01-day-one-checklist
