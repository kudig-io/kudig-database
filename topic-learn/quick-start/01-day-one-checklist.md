...
2. `topic-cheat-sheet/kubectl-scene-cheatsheet.md` — kubectl 场景速查
3. `domain-12-troubleshooting/00-troubleshooting-overview.md` — 故障排查总览
4. `topic-learn/public-training/week-1-ack-acr-lifecycle/README.md` — Week 1 培训
...
related_topics:
  - topic-learn/quick-start/02-first-ticket-guide
  - topic-learn/quick-start/03-oncall-handoff
