...
深海设备一旦部署，维护成本极高。系统设计需要高度自主和容错：AUV 需要自主避障和应急上浮能力；海底观测网需要问题自检测和冗余切换能力；所有设备需要看门狗和自动重启机制。软件系统需要防御性编程，对硬件问题、通信中断、数据异常等场景有完善的处理逻辑。
...
#<!-- chunk: 7.4 单点问题 -->## 7.4 单点问题

关键系统无冗余设计，单点问题导致整个任务失败。
