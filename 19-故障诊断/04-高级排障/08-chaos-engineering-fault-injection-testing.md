...
# 42 - 混沌工程和故障注入测试 ([[17-系统基础/06-知识字典/operations/chaos-engineering.md|Chaos Engineering]] and Fault Injection Testing)
...
- **[33-性能瓶颈故障排查](../03-基础设施排障/09-performance-bottleneck-troubleshooting.md)** - 性能退化测试
- **[34-升级迁移故障排查](../03-基础设施排障/10-upgrade-migration-troubleshooting.md)** - 升级过程中断测试
- **[39-企业级监控告警体系](05-enterprise-monitoring-alerting-system.md)** - 混沌实验监控告警配置
- **[41-事件驱动架构故障排查](07-event-driven-architecture-troubleshooting.md)** - 事件流系统韧性测试
...
- [[19-故障诊断/04-高级排障/06-large-scale-cluster-operations.md|40-large-scale-cluster-operations]]
- [[19-故障诊断/04-高级排障/07-event-driven-architecture-troubleshooting.md|41-event-driven-architecture-troubleshooting]]
