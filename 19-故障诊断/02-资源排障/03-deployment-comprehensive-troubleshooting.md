...
- **[17-HPA/VPA故障排查](09-hpa-vpa-troubleshooting.md)** - 自动扩缩容相关问题
- **[34-升级迁移故障排查](../03-基础设施排障/10-upgrade-migration-troubleshooting.md)** - 版本升级兼容性问题

### 📚 扩展学习资料
- **[Kubernetes控制器模式](../../01-集群基础/02-设计原则/04-controller-pattern.md)** - 理解Deployment控制器原理
- **[资源版本控制](../../01-集群基础/02-设计原则/07-resource-version-control.md)** - 资源状态管理机制
