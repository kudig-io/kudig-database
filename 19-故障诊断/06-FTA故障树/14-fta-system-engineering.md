...
> **上一章**: [第十三章：智能工单处理的 AI Agent 架构](./13-intelligent-ticket-processing.md)  
...
| **执行引擎** | Ansible + kubectl | Terraform, Pulumi | Ansible 适合节点级操作，kubectl 适合 [[23-实体/02-K8s核心组件/kubernetes|k8s]] 操作 |
