...
> **⚠️ 历史版本声明**：本文档为 v1.0（8 个顶事件 / 63 个底事件），**已由 [kubernetes-fta-full-analysis-v2.md](./kubernetes-fta-full-analysis-v2.md)（16 个顶事件 / ~300 个底事件）取代**。新排障场景请使用 v2；本文档保留作为历史参考与排查命令速查。
> **最后更新**: 2024年
...
- 无法创建/启动容器
- `crictl`/`[[23-实体/03-运行时/docker|docker]]` 命令无法执行
