...
# 用法: cd 故障诊断/topic-skills && bash scripts/batch-generate-wave1.sh
...
python3 "$SCRIPT_DIR/skill-generator.py" \
  ...
  --source-structural "故障诊断/36-helm-chart-troubleshooting.md" \
...
python3 "$SCRIPT_DIR/skill-generator.py" \
  ...
  --source-structural "故障诊断/topic-structural-trouble-shooting/05-workloads/05-service-mesh-istio-troubleshooting.md" \
...
python3 "$SCRIPT_DIR/skill-generator.py" \
  ...
  --source-structural "故障诊断/topic-structural-trouble-shooting/08-cluster-operations/05-crd-operator-troubleshooting.md" \
...
python3 "$SCRIPT_DIR/skill-generator.py" \
  ...
  --source-structural "故障诊断/31-backup-restore-troubleshooting.md" \
...
python3 "$SCRIPT_DIR/skill-generator.py" \
  ...
  --source-structural "故障诊断/topic-structural-trouble-shooting/10-ai-ml-workloads/01-ai-ml-workloads-troubleshooting.md" \
