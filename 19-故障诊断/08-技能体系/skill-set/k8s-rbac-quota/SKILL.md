...
summary: Kubernetes RBAC 权限不足、ResourceQuota 超限的完整诊断-修复-验证 Skill
...
| 单文件完整版 | [../09-rbac-quota-failure.md](../../10-rbac-quota-failure.md) |
...
- [[22-概念/05-安全/rbac-authorization.md|RBAC 授权]] — Kubernetes 基于角色的访问控制与权限模型
