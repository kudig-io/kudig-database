...
> 1. **影响范围**：多少 Pod / [[17-系统基础/06-知识字典/fundamentals/namespaces.md|命名空间]] / 节点受影响？
...
**工程师**：「Pod 一直在 Pending」/「[[23-实体/02-K8s核心组件/deployment.md|Deployment]] 滚动更新卡住了」/「新发布的版本起不来」
...
**分支决策**：
- **C1**：DNS 解析失败 → 升级至 [[26-技能/03-节点/node/skill-notready/skill-k8s-node-notready-SKILL.md|SKILL]]-NET-001（DNS 问题诊断）
...
如专有云Harbor无法访问：
1. 检查Harbor Pod状态
2. 检查Harbor [[17-系统基础/06-知识字典/networking/service.md|Service]]
3. 检查节点到Harbor网络连通性
4. 如Harbor异常，联系平台团队
...
| 需要修改节点系统级配置 | **节点管理团队** | systemd、[[23-实体/02-K8s核心组件/kubelet.md|kubelet]] 等 |
