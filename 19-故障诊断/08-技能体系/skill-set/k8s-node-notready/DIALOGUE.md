...
- target: '[[23-实体/02-K8s核心组件/kubernetes.md]]'
  type: uses
- target: '[[31-脚本/video-scripts/node-notready.md]]'
  type: uses
---
...
# [[31-脚本/video-scripts/node-notready.md|Node NotReady]] 远程顾问对话脚本

> 本脚本用于远程顾问指导现场工程师诊断和修复 [[23-实体/02-K8s核心组件/kubernetes.md|Kubernetes]] 节点 NotReady 问题。
...
- **[[23-实体/04-网络/cilium.md|Cilium]]**：检查 cilium-agent Pod，确认 eBPF 状态
