...
2. 是否使用了 Service Mesh（[[23-实体/04-网络/istio.md|Istio]] / Linkerd）？如果是，请检查 sidecar 资源使用
3. 节点网络带宽使用率是否接近上限？"
...
- **磁盘 IO 饱和导致 [[23-实体/02-K8s核心组件/etcd.md|etcd]] 响应慢**，影响整个集群稳定性
...
顾问："当前情况已超出本 [[26-技能/03-节点/node/skill-notready/skill-k8s-node-notready-SKILL.md|Skill]] 的自主修复范围，建议立即升级。
