...
- target: '[[23-实体/04-网络/cilium.md]]'
  type: uses
- target: '[[17-系统基础/06-知识字典/configuration/configmaps.md]]'
  type: uses
- target: '[[17-系统基础/06-知识字典/fundamentals/nodes.md]]'
  type: uses
---
...
> **⚠️ 重要提醒**：本 [[26-技能/03-节点/node/skill-notready/skill-k8s-node-notready-SKILL.md|Skill]] 为 **L1-advisory** 模式。所有操作均为建议性质，必须由安全团队和人工审批后执行。Agent 不会自动执行任何可能影响证据或扩大影响的操作。
...
3. **访问范围**：尝试访问了哪些资源？（secrets / [[17-系统基础/06-知识字典/configuration/configmaps.md|configmaps]] / pods / [[17-系统基础/06-知识字典/fundamentals/nodes.md|nodes]]）"
...
> **替代方案 B**：如果是 [[23-实体/04-网络/cilium.md|Cilium]]，使用 Calico NetworkPolicy 或 CiliumNetworkPolicy 限制
