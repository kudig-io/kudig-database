...
func Config(kubeadmConfigVersion string, data ConfigData) (config string, err error) {
	...
	case "v1":
		templateSource = configTemplatev1
	case "v1beta4":
		templateSource = configTemplatev1beta4
	default:
...
func GetKubeadmConfigVersion(kubeadmVersion *K8sVersion.Version) string {
	...
	// TODO: enable v1 by default for versions where it becomes available.
	return "v1"
}
...
// configTemplatev1beta4 is the kubeadm config template for API version v1beta4
const configTemplatev1beta4 = `# config generated by kind
...
// configTemplatev1 is the kubeadm config template for API version v1beta4
const configTemplatev1 = `# config generated by kind
