...
![benchmark-1](../../资产/images/benchmark-1.jpg)

#### Latency

Note the y-axis latency in **microsecond(μs)** not millisecond.

![latency-1](../../资产/images/latency-1.jpg)

#### Flame Graph

The result of Flame Graph:
![flamegraph-1](../../资产/images/flamegraph-1.jpg)
...
![benchmark-2](../../资产/images/benchmark-2.jpg)

#### Latency

Note the y-axis latency in **microsecond(μs)** not millisecond.

![latency-2](../../资产/images/latency-2.jpg)

#### Flame Graph

The result of Flame Graph:
![flamegraph-2](../../资产/images/flamegraph-2.jpg)
