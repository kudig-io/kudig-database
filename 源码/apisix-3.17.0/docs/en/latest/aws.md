...
![Apache APISIX Serverless Architecture](../../资产/images/aws-fargate-cdk.png)
...
![upstream with AWS NLB IP addresses](../../资产/images/aws-nlb-ip-addr.png)
![service with created upstream](../../资产/images/aws-define-service.png)
![define route with service and uri](../../资产/images/aws-define-route.png)

## Validation

OK. Let's test the `/index.php` on `{apiSix.ApiSixServiceServiceURL}/index.php`

![Testing Apache APISIX on AWS Fargate](../../资产/images/aws-caddy-php-welcome-page.png)
