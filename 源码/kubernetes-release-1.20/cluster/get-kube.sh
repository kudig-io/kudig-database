...
# <path>/<version> (e.g. "发布/stable",' "ci/latest-1") by reading from GCS.
#
...
release=${KUBERNETES_RELEASE:-"发布/stable"}

# Validate Kubernetes release version.
# Translate a published version <bucket>/<version> (e.g. "发布/stable") to version number.
