...
SYNC_FILES="CODE_OF_CONDUCT.md LICENSE Makefile.common SECURITY.md .dockerignore .yamllint 脚本/golangci-lint.yml .github/workflows/govulncheck.yml .github/workflows/scorecards.yml .github/workflows/container_description.yml .github/workflows/stale.yml"
...
process_repo() {
  ...
  for source_file in ${SYNC_FILES}; do
    ...
    if ! check_go "${org_repo}" "${default_branch}" ; then
      if [[ "${source_file}" == '脚本/golangci-lint.yml' ]] ; then
