...
go mod edit -go=${NEW_VERSION}.0 站点/ui/mantine-ui/src/promql/tools/go.mod
...
sed -i "s/go-version: ${NEW_VERSION}\.x/go-version: ${LATEST_VERSION}.x/g" 脚本/golangci-lint.yml .github/workflows/*.yml
sed -i "s/golang-builder:${NEW_VERSION}-base/golang-builder:${LATEST_VERSION}-base/g" .github/workflows/*.yml
sed -i "s/go-version: ${CURRENT_VERSION}\.x/go-version: ${NEW_VERSION}.x/g" 脚本/golangci-lint.yml .github/workflows/*.yml
