...
impact to end-users. See the [Breaking changes](文档/coding-guidelines.md#breaking-changes) section
...
(e.g. a new feature or enhancement) please first read our [vision](文档/vision.md)
...
If you're new to the Collector, the [internal architecture](文档/internal-architecture.md) documentation may be helpful.
...
See the [Coding Guidelines](文档/coding-guidelines.md) document for more information.
...
See [release](文档/release.md) for details.
