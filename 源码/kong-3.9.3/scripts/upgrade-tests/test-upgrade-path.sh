...
COMPOSE="docker compose -p $ENV_PREFIX -f 脚本/upgrade-tests/docker-compose.yml"
...
function prepare_container() {
    ...
    docker cp 脚本/upgrade-tests/luarocks-system-lua $1:/usr/local/bin/luarocks
}
...
old_versions=()
mapfile -t old_versions < "脚本/upgrade-tests/source-versions"
