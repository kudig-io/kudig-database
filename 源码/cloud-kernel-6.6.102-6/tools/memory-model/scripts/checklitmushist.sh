...
# See 脚本/parseargs.sh for list of arguments.
#
...
then
	...
	echo Run 脚本/initlitmushist.sh first, need litmus repo.
	exit 1
fi
...
脚本/runlitmushist.sh < $T/list-C-short > $T/runlitmushist.sh.out 2>&1
