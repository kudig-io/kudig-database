...
|---|---|---|---|
| **Entities** | `实体/` | 工具、产品、公司、人物 | Docker, Prometheus, CNCF |
| **Concepts** | `概念/` | 概念、模式、技术、方法 | Pod 生命周期, Raft 共识 |
| **Syntheses** | `综合/` | 跨域综合、对比分析、趋势 | 多云对比, 可观测性全景 |
| **Sources** | `研究/` | 研究性笔记、调研报告 | Service Mesh 演进研究 |
| **Skills** | `技能/` | Agent Skill 定义、能力模块 | K8s 排障技能 |
...
| 目录 | 中文简称，英文工具名保留 | `GitOps/`, `eBPF/`, `控制平面/` |
...
- [[元数据/domain-mapping.md|Domain 映射]] — 目录结构规范
- [[元数据/corpus-config/rag-chunking-strategy.md|RAG 分块策略]] — 语料分块规范
