...
|---|---|---|---|
| **Certificate / PKI Lifecycle** | Cert expiry and CA rotation are recurring P0/P1 causes. | 01, 05, 07, 08, 09, 11, 16 | 平台工程 / 可靠性 |
| **Multi-Cluster / Fleet / GitOps at Scale** | Production platforms are multi-cluster; needs ApplicationSet, OCM/Karmada, secret sync, global LB. | 02, 03, 07, 08, 09, 11, 12, 14, 18, 20 | 云厂商 / 发布变更 |
| **Disaster Recovery / Business Continuity** | Needs actionable runbooks for control plane, etcd, AZ/region, network, stateful workloads. | 01, 03, 04, 07, 09, 11, 12, 14, 16, 20 | 可靠性 |
| **Production Readiness Review (PRR)** | Standard SRE gate for production launches. | 07, 09, 11, 20 | 可靠性 / 平台工程 |
| **Incident Response / On-Call Runbooks** | Severity routing, escalation, communication, postmortem. | 01, 07, 09, 10, 11, 14 | 生产运维 / 故障诊断 |
| **FinOps / Cost Governance** | Right-sizing, spot/preemptible, chargeback/showback, autoscaling economics. | 02, 04, 07, 08, 11, 12, 14, 18, 20 | 生产运维 / 平台工程 |
| **Observability / SLO Operations** | RED/USE, SLO/SLI, alert routing, cardinality governance, self-monitoring. | 03, 06, 09, 11, 18, 20 | 可观测性 / 生产运维 |
| **Node & Runtime Security Hardening** | SELinux/AppArmor/seccomp, privileged restrictions, runtime threat detection, PSA. | 01, 04, 05, 07, 11, 13, 17 | 安全 / 容器运行时 |
| **GPU / AI-ML Operations** | GPU scheduling, MIG/time-slicing, DCGM, RDMA, training/inference DR, spot GPU. | 02, 06, 13, 14, 17 | AI基础设施 |
| **Edge / WebAssembly Production** | Fleet lifecycle, network-partition tolerance, Wasm runtime hardening, observability. | 10, 15 | 专项技术 |
| **Cloud Provider Operational Runbooks** | Provider-specific upgrade, DR, observability, security, IAM, storage, troubleshooting. | 12, 17 | 云厂商 |
| **Cluster Upgrade / Rollback Runbooks** | High-risk recurring operation; needs pre-checks, skew checks, rollback gates. | 01, 08, 09, 11, 12 | 集群基础 / 可靠性 |
| **Image Registry / Supply Chain Security** | Hardened registry, signing, admission verification, promotion pipelines. | 08, 13 | 容器运行时 / 安全 |
| **Stateful Workload DR** | Databases, Kafka, Redis, PVC snapshots, cross-region failover, restore drills. | 02, 04, 09, 16, 20 | 存储 / 数据库中间件 |
