...
> **交叉引用**：API Server 准入控制的详细实现请参考 [Domain-3: API Server 深度解析](../03-%E6%8E%A7%E5%88%B6%E5%B9%B3%E9%9D%A2/12-apiserver-deep-dive.md) 和 [Domain-3: 认证授权深度解析](../03-控制平面/28-authz-authn-deep-dive.md)。
