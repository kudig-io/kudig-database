...
### 1.2 [[17-系统基础/06-知识字典/workloads/sidecar-containers.md|Sidecar Containers]]：Pod 生命周期语义增强
...
**设计影响**: [[17-系统基础/06-知识字典/scheduling/dynamic-resource-allocation.md|Dynamic Resource Allocation]] (v1.33 GA) 将控制器模式扩展到了**硬件资源分配领域**。
