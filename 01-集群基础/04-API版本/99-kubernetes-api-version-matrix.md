...
[[17-系统基础/06-知识字典/fundamentals/the-kubernetes-api.md|Kubernetes API]] 资源在不同版本间的字段稳定性分为：
...
related:
  - 集群基础/03-api-versions-features.md
  - 清单模式/01-yaml-syntax-resource-conventions.md
---
```
