...
> **适用版本**: v1.25 - v1.33 | **最后更新**: 2026-04-24 | **参考**: [[23-实体/02-K8s核心组件/kubernetes.md|kubernetes]].io/docs/reference/kubernetes-api](https://kubernetes.io/docs/reference/kubernetes-api/)
