...
intent_queries:
- CNI 容器网络接口深度解析 (Container Network Interface Deep Dive) 是什么
- 如何 CNI 容器网络接口深度解析 (Container Network Interface Deep Dive)
...
5. [[23-实体/04-网络/cilium.md|Cilium]] 深度解析](#5-cilium-深度解析)
...
| 概念 | 描述 | 作用 |
|------|------|------|
| **[[22-概念/15-运行时与系统/container-runtime.md|Container Runtime]]** | 容器运行时 ([[containerd|containerd]]/CRI-O) | 调用 CNI 插件 |
