...
| **BootstrapsignerController** | ConfigMap | ConfigMap | 为[[23-实体/02-K8s核心组件/kubelet.md|kubelet]]引导签名Token |
...
- [[10-平台工程/06-代码分析/kubernetes-core/03-kube-controller-manager-deep-dive.md|KCM 源码深度剖析（控制器注册表/选主/调谐链行号级实现）]]
