...
- **全集群证书灾难**：参考 [[12-可靠性/02-灾难恢复/22-certificate-expiry-mass-rotation-playbook.md|集群证书批量过期紧急轮转]]。该场景下通常需要 SSH 登录控制平面节点，在时间回退或救援模式下完成证书续期。
...
- [[12-可靠性/02-灾难恢复/22-certificate-expiry-mass-rotation-playbook.md|集群证书批量过期紧急轮转]]
- [[01-集群基础/03-控制平面/35-kubeadm-cluster-lifecycle.md|kubeadm 集群生命周期管理]]
