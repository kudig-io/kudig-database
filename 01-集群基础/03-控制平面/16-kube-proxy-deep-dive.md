...
<!-- chunk: 附录: 无 kube-proxy 模式 (eBPF替代) -->
...
- [[10-平台工程/06-代码分析/kubernetes-core/07-component-interaction-dataflow.md|组件交互与数据流源码分析（BoundedFrequencyRunner 防抖同步机制）]]
