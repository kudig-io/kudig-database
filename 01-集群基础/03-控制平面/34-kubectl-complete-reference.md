...

{
  "clientVersion": {
    ...
    "minor": "35",
    "gitVersion": "v1.35.3",
    "gitCommit": "6c1cd99aef09161ddb07b8ade6c9564e9b9[[23-实体/04-网络/bfe.md|bfe]]27",
    "gitTreeState": "clean",
...
> 完整深度指南请参考 → [[01-集群基础/05-kubectl/01-kubectl-debug-ephemeral-containers|kubectl debug 深度指南]]（ephemeral 容器注入、节点调试、Pod 复制调试、Profile 调试及生产故障排查工作流）
...
- [[10-平台工程/06-代码分析/deployment-create/01-overview.md|01-overview]]
- [[10-平台工程/06-代码分析/cluster-delete/01-overview.md|01-overview]]
