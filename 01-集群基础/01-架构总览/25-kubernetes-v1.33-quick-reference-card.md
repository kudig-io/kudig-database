...
| 文档 | 内容 |
|:---|:---|
| [99-kubernetes-v1.29-v1.33-features-guide.md](20-kubernetes-v1.29-v1.33-features-guide.md) | 按版本详解 |
| [99-kubernetes-core-components-v1.29-v1.33-update.md](16-kubernetes-core-components-v1.29-v1.33-update.md) | 按组件速查 |
| [99-kubernetes-v1.33-upgrade-guide.md](../06-升级路径/04-kubernetes-v1.33-upgrade-guide.md) | 升级实操 |
| [99-kubectl-v1.29-v1.33-new-commands-guide.md](../05-kubectl/04-kubectl-v1.29-v1.33-new-commands-guide.md) | kubectl 新命令 |
| [99-kubernetes-v1.33-production-best-practices.md](24-kubernetes-v1.33-production-best-practices.md) | 生产最佳实践 |
| [99-kubernetes-version-lifecycle-support-policy.md](../04-API版本/04-kubernetes-version-lifecycle-support-policy.md) | 版本生命周期 |
| [99-kubernetes-v1.33-ecosystem-compatibility-matrix.md](22-kubernetes-v1.33-ecosystem-compatibility-matrix.md) | 兼容性矩阵 |
