...
intent_queries:
- Kubernetes 源码结构深度解析 是什么
- 如何 Kubernetes 源码结构深度解析
...
<!-- chunk: staging/ 独立发布机制：客户端库与接口定义 -->
...
<!-- chunk: 调度器代码结构（Scheduler Framework） -->
...
<!-- chunk: API Server 代码结构（Control Plane Core） -->
...
<!-- chunk: 控制器代码结构（Controller Manager） -->
...
- [[10-平台工程/06-代码分析/kubernetes-core/01-source-tree-architecture.md|源码整体架构与目录结构（kubernetes-core 源码级剖析，行号实测）]]
- [[10-平台工程/06-代码分析/kubernetes-core/README.md|kubernetes-core 源码解析系列总览]]
